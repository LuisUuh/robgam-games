...
d.kc = function (a) {
    ...
    if (a = Uh(this, a)) {
        ...
        c == Zd(document) ? (k = e.x - c.scrollLeft, e = e.y - c.scrollTop,
            !x || 10 <= Number(wb) || (k += h.left, e += h.top)) : (k = e.x - f.x - h.left, e = e.y - f.y - h.top);
        b = jh(b);
...
w.g.CANNOT_DELETE_VARIABLE_PROCEDURE = 'No se puede eliminar la variable "%1" porque es parte de la definici\u00f3n de la funci\u00f3n "%2"';
...
w.g.COLOUR_BLEND_TOOLTIP = "Combina dos colores con una proporci\u00f3n determinada (0,0\u20131,0).";
...
w.g.COLOUR_RGB_TOOLTIP = "Crea un color con cantidades espec\u00edficas de rojo, verde y azul. Todos los valores deben encontrarse entre 0 y 100.";
...
w.g.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE = "continuar con la siguiente iteraci\u00f3n del bucle";
w.g.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK = "Romper el bucle que lo contiene.";
w.g.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE = "Saltar el resto de este bucle, y continuar con la siguiente iteraci\u00f3n.";
w.g.CONTROLS_FLOW_STATEMENTS_WARNING = "Atenci\u00f3n: este bloque puede usarse solamente dentro de un bucle.";
...
w.g.CONTROLS_FOREACH_TOOLTIP = "Para cada elemento en una lista, establecer la variable '%1' al elemento y luego hacer algunas declaraciones.";
...
w.g.CONTROLS_FOR_TOOLTIP = 'Hacer que la variable "%1" tome los valores desde el n\u00famero de inicio hasta el n\u00famero final, contando con el intervalo especificado, y hacer los bloques especificados.';
w.g.CONTROLS_IF_ELSEIF_TOOLTIP = "Agregar una condici\u00f3n a este bloque.";
w.g.CONTROLS_IF_ELSE_TOOLTIP = "Agregar una condici\u00f3n general final a este bloque.";
w.g.CONTROLS_IF_HELPURL = "https://github.com/google/blockly/wiki/IfElse";
w.g.CONTROLS_IF_IF_TOOLTIP = "Agregar, eliminar o reordenar las secciones para reconfigurar este bloque.";
w.g.CONTROLS_IF_MSG_ELSE = "sino";
w.g.CONTROLS_IF_MSG_ELSEIF = "sino si";
w.g.CONTROLS_IF_MSG_IF = "si";
w.g.CONTROLS_IF_TOOLTIP_1 = "Si un valor es verdadero, entonces hacer algunas declaraciones.";
w.g.CONTROLS_IF_TOOLTIP_2 = "Si un valor es verdadero, entonces hacer el primer bloque de declaraciones.  De lo contrario, hacer el segundo bloque de declaraciones.";
w.g.CONTROLS_IF_TOOLTIP_3 = "Si el primer valor es verdadero, entonces hacer el primer bloque de declaraciones. De lo contrario, si el segundo valor es verdadero, hacer el segundo bloque de declaraciones.";
w.g.CONTROLS_IF_TOOLTIP_4 = "Si el primer valor es verdadero, entonces hacer el primer bloque de declaraciones. De lo contrario, si el segundo valor es verdadero, hacer el segundo bloque de declaraciones. Si ninguno de los valores son verdaderos, hacer el \u00faltimo bloque de declaraciones.";
...
w.g.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL = "Mientras un valor sea falso, entonces hacer algunas declaraciones.";
w.g.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE = "Mientras un valor sea verdadero, entonces hacer algunas declaraciones.";
...
w.g.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR = "Esta funci\u00f3n tiene entradas duplicadas.";
...
w.g.IOS_VARIABLES_EMPTY_NAME_ERROR = "No puedes usar un nombre de variable vac\u00edo.";
...
w.g.LISTS_CREATE_EMPTY_TOOLTIP = "Devuelve una lista, de longitud 0, sin ning\u00fan dato";
w.g.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = "lista";
w.g.LISTS_CREATE_WITH_CONTAINER_TOOLTIP = "Agregar, eliminar o reorganizar las secciones para reconfigurar este bloque de lista.";
...
w.g.LISTS_CREATE_WITH_TOOLTIP = "Crear una lista con cualquier n\u00famero de elementos.";
...
w.g.LISTS_GET_INDEX_TOOLTIP_GET_FIRST = "Devuelve el primer elemento de una lista.";
w.g.LISTS_GET_INDEX_TOOLTIP_GET_FROM = "Devuelve el elemento en la posici\u00f3n especificada en una lista.";
w.g.LISTS_GET_INDEX_TOOLTIP_GET_LAST = "Devuelve el \u00faltimo elemento de una lista.";
w.g.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM = "Devuelve un elemento aleatorio en una lista.";
w.g.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST = "Elimina y devuelve el primer elemento de una lista.";
w.g.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM = "Elimina y devuelve el elemento en la posici\u00f3n especificada en una lista.";
w.g.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_LAST = "Elimina y devuelve el \u00faltimo elemento de una lista.";
w.g.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_RANDOM = "Elimina y devuelve un elemento aleatorio en una lista.";
w.g.LISTS_GET_INDEX_TOOLTIP_REMOVE_FIRST = "Elimina el primer elemento de una lista.";
w.g.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM = "Elimina el elemento en la posici\u00f3n especificada en una lista.";
w.g.LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST = "Elimina el \u00faltimo elemento de una lista.";
w.g.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM = "Elimina un elemento aleatorio en una lista.";
...
w.g.LISTS_GET_SUBLIST_TOOLTIP = "Crea una copia de la parte especificada de una lista.";
...
w.g.LISTS_INDEX_OF_LAST = "encontrar la \u00faltima aparici\u00f3n del elemento";
w.g.LISTS_INDEX_OF_TOOLTIP = "Devuelve el \u00edndice de la primera/\u00faltima aparici\u00f3n del elemento en la lista. Devuelve %1 si el elemento no se encuentra.";
...
w.g.LISTS_ISEMPTY_TOOLTIP = "Devuelve verdadero si la lista est\u00e1 vac\u00eda.";
...
w.g.LISTS_REPEAT_TOOLTIP = "Crea una lista que consta de un valor dado repetido el n\u00famero de veces especificado.";
...
w.g.LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST = "Inserta el elemento al inicio de una lista.";
w.g.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM = "Inserta el elemento en la posici\u00f3n especificada en una lista.";
w.g.LISTS_SET_INDEX_TOOLTIP_INSERT_LAST = "A\u00f1ade el elemento al final de una lista.";
w.g.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM = "Inserta el elemento aleatoriamente en una lista.";
w.g.LISTS_SET_INDEX_TOOLTIP_SET_FIRST = "Establece el primer elemento de una lista.";
w.g.LISTS_SET_INDEX_TOOLTIP_SET_FROM = "Establece el elemento en la posici\u00f3n especificada en una lista.";
w.g.LISTS_SET_INDEX_TOOLTIP_SET_LAST = "Establece el \u00faltimo elemento de una lista.";
w.g.LISTS_SET_INDEX_TOOLTIP_SET_RANDOM = "Establece un elemento aleatorio en una lista.";
...
w.g.LISTS_SORT_TYPE_IGNORECASE = "alfab\u00e9tico, ignorar may\u00fascula/min\u00fascula";
...
w.g.LISTS_SPLIT_TOOLTIP_JOIN = "Unir una lista de textos en un solo texto, separado por un delimitador.";
w.g.LISTS_SPLIT_TOOLTIP_SPLIT = "Dividir el texto en una lista de textos, separando en cada delimitador.";
...
w.g.LOGIC_COMPARE_HELPURL = "https://es.wikipedia.org/wiki/Desigualdad_matem\u00e1tica";
w.g.LOGIC_COMPARE_TOOLTIP_EQ = "Devuelve verdadero si ambas entradas son iguales.";
w.g.LOGIC_COMPARE_TOOLTIP_GT = "Devuelve verdadero si la primera entrada es mayor que la segunda entrada.";
w.g.LOGIC_COMPARE_TOOLTIP_GTE = "Devuelve verdadero si la primera entrada es mayor o igual a la segunda entrada.";
w.g.LOGIC_COMPARE_TOOLTIP_LT = "Devuelve verdadero si la primera entrada es menor que la segunda entrada.";
w.g.LOGIC_COMPARE_TOOLTIP_LTE = "Devuelve verdadero si la primera entrada es menor que o igual a la segunda entrada.";
w.g.LOGIC_COMPARE_TOOLTIP_NEQ = "Devuelve verdadero si ambas entradas son distintas.";
w.g.LOGIC_NEGATE_HELPURL = "https://github.com/google/blockly/wiki/Logic#not";
w.g.LOGIC_NEGATE_TITLE = "no %1";
w.g.LOGIC_NEGATE_TOOLTIP = "Devuelve verdadero si la entrada es falsa. Devuelve falso si la entrada es verdadera.";
w.g.LOGIC_NULL = "nulo";
...
w.g.LOGIC_OPERATION_TOOLTIP_AND = "Devuelve verdadero si ambas entradas son verdaderas.";
w.g.LOGIC_OPERATION_TOOLTIP_OR = "Devuelve verdadero si al menos una de las entradas es verdadera.";
...
w.g.LOGIC_TERNARY_TOOLTIP = 'Comprueba la condici\u00f3n en "prueba". Si la condici\u00f3n es verdadera, devuelve el valor "si es verdadero"; de lo contrario, devuelve el valor "si es falso".';
...
w.g.MATH_ARITHMETIC_TOOLTIP_DIVIDE = "Devuelve el cociente de ambos n\u00fameros.";
w.g.MATH_ARITHMETIC_TOOLTIP_MINUS = "Devuelve la diferencia de ambos n\u00fameros.";
w.g.MATH_ARITHMETIC_TOOLTIP_MULTIPLY = "Devuelve el producto de ambos n\u00fameros.";
w.g.MATH_ARITHMETIC_TOOLTIP_POWER = "Devuelve el primer n\u00famero elevado a la potencia del segundo.";
...
w.g.MATH_CHANGE_TOOLTIP = "A\u00f1adir un n\u00famero a la variable \u00ab%1\u00bb.";
w.g.MATH_CONSTANT_HELPURL = "https://es.wikipedia.org/wiki/Anexo:Constantes_matem\u00e1ticas";
w.g.MATH_CONSTANT_TOOLTIP = "Devuelve una de las constantes comunes: \u03c0 (3.141\u2026), e (2.718\u2026), \u03c6 (1.618\u2026), sqrt(2) (1.414\u2026), sqrt(\u00bd) (0.707\u2026) o \u221e (infinito).";
w.g.MATH_CONSTRAIN_HELPURL = "https://en.wikipedia.org/wiki/Clamping_(graphics)";
w.g.MATH_CONSTRAIN_TITLE = "limitar %1 entre %2 y %3";
w.g.MATH_CONSTRAIN_TOOLTIP = "Limitar un n\u00famero entre los l\u00edmites especificados (inclusive).";
...
w.g.MATH_IS_TOOLTIP = "Comprueba si un n\u00famero es par, impar, primo, entero, positivo, negativo, o si es divisible por un n\u00famero determinado. Devuelve verdadero o falso.";
...
w.g.MATH_ONLIST_TOOLTIP_AVERAGE = "Devuelve el promedio (media aritm\u00e9tica) de los valores num\u00e9ricos en la lista.";
w.g.MATH_ONLIST_TOOLTIP_MAX = "Devuelve el n\u00famero m\u00e1s grande en la lista.";
w.g.MATH_ONLIST_TOOLTIP_MEDIAN = "Devuelve la mediana en la lista.";
w.g.MATH_ONLIST_TOOLTIP_MIN = "Devuelve el n\u00famero m\u00e1s peque\u00f1o en la lista.";
w.g.MATH_ONLIST_TOOLTIP_MODE = "Devuelve una lista de los elementos m\u00e1s comunes en la lista.";
w.g.MATH_ONLIST_TOOLTIP_RANDOM = "Devuelve un elemento aleatorio de la lista.";
w.g.MATH_ONLIST_TOOLTIP_STD_DEV = "Devuelve la desviaci\u00f3n est\u00e1ndar de la lista.";
w.g.MATH_ONLIST_TOOLTIP_SUM = "Devuelve la suma de todos los n\u00fameros en la lista.";
w.g.MATH_POWER_SYMBOL = "^";
w.g.MATH_RANDOM_FLOAT_HELPURL = "https://es.wikipedia.org/wiki/Generador_de_n\u00fameros_aleatorios";
w.g.MATH_RANDOM_FLOAT_TITLE_RANDOM = "fracci\u00f3n aleatoria";
w.g.MATH_RANDOM_FLOAT_TOOLTIP = "Devuelve una fracci\u00f3n aleatoria entre 0,0 (ambos inclusive) y 1.0 (exclusivo).";
w.g.MATH_RANDOM_INT_HELPURL = "https://es.wikipedia.org/wiki/Generador_de_n\u00fameros_aleatorios";
w.g.MATH_RANDOM_INT_TITLE = "entero aleatorio de %1 a %2";
w.g.MATH_RANDOM_INT_TOOLTIP = "Devuelve un entero aleatorio entre los dos l\u00edmites especificados, inclusive.";
...
w.g.MATH_SINGLE_TOOLTIP_LOG10 = "Devuelve el logaritmo base 10 de un n\u00famero.";
...
w.g.MATH_SINGLE_TOOLTIP_ROOT = "Devuelve la ra\u00edz cuadrada de un n\u00famero.";
w.g.MATH_SUBTRACTION_SYMBOL = "-";
w.g.MATH_TRIG_ACOS = "acos";
w.g.MATH_TRIG_ASIN = "asin";
w.g.MATH_TRIG_ATAN = "atan";
w.g.MATH_TRIG_COS = "cos";
w.g.MATH_TRIG_HELPURL = "https://es.wikipedia.org/wiki/Funci\u00f3n_trigonom\u00e9trica";
...
w.g.MATH_TRIG_TOOLTIP_TAN = "Devuelve la tangente de un grado (no radi\u00e1n).";
...
w.g.PROCEDURES_CALLNORETURN_TOOLTIP = "Ejecuta la funci\u00f3n definida por el usuario '%1'.";
w.g.PROCEDURES_CALLRETURN_HELPURL = "https://es.wikipedia.org/wiki/Subrutina";
w.g.PROCEDURES_CALLRETURN_TOOLTIP = "Ejecuta la funci\u00f3n definida por el usuario '%1' y usa su salida.";
...
w.g.PROCEDURES_DEF_DUPLICATE_WARNING = "Advertencia: Esta funci\u00f3n tiene par\u00e1metros duplicados.";
...
w.g.PROCEDURES_IFRETURN_TOOLTIP = "Si un valor es verdadero, entonces devuelve un segundo valor.";
w.g.PROCEDURES_IFRETURN_WARNING = "Advertencia: Este bloque solo puede ser utilizado dentro de la definici\u00f3n de una funci\u00f3n.";
w.g.PROCEDURES_MUTATORARG_TITLE = "nombre de entrada:";
w.g.PROCEDURES_MUTATORARG_TOOLTIP = "A\u00f1adir una entrada a la funci\u00f3n.";
w.g.PROCEDURES_MUTATORCONTAINER_TITLE = "entradas";
w.g.PROCEDURES_MUTATORCONTAINER_TOOLTIP = "A\u00f1adir, eliminar o reordenar entradas para esta funci\u00f3n.";
w.g.REDO = "Rehacer";
...
w.g.TEXT_CHANGECASE_TOOLTIP = "Devuelve una copia del texto en un tama\u00f1o diferente.";
...
w.g.TEXT_CREATE_JOIN_TOOLTIP = "Agregar, eliminar o reordenar las secciones para reconfigurar este bloque de texto.";
...
w.g.TEXT_GET_SUBSTRING_START_FROM_END = "obtener subcadena desde la letra # del final";
w.g.TEXT_GET_SUBSTRING_START_FROM_START = "obtener subcadena desde la letra #";
w.g.TEXT_GET_SUBSTRING_TAIL = "";
w.g.TEXT_GET_SUBSTRING_TOOLTIP = "Devuelve una porci\u00f3n determinada del texto.";
w.g.TEXT_INDEXOF_HELPURL = "https://github.com/google/blockly/wiki/Text#finding-text";
w.g.TEXT_INDEXOF_OPERATOR_FIRST = "encontrar la primera aparici\u00f3n del texto";
w.g.TEXT_INDEXOF_OPERATOR_LAST = "encontrar la \u00faltima aparici\u00f3n del texto";
w.g.TEXT_INDEXOF_TITLE = "en el texto %1 %2 %3";
w.g.TEXT_INDEXOF_TOOLTIP = "Devuelve el \u00edndice de la primera/\u00faltima aparici\u00f3n del primer texto en el segundo texto. Devuelve %1 si el texto no se encuentra.";
...
w.g.TEXT_ISEMPTY_TOOLTIP = "Devuelve verdadero si el texto proporcionado est\u00e1 vac\u00edo.";
...
w.g.TEXT_JOIN_TOOLTIP = "Crear un fragmento de texto al unir cualquier n\u00famero de elementos.";
w.g.TEXT_LENGTH_HELPURL = "https://github.com/google/blockly/wiki/Text#text-modification";
w.g.TEXT_LENGTH_TITLE = "longitud de %1";
w.g.TEXT_LENGTH_TOOLTIP = "Devuelve el n\u00famero de letras (espacios incluidos) del texto proporcionado.";
w.g.TEXT_PRINT_HELPURL = "https://github.com/google/blockly/wiki/Text#printing-text";
w.g.TEXT_PRINT_TITLE = "imprimir %1";
w.g.TEXT_PRINT_TOOLTIP = "Imprimir el texto, n\u00famero u otro valor especificado.";
...
w.g.TEXT_REPLACE_TOOLTIP = "Reemplazar todas las veces que un texto dentro de otro texto.";
...
w.g.TEXT_TRIM_TOOLTIP = "Devuelve una copia del texto sin los espacios de uno o ambos extremos.";
w.g.TODAY = "Hoy";
w.g.UNDO = "Deshacer";
...
w.g.VARIABLES_SET_TOOLTIP = "Establece esta variable para que sea igual a la entrada.";
w.g.VARIABLE_ALREADY_EXISTS = 'Ya existe una variable llamada "%1".';
w.g.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE = "Ya existe una variable nombrada '%1' para otra variable del tipo: '%2'.";
...
w.h.math_on_list = function (a) {
    ...
    switch (b) {
        ...
        case "MODE":
            b = Bk("mathModes",
                ["function " + w.h.$b + "(values) {", "  var modes = [];", "  var counts = [];", "  var maxCount = 0;", "  for (var i = 0; i < values.length; i++) {", "    var value = values[i];", "    var found = false;", "    var thisCount;", "    for (var j = 0; j < counts.length; j++) {", "      if (counts[j][0] === value) {", "        thisCount = ++counts[j][1];", "        found = true;", "        break;", "      }", "    }", "    if (!found) {", "      counts.push([value, 1]);", "      thisCount = 1;", "    }", "    maxCount = Math.max(thisCount, maxCount);",
...
function wm() {
    ...
    return a +
        ...
        `<category name="Tortuga">
            ...
            + (3 < S ? '<block type="turtle_pen"></block>' : "") 
            + "</category>" 
            + (2 < S ? '<category name="Color"><block type="turtle_colour_internal"></block></category>' : "") 
            + '<category name="Bucles"><block type="turtle_repeat_internal"><field name="TIMES">4</field></block></category>') 
            + "</xml>") 
            + `<div id="blockly"></div>
               ...
               <div id="dialogDone" class="dialogHiddenContent">
                    ...
                    <pre id="containerCode"></pre><div id="dialogDoneText" style="font-size: large; margin: 1em;"></div>
                    <div id="dialogDoneButtons" class="farSide" style="padding: 1ex 3ex 0">
                        <button id="doneCancel">Cancelar</button>
                        <button id="doneOk" class="secondary">Aceptar</button>
                        <button id="doneDownload" class="primary">Descargar</button>
                    </div>
                </div>
                <div id="dialogAbort" class="dialogHiddenContent">
                    ...
                    <button id="abortCancel">Cancelar</button>
                    <button id="abortOk" class="secondary">Aceptar</button>
                </div>
            </div>` 
            +
        ('<div id="dialogStorage" class="dialogHiddenContent"><div id="containerStorage"></div>' + vm() + "</div>") + (4 > S ? '<div id="helpUseLoop" class="dialogHiddenContent"><div style="padding-bottom: 0.7ex">La soluci\u00f3n funciona, pero se puede hacer mejor. ' + (3 > S ? "Dibuja la forma con solo tres bloques." : "Dibuja la estrella con solo cuatro bloques.") + "</div>" + vm() + "</div>" : "") + '<div id="help" class="dialogHiddenContent"><div style="padding-bottom: 0.7ex">' + (1 == S ? 'Crea un programa que dibuje un cuadrado.<br><img src="turtle/square.gif" height=146 width=146 style="margin-bottom: -50px">' :
            2 == S ? "Cambia el programa para dibujar un pent\u00e1gono en lugar de un cuadrado." : 3 == S ? 'Hay un bloque nuevo que permite cambiar el color:<div id="sampleHelp3" class="readonly"></div>Dibuja una estrella amarilla.' : 4 == S ? 'Hay un bloque nuevo que permite levantar el l\u00e1piz del papel cuando te mueves:<div id="sampleHelp4" class="readonly"></div>Dibuja una estrella amarilla, luego dibuja una l\u00ednea por encima de ella.' : 5 == S ? "En lugar de una estrella, \u00bfpuedes dibujar cuatro estrellas dispuestas en un cuadrado?" :
            6 == S ? "Dibuja tres estrellas amarillas y una l\u00ednea blanca." : 7 == S ? "Dibuja las estrellas, luego dibuja cuatro l\u00edneas blancas." : 8 == S ? "Dibujar 360 l\u00edneas blancas se ver\u00e1 como la luna llena." : 9 == S ? "\u00bfPuedes agregar un c\u00edrculo negro para que la luna se convierta en una media luna?" : 10 == S ? "Dibuja lo que quieras. Tienes muchos bloques nuevos para explorar \u00a1Divi\u00e9rtete!" + (Gl ? "" : '<br><br>Usa el bot\u00f3n "Ver galer\u00eda" para ver lo que otros han dibujado. Si has dibujado algo interesante, usa el bot\u00f3n "Enviar a la galer\u00eda" para publicarlo.') :
            "") + "</div>" + vm() + "</div>" + (1 == S ? '<div id="helpToolbox" class="dialogHiddenContent"><div><img src="turtle/help_left.png" class="mirrorImg" height=23 width=64></div>Elige una categor\u00eda para ver los bloques.</div>' : "")
};
var Ol = "turtle",
    xm = [],
    ym = 0,
