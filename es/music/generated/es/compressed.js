...
function Da(a, b) {
  ...
  for (var c = a.length, e = Ea, f = 0; f < c; f++)
    if (!e(a[f], b[f])) return !1;
  return !0;
}
function Ea(a, b) {
  return a === b;
...
function fb(a) {
  ...
  if (1 == b && u(arguments[0])) return fb.apply(null, arguments[0]);
...
var jb = bb("Opera"),
  ...
  lb =
    bb("Gecko") &&
    !(-1 != Za.toLowerCase().indexOf("webkit") && !bb("Edge")) &&
    !(bb("Trident") || bb("MSIE")) &&
    !bb("Edge"),
...
Gb.prototype.A = function() {
  if (!this.Ph && ((this.Ph = !0), this.Ta(), 0 != Hb)) {
    var a = ia(this);
    if (0 != Hb && this.ff && 0 < this.ff.length)
      throw Error(
        this +
...
function Jb(a, b) {
  a.Ph
    ? aa(void 0)
      ? b.call(void 0)
      : b()
    : (a.ff || (a.ff = []), a.ff.push(aa(void 0) ? na(b, void 0) : b));
}
Gb.prototype.Ta = function() {
  if (this.ff) for (; this.ff.length; ) this.ff.shift()();
};
function Kb(a) {
...
function Mb(a) {
  return B ? "webkit" + a : jb ? "o" + a.toLowerCase() : a.toLowerCase();
}
var Nb = {
    xy: "click",
    QA: "rightclick",
...
Pb.prototype.stopPropagation = function() {
  Pb.s.stopPropagation.call(this);
  this.le.stopPropagation
    ? this.le.stopPropagation()
    : (this.le.cancelBubble = !0);
};
Pb.prototype.preventDefault = function() {
  Pb.s.preventDefault.call(this);
  var a = this.le;
...
Yb.prototype.add = function(a, b, c, e, f) {
  var h = a.toString();
  a = this.xc[h];
  a || ((a = this.xc[h] = []), this.vk++);
  var k = Zb(a, b, e, f);
  -1 < k
    ? ((b = a[k]), c || (b.Rk = !1))
    : ((b = new Wb(b, this.src, h, !!e, f)), (b.Rk = c), a.push(b));
  return b;
};
Yb.prototype.remove = function(a, b, c, e) {
  a = a.toString();
  ...
  return -1 < b
    ? (Xb(f[b]),
      ...
      0 == f.length && (delete this.xc[a], this.vk--),
      !0)
    : !1;
};
function $b(a, b) {
  ...
  c in a.xc &&
    xa(a.xc[c], b) &&
    (Xb(b), 0 == a.xc[c].length && (delete a.xc[c], a.vk--));
}
Yb.prototype.removeAll = function(a) {
  a = a && a.toString();
  var b = 0,
    c;
  for (c in this.xc)
    if (!a || c == a) {
      for (var e = this.xc[c], f = 0; f < e.length; f++) ++b, Xb(e[f]);
      delete this.xc[c];
      this.vk--;
    }
  return b;
};
Yb.prototype.oj = function(a, b, c, e) {
...
function Zb(a, b, c, e) {
  for (var f = 0; f < a.length; ++f) {
    var h = a[f];
    if (!h.ui && h.listener == b && h.capture == !!c && h.Ll == e) return f;
  }
  return -1;
}
...
function dc(a, b, c, e, f) {
  if (e && e.once) return ec(a, b, c, e, f);
  if (u(b)) {
  ...
  c = fc(c);
  return Ub(a)
    ? a.na(b, c, ha(e) ? !!e.capture : !!e, f)
    : gc(a, b, c, !1, e, f);
}
function gc(a, b, c, e, f, h) {
...
function ec(a, b, c, e, f) {
  ...
  c = fc(c);
  return Ub(a)
    ? a.ls(b, c, ha(e) ? !!e.capture : !!e, f)
    : gc(a, b, c, !0, e, f);
}
function lc(a, b, c, e, f) {
  if (u(b)) for (var h = 0; h < b.length; h++) lc(a, b[h], c, e, f);
  else
    (e = ha(e) ? !!e.capture : !!e),
      (c = fc(c)),
      Ub(a)
        ? a.jd(b, c, e, f)
        : a && (a = hc(a)) && (b = a.oj(b, c, e, f)) && mc(b);
}
function mc(a) {
  if (!t(a) && a && !a.ui) {
    var b = a.src;
    if (Ub(b)) $b(b.Xe, a);
      ...
      b.removeEventListener
        ...
        : b.detachEvent
        ? b.detachEvent(jc(c), e)
        : b.addListener && b.removeListener && b.removeListener(e);
      cc--;
      (c = hc(b))
        ? ($b(c, a), 0 == c.vk && ((c.src = null), (b[ac] = null)))
        : Xb(a);
    }
  }
}
...
function kc(a, b) {
  ...
  if (!Ab) {
    ...
    if (!(0 > e.keyCode || void 0 != e.returnValue)) {
      ...
      a = a.type;
      for (f = e.length - 1; !b.$g && 0 <= f; f--) {
        b.currentTarget = e[f];
        var h = nc(e[f], a, !0, b);
        c = c && h;
      }
      for (f = 0; !b.$g && f < e.length; f++)
        (b.currentTarget = e[f]), (h = nc(e[f], a, !1, b)), (c = c && h);
    }
    return c;
  }
...
z.Xf = function() {
  z.$l && (clearTimeout(z.$l), (z.$l = 0));
};
z.Touch.Te = function() {
  z.Touch.rk = null;
};
z.Touch.Bp = function(a) {
  return !z.Touch.zw(a) || z.Touch.$u(a);
};
z.Touch.Hl = function(a) {
...
z.Touch.$u = function(a) {
  var b = z.Touch.Hl(a);
  return void 0 != z.Touch.rk && null != z.Touch.rk
    ? z.Touch.rk == b
    : "mousedown" == a.type || "touchstart" == a.type || "pointerdown" == a.type
    ? ((z.Touch.rk = b), !0)
    : !1;
};
z.Touch.zx = function(a) {
  if (Fa(a.type, "touch")) {
...
z.Touch.zw = function(a) {
  return Fa(a.type, "touch") || Fa(a.type, "mouse") || Fa(a.type, "pointer");
};
z.Touch.Wl = function(a) {
  return Fa(a.type, "touch") || Fa(a.type, "pointer");
};
z.Touch.Cx = function(a) {
  var b = [];
  if (a.changedTouches)
...
z.j.Hi = [];
z.j.U = function(a) {
  z.j.isEnabled() && (z.j.Hi.length || setTimeout(z.j.Qv, 0), z.j.Hi.push(a));
};
z.j.Qv = function() {
  for (
    var a = z.j.filter(z.j.Hi, !0), b = (z.j.Hi.length = 0), c;
    (c = a[b]);
    b++
  ) {
    var e = wc[c.Bc] || null;
    if (e) {
      var f = c;
      f.hc &&
        (e.rh.push(f), (e.Yj.length = 0), e.rh.length > e.ku && e.rh.unshift());
...
z.j.filter = function(a, b) {
  ...
  for (var c = [], e = Object.create(null), f = 0, h; (h = a[f]); f++)
    if (!h.ei()) {
      var k = [h.type, h.$b, h.Bc].join(" "),
        l = e[k];
      l
        ? h.type == z.j.Li
          ? ((l.Wg = h.Wg), (l.Vg = h.Vg), (l.Zf = h.Zf))
          : h.type == z.j.zh && h.element == l.element && h.name == l.name
  ...
  b || a.reverse();
  for (f = 1; (h = a[f]); f++)
    h.type == z.j.zh && "mutation" == h.element && a.unshift(a.splice(f, 1)[0]);
  return a;
};
z.j.bv = function() {
  for (var a = 0, b; (b = z.j.Hi[a]); a++) b.hc = !1;
};
z.j.disable = function() {
  z.j.Fn++;
};
z.j.enable = function() {
  z.j.Fn--;
};
z.j.isEnabled = function() {
  return 0 == z.j.Fn;
};
z.j.rc = function() {
  return z.j.Il;
...
z.j.R = function(a) {
  z.j.Il = "boolean" == typeof a ? (a ? z.i.ne() : "") : a;
};
z.j.Gr = function(a) {
  var b = [];
  a = xc(a, !1);
...
z.j.Ev = function(a) {
  if (a.type == z.j.Li || a.type == z.j.Gk) {
    var b = wc[a.Bc] || null;
    if ((a = Kc(b, a.$b)))
      if (a.getParent() && !a.getParent().disabled) {
        b = xc(a, !1);
        a = 0;
        for (var c; (c = b[a]); a++) c.Nc(!1);
      } else if ((a.N || a.Y) && !b.pb()) {
        do a.Nc(!0), (a = Lc(a));
        while (a);
      }
  }
...
function Oc(a) {
  Oc.s.constructor.call(this);
  this.sg = a.$();
  this.Bc = a.o.id;
}
y(Oc, Mc);
Oc.prototype.Aa = function() {
  var a = Oc.s.Aa.call(this);
  a.varId = this.sg;
  return a;
};
Oc.prototype.ia = function(a) {
  Oc.s.Aa.call(this);
  this.sg = a.varId;
};
function Cc(a) {
  a && (Cc.s.constructor.call(this, a), (this.vh = a.type), (this.uh = a.name));
}
y(Cc, Oc);
Cc.prototype.type = z.j.jq;
Cc.prototype.Aa = function() {
  var a = Cc.s.Aa.call(this);
  a.varType = this.vh;
  a.varName = this.uh;
  return a;
};
Cc.prototype.ia = function(a) {
  Cc.s.ia.call(this, a);
  this.vh = a.varType;
  this.uh = a.varName;
};
...
function Dc(a) {
  a && (Dc.s.constructor.call(this, a), (this.vh = a.type), (this.uh = a.name));
}
y(Dc, Oc);
Dc.prototype.type = z.j.kq;
Dc.prototype.Aa = function() {
  var a = Dc.s.Aa.call(this);
  a.varType = this.vh;
  a.varName = this.uh;
  return a;
};
...
Dc.prototype.run = function(a) {
  var b = Nc(this);
  a ? b.Ff(this.sg) : b.Wc(this.uh, this.vh, this.sg);
};
function Ec(a, b) {
  a && (Ec.s.constructor.call(this, a), (this.Io = a.name), (this.Eo = b));
}
y(Ec, Oc);
Ec.prototype.type = z.j.lq;
Ec.prototype.Aa = function() {
  var a = Ec.s.Aa.call(this);
  a.oldName = this.Io;
  a.newName = this.Eo;
  return a;
};
...
d.ep = function(a, b) {
  ...
  try {
    if (c && c.$() != a.$()) {
      var f = a.type;
      b != c.name && Rc(c, b, e);
      for (b = 0; b < e.length; b++) e[b].ak(a.$(), c.$());
      z.j.U(new Dc(a));
      this.ra[f].splice(this.sj(f).indexOf(a), 1);
    } else Rc(a, b, e);
  } finally {
    z.j.R(!1);
  }
...
d.Wc = function(a, b, c) {
  ...
  this.ra[b] ? this.ra[b].push(e) : (this.ra[b] = [e]);
  return e;
};
d.Ff = function(a) {
  var b = this.Nd(a);
  if (b) {
    ...
    for (var f; (f = e[a]); a++)
      if (
        ...
        a = E(f, "NAME");
        c = z.g.CANNOT_DELETE_VARIABLE_PROCEDURE.replace("%1", c).replace(
          "%2",
          a
        );
        z.alert(c);
    ...
    var h = this;
    1 < e.length
      ? ((c = z.g.DELETE_VARIABLE_CONFIRMATION.replace(
          "%1",
          String(e.length)
        ).replace("%2", c)),
        z.confirm(c, function(a) {
          a && h.cl(b, e);
        }))
      : h.cl(b, e);
...
d.Jc = function(a, b) {
  if ((b = this.ra[b || ""]))
    for (var c = 0, e; (e = b[c]); c++) if (Tc(e.name, a)) return e;
  return null;
};
d.Nd = function(a) {
  for (var b = Object.keys(this.ra), c = 0; c < b.length; c++)
...
d.Xn = function() {
  for (var a = Object.keys(this.ra), b = !1, c = 0; c < a.length; c++)
    "" == a[c] && (b = !0);
  b || a.push("");
  return a;
};
d.Ye = function() {
  for (var a = [], b = Object.keys(this.ra), c = 0; c < b.length; c++)
    a = a.concat(this.ra[b[c]]);
  return a;
};
d.Yn = function(a) {
  for (var b = [], c = Qc(this.o), e = 0; e < c.length; e++) {
    var f = c[e].Jf();
    if (f) for (var h = 0; h < f.length; h++) f[h].$() == a && b.push(c[e]);
  }
  return b;
};
function Vc(a) {
...
Vc.prototype.ia = function(a) {
  this.Jd = a.commentId;
  this.group = a.group;
};
function Hc(a, b, c) {
  a && (Hc.s.constructor.call(this, a), (this.zs = b), (this.gm = c));
}
y(Hc, Vc);
d = Hc.prototype;
d.type = z.j.Tp;
d.Aa = function() {
  var a = Hc.s.Aa.call(this);
  a.newContents = this.gm;
  return a;
};
d.ia = function(a) {
  Hc.s.ia.call(this, a);
...
d.ei = function() {
  return this.zs == this.gm;
};
d.run = function(a) {
  var b = Wc(Nc(this), this.Jd);
  b
    ? b.Cd(a ? this.gm : this.zs)
    : console.warn("Can't change non-existent comment: " + this.Jd);
};
function Gc(a) {
  a && (Gc.s.constructor.call(this, a), (this.xml = a.qk()));
}
y(Gc, Vc);
Gc.prototype.type = z.j.Vp;
Gc.prototype.Aa = function() {
  var a = Gc.s.Aa.call(this);
  a.xml = z.D.wd(this.xml);
  return a;
};
Gc.prototype.ia = function(a) {
  Gc.s.ia.call(this, a);
...
Gc.prototype.run = function(a) {
  var b = Nc(this);
  a
    ? ((a = F("xml")), a.appendChild(this.xml), z.D.ie(a, b))
    : (b = Wc(b, this.Jd))
    ? b.A(!1, !1)
    : console.warn("Can't uncreate non-existent comment: " + this.Jd);
};
function Jc(a) {
  a && (Jc.s.constructor.call(this, a), (this.xml = a.qk()));
}
y(Jc, Vc);
Jc.prototype.type = z.j.Wp;
Jc.prototype.Aa = function() {
  return Jc.s.Aa.call(this);
};
Jc.prototype.ia = function(a) {
  Jc.s.ia.call(this, a);
};
...
d.type = z.j.Xp;
d.Aa = function() {
  var a = Ic.s.Aa.call(this);
  this.Ug &&
    (a.newCoordinate = Math.round(this.Ug.x) + "," + Math.round(this.Ug.y));
  return a;
};
d.ia = function(a) {
  Ic.s.ia.call(this, a);
  a.newCoordinate &&
    ...
    (this.Ug = new D(parseFloat(a[0]), parseFloat(a[1]))));
};
d.ei = function() {
  return sc(this.Ho, this.Ug);
};
d.run = function(a) {
  var b = Wc(Nc(this), this.Jd);
  if (b) {
...
d.A = function() {
  if (this.o) {
    z.j.isEnabled() && z.j.U(new Jc(this));
    var a = this.o;
    if (!xa(a.Bi, this))
...
d.ec = function() {
  return this.ej && !(this.o && this.o.options.readOnly);
};
d.ym = function(a) {
  this.ej = a;
};
d.we = function() {
  return this.Tj && !(this.o && this.o.options.readOnly);
};
d.hh = function(a) {
  this.Tj = a;
};
...
d.Cd = function(a) {
  this.Vc != a && (z.j.U(new Hc(this, this.Vc, a)), (this.Vc = a));
};
d.qk = function(a) {
  a = Zc(this, a);
...
function $c(a) {
  ...
  return {
    ...
    Lr: b ? parseInt(b, 10) : 100,
    xt: c ? parseInt(c, 10) : 100,
...
function Qc(a) {
  var b = cd(a, !1);
  for (a = 0; a < b.length; a++) b.push.apply(b, b[a].If(!1));
  return b;
}
d.clear = function() {
  this.po = !0;
  try {
    var a = z.j.rc();
    for (a || z.j.R(!0); this.Ai.length; ) this.Ai[0].A();
...
function fd(a) {
  return isNaN(a.options.os) ? Infinity : a.options.os - Qc(a).length;
}
d.Pp = function(a) {
  var b = a ? this.Yj : this.rh,
    c = a ? this.rh : this.Yj,
    e = b.pop();
  if (e) {
...
kd.prototype.Of = !0;
kd.prototype.te = function() {
  return this.Kp;
};
kd.prototype.toString = function() {
  return "Const{" + this.Kp + "}";
};
function md(a) {
  return a instanceof kd && a.constructor === kd && a.wu === ld
    ? a.Kp
    : "type_error:Const";
}
var ld = {};
...
pd.prototype.Of = !0;
pd.prototype.te = function() {
  return this.Zg;
};
pd.prototype.jo = !0;
pd.prototype.Wh = function() {
  return 1;
};
function rd(a) {
  if (a instanceof pd && a.constructor === pd && a.uu === qd) return a.Zg;
  ea(a);
...
function td(a) {
  ...
  sd.test(a) || (a = "about:invalid#zClosurez");
  return ud(a);
}
var qd = {};
function ud(a) {
...
vd.prototype.Of = !0;
var wd = {};
vd.prototype.te = function() {
  return this.Zo;
};
vd.prototype.Pl = function(a) {
  this.Zo = a;
  return this;
};
var xd = new vd().Pl("");
function yd(a) {
  ...
  for (c in a) {
    ...
    var e = a[c];
    null != e &&
      ((e = u(e) ? ta(e, zd).join(" ") : zd(e)), (b += c + ":" + e + ";"));
  }
  return b ? new vd().Pl(b) : xd;
}
function zd(a) {
  if (a instanceof pd)
    a =
    ...
    a = String(a);
    var b = a.replace(Ad, "$1").replace(Bd, "url");
    if ((b = Dd.test(b))) {
...
function Ed(a) {
  return a.replace(Bd, function(a, c, e, f) {
    var b = "";
...
Fd.prototype.Of = !0;
Fd.prototype.te = function() {
  return this.Zg;
};
function Hd(a) {
  if (a instanceof Fd && a.constructor === Fd && a.su === Gd) return a.Zg;
  ea(a);
...
function Id(a) {
  ...
  var b = null;
  a.jo && (b = a.Wh());
  return Jd(Ka(a.Of ? a.te() : String(a)), b);
}
var Kd = /^[a-zA-Z0-9-]+$/,
  Ld = {
    action: !0,
    ...
    for (n in b) {
      ...
      if (null != k) {
        ...
        if (k instanceof kd) k = md(k);
          ...
          k instanceof vd && k.constructor === vd && k.tu === wd
            ? (k = k.Zo)
          ...
          if (m.toLowerCase() in Ld)
            if (k instanceof nd)
              k instanceof nd && k.constructor === nd && k.xu === od
                ? (k = k.Rs)
...
var Gd = {};
function Jd(a, b) {
  return new Fd().Pl(a, b);
}
Fd.prototype.Pl = function(a, b) {
  this.Zg = a;
  this.qr = b;
  return this;
};
...
function $d(a) {
  ...
  return A && wb("10") && a.pageYOffset != b.scrollTop
...
function be(a, b) {
  var c = String(b[0]),
    e = b[1];
  if (!gd && e && (e.name || e.type)) {
    c = ["<", c];
    e.name && c.push(' name="', Ka(e.name), '"');
    if (e.type) {
      c.push(' type="', Ka(e.type), '"');
      var f = {};
      eb(f, e);
      delete f.type;
      e = f;
  ...
  c = a.createElement(c);
  e &&
    (q(e) ? (c.className = e) : u(e) ? (c.className = e.join(" ")) : Xd(c, e));
  2 < b.length && ce(a, c, b, 2);
  return c;
}
function ce(a, b, c, e) {
  function f(c) {
  ...
  for (; e < c.length; e++) {
    var h = c[e];
    !fa(h) || (ha(h) && 0 < h.nodeType) ? f(h) : ra(de(h) ? za(h) : h, f);
  }
}
function ee(a) {
...
function he(a, b) {
  ...
  } else ee(a), a.appendChild(Vd(a).createTextNode(String(b)));
}
...
function pe(a, b, c, e, f, h) {
  ...
  this.fg && re(this);
  (f && h) ||
    ((b = this.Vc.getBBox()), (f = b.width + 2 * se), (h = b.height + 2 * se));
  this.hg(f, h);
  re(this);
  te(this);
  this.fg = !0;
  a.options.readOnly ||
    (z.O(this.Si, "mousedown", this, this.Su),
    this.Mb && z.O(this.Mb, "mousedown", this, this.gp));
}
var se = 6,
  qe = 20,
  ue = null,
...
d.$i = function(a, b) {
  ...
  var c = { filter: "url(#" + this.m.options.zr + ")" };
  -1 != Za.indexOf("JavaFX") && (c = {});
  c = z.i.B("g", c, this.Uc);
  this.nn = z.i.B("path", {}, c);
  this.Si = z.i.B(
    "rect",
    { class: "blocklyDraggable", x: 0, y: 0, rx: se, ry: se },
    c
  );
  b
    ? ((this.Mb = z.i.B(
...
d.gp = function(a) {
  ...
  we();
  z.i.Uf(a) ||
    (this.m.Em(a, new D(this.m.u ? -this.ka : this.ka, this.Ca)),
    (ue = z.O(document, "mouseup", this, xe)),
    (ve = z.O(document, "mousemove", this, this.hp)),
    z.Qb());
  a.stopPropagation();
};
d.hp = function(a) {
...
function ze(a) {
  var b = a.Uc.parentNode;
  return b.lastChild !== a.Uc ? (b.appendChild(a.Uc), !0) : !1;
}
function re(a) {
  var b = a.sd.x;
  b = a.m.u ? b - (a.ti + a.ka) : b + a.ti;
  a.moveTo(b, a.Zj + a.sd.y);
}
d.moveTo = function(a, b) {
  this.Uc.setAttribute("transform", "translate(" + a + "," + b + ")");
};
d.Kg = function() {
  return { width: this.ka, height: this.Ca };
};
d.hg = function(a, b) {
  var c = 2 * se;
  a = Math.max(a, c + 45);
  ...
  if (this.fg) {
    if (this.Pk) {
      ...
      this.m.u
        ? e - c.Cb - a - this.ka < H
          ? (a = e - c.Cb - this.ka - H)
          : e - c.Cb - a > c.ya && (a = e - c.Cb - c.ya)
        : e + a < c.Cb
        ? (a = c.Cb - e)
        : c.Cb + c.ya < e + a + this.ka + 10 + H &&
          (a = c.Cb + c.ya - e - this.ka - H);
...
d.em = function(a, b) {
  a ? a.qf(b.x, b.y) : this.moveTo(b.x, b.y);
  this.ti = this.m.u ? this.sd.x - b.x - this.ka : b.x - this.sd.x;
  this.Zj = b.y - this.sd.y;
  te(this);
};
d.la = function() {
  return new D(this.sd.x + this.ti, this.sd.y + this.Zj);
};
d.bt = function(a) {
  this.Pk = a;
};
function Be(a) {
  Be.s.constructor.call(this);
  this.$b = a.id;
  this.Bc = a.o.id;
}
y(Be, Mc);
Be.prototype.Aa = function() {
  var a = Be.s.Aa.call(this);
  a.blockId = this.$b;
  return a;
};
Be.prototype.ia = function(a) {
  Be.s.Aa.call(this);
  this.$b = a.blockId;
};
function Ac(a, b, c, e, f) {
  a &&
    (Ac.s.constructor.call(this, a),
    (this.element = b),
    (this.name = c),
    (this.oldValue = e),
    (this.newValue = f));
    ...
    switch (
      ...
      case "mutation":
        ...
        if (b.fb) {
          ...
          var e = z.D.fd("<xml>" + a + "</xml>");
          b.fb(e.firstChild);
        }
        z.j.U(new Ac(b, "mutation", null, c, a));
        break;
      default:
...
function yc(a) {
  a &&
    ...
    (this.xml = a.o.P ? z.D.mn(a) : z.D.Bf(a)),
    (this.cf = z.j.Gr(a)));
}
y(yc, Be);
z.j.Fk = yc;
...
yc.prototype.Aa = function() {
  var a = yc.s.Aa.call(this);
  a.xml = z.D.wd(this.xml);
  a.ids = this.cf;
  return a;
};
yc.prototype.ia = function(a) {
  yc.s.ia.call(this, a);
  this.xml = z.D.fd("<xml>" + a.xml + "</xml>").firstChild;
  this.cf = a.ids;
};
yc.prototype.run = function(a) {
  var b = Nc(this);
  if (a) (a = F("xml")), a.appendChild(this.xml), z.D.ie(a, b);
  else {
    a = 0;
    for (var c; (c = this.cf[a]); a++) {
      var e = Kc(b, c);
      e
        ? e.A(!1, !1)
        : c == this.$b &&
...
zc.prototype.run = function(a) {
  ...
  if (a) {
    ...
    for (var c; (c = this.cf[a]); a++) {
      ...
      e
        ? e.A(!1, !1)
        : c == this.$b && console.warn("Can't delete non-existent block: " + c);
    }
  } else (a = F("xml")), a.appendChild(this.Uw), z.D.ie(a, b);
};
function Bc(a) {
  a &&
...
d.type = z.j.Li;
d.Aa = function() {
  var a = Bc.s.Aa.call(this);
  this.Wg && (a.newParentId = this.Wg);
  this.Vg && (a.newInputName = this.Vg);
  this.Zf &&
    (a.newCoordinate = Math.round(this.Zf.x) + "," + Math.round(this.Zf.y));
  return a;
};
d.ia = function(a) {
  Bc.s.ia.call(this, a);
  ...
  a.newCoordinate &&
    ((a = a.newCoordinate.split(",")),
    (this.Zf = new D(parseFloat(a[0]), parseFloat(a[1]))));
};
d.hf = function() {
  var a = De(this);
  this.Wg = a.Ms;
...
d.ei = function() {
  return this.Bs == this.Wg && this.As == this.Vg && sc(this.Go, this.Zf);
};
d.run = function(a) {
  var b = Nc(this),
    c = Kc(b, this.$b);
  if (c) {
    var e = a ? this.Wg : this.Bs,
      f = a ? this.Vg : this.As;
    a = a ? this.Zf : this.Go;
    var h = null;
    if (e && ((h = Kc(b, e)), !h)) {
    ...
    if (a) (f = c.la()), c.moveBy(a.x - f.x, a.y - f.y);
      ...
      } else c.type == z.wf && (k = h.K);
      k
        ? c.connect(k)
        : console.warn("Can't connect to non-existent input: " + f);
    }
  } else console.warn("Can't move non-existent block: " + this.$b);
};
function Fc(a, b, c, e) {
  Fc.s.constructor.call(this);
  this.$b = a ? a.id : null;
...
Fc.prototype.Aa = function() {
  var a = Fc.s.Aa.call(this);
  a.element = this.element;
  void 0 !== this.newValue && (a.newValue = this.newValue);
  this.$b && (a.blockId = this.$b);
  return a;
};
Fc.prototype.ia = function(a) {
  Fc.s.ia.call(this, a);
  this.element = a.element;
  this.newValue = a.newValue;
  this.$b = a.blockId;
...
function Ge(a) {
  a.vc ||
    ((a.vc = z.i.B("g", { class: "blocklyIconGroup" }, null)),
    a.T.tb && z.i.mb(a.vc, "blocklyIconGroupReadonly"),
    a.Kn(a.vc),
    a.T.ga().appendChild(a.vc),
    z.O(a.vc, "mouseup", a, a.io),
    a.tf());
}
d.A = function() {
  G(this.vc);
...
d.io = function(a) {
  this.T.o.pb() || this.T.tb || z.i.Uf(a) || this.oa(!this.X());
};
d.sf = function() {
  this.X() && this.Za.qb(this.T.ge);
};
function He(a) {
  var b = a.T.la(),
    c = z.i.tc(a.vc);
...
d.Ca = 80;
d.Kn = function(a) {
  z.i.B("circle", { class: "blocklyIconShape", r: "8", cx: "8", cy: "8" }, a);
  z.i.B(
    "path",
    {
...
d.aj = function() {
  ...
  z.O(b, "wheel", this, function(a) {
    a.stopPropagation();
  });
  z.O(b, "change", this, function() {
    this.va != b.value &&
      (z.j.U(new z.j.Cc(this.T, "comment", null, this.va, b.value)),
      (this.va = b.value));
  });
  setTimeout(function() {
    b.focus();
...
d.oa = function(a) {
  if (a != this.X())
    if (
      (z.j.U(new Fc(this.T, "commentOpen", !a, a)),
      (!Je(this.T) && !this.wb) || A)
    )
      Ke.prototype.oa.call(this, a);
    else {
      var b = this.Ib(),
        c = this.Kg();
      a
        ? ((this.Za = new pe(
          ...
          (this.Za.fp = a),
          this.sf())
        : (this.Za.A(), (this.Yc = this.wb = this.Za = null));
      this.vb(b);
      this.hg(c.width, c.height);
    }
};
d.Jx = function() {
  ze(this.Za) && this.wb.focus();
};
d.Kg = function() {
  return this.X() ? this.Za.Kg() : { width: this.ka, height: this.Ca };
};
d.hg = function(a, b) {
  this.wb ? this.Za.hg(a, b) : ((this.ka = a), (this.Ca = b));
};
d.Ib = function() {
  return this.wb ? this.wb.value : this.va;
};
d.vb = function(a) {
  this.va != a &&
    (z.j.U(new z.j.Cc(this.T, "comment", null, this.va, a)), (this.va = a));
  this.wb && (this.wb.value = a);
};
d.A = function() {
  z.j.isEnabled() && this.vb("");
  this.T.Sa = null;
...
function Le(a, b) {
  ...
  this.type = b;
  a.o.tn &&
    ((this.vd = a.o.tn[b]), (this.bl = a.o.tn[z.Fh[b]]), (this.ho = !this.vd));
}
d = Le.prototype;
d.Na = null;
d.Qe = null;
...
d.Zk = function(a) {
  ...
  if (b.isConnected()) {
    ...
    if (f.hb) (h = z.D.Bf(f)), f.A(), (f = null);
      ...
      if (!f.N) throw "Orphan block does not have an output connection.";
      var k = Me(e, f);
      k && (f.N.connect(k), (f = null));
    } else if (b.type == z.Qa) {
      if (!f.Y) throw "Orphan block does not have a previous connection.";
      for (k = e; k.K; ) {
        var l = Lc(k);
        if (l && !l.hb) k = l;
        else {
          Ne(f.Y, k.K) && (k.K.connect(f.Y), (f = null));
          break;
        }
      }
    }
    if (f && (b.disconnect(), z.j.hc)) {
      ...
      setTimeout(function() {
        f.o &&
          !f.getParent() &&
          (z.j.R(m), f.N ? Oe(f.N, b) : f.Y && Oe(f.Y, b), z.j.R(!1));
      }, z.Ek);
    }
    b.Fe = h;
  }
...
function Re(a) {
  return a.type == z.Wa || a.type == z.Qa;
}
...
d.Ql = function(a) {
  if (0 != Se(this, a)) return !1;
  if (a.type == z.Hh || a.type == z.wf)
    if (a.isConnected() || this.isConnected()) return !1;
  return (a.type == z.Wa && a.isConnected() && !J(a).we() && !J(a).hb) ||
    (this.type == z.wf && a.isConnected() && !this.v.K && !J(a).hb && J(a).K) ||
    -1 != z.ll.indexOf(a)
    ? !1
    : !0;
};
    ...
    switch (Se(this, a)) {
      ...
      case 4:
        throw "Connection checks failed. " +
          (this + " expected " + this.Qe + ", found " + a.Qe);
      case 6:
        throw "Connecting non-shadow to shadow block.";
      default:
        throw "Unknown connection failure: this should never happen!";
    }
    Re(this) ? this.Zk(a) : a.Zk(this);
  }
};
function Pe(a, b) {
  a.Na = b;
...
function Me(a, b) {
  for (var c; (c = Te(a, b)); ) if (((a = J(c)), !a || a.hb)) return c;
  return null;
}
...
function J(a) {
  return a.isConnected() ? a.Na.v : null;
}
function Ne(a, b) {
  if (!a.Qe || !b.Qe) return !0;
  for (var c = 0; c < a.Qe.length; c++)
    if (-1 != b.Qe.indexOf(a.Qe[c])) return !0;
  return !1;
}
d.Ds = function() {
  this.isConnected() && !Ne(this, this.Na) && Ee(Re(this) ? J(this) : this.v);
};
d.bb = function(a) {
  a ? (u(a) || (a = [a]), (this.Qe = a), this.Ds()) : (this.Qe = null);
  return this;
};
d.ys = function() {
  return [];
...
Ve.prototype = [];
function We(a, b) {
  if (b.Pf) throw "Connection already in database.";
...
function Ye(a, b) {
  ...
  for (var e = b.Pa, f = c; 0 <= f && a[f].Pa == e; ) {
    if (a[f] == b) return f;
    f--;
  }
  for (; c < a.length && a[c].Pa == e; ) {
    if (a[c] == b) return c;
    c++;
  }
  return -1;
...
function Qe(a, b) {
  if (!b.Pf) throw "Connection not in database.";
  var c = Ye(a, b);
...
function Ze(a, b, c) {
  ...
  for (var l = (b = f.length - 2); a < l; )
    f[l].Pa < k ? (a = l) : (b = l), (l = Math.floor((a + b) / 2));
  var m = [];
  b = a = l;
  if (f.length) {
    for (; 0 <= a && e(a); ) a--;
...
z.Ea.ur = function(a, b, c, e) {
  ...
  1 < f
    ...
    : (a.setAttribute(
        "transform",
        "translate(" +
          (a.Ox + (((b ? -1 : 1) * a.tq.width * e) / 2) * f) +
          "," +
          (a.Px + a.tq.height * e * f) +
          ") scale(" +
          (1 - f) * e +
          ")"
      ),
      setTimeout(z.Ea.ur, 10, a, b, c, e));
};
z.Ea.iv = function(a) {
  var b = a.o,
    c = b.scale;
...
z.Ea.Mq = function(a, b, c) {
  var e = (new Date() - b) / 150;
  1 < e
    ? G(a)
    : (a.setAttribute("r", 25 * e * c),
      (a.style.opacity = 1 - e),
      (z.Ea.Hn = setTimeout(z.Ea.Mq, 10, a, b, c)));
};
z.Ea.Fv = function(a) {
  a.o.Af.play("disconnect");
  if (!(1 > a.o.scale)) {
    var b = a.Hb().height;
...
z.Ea.rr = function(a, b, c) {
  ...
  1 < e
    ...
    : ((a.kh =
      ...
      (z.Ea.hl = a),
      (z.Ea.Hn = setTimeout(z.Ea.rr, 10, a, b, c)));
  a.setAttribute("transform", a.rf + a.kh);
};
z.Ea.In = function() {
  if (z.Ea.hl) {
    clearTimeout(z.Ea.Hn);
    var a = z.Ea.hl;
    a.kh = "";
...
function af(a, b) {
  af.s.constructor.call(this, a, b);
  this.im = new D(0, 0);
}
y(af, Le);
function bf(a, b) {
...
d.moveBy = function(a, b) {
  this.moveTo(this.Rc + a, this.Pa + b);
};
function df(a, b) {
  a.moveTo(b.x + a.im.x, b.y + a.im.y);
}
function ef(a, b, c) {
  a.im.x = b;
  a.im.y = c;
...
d.closest = function(a, b) {
  ...
  if (c.length) {
    ...
    var h = Xe(c, this);
    b = null;
    for (var k = a, l, m = h - 1; 0 <= m && Math.abs(c[m].Pa - this.Pa) <= a; )
      (l = c[m]), this.Ql(l, k) && ((b = l), (k = bf(l, this))), m--;
    for (; h < c.length && Math.abs(c[h].Pa - this.Pa) <= a; )
      (l = c[h]), this.Ql(l, k) && ((b = l), (k = bf(l, this))), h++;
    this.Rc = f;
    this.Pa = e;
    a = { connection: b, Vs: k };
  } else a = { connection: null, Vs: a };
  return a;
};
d.Aj = function() {
  var a =
    this.type == z.Wa || this.type == z.Hh
      ? "m 0,0 " + hf + " v 5"
...
function jf(a) {
  kf(a, !1);
  var b = [];
  if (a.type != z.Wa && a.type != z.Qa) return b;
  if ((a = J(a))) {
    if (a.isCollapsed()) {
      var c = [];
      a.N && c.push(a.N);
    ...
    for (var e = 0; e < c.length; e++) b.push.apply(b, jf(c[e]));
    b.length || (b[0] = a);
  }
  return b;
}
...
function kf(a, b) {
  (a.ho = b) && a.Pf ? Qe(a.vd, a) : b || a.Pf || We(a.vd, a);
}
d.Ql = function(a, b) {
  return bf(this, a) > b ? !1 : af.s.Ql.call(this, a);
};
d.Gn = function(a, b) {
  af.s.Gn.call(this, a, b);
  a.P && a.Z();
  b.P && (mf(b), b.Z());
};
d.jp = function() {
...
d.Ds = function() {
  this.isConnected() &&
    !Ne(this, this.Na) &&
    (Ee(Re(this) ? J(this) : this.v), this.v.ob());
};
function nf(a) {
  this.og = z.selected = a;
  this.m = a.o;
  a = this.og.pe(!1);
  var b;
  a: {
...
nf.prototype.update = function(a, b) {
  var c = this.dc,
    e = this.dc;
  this.ki = this.dc = null;
  this.$o = z.Tc;
  for (var f = 0; f < this.kn.length; f++) {
    var h = this.kn[f],
      k = h.closest(this.$o, a);
    k.connection && ((this.dc = k.connection), (this.ki = h), (this.$o = k.Vs));
  }
  (a = e != this.dc) && c && lf();
  c = !!this.dc && b != z.Zp;
  this.ug = (b = !!b && !this.og.getParent() && this.og.ec()) && !c;
  b && this.dc && (lf(), (this.dc = null));
  !this.ug && a && this.dc && this.dc && this.dc.Aj();
};
function of(a, b) {
  this.gb = a;
  this.m = b;
  ...
  for (var c = 0, e; (e = a[c]); c++) {
    ...
    for (var f = 0; f < e.length; f++)
      b.push({ location: e[f].Og, icon: e[f] });
  }
  this.kl = b;
}
of.prototype.A = function() {
  this.jb = this.m = this.gb = null;
  this.kl.length = 0;
...
function qf(a, b, c) {
  c = a.pi(c);
  a.gb.em(vc(a.Ge, c));
  for (var e = 0; e < a.kl.length; e++) {
    var f = a.kl[e],
      h = f.icon;
    f = vc(f.location, c);
    h.Og = f;
    h.X() && ((h = h.Za), (h.sd = f), h.fg && re(h));
  }
  a.Fg = rf(a.m, b);
  a.Rh.update(c, a.Fg);
  a.ug = a.Rh.ug;
...
function tf(a, b, c) {
  ...
  a.ug ||
    ...
    b.dc &&
      (b.ki.connect(b.dc),
      b.og.P && (z.Ea.iv((Re(b.ki) ? b.dc : b.ki).v), vf(cf(b.og))),
      b.dc && lf()),
    a.gb.Z(),
    a.jj(),
    wf(a.gb));
  a.m.Sb(!0);
  (b = a.m.ea) &&
    z.i.Rb(b.Dc, a.gb.ec() ? "blocklyToolboxDelete" : "blocklyToolboxGrab");
  z.j.R(!1);
}
of.prototype.jj = function() {
  var a = new z.j.Gi(this.gb);
  a.Go = this.Ge;
  a.hf();
  z.j.U(a);
};
of.prototype.pi = function(a) {
  a = new D(a.x / this.m.scale, a.y / this.m.scale);
  this.m.Jj && (a = a.scale(1 / this.m.options.Lb.scale));
  return a;
};
function xf(a, b, c, e, f) {
  this.w = z.i.B("g", { class: "blocklyComment" }, null);
  this.w.rf = "";
  this.pk = z.i.B("rect", {
...
d.wc = function() {
  this.o.options.readOnly ||
    this.Mn ||
    (z.O(this.ng, "mousedown", this, this.Ns),
    z.O(this.oh, "mousedown", this, this.Ns));
  this.Mn = !0;
  yf(this);
...
d.select = function() {
  if (z.selected != this) {
    ...
    a = new Fc(null, "selected", a, this.id);
    a.Bc = this.o.id;
    z.j.U(a);
    z.selected = this;
    this.Kh();
...
d.qg = function() {
  if (z.selected == this) {
    var a = new Fc(null, "selected", this.id, null);
    a.Bc = this.o.id;
    z.j.U(a);
    z.selected = null;
    this.dh();
...
d.Kh = function() {
  z.i.mb(this.w, "blocklySelected");
  this.up();
};
d.dh = function() {
  z.i.Rb(this.w, "blocklySelected");
  zf(this);
};
d.la = function() {
  var a = 0,
  ...
  if (e) {
    do {
      ...
      b += f.y;
      this.Je &&
        this.o.zb.je.firstChild == e &&
        ((f = this.o.zb.Gl()), (a += f.x), (b += f.y));
      e = e.parentNode;
    } while (e && e != this.o.Yd && e != c);
  }
  return (this.nd = new D(a, b));
};
d.moveBy = function(a, b) {
  var c = new Ic(this),
    e = this.la();
...
d.us = function(a) {
  this.Je && (this.translate(a.x, a.y), this.o.zb.Ui(this.o.Ma));
};
d.em = function(a, b) {
  a
    ? a.qf(b.x, b.y)
    : ((this.w.rf = "translate(" + b.x + "," + b.y + ")"),
      this.w.setAttribute("transform", this.w.rf + this.w.kh));
};
d.moveTo = function(a, b) {
  this.translate(a, b);
};
...
function yf(a) {
  a.we() ? z.i.mb(a.w, "blocklyDraggable") : z.i.Rb(a.w, "blocklyDraggable");
}
d.hh = function(a) {
  xf.s.hh.call(this, a);
  yf(this);
...
d.jg = function(a) {
  a
    ? ((a = this.ga()),
      (a.rf = ""),
      (a.kh = ""),
      z.i.mb(this.w, "blocklyDragging"))
    : z.i.Rb(this.w, "blocklyDragging");
};
d.ga = function() {
  return this.w;
};
d.Ic = function() {
  return this.wb ? this.wb.value : this.Vc;
};
d.Cd = function(a) {
  xf.s.Cd.call(this, a);
  this.wb && (this.wb.value = a);
...
d.ek = function(a) {
  a
    ? z.i.mb(this.w, "blocklyDraggingDelete")
    : z.i.Rb(this.w, "blocklyDraggingDelete");
};
d.bt = function() {};
function Cf(a, b, c) {
  z.j.disable();
...
function Df(a, b) {
  ...
  this.Lm = !1;
  this.Ge = this.Fb.la();
  this.Gg = z.i.Sf() && b.zb ? b.zb : null;
}
Df.prototype.A = function() {
  this.Gg = this.m = this.Fb = null;
};
function Ef(a, b, c) {
  c = a.pi(c);
...
function Ff(a, b, c) {
  ...
  a.m.ea &&
    z.i.Rb(
      a.m.ea.Dc,
      a.Fb.ec() ? "blocklyToolboxDelete" : "blocklyToolboxGrab"
    );
  z.j.R(!1);
}
Df.prototype.jj = function() {
  if (this.Fb.Yr) {
    var a = new Ic(this.Fb);
    a.Ho = this.Ge;
    a.hf();
    z.j.U(a);
  }
};
Df.prototype.pi = function(a) {
  a = new D(a.x / this.m.scale, a.y / this.m.scale);
  this.m.Jj && (a = a.scale(1 / this.m.options.Lb.scale));
  return a;
};
Df.prototype.fm = function() {
  this.Fb.moveTo(0, 0);
...
function Gf(a) {
  this.m = a;
  this.Ex = a.rb();
  this.Gx = new D(a.scrollX, a.scrollY);
}
Gf.prototype.A = function() {
  this.m = null;
};
Gf.prototype.Em = function() {
...
Gf.prototype.ut = function(a, b) {
  this.m.ib.set(a, b);
};
function Jf(a) {
  Jf.s.constructor.call(this, a.tj());
  this.Ub = a.Ub;
  this.Od = a.Od;
}
y(Jf, Gf);
Jf.prototype.ut = function(a, b) {
  this.Od ? this.Ub.set(a) : this.Ub.set(b);
};
z.C = {};
z.C.visible = !1;
z.C.Mh = !1;
...
z.C.V = function() {
  z.C.ha ||
    ((z.C.ha = F("DIV", "blocklyTooltipDiv")),
    document.body.appendChild(z.C.ha));
};
z.C.Cg = function(a) {
  z.Zb(a, "mouseover", null, z.C.lx);
  z.Zb(a, "mouseout", null, z.C.kx);
  a.addEventListener("mousemove", z.C.jx, !1);
};
z.C.lx = function(a) {
  if (!z.C.Mh) {
    for (a = a.target; !q(a.gd) && !v(a.gd); ) a = a.gd;
...
z.C.jx = function(a) {
  if (z.C.S && z.C.S.gd && !z.H.X() && !z.C.Mh)
    if (z.C.visible) {
      var b = z.C.vo - a.pageX;
      a = z.C.wo - a.pageY;
      Math.sqrt(b * b + a * a) > z.C.qu && z.C.Fa();
    } else
      z.C.nm != z.C.S &&
        (clearTimeout(z.C.jk),
        (z.C.vo = a.pageX),
        (z.C.wo = a.pageY),
        (z.C.jk = setTimeout(z.C.Ax, z.C.Vt)));
};
z.C.Fa = function() {
  z.C.visible &&
    ((z.C.visible = !1), z.C.ha && (z.C.ha.style.display = "none"));
...
z.C.Ax = function() {
  if (!z.C.Mh && ((z.C.nm = z.C.S), z.C.ha)) {
    ...
    var e = z.C.wo + z.C.eq;
    e + z.C.ha.offsetHeight > b.height + window.scrollY &&
      (e -= z.C.ha.offsetHeight + 2 * z.C.eq);
    a
      ? (c = Math.max(z.C.Qm - window.scrollX, c))
      : c + z.C.ha.offsetWidth > b.width + window.scrollX - 2 * z.C.Qm &&
        (c = b.width - z.C.ha.offsetWidth - 2 * z.C.Qm);
    z.C.ha.style.top = e + "px";
    z.C.ha.style.left = c + "px";
  }
};
function Kf(a, b) {
  this.jb = this.Xb = this.lh = this.mh = this.Ac = this.oc = this.ss = null;
  this.mv = b;
...
function Lf(a, b) {
  ...
  if (a.Mg) var c = !1;
    ...
    (c = a.oc),
      (a.Mg = Math.sqrt(c.x * c.x + c.y * c.y) > (a.I ? z.Pt : z.aq)),
      (c = a.Mg);
  if (c) {
    if (a.Ac) {
      a.Hj = !0;
      ...
      var e = c.m.ea;
      e &&
        z.i.mb(e.Dc, c.Fb.ec() ? "blocklyToolboxDelete" : "blocklyToolboxGrab");
      Ef(a.Pe, a.Lc, a.oc);
      c = !0;
    } else c = !1;
    if (!c) {
      if (a.Xb)
        if (
          ...
          c.m.Sb(!1);
          z.Ea.In();
          if (c.gb.getParent() || (f && c.gb.K && J(c.gb.K)))
            Ee(c.gb, f),
              (e = c.pi(e)),
              (e = vc(c.Ge, e)),
              c.gb.translate(e.x, e.y),
              z.Ea.Fv(c.gb);
          c.gb.jg(!0);
          c.gb.fm();
          (e = c.m.ea) &&
            z.i.mb(
              e.Dc,
              c.gb.ec() ? "blocklyToolboxDelete" : "blocklyToolboxGrab"
            );
          qf(a.Oe, a.Lc, a.oc);
          c = !0;
        } else c = !1;
      ...
      !c &&
        (a.I ? Mf(a.I) : a.jb && a.jb.ib) &&
        ((a.tg = a.I ? new Jf(a.I) : new Gf(a.jb)), (a.Ij = !0), a.tg.Em());
    }
    z.Xf();
  }
  a.Lc = b;
...
d.gj = function(a) {
  z.i.Vl(a)
    ...
    : ((this.Rr = !0),
      z.Ea.In(),
      Nf(this.jb),
      this.jb.Jj && this.jb.resize(),
      Pf(this.jb),
      (this.Lc = a),
      z.Qb(!!this.I),
      z.C.block(),
      this.Xb && this.Xb.select(),
      z.i.Uf(a)
        ? qc(this, a)
        : (("touchstart" == a.type.toLowerCase() ||
            ("pointerdown" == a.type.toLowerCase() &&
              "mouse" != a.pointerType)) &&
            z.Jw(a, this),
          (this.ss = new D(a.clientX, a.clientY)),
          (this.Sr = a.altKey || a.ctrlKey || a.metaKey),
          this.Cg(a)));
};
d.Cg = function(a) {
  this.km = z.O(document, "mousemove", null, this.xj.bind(this));
...
d.xj = function(a) {
  ...
  this.Ij
    ? If(this.tg, this.oc)
    : this.Rg
    ? qf(this.Oe, this.Lc, this.oc)
    : this.Hj && Ef(this.Pe, this.Lc, this.oc);
  a.preventDefault();
  a.stopPropagation();
};
d.Kl = function(a) {
  ...
  if (this.Sl) console.log("Trying to end a gesture recursively.");
    ...
    if (this.Hj) Ff(this.Pe, a, this.oc);
      ...
      this.Ac && !this.Mg
        ? (this.Ac.up && this.Ac.up(), this.Ac.select && this.Ac.select())
        : Rf(this)
        ? (this.mh.Fd(), Sf(this))
        : !this.lh || this.Mg || Rf(this)
        ? this.lh ||
          this.Ac ||
          this.mh ||
          this.Mg ||
        ...
        : (this.I && this.I.Lh
            ? this.Xb.disabled ||
              (z.j.rc() || z.j.R(!0), wf(Of(this.I, this.Xb)))
            : z.j.U(new Fc(this.lh, "click", void 0, void 0)),
          Sf(this),
          z.j.R(!1));
    a.preventDefault();
    a.stopPropagation();
...
d.cancel = function() {
  if (!this.Sl) {
    z.Xf();
    if (this.Hj) Ff(this.Pe, this.Lc, this.oc);
...
function qc(a, b) {
  a.Xb
    ? (Sf(a), z.Qb(a.I), a.Xb.xi(b))
    : a.Ac
    ? a.Ac.xi(b)
    : a.jb && !a.I && (z.Qb(), a.jb.xi(b));
  b.preventDefault();
  b.stopPropagation();
  a.A();
}
...
function Tf(a, b) {
  a.lh || a.Ac || ((a.lh = b), b.tb && b != cf(b) ? Uf(a, cf(b)) : Uf(a, b));
}
function Uf(a, b) {
  b.hb ? Uf(a, b.getParent()) : (a.Xb = b);
}
function Rf(a) {
  if (a.mh) {
    var b = a.mh;
  ...
  return b && !a.Mg && (!a.I || !a.I.Lh);
}
d.pb = function() {
  return this.Ij || this.Rg || this.Hj;
};
z.i = {};
z.i.removeAttribute = function(a, b) {
  A && wb("10.0") ? a.setAttribute(b, null) : a.removeAttribute(b);
};
z.i.mb = function(a, b) {
...
z.i.tc = function(a) {
  ...
  if ((c = (c = a.getAttribute("transform")) && c.match(z.i.tc.Cu)))
    (b.x += parseFloat(c[1])), c[3] && (b.y += parseFloat(c[3]));
  (a = a.getAttribute("style")) &&
    -1 < a.indexOf("translate") &&
    ((c = a.match(z.i.tc.Au)) || (c = a.match(z.i.tc.Bu)),
...
z.i.B = function(a, b, c) {
  a = document.createElementNS(z.Zm, a);
...
z.i.Bq = function(a) {
  for (var b = z.g, c = /%{(BKY_[A-Z][A-Z0-9_]*)}/gi, e = c.exec(a); e; ) {
    var f = e[1];
    f = f.toUpperCase();
    "BKY_" != f.substr(0, 4)
      ? console.log(
        ...
        ("" == l
          ...
          : ((f = a.join("")),
            /[a-zA-Z][a-zA-Z0-9_]*/.test(f)
              ? ((l = f.toUpperCase()),
                (l = Fa(l, "BKY_") ? l.substring(4) : null) && l in z.g
                  ? ((f = z.g[l]),
                    q(f)
                      ? Array.prototype.push.apply(c, z.i.Op(f, b))
                      : b
                      ? c.push(String(f))
                      : c.push(f))
                  : c.push("%{" + f + "}"))
...
z.i.ne = function() {
  for (var a = z.i.ne.ft.length, b = [], c = 0; 20 > c; c++)
    b[c] = z.i.ne.ft.charAt(Math.random() * a);
  return b.join("");
};
z.i.ne.ft =
...
z.i.At = function(a, b) {
  a = a.split("\n");
  for (var c = 0; c < a.length; c++) a[c] = z.i.Xx(a[c], b);
  return a.join("\n");
};
z.i.Xx = function(a, b) {
...
z.i.Bt = function(a, b, c) {
  for (var e = z.i.Sp(a, b, c), f, h = 0; h < b.length - 1; h++)
    if (b[h] != b[h + 1]) {
      var k = [].concat(b);
      k[h] = !k[h];
      k[h + 1] = !k[h + 1];
...
Wf.prototype.moveTo = function(a, b) {
...
function Yf(a) {
  ...
  b.Rj = void 0 === a.minScale ? 0.3 : parseFloat(a.minScale);
...
function $f(a) {
  ...
  this.Zi = z.i.B(
    "rect",
    { height: H, width: H, class: "blocklyScrollbarBackground" },
    null
  );
  z.i.Fj(this.Zi, a.Yd);
}
...
$f.prototype.resize = function() {
  ...
  if (a) {
    ...
    b && this.Lf.resize(a);
    c && this.rg.resize(a);
    (this.ab && this.ab.ya == a.ya && this.ab.lb == a.lb) ||
      this.Zi.setAttribute("x", this.rg.Mc.x);
    (this.ab && this.ab.cb == a.cb && this.ab.xb == a.xb) ||
      this.Zi.setAttribute("y", this.Lf.Mc.y);
    this.ab = a;
  }
};
...
function ag(a, b, c, e) {
  ...
  a = H;
  b
    ? (this.ed.setAttribute("height", a),
      this.ze.setAttribute("height", a),
      this.Ie.setAttribute("height", a - 5),
      this.Ie.setAttribute("y", 2.5),
      (this.Nj = "width"),
      (this.Os = "x"))
    : (this.ed.setAttribute("width", a),
      this.ze.setAttribute("width", a),
      this.Ie.setAttribute("width", a - 5),
      this.Ie.setAttribute("x", 2.5),
      (this.Nj = "height"),
      (this.Os = "y"));
  this.Is = z.O(this.ed, "mousedown", this, this.gx);
  this.Js = z.O(this.Ie, "mousedown", this, this.hx);
}
var cg, dg;
d = ag.prototype;
d.Oo = new D(0, 0);
...
function gg(a, b, c) {
  ...
  z.i.dk(
    a.ze,
    "translate(" + (a.Mc.x + a.Oo.x) + "px," + (a.Mc.y + a.Oo.y) + "px)"
  );
}
d = ag.prototype;
d.resize = function(a) {
  ...
  if (
    ...
    if (this.Ng) {
      ...
      gg(this, b, a.xb + a.cb - H - 0.5);
      this.oi || this.oa(this.Bd < a.Hc);
      this.gc = this.Bd / a.Hc;
      if (-Infinity == this.gc || Infinity == this.gc || isNaN(this.gc))
        this.gc = 0;
      ...
      this.gc = this.Bd / a.mc;
      if (-Infinity == this.gc || Infinity == this.gc || isNaN(this.gc))
        this.gc = 0;
      this.Mf = Math.max(0, a.cb * this.gc);
      this.Ie.setAttribute(this.Nj, this.Mf);
      bg(this, hg(this, (a.Ke - a.nc) * this.gc));
    }
    ig(this);
  }
};
d.$i = function(a) {
  var b = "blocklyScrollbar" + (this.Ng ? "Horizontal" : "Vertical");
  a && (b += " " + a);
...
d.wk = function() {
  this.Dg && this.X()
    ? this.ze.setAttribute("display", "block")
    : this.ze.setAttribute("display", "none");
};
d.gx = function(a) {
  Pf(this.m);
  z.Touch.Te();
  eg();
  if (z.i.Uf(a)) a.stopPropagation();
  else {
    var b = z.i.Sj(a, L(this.m), jg(this.m));
    b = this.Ng ? b.x : b.y;
    var c = z.i.Al(this.Ie);
    c = this.Ng ? c.x : c.y;
    var e = this.yj,
      f = 0.95 * this.Mf;
...
d.hx = function(a) {
  ...
  z.i.Uf(a)
    ...
    : ((this.Dx = this.yj),
      Hf(this.m),
      (this.jt = this.Ng ? a.clientX : a.clientY),
      (cg = z.O(document, "mouseup", this, this.mx)),
      (dg = z.O(document, "mousemove", this, this.ix)),
      a.stopPropagation(),
      a.preventDefault());
};
d.ix = function(a) {
  bg(this, hg(this, this.Dx + ((this.Ng ? a.clientX : a.clientY) - this.jt)));
  ig(this);
};
d.mx = function() {
  Qf(this.m);
...
function hg(a, b) {
  return (b = 0 >= b || isNaN(b) || a.Bd < a.Mf ? 0 : Math.min(b, a.Bd - a.Mf));
}
function ig(a) {
  var b = a.yj / a.Bd;
  isNaN(b) && (b = 0);
...
d.set = function(a) {
  bg(this, hg(this, a * this.gc));
  ig(this);
};
function kg(a, b) {
  kg.s.constructor.call(this, a, b);
  this.Tl = !1;
  this.ud = {};
  this.ht = this.Xj = 0;
  this.No = null;
...
d.gj = function(a) {
  kg.s.gj.call(this, a);
  !this.Sl && z.Touch.Wl(a) && lg(this, a);
};
d.Cg = function(a) {
  this.No = z.O(document, "mousedown", null, this.lw.bind(this), !0);
...
d.lw = function(a) {
  !this.pb() && z.Touch.Wl(a) && (lg(this, a), this.Tl && z.Xf());
};
d.xj = function(a) {
  if (this.pb()) z.Touch.Bp(a) && kg.s.xj.call(this, a);
  else if (this.Tl) {
    if (z.Touch.Wl(a)) {
      this.ud[z.Touch.Hl(a)] = mg(this, a);
      var b = Object.keys(this.ud);
      if (2 == b.length) {
        b = tc(this.ud[b[0]], this.ud[b[1]]) / this.ht;
        if (0 < this.Xj && Infinity > this.Xj) {
          var c = b - this.Xj;
          c = 0 < c ? 5 * c : 6 * c;
          var e = this.jb,
            f = z.i.Sj(a, L(e), jg(e));
    ...
    z.Xf();
  } else kg.s.xj.call(this, a);
};
d.Kl = function(a) {
  if (z.Touch.Wl(a) && !this.pb()) {
    var b = z.Touch.Hl(a);
    this.ud[b] && delete this.ud[b];
    2 > Object.keys(this.ud).length && ((this.ud = {}), (this.Xj = 0));
  }
  !this.Tl || this.pb()
    ? z.Touch.Bp(a) && kg.s.Kl.call(this, a)
...
function lg(a, b) {
  a.ud[z.Touch.Hl(b)] = mg(a, b);
  var c = Object.keys(a.ud);
  2 == c.length &&
    ((a.ht = tc(a.ud[c[0]], a.ud[c[1]])), (a.Tl = !0), b.preventDefault());
}
function mg(a, b) {
  return a.jb
    ? new D(
...
d.dispatchEvent = function(a) {
  ...
  if (b)
    for (h = 0; !a.$g && h < b.length; h++)
      (k = a.currentTarget = b[h]), (f = og(k, e, !1, a) && f);
  return f;
};
d.Ta = function() {
  ng.s.Ta.call(this);
...
d.oj = function(a, b, c, e) {
  return this.Xe.oj(String(a), b, c, e);
};
function uf(a, b, c) {
  if (v(a)) c && (a = na(a, c));
...
d.clone = function() {
  return new pg(this.top, this.right, this.bottom, this.left);
};
...
d = qg.prototype;
d.clone = function() {
  return new qg(this.left, this.top, this.width, this.height);
};
d.contains = function(a) {
...
d.L = function(a) {
  this.Ri = this.Rm + a;
  sf(this, !1);
  return this.Ri + this.Dk + this.Bh;
};
d.A = function() {
...
d.position = function() {
  ...
  a &&
    (this.m.u
      ? ((this.Jb = this.Ii + H),
        a.Ba == z.xf && ((this.Jb += a.ql), this.m.ea && (this.Jb += a.lb)))
      : ((this.Jb = a.ya + a.lb - this.Bg - this.Ii - H),
        a.Ba == z.$d && (this.Jb -= a.ql)),
    (this.pf = a.cb + a.xb - (this.Dk + this.Bh) - this.Ri),
    a.Ba == z.Ag && (this.pf -= a.Cr),
    this.w.setAttribute(
      "transform",
      "translate(" + this.Jb + "," + this.pf + ")"
    ));
};
d.Uh = function() {
  ...
  return new qg(
    a.left + this.Xm - this.Kk,
    a.top + this.Ym - this.Kk,
    this.Bg + 2 * this.Kk,
    this.Bh + this.Dk + 2 * this.Kk
  );
};
function sf(a, b) {
  a.gi != b && (g.clearTimeout(a.xo), (a.gi = b), a.gn());
}
d.gn = function() {
  this.Wf += this.gi ? 0.2 : -0.2;
  this.Wf = rc(this.Wf, 0, 1);
  var a = 45 * this.Wf;
  this.Gm.setAttribute(
    "transform",
    "rotate(" +
      (this.m.u ? -a : a) +
      "," +
      (this.m.u ? 4 : this.Bg - 4) +
      "," +
      (this.Bh - 2) +
      ")"
  );
  this.w.style.opacity = 0.4 + 0.4 * this.Wf;
...
d.click = function() {
  var a = this.m.Fx - this.m.scrollX,
...
z.G.On = function(a) {
  ...
  if (0 < a.length) {
    var c = a[0];
    if (z.J.variables_set) {
      var e = z.J.math_change ? 8 : 24;
      e =
...
z.G.Nh = function(a, b, c) {
  function e(c) {
    z.G.Ts(z.g.NEW_VARIABLE_TITLE, c, function(c) {
      if (c) {
        var h = z.G.Pw(c, a);
        if (h) {
          var k = c.toLowerCase();
          if (h.type == f) var n = z.g.VARIABLE_ALREADY_EXISTS.replace("%1", k);
          else
            (n = z.g.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE),
...
z.G.ep = function(a, b) {
  function c(e) {
    var f = z.g.RENAME_VARIABLE_TITLE.replace("%1", b.name);
    z.G.Ts(f, e, function(e) {
      if (e) {
        var f = z.G.Qw(e, b.type, a);
        f
          ? ((f = z.g.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE.replace(
              "%1",
              e.toLowerCase()
            ).replace("%2", f.type)),
            z.alert(f, function() {
...
z.G.Ts = function(a, b, c) {
  z.prompt(a, b, function(a) {
    a &&
      ((a = a.replace(/[\s\xa0]+/g, " ").replace(/^ | $/g, "")),
      a == z.g.RENAME_VARIABLE || a == z.g.NEW_VARIABLE) &&
      (a = null);
    c(a);
  });
};
z.G.Qw = function(a, b, c) {
  c = c.ra.Ye();
  a = a.toLowerCase();
...
z.G.Er = function(a) {
  a = "<xml>" + z.G.Th(a) + "</xml>";
  return z.D.fd(a).firstChild;
};
z.G.Dl = function(a, b, c, e) {
  var f = z.G.Jc(a, b, c, e);
  f || (f = z.G.kv(a, b, c, e));
  return f;
};
z.G.Jc = function(a, b, c, e) {
  var f = a.si;
  if (b) {
    var h = a.Nd(b);
    !h && f && (h = f.Nd(b));
...
z.G.kv = function(a, b, c, e) {
  var f = a.si;
  c || (c = z.G.Sv(a.Pd ? a.qh : a));
  return f ? f.Wc(c, e, b) : a.Wc(c, e, b);
};
z.G.Fr = function(a, b) {
  a = a.Ye();
  var c = [];
...
z.rd = {};
z.rd.Yw = function(a) {
  z.G.Nh(a.ta, null, "String");
};
z.rd.Xw = function(a) {
  z.G.Nh(a.ta, null, "Number");
};
z.rd.Ww = function(a) {
  z.G.Nh(a.ta, null, "Colour");
};
z.rd.Hf = function(a) {
  var b = [],
    c = F("button");
  ...
  a.Ig.CREATE_VARIABLE_COLOUR = z.rd.Ww;
  a = z.rd.On(a);
  return (b = b.concat(a));
};
z.rd.On = function(a) {
...
d.play = function(a, b) {
  ...
  c
    ? ((a = new Date()),
      (null != this.uo && a - this.uo < z.vu) ||
        ((this.uo = a),
        (c = (xb && 9 === xb) || qb || ob ? c : c.cloneNode()),
        (c.volume = void 0 === b ? 1 : b),
        c.play()))
    : this.Ro && this.Ro.Af.play(a, b);
};
d = xf.prototype;
d.Hb = function() {
  return { width: this.$c(), height: this.Xh() };
};
d.Z = function() {
  if (!this.fg) {
    var a = this.Hb();
    ...
    this.ec() &&
      ((this.Ef = z.i.B("g", { class: "blocklyCommentDeleteIcon" }, this.w)),
      (this.kr = z.i.B(
        "circle",
    ...
    this.Mb && z.O(this.Mb, "mousedown", this, this.gp);
    this.ec() &&
      (z.O(this.Ef, "mousedown", this, this.yv),
      z.O(this.Ef, "mouseout", this, this.zv),
      z.O(this.Ef, "mouseup", this, this.Av));
  }
};
d.aj = function() {
  this.Yc = z.i.B(
...
d.gp = function(a) {
  wg(this);
  z.i.Uf(a) ||
    (this.o.Em(a, new D(this.o.u ? -this.ka : this.ka, this.Ca)),
    (this.ni = z.O(document, "mouseup", this, this.vx)),
    (this.Mo = z.O(document, "mousemove", this, this.hp)),
    z.Qb());
  a.stopPropagation();
};
d.yv = function(a) {
  z.i.mb(this.kr, "blocklyDeleteIconHighlighted");
  a.stopPropagation();
};
d.zv = function() {
  z.i.Rb(this.kr, "blocklyDeleteIconHighlighted");
};
d.Av = function(a) {
  this.A(!0, !0);
  a.stopPropagation();
...
function vg(a, b, c) {
  ...
  a.u &&
    (a.pk.setAttribute("transform", "scale(-1 1)"),
    a.ng.setAttribute("transform", "scale(-1 1)"));
  a.Mb &&
    (a.u
      ? (a.Mb.setAttribute(
          "transform",
      ...
      : (a.Mb.setAttribute(
        ...
        a.Ef.setAttribute("transform", "translate(" + (b - 8) + ",-8)")));
  b = a.Hb();
...
d.up = function() {
  ...
  setTimeout(function() {
    ...
    z.i.mb(a.oh, "blocklyCommentHandleTargetFocused");
  }, 0);
};
function zf(a) {
  a.kj = !1;
  setTimeout(function() {
    ...
    z.i.Rb(a.oh, "blocklyCommentHandleTargetFocused");
  }, 0);
}
function xg(a) {
  this.Yi = a;
...
d.Ui = function(a) {
  ...
  if (
    !(
      b &&
      c &&
      z.i.Or(b, "blocklyBlockCanvas") &&
      z.i.Or(c, "blocklyBubbleCanvas")
    )
  )
...
z.D.Rp = function(a, b) {
  var c = F("xml");
  c.appendChild(z.D.Tx(z.G.pq(a)));
  for (var e = dd(a, !0), f = 0, h; (h = e[f]); f++) c.appendChild(h.qk(b));
  a = cd(a, !0);
  for (f = 0; (e = a[f]); f++) c.appendChild(z.D.mn(e, b));
  return c;
};
z.D.Tx = function(a) {
  for (var b = F("variables"), c = 0, e; (e = a[c]); c++) {
    var f = F("variable", null, e.name);
...
z.D.Ov = function(a) {
  if (a.name && a.vg) {
    if (a.bh()) return z.D.Nv(a);
    var b = F("field", null, a.getValue());
...
z.D.Bf = function(a, b) {
  ...
  if ((e = a.wl())) {
    e = F("comment", null, e);
    if ("object" == typeof a.Sa) {
      e.setAttribute("pinned", a.Sa.X());
      var f = a.Sa.Kg();
  ...
  a.data && ((e = F("data", null, a.data)), c.appendChild(e));
  f = 0;
  for (var h; (h = a.W[f]); f++) {
    var k,
      l = !0;
  ...
  if ((f = Lc(a))) (k = F("next", null, z.D.Bf(f, b))), c.appendChild(k);
  e = a.K && a.K.Fe;
  ...
  for (var b = (a = a.cloneNode(!0)), c; b; )
    if (b.firstChild) b = b.firstChild;
      ...
      for (; b && !b.nextSibling; )
        (c = b),
          (b = b.parentNode),
          3 == c.nodeType && "" == c.data.trim() && b.firstChild != c && G(c);
      b &&
        ((c = b),
        (b = b.nextSibling),
        3 == c.nodeType && "" == c.data.trim() && G(c));
    }
  return a;
};
z.D.wd = function(a) {
    ...
    for (var l = 0; l < f; l++) {
      ...
      if ("block" == n || ("shadow" == n && !z.j.hc)) {
        ...
        var r = m.hasAttribute("x") ? parseInt(m.getAttribute("x"), 10) : 10,
          x = m.hasAttribute("y") ? parseInt(m.getAttribute("y"), 10) : 10;
...
z.D.zB = function(a, b) {
  ...
  if (e && e.height) {
    ...
    var m;
    b.u && (m = b.$c());
    for (e = 0; e < a.length; e++) Kc(b, a[e]).moveBy(b.u ? m - f : f, c);
  }
  return a;
};
z.D.Qh = function(a, b) {
  ...
  try {
    ...
    if (b.P) {
      ...
      for (h = f.length - 1; 0 <= h; h--) f[h].Z(!1);
      setTimeout(function() {
        e.o && Bg(e, !1);
      }, 1);
      mf(e);
      Af(b);
    } else for (h = f.length - 1; 0 <= h; h--) f[h].Pg();
  } finally {
    z.j.enable();
  }
  if (z.j.isEnabled()) {
    a = z.G.Fr(b, c);
    for (h = 0; h < a.length; h++) z.j.U(new Cc(a[h]));
    z.j.U(new z.j.Fk(e));
  }
  return e;
};
    ...
    if (3 != k.nodeType) {
      ...
      switch (k.nodeName.toLowerCase()) {
        ...
        case "statement":
          ...
          h &&
            ((h = z.D.Jn(h, b)),
            h.N ? k.connection.connect(h.N) : h.Y && k.connection.connect(h.Y));
          break;
        case "next":
          l && c.K && (c.K.Fe = l);
          h && ((h = z.D.Jn(h, b)), c.K.connect(h.Y));
          break;
        default:
...
z.D.Jv = function(a, b, c) {
  var e = I(a, b);
  e
    ? ((a = a.o),
      (b = c.textContent),
      e.bh() ? z.D.Iv(a, c, b, e) : e.setValue(b))
...
d.pf = 0;
d.V = function() {
  this.w = z.i.B("g", { class: "blocklyZoom" }, null);
  var a = String(Math.random()).substring(2);
  Dg(this, a);
  Eg(this, a);
  Fg(this, a);
...
d.position = function() {
  ...
  a &&
    (this.m.u
      ...
      : ((this.Jb = a.ya + a.lb - this.Bg - this.Ii - H),
        a.Ba == z.$d && (this.Jb -= a.ql)),
    (this.pf = a.cb + a.xb - this.bq - this.Ri),
    a.Ba == z.Ag && (this.pf -= a.Cr),
    this.w.setAttribute(
      "transform",
      "translate(" + this.Jb + "," + this.pf + ")"
...
function Hg(a, b, c) {
  ...
  z.qa && z.qa.Hf && (this.zi[z.gq] = z.qa.Hf);
}
y(Hg, ad);
d = Hg.prototype;
d.tm = null;
...
function $e(a, b) {
  var c = 0,
    e = 0,
    f = 1;
  if (ge(a.Ma, b) || ge(a.Yd, b)) f = a.scale;
  do {
    var h = z.i.tc(b);
    if (b == a.Ma || b == a.Yd) f = 1;
    c += h.x * f;
    e += h.y * f;
    b = b.parentNode;
  } while (b && b != L(a));
...
d.V = function(a) {
  ...
  a &&
    ...
    "blocklyMainBackground" == a &&
      this.zd &&
      (this.ed.style.fill = "url(#" + this.zd.Zh.id + ")"));
  ...
  this.options.Yb &&
    this.options.Yb.controls &&
    ((this.xh = new Cg(this)),
    (b = this.xh.V()),
    this.w.appendChild(b),
    this.xh.L(a));
  this.Pd ||
    (z.O(this.w, "mousedown", this, this.gf, !1, !0),
    this.options.Yb &&
      this.options.Yb.Vx &&
      z.O(this.w, "wheel", this, this.ox));
...
function Af(a) {
  a.ip && a.P && (a.ib && a.ib.resize(), (a.Gj = !0));
}
d.resize = function() {
  this.ea && this.ea.position();
...
function L(a) {
  if (a.vq) return a.vq;
  for (var b = a.w; b; ) {
    if ("svg" == b.tagName) return (a.vq = b);
    b = b.parentNode;
  }
  return null;
}
d.translate = function(a, b) {
  if (this.Km && this.Rl) this.wh.qf(a, b);
  else {
    var c = "translate(" + a + "," + b + ") scale(" + this.scale + ")";
    this.Ma.setAttribute("transform", c);
    this.Yd.setAttribute("transform", c);
  }
  if (this.zb) {
    c = this.zb;
    var e = this.scale;
...
d.$c = function() {
  var a = this.rb();
  return a ? a.ya / this.scale : 0;
};
d.oa = function(a) {
  this.ib && this.ib.gh(a);
  (this.I || (this.ea && this.ea.I)) &&
    (this.I ? this.I : this.ea ? this.ea.I : null).gh(a);
  L(this).style.display = a ? "block" : "none";
  this.ea && (this.ea.Dc.style.display = a ? "block" : "none");
  a ? (this.Z(), this.ea && this.ea.position()) : z.Qb(!0);
};
d.Z = function() {
  for (var a = Qc(this), b = a.length - 1; 0 <= b; b--) a[b].Z(!1);
};
function Pg(a, b) {
  var c = O;
  if (void 0 === b) {
    for (var e = 0, f; (f = c.Bj[e]); e++) f.Wb(!1);
    c.Bj.length = 0;
  }
  if ((f = a ? Kc(c, a) : null))
    (a = void 0 === b || b)
      ? -1 == c.Bj.indexOf(f) && c.Bj.push(f)
      : xa(c.Bj, f),
      f.Wb(a);
}
function Qg(a) {
  ...
  if (a.P && !(b.getElementsByTagName("block").length >= fd(a)))
    if ((a.Eb && a.Eb.cancel(), "comment" == b.tagName.toLowerCase())) {
        ...
        if (!isNaN(k) && !isNaN(l)) {
          ...
          do {
            ...
            if (!b) {
              ...
              c = 0;
              for (var x; (x = r[c]); c++)
                if (x.closest(z.Tc, new D(k, l)).connection) {
                  b = !0;
                  break;
                }
            }
            b && ((k = a.u ? k - z.Tc : k + z.Tc), (l += 2 * z.Tc));
          } while (b);
          h.moveBy(k, l);
        }
      } finally {
      ...
      z.j.isEnabled() && !h.hb && z.j.U(new z.j.Fk(h));
      h.select();
    }
}
function Rg(a) {
  if ((a = a.Pd ? a.qh : a) && !a.Eb && a.ea && a.ea.I) {
    a = a.ea;
    var b = a.Hd.se();
    b && b.ee && a.I.show(b.ee);
  }
}
d.eh = function(a, b) {
  Hg.s.eh.call(this, a, b);
  Rg(this);
};
d.Ff = function(a) {
  Hg.s.Ff.call(this, a);
...
d.Wc = function(a, b, c) {
  a = Hg.s.Wc.call(this, a, b, c);
  Rg(this);
  return a;
};
function Lg(a) {
  a.jr = a.Pc && a.w.parentNode ? a.Pc.Uh() : null;
  a.ir = a.I ? a.I.Uh() : a.ea ? a.ea.Uh() : null;
}
function rf(a, b) {
  b = new D(b.clientX, b.clientY);
  return a.jr && a.jr.contains(b)
    ? z.Om
    : a.ir && a.ir.contains(b)
    ? z.Zp
    : z.Yp;
}
d.gf = function(a) {
...
d.pb = function() {
  return null != this.Eb && this.Eb.pb();
};
d.ox = function(a) {
  this.Eb && this.Eb.cancel();
  var b = -a.deltaY / 50,
...
function Ag(a) {
  ...
  for (var c = 1; c < b.length; c++) {
    ...
    e.Id.y > a.Id.y && (a.Id.y = e.Id.y);
  }
  return {
    x: a.hd.x,
    y: a.hd.y,
    width: a.Id.x - a.hd.x,
    height: a.Id.y - a.hd.y
  };
}
d.av = function() {
  this.Sb(!1);
  z.j.R(!0);
  for (var a = cd(this, !0), b = 0, c = 0, e; (e = a[c]); c++) {
    var f = e.la();
    e.moveBy(-f.x, b - f.y);
    Sg(e);
    b = e.la().y + e.Hb().height + 25;
  }
  z.j.R(!1);
  this.Sb(!0);
};
d.xi = function(a) {
  ...
  if (!this.options.readOnly && !this.Pd) {
    ...
    this.ib &&
      ...
      (l.eb = this.av.bind(this)),
      e.push(l));
    if (this.options.collapse) {
      for (var m = (l = !1), n = 0; n < f.length; n++)
        for (var p = f[n]; p; )
          p.isCollapsed() ? (l = !0) : (m = !0), (p = Lc(p));
      var r = function(a) {
        for (var b = 0, c = 0; c < f.length; c++)
          for (var e = f[c]; e; )
            setTimeout(e.ig.bind(e, a), b), (e = Lc(e)), (b += 10);
      };
      m = { enabled: m };
    ...
    l = {
      text:
        1 == x.length
          ? z.g.DELETE_BLOCK
          : z.g.DELETE_X_BLOCKS.replace("%1", String(x.length)),
      enabled: 0 < x.length,
      eb: function() {
        k.Eb && k.Eb.cancel();
        2 > x.length
          ? c()
          : z.confirm(z.g.DELETE_ALL_BLOCKS.replace("%1", x.length), function(
              a
            ) {
              a && c();
            });
...
d.Im = function(a) {
  ...
  } else if (this.options.xe) throw "Can't nullify an existing toolbox.";
};
function Pf(a) {
  if (a.options.Lb) Pf(a.options.Lb);
  else {
    z.Yf = a;
...
d.zoom = function(a, b, c) {
  ...
  e = Math.pow(e, c);
  c = this.scale * e;
  c > this.options.Yb.Qj
    ? (e = this.options.Yb.Qj / this.scale)
    : c < this.options.Yb.Rj && (e = this.options.Yb.Rj / this.scale);
  this.scale != c &&
    (this.ib &&
      ((a = h
        .getCTM()
      ...
      (this.scrollY = a.f - f.xb)),
    this.setScale(c));
};
function Gg(a, b) {
  var c = a.rb();
  a.zoom(c.ya / 2, c.cb / 2, b);
}
d.setScale = function(a) {
  this.options.Yb.Qj && a > this.options.Yb.Qj
    ? (a = this.options.Yb.Qj)
    : this.options.Yb.Rj && a < this.options.Yb.Rj && (a = this.options.Yb.Rj);
  this.scale = a;
  this.zd && this.zd.update(this.scale);
...
function tg(a, b) {
  a.Ig.CREATE_VARIABLE = b;
}
function Wg(a, b) {
  return (a = a.Ig[b]) ? a : null;
}
function Xg(a, b) {
...
d.io = function(a) {
  Je(this.T) && Fe.prototype.io.call(this, a);
};
d.aj = function() {
  this.mk = z.i.B("svg", { x: se, y: se }, null);
  if (this.Us.length)
    for (var a = F("xml"), b = 0, c; (c = this.Us[b]); b++)
      a.appendChild(F("block", { type: c }));
  else a = null;
  a = {
    xe: a,
    Lb: this.T.o,
    Sd: this.T.o.options.Sd,
    u: this.T.u,
    Ba: this.T.u ? z.$d : z.xf,
    ue: !1,
    rb: this.Wv.bind(this),
    kg: null
  };
  this.m = new Hg(a);
  this.m.Jj = !0;
  ...
  this.mk.appendChild(b);
  return this.mk;
};
d.tf = function() {
  this.T.tb ||
    (Je(this.T)
      ? this.vc && z.i.Rb(this.vc, "blocklyIconGroupReadonly")
      : (this.oa(!1), this.vc && z.i.mb(this.vc, "blocklyIconGroupReadonly")));
  Fe.prototype.tf.call(this);
};
d.sm = function() {
  var a = 2 * se,
    b = this.m.Ma.getBBox();
  var c = this.T.u ? -b.x : b.width + b.x;
  b = b.height + 3 * a;
  if (this.m.I) {
    var e = this.m.I.Ze();
  ...
  c += 3 * a;
  if (Math.abs(this.Ei - c) > a || Math.abs(this.Bk - b) > a)
    (this.Ei = c),
      (this.Bk = b),
      this.Za.hg(c + a, b + a),
      this.mk.setAttribute("width", this.Ei),
      this.mk.setAttribute("height", this.Bk);
  this.T.u &&
    this.m.Ma.setAttribute("transform", "translate(" + this.Ei + ",0)");
  this.m.resize();
};
d.oa = function(a) {
  if (a != this.X())
    if ((z.j.U(new Fc(this.T, "mutatorOpen", !a, a)), a)) {
      ...
      ye(this.Za, this.T.id);
      if ((a = this.m.options.xe))
        this.m.I.L(this.m), this.m.I.show(a.childNodes);
      ...
      (this.mk = null),
        ...
        (this.Za = null),
        (this.Bk = this.Ei = 0),
        this.Cm && (this.T.o.dg(this.Cm), (this.Cm = null));
};
d.Wx = function() {
  if (!this.m.pb())
    for (var a = cd(this.m, !1), b = 0, c; (c = a[b]); b++) {
      var e = c.la(),
        f = c.Hb();
  ...
  if (this.jf.o == this.m) {
    ...
    b = (b = c.Ga()) && z.D.wd(b);
    if (a != b) {
      z.j.U(new z.j.Cc(c, "mutation", null, a, b));
      var h = z.j.rc();
      setTimeout(function() {
        z.j.R(h);
        c.ob();
...
d.Wv = function() {
  return { cb: this.Bk, ya: this.Ei, xb: 0, lb: 0 };
};
d.A = function() {
  this.T.bd = null;
  Fe.prototype.A.call(this);
...
function $g(a) {
  ...
  if (a && a.options) {
    var c = a.options.Lb;
    a.Pd ? c && c.options && (b = c.options.Lb) : c && (b = c);
  }
  return b;
}
g.Blockly || (g.Blockly = {});
...
z.M.qm = function(a, b) {
  ...
  z.M.register(a, function() {
    ah(this, b);
  });
};
z.M.bp = function(a, b, c, e) {
  var f = 'Error when registering mutator "' + a + '": ';
  z.M.Aq(f, b.fb, "domToMutation");
  z.M.Aq(f, b.Ga, "mutationToDom");
  var h = z.M.Cq(b, f);
...
z.M.apply = function(a, b, c) {
  var e = z.M.Mm[a];
  if (!v(e)) throw Error('Error: Extension "' + a + '" not found.');
  if (c) z.M.Zu(a, b);
  else var f = z.M.Vn(b);
  e.apply(b);
  if (c) z.M.Xu('Error after applying mutator "' + a + '": ', b);
  else if (!z.M.Ow(f, b))
    throw Error(
...
z.M.Qk = function(a, b) {
  ...
  "object" == typeof document &&
    z.i.$s(function() {
      for (var a in b) z.i.Bq(b[a]);
    });
  return function() {
    this.type &&
      -1 === c.indexOf(this.type) &&
      (z.M.Yu(this, a, b), c.push(this.type));
    this.La(
      function() {
        var e = E(this, a),
          f = b[e];
...
z.M.on = function(a) {
  ...
  return function() {
    this.La(
      function() {
        var b = I(this, "VAR");
        return z.i.ic(a).replace("%1", b ? b.Ib() : "");
      }.bind(this)
    );
  };
};
...
function gh(a) {
  var b = Vd(a),
    c = new D(0, 0);
  var e = b ? Vd(b) : document;
  e =
    !A || 9 <= Number(xb) || "CSS1Compat" == Td(e).Kd.compatMode
      ? e.documentElement
      : e.body;
  if (a == e) return c;
  a = fh(a);
...
function jh(a) {
  ...
  return (aa(b) && !e) || !a.getBoundingClientRect
    ? new Sd(b, c)
    : ((a = fh(a)), new Sd(a.right - a.left, a.bottom - a.top));
}
function kh(a, b) {
...
d.L = function() {
  this.Ua ||
    ((this.Ua = z.i.B("g", {}, null)),
    this.Oa || (this.Ua.style.display = "none"),
    (this.td = z.i.B(
      "rect",
    ...
    (this.xa = z.i.B(
      "text",
      { class: "blocklyText", y: this.sa.height - 12.5 },
      this.Ua
    )),
    this.tf(),
    this.v.ga().appendChild(this.Ua),
    (this.dm = z.O(this.Ua, "mousedown", this, this.gf)),
    this.Be());
};
d.Pg = function() {};
d.A = function() {
  this.dm && (z.Da(this.dm), (this.dm = null));
  this.v = null;
  G(this.Ua);
...
d.tf = function() {
  ...
  this.vg &&
    a &&
    (Je(this.v)
      ? (z.i.mb(a, "blocklyEditableText"),
        z.i.Rb(a, "blocklyNonEditableText"),
        (this.Ua.style.cursor = this.Hk))
      : (z.i.mb(a, "blocklyNonEditableText"),
        z.i.Rb(a, "blocklyEditableText"),
        (this.Ua.style.cursor = "")));
};
d.X = function() {
  return this.Oa;
};
...
d.Be = function() {
  this.Oa ? ((this.xa.textContent = vh(this)), this.Ak()) : (this.sa.width = 0);
};
d.Ak = function() {
  var a = wh(this.xa);
...
function wh(a) {
  ...
  try {
    c = A || kb ? a.getBBox().width : a.getComputedTextLength();
  } catch (e) {
...
d.vb = function(a) {
  null !== a && ((a = String(a)), a !== this.va && ((this.va = a), this.lj()));
};
d.lj = function() {
  this.sa.width = 0;
...
d.setValue = function(a) {
  if (null !== a) {
    ...
    b != a &&
      (this.v &&
        z.j.isEnabled() &&
        z.j.U(new z.j.Cc(this.v, "field", this.name, b, a)),
      this.vb(a));
  }
};
d.gf = function(a) {
  this.v && this.v.o && (a = this.v.o.qe(a)) && !a.mh && (a.mh = this);
};
d.La = function() {};
d.bh = function() {
  return !1;
...
d.L = function() {
  this.xa ||
    ((this.xa = z.i.B(
      "text",
      { class: "blocklyText", y: this.sa.height - 5 },
      null
    )),
    this.Fq && z.i.mb(this.xa, this.Fq),
    this.Oa || (this.xa.style.display = "none"),
    this.v.ga().appendChild(this.xa),
    (this.xa.gd = this.v),
    z.C.Cg(this.xa),
    this.Be());
};
...
d.Oa = !0;
function P(a, b, c) {
  Ah(a, a.Ja.length, b, c);
  return a;
}
function Ah(a, b, c, e) {
  if (0 > b || b > a.Ja.length) throw Error("index " + b + " out of bounds.");
  if (!c && !e) return b;
  q(c) && (c = new yh(c));
  c.zp(a.v);
  a.v.P && c.L();
...
d.oa = function(a) {
  var b = [];
  if (this.Oa == a) return b;
  for (
    var c = (this.Oa = a) ? "block" : "none", e = 0, f;
    (f = this.Ja[e]);
    e++
  )
    f.oa(a);
  if (this.connection) {
    if (a) b = jf(this.connection);
    else if (((e = this.connection), kf(e, !0), e.Na))
      for (e = xc(J(e), !1), f = 0; f < e.length; f++) {
        for (var h = e[f], k = h.pe(!0), l = 0; l < k.length; l++) kf(k[l], !0);
        h = pf(h);
        for (l = 0; l < h.length; l++) h[l].oa(!1);
      }
    if ((e = J(this.connection))) (e.ga().style.display = c), a || (e.P = !1);
  }
  return b;
};
d.bb = function(a) {
  if (!this.connection) throw "This input does not have a connection.";
  this.connection.bb(a);
  return this;
};
function Bh(a, b) {
  a.align = b;
...
d.L = function() {
  if (this.v.o.P) for (var a = 0; a < this.Ja.length; a++) this.Ja[a].L();
};
d.A = function() {
  for (var a = 0, b; (b = this.Ja[a]); a++) b.A();
  this.connection && this.connection.A();
  this.v = null;
};
function Ke(a) {
  Ke.s.constructor.call(this, a);
  Ge(this);
  this.va = {};
}
y(Ke, Fe);
...
d.oa = function(a) {
  if (a != this.X())
    if ((z.j.U(new Fc(this.T, "warningOpen", !a, a)), a)) {
      ...
      a = z.i.B(
        "text",
        { class: "blocklyText blocklyBubbleText", y: se },
        null
      );
      b = b.split("\n");
      for (var c = 0; c < b.length; c++)
        z.i
          .B("tspan", { dy: "1em", x: se }, a)
      ...
      if (this.T.u) {
        ...
        for (var e; (e = a.childNodes[c]); c++)
          e.setAttribute("text-anchor", "end"), e.setAttribute("x", b + se);
      }
      this.sf();
      a = this.Za.Kg();
...
d.vb = function(a, b) {
  this.va[b] != a &&
    (a ? (this.va[b] = a) : delete this.va[b],
    this.X() && (this.oa(!1), this.oa(!0)));
};
d.Ib = function() {
  var a = [],
...
function ed(a, b, c) {
  "undefined" !== typeof Ch.prototype[b] &&
    console.warn(
  ...
  if (v(this.onchange)) {
    ...
    this.Uj && this.o.dg(this.Uj);
    if ((this.onchange = a)) (this.Uj = a.bind(this)), this.o.Fc(this.Uj);
  }
}
d = ed.prototype;
d.data = null;
...
d.A = function(a) {
  if (this.o) {
    ...
    z.j.disable();
    try {
      this.o && (bd(this.o, this), delete this.o.ln[this.id], (this.o = null));
      z.selected == this && (z.selected = null);
      for (var b = this.Re.length - 1; 0 <= b; b--) this.Re[b].A(!1);
      b = 0;
...
function Ee(a, b) {
  if (a.N) a.N.isConnected() && a.N.disconnect();
  else if (a.Y) {
    var c = null;
    a.Y.isConnected() && ((c = a.Y.Na), a.Y.disconnect());
    var e = Lc(a);
    b && e && ((a = a.K.Na), a.disconnect(), c && Ne(c, a) && c.connect(a));
  }
}
d.pe = function() {
  var a = [];
...
d.ih = function(a) {
  if (a != this.$f) {
    if (this.$f) {
      xa(this.$f.Re, this);
      if (this.Y && this.Y.isConnected())
        throw "Still connected to previous block.";
      if (this.N && this.N.isConnected())
...
function xc(a, b) {
  var c = [a];
  a = a.If(b);
  for (var e, f = 0; (e = a[f]); f++) c.push.apply(c, xc(e, b));
  return c;
}
d.ec = function() {
  return this.ej && !this.hb && !(this.o && this.o.options.readOnly);
};
d.ym = function(a) {
  this.ej = a;
};
d.we = function() {
  return this.Tj && !this.hb && !(this.o && this.o.options.readOnly);
};
d.hh = function(a) {
  this.Tj = a;
};
...
function Je(a) {
  return a.yr && !(a.o && a.o.options.readOnly);
}
d.tp = function(a) {
  this.yr = a;
  a = 0;
...
function Bg(a, b) {
  if (!b && a.isCollapsed()) {
    if ((a.N && kf(a.N, b), a.Y && kf(a.Y, b), a.K)) {
      kf(a.K, b);
      var c = J(a.K);
      c && Bg(c, b);
    }
    ...
    a = a.pe(!0);
    for (var e = 0; (c = a[e]); e++) kf(c, b), Re(c) && (c = J(c)) && Bg(c, b);
  }
}
d.La = function(a) {
  this.gd = a;
...
d.qb = function(a) {
  var b = q(a) ? z.i.ic(a) : a,
    c = Number(b);
  if (!isNaN(c) && 0 <= c && 360 >= c) this.ge = z.Ur(c);
...
function I(a, b) {
  for (var c = 0, e; (e = a.W[c]); c++)
    for (var f = 0, h; (h = e.Ja[f]); f++) if (h.name === b) return h;
  return null;
}
d.Zn = function() {
  for (var a = [], b = 0, c; (c = this.W[b]); b++)
    for (var e = 0, f; (f = c.Ja[e]); e++) f.bh() && a.push(f.getValue());
  return a;
};
d.Jf = function() {
  for (var a = [], b = 0, c; (c = this.W[b]); b++)
    for (var e = 0, f; (f = c.Ja[e]); e++)
      f.bh() && (f = this.o.Nd(f.getValue())) && a.push(f);
  return a;
};
d.Jm = function(a) {
  for (var b = 0, c; (c = this.W[b]); b++)
    for (var e = 0, f; (f = c.Ja[e]); e++)
      f.bh() && a.$() == f.getValue() && f.vb(a.name);
};
d.ak = function(a, b) {
  for (var c = 0, e; (e = this.W[c]); c++)
    for (var f = 0, h; (h = e.Ja[f]); f++)
      h.bh() && a == h.getValue() && h.setValue(b);
};
function E(a, b) {
  return (a = I(a, b)) ? a.getValue() : null;
}
d.De = function(a, b) {
  a
    ? (void 0 === b && (b = null),
      this.Y || (this.Y = this.Oj(z.wf)),
      this.Y.bb(b))
...
d.Ed = function(a, b) {
  a
    ? (void 0 === b && (b = null),
      this.N || (this.N = this.Oj(z.Hh)),
      this.N.bb(b))
    : this.N && (this.N.A(), (this.N = null));
};
d.Dd = function(a) {
  this.Rf != a &&
    (z.j.U(new z.j.Cc(this, "inline", null, this.Rf, a)), (this.Rf = a));
};
function bh(a) {
  if (void 0 != a.Rf) return a.Rf;
  for (var b = 1; b < a.W.length; b++)
    if (a.W[b - 1].type == z.Le && a.W[b].type == z.Le) return !1;
  for (b = 1; b < a.W.length; b++)
    if (a.W[b - 1].type == z.Wa && a.W[b].type == z.Le) return !0;
  return !1;
}
d.Nc = function(a) {
  this.disabled != a &&
    (z.j.U(new z.j.Cc(this, "disabled", null, this.disabled, a)),
    (this.disabled = a));
};
function Eh(a) {
  for (a = Dh(a); a; ) {
...
d.ig = function(a) {
  this.fe != a &&
    (z.j.U(new z.j.Cc(this, "collapsed", null, this.fe, a)), (this.fe = a));
};
d.toString = function(a, b) {
  var c = [],
    e = b || "?";
  if (this.fe) c.push(K(this, "_TEMP_COLLAPSED_INPUT").Ja[0].va);
  else
    for (var f = 0, h; (h = this.W[f]); f++) {
      for (var k = 0, l; (l = h.Ja[k]); k++)
        l instanceof Fh && !l.getValue() ? c.push(e) : c.push(l.Ib());
      h.connection &&
  ...
  for (e = 0; void 0 !== b["message" + e]; ) {
    for (
      ...
      if ("number" == typeof x) {
        if (0 >= x || x > h.length)
          throw Error(
            'Block "' + f.type + '": Message index %' + x + " out of range."
          );
        if (m[x])
          throw Error(
            'Block "' + f.type + '": Message index %' + x + " duplicated."
          );
        m[x] = !0;
        n++;
        p.push(h[x - 1]);
    ...
    for (r = 0; r < p.length; r++)
      if (((m = p[r]), "string" == typeof m)) h.push([m, void 0]);
        ...
        if (x) h.push([x, m.name]);
          ...
          m.check && l.bb(m.check);
          m.align && Bh(l, k[m.align]);
          for (m = 0; m < h.length; m++) P(l, h[m][0], h[m][1]);
          h.length = 0;
        }
      }
    e++;
  }
  void 0 !== b.inputsInline && a.Dd(b.inputsInline);
  ...
  for (var b = 0, c; (c = this.W[b]); b++)
    if (c.name == a) {
      c.connection &&
        ...
        ((c.connection.Fe = null), (a = J(c.connection)), a.hb ? a.A() : Ee(a));
      c.A();
      this.W.splice(b, 1);
      break;
    }
...
d.fh = function(a) {
  this.Sa != a &&
    (z.j.U(new z.j.Cc(this, "comment", null, this.Sa, a || "")), (this.Sa = a));
};
d.Ee = function() {};
d.gk = function() {};
d.la = function() {
...
z.i.Ci = {};
z.i.Ci.af = function(a) {
  a = a.F();
  var b = ih(a);
  b.height = a.scrollHeight;
  return b;
};
z.i.Ci.oq = function(a, b, c) {
  b.left += c.width;
  b.right += c.width;
  a.left += c.width;
  a.right += c.width;
...
d = Kh.prototype;
d.na = function(a, b, c, e) {
  u(b) || (b && (Lh[0] = b.toString()), (b = Lh));
  for (var f = 0; f < b.length; f++) {
    var h = dc(a, b[f], c || this.handleEvent, e || !1, this.bi || this);
    if (!h) break;
    this.ji[h.key] = h;
  }
  return this;
...
d.ls = function(a, b, c, e) {
  return Mh(this, a, b, c, e);
};
function Mh(a, b, c, e, f, h) {
  if (u(c)) for (var k = 0; k < c.length; k++) Mh(a, b, c[k], e, f, h);
  else {
    b = ec(b, c, e || a.handleEvent, f, h || a.bi || a);
    if (!b) return a;
    a.ji[b.key] = b;
  }
  return a;
}
d.jd = function(a, b, c, e, f) {
  if (u(b)) for (var h = 0; h < b.length; h++) this.jd(a, b[h], c, e, f);
  else
...
d = Oh.prototype;
d.$ = function() {
  return this.di || (this.di = ":" + (this.tw.Rw++).toString(36));
};
d.F = function() {
  return this.S;
};
...
d.ih = function(a) {
  ...
  if (a && this.Ae && this.di && Sh(this.Ae, this.di) && this.Ae != a)
...
d.Am = function(a) {
  if (this.Ae && this.Ae != a) throw Error("Method not supported");
  Oh.s.Am.call(this, a);
};
d.pc = function() {
  return this.jl;
...
d.V = function() {
  this.S = this.jl.createElement("DIV");
};
d.Z = function(a) {
  this.Be(a);
};
...
d.Jh = function(a, b, c) {
  ...
  a.za && this.za && a.getParent() == this
    ...
    ? (this.S || this.V(),
      (b = R(this, b + 1)),
      a.Be(this.Zc(), b ? b.S : null))
    : this.za &&
      !a.za &&
      a.S &&
      a.S.parentNode &&
      1 == a.S.parentNode.nodeType &&
      a.Gb();
};
d.Zc = function() {
  return this.S;
...
function Vh(a) {
  null == a.wi && (a.wi = "rtl" == eh(a.za ? a.S : a.jl.Kd.body, "direction"));
  return a.wi;
}
d.lf = function(a) {
  if (this.za) throw Error("Component already rendered");
...
function Uh(a) {
  return a.cc ? a.cc.length : 0;
}
function Sh(a, b) {
  a.Cf && b
    ? ((a = a.Cf), (b = (null !== a && b in a ? a[b] : void 0) || null))
    : (b = null);
  return b;
}
function R(a, b) {
  return a.cc ? a.cc[b] || null : null;
}
function Th(a, b, c) {
  a.cc && ra(a.cc, b, c);
}
function Xh(a, b) {
  return a.cc && b ? qa(a.cc, b) : -1;
}
...
d.Xs = function(a) {
  for (var b = []; Wh(this); ) b.push(this.removeChild(R(this, 0), a));
  return b;
};
var Yh;
fb(
...
d.fw = function(a) {
  ...
  ii && !ai(a.keyCode, this.Kc, a.shiftKey, a.ctrlKey, a.altKey, a.metaKey)
    ? this.handleEvent(a)
    : ((this.Vf = ci(a.keyCode)), ji && (this.fn = a.altKey));
};
d.gw = function(a) {
  this.Vf = this.Kc = -1;
  this.fn = a.altKey;
...
d.handleEvent = function(a) {
  ...
  if (A && "keypress" == a.type) {
    ...
    (B || kb) && "keypress" == a.type
      ? ((e = this.Vf),
        (f = 0 <= b.charCode && 63232 > b.charCode && bi(e) ? b.charCode : 0))
      : jb && !B
      ? ((e = this.Vf), (f = bi(e) ? b.keyCode : 0))
      : ((e = b.keyCode || this.Vf),
        (f = b.charCode || 0),
        ji && "keypress" == a.type && (c = this.fn),
        nb && 63 == f && 224 == e && (e = 191));
  var h = (e = ci(e));
  e
    ? 63232 <= e && e in gi
      ? (h = gi[e])
      : 25 == e && a.shiftKey && (h = 9)
    : b.keyIdentifier && b.keyIdentifier in hi && (h = hi[b.keyIdentifier]);
  (lb &&
    ii &&
    "keypress" == a.type &&
    !ai(h, this.Kc, a.shiftKey, a.ctrlKey, c, a.metaKey)) ||
    ((a = h == this.Kc),
    (this.Kc = h),
    (b = new ki(h, f, a, b)),
    (b.altKey = c),
...
function mi(a, b) {
  return a.classList ? a.classList.contains(b) : wa(li(a), b);
}
function ni(a, b) {
  a.classList
    ? a.classList.add(b)
    : mi(a, b) || (a.className += 0 < a.className.length ? " " + b : b);
}
function oi(a, b) {
  if (a.classList)
    ra(b, function(b) {
...
function pi(a, b) {
  a.classList
    ...
    : mi(a, b) &&
      (a.className = sa(li(a), function(a) {
        return a != b;
      }).join(" "));
}
function qi(a, b) {
...
d.V = function(a) {
  return a.pc().V("DIV", this.nj(a).join(" "));
};
d.Zc = function(a) {
  return a;
};
...
d.rl = function() {};
d.V = function(a) {
  return a.pc().V("DIV", this.nj(a).join(" "), a.Ic());
};
d.Zc = function(a) {
  return a;
};
...
function Ai(a, b, c) {
  if ((a = c || a.rl()))
    (c = b.getAttribute("role") || null), a != c && Zh(b, a);
}
function Bi(a, b, c) {
  var e = b.qq;
  null != e && a.qp(c, e);
...
d.lf = function(a, b) {
  this.hj(a, this.Ka() + "-rtl", b);
};
d.df = function(a) {
  var b;
  return a.Bb & 32 && (b = a.Ob()) ? ke(b) && le(b) : !1;
};
d.kf = function(a, b) {
  var c;
  if (a.Bb & 32 && (c = a.Ob())) {
...
function Ci(a, b, c) {
  xi || (xi = { 1: "disabled", 8: "selected", 16: "checked", 64: "expanded" });
  b = xi[b];
...
d.Bl = function() {
  return this.fc || (this.fc = new ei());
};
d.hj = function(a, b) {
  b
    ? a &&
      (this.me ? wa(this.me, a) || this.me.push(a) : (this.me = [a]),
      this.ma.hj(this, a, !0))
    : a &&
      this.me &&
      xa(this.me, a) &&
      (0 == this.me.length && (this.me = null), this.ma.hj(this, a, !1));
};
d.V = function() {
  var a = this.ma.V(this);
  this.S = a;
...
d.Zc = function() {
  return this.ma.Zc(this.F());
};
d.Gb = function() {
  T.s.Gb.call(this);
  Bi(this.ma, this, this.S);
  this.ma.Ej(this);
  if (this.Bb & -2 && (this.vj && Di(this, !0), this.Bb & 32)) {
    var a = this.Ob();
    if (a) {
      var b = this.Bl();
      fi(b, a);
...
function Di(a, b) {
  ...
  b
    ? (e
        ...
        .na(f, [c.Eh, c.Ch], a.ai)
        .na(f, c.Ji, a.co),
      a.ri && e.na(f, "gotpointercapture", a.pm),
      a.$h != ca && e.na(f, "contextmenu", a.$h),
      A &&
        (wb(9) || e.na(f, "dblclick", a.Mr),
        a.Dj || ((a.Dj = new Ei(a)), Jb(a, oa(Kb, a.Dj)))))
    : (e
        .jd(f, c.Ki, a.wj)
        .jd(f, c.Dh, a.bf)
        .jd(f, [c.Eh, c.Ch], a.ai)
        .jd(f, c.Ji, a.co),
      a.ri && e.jd(f, "gotpointercapture", a.pm),
      a.$h != ca && e.jd(f, "contextmenu", a.$h),
      A && (wb(9) || e.jd(f, "dblclick", a.Mr), Kb(a.Dj), (a.Dj = null)));
}
d.xd = function() {
  T.s.xd.call(this);
...
d.oa = function(a, b) {
  return b || (this.Oa != a && this.dispatchEvent(a ? "show" : "hide"))
    ? ((b = this.F()) && this.ma.oa(b, a),
      this.isEnabled() && this.ma.kf(this, a),
      (this.Oa = a),
      !0)
    : !1;
};
...
d.fk = function(a) {
  ...
  (b && "function" == typeof b.isEnabled && !b.isEnabled()) ||
    !Fi(this, 1, !a) ||
    (a || (this.setActive(!1), this.Wb(!1)),
    this.X() && this.ma.kf(this, a),
    this.Wd(1, !a, !0));
};
d.Wb = function(a) {
  Fi(this, 2, a) && this.Wd(2, a);
};
d.setActive = function(a) {
  Fi(this, 4, a) && this.Wd(4, a);
};
d.Ul = function() {
  return !!(this.Ha & 8);
};
d.wp = function(a) {
  Fi(this, 8, a) && this.Wd(8, a);
};
function Gi(a, b) {
  Fi(a, 16, b) && a.Wd(16, b);
}
...
d.Wd = function(a, b, c) {
  c || 1 != a
    ? this.Bb & a &&
      b != !!(this.Ha & a) &&
      (this.ma.Wd(this, a, b), (this.Ha = b ? this.Ha | a : this.Ha & ~a))
    : this.fk(!b);
};
d.zc = function(a, b) {
  if (this.za && this.Ha & a && !b) throw Error("Component already rendered");
  !b && this.Ha & a && this.Wd(a, !1);
  this.Bb = b ? this.Bb | a : this.Bb & ~a;
};
function Ii(a, b) {
  return !!(a.jn & b) && !!(a.Bb & b);
}
function Fi(a, b, c) {
  return (
    !!(a.Bb & b) &&
    !!(a.Ha & b) != c &&
    (!(a.nh & b) || a.dispatchEvent(Qh(b, c))) &&
    !a.Ph
  );
}
d.wj = function(a) {
...
d.co = function(a) {
  !Ji(a, this.F()) &&
    ...
    (Ii(this, 4) && this.setActive(!1), Ii(this, 2) && this.Wb(!1));
};
d.pm = function(a) {
  var b = a.target;
...
d.$h = ca;
function Ji(a, b) {
  return !!a.relatedTarget && ge(b, a.relatedTarget);
}
d.bf = function(a) {
  this.isEnabled() &&
    (Ii(this, 2) && this.Wb(!0),
    !Sb(a) ||
      (B && nb && a.ctrlKey) ||
      (Ii(this, 4) && this.setActive(!0),
      this.ma && this.ma.df(this) && this.Ob().focus()));
  this.dn || !Sb(a) || (B && nb && a.ctrlKey) || a.preventDefault();
};
d.ai = function(a) {
  this.isEnabled() &&
    (Ii(this, 2) && this.Wb(!0),
    this.Ha & 4 && this.ag(a) && Ii(this, 4) && this.setActive(!1));
};
d.Mr = function(a) {
  this.isEnabled() && this.ag(a);
};
d.ag = function(a) {
  Ii(this, 16) && Gi(this, !(this.Ha & 16));
  Ii(this, 8) && this.wp(!0);
  Ii(this, 64) && Hi(this, !this.gi());
  var b = new Lb("action", this);
  a &&
    ((b.altKey = a.altKey),
    (b.ctrlKey = a.ctrlKey),
    (b.metaKey = a.metaKey),
...
d.Jl = function() {
  Ii(this, 32) && Fi(this, 32, !0) && this.Wd(32, !0);
};
d.uj = function() {
...
d.Ad = function(a) {
  return this.X() && this.isEnabled() && this.Lg(a)
    ? (a.preventDefault(), a.stopPropagation(), !0)
    : !1;
};
d.Lg = function(a) {
  return 13 == a.keyCode && this.ag(a);
};
...
function Ei(a) {
  ...
  a = this.$k.S;
  this.bi
    .na(a, "mousedown", this.hw)
    .na(a, "mouseup", this.iw)
    .na(a, "click", this.aw);
}
y(Ei, Gb);
var Li = !A || 9 <= Number(xb);
Ei.prototype.hw = function() {
  this.Vk = !1;
};
Ei.prototype.iw = function() {
  this.Vk = !0;
};
function Mi(a, b) {
...
d.Se = null;
d.Ob = function() {
  return this.ro || this.ma.Ob(this);
};
d.Bl = function() {
  return this.fc || (this.fc = new ei(this.Ob()));
};
d.V = function() {
  this.S = this.ma.V(this);
};
d.Zc = function() {
  return this.ma.Zc(this.F());
};
d.Gb = function() {
  ...
  var b = this.ri ? Ob : Nb;
  Rh(this)
    .na(this, "enter", this.ao)
    .na(this, "highlight", this.ew)
    .na(this, "unhighlight", this.nw)
    .na(this, "open", this.jw)
    .na(this, "close", this.bw)
    .na(a, b.Dh, this.bf)
    .na(Vd(a), [b.Eh, b.Ch], this.cw)
    .na(a, [b.Dh, b.Eh, b.Ch, b.Ki, b.Ji, "contextmenu"], this.$v);
...
d.ew = function(a) {
  ...
  if (-1 < b && b != this.ua) {
    ...
    this.qx &&
      this.Kb &&
      c != this.Kb &&
      (c.Bb & 64 ? Hi(c, !0) : Hi(this.Kb, !1));
  }
  b = this.F();
  null != a.target.F() && S(b, "activedescendant", a.target.F().id);
};
d.nw = function(a) {
  a.target == R(this, this.ua) && (this.ua = -1);
...
d.jw = function(a) {
  (a = a.target) &&
    a != this.Kb &&
    a.getParent() == this &&
    (this.Kb && Hi(this.Kb, !1), (this.Kb = a));
};
d.bw = function(a) {
  ...
  b &&
    a.target.Ha & 2 &&
    c &&
    ((a = ""), c && (a = c.id), S(b, "activedescendant", a));
};
d.bf = function(a) {
  this.Hg && (this.mi = !0);
  var b = this.Ob();
...
d.Lg = function(a) {
  ...
  if (
    (b && "function" == typeof b.Ad && b.Ad(a)) ||
    (this.Kb &&
      this.Kb != b &&
      "function" == typeof this.Kb.Ad &&
      this.Kb.Ad(a))
  )
    return !0;
...
d.Jh = function(a, b, c) {
  ...
  -1 == a && (a = Uh(this));
  a == this.ua
    ? (this.ua = Math.min(Uh(this) - 1, b))
    : a > this.ua && b <= this.ua
    ? this.ua++
    : a < this.ua && b > this.ua && this.ua--;
};
d.removeChild = function(a, b) {
  if ((a = q(a) ? Sh(this, a) : a)) {
    var c = Xh(this, a);
    -1 != c &&
      (c == this.ua ? (a.Wb(!1), (this.ua = -1)) : c < this.ua && this.ua--);
    var e = a.F();
    e && e.id && this.Se && ((c = this.Se), (e = e.id), e in c && delete c[e]);
  }
...
d.oa = function(a, b) {
  if (b || (this.Oa != a && this.dispatchEvent(a ? "show" : "hide"))) {
    ...
    c &&
      (kh(c, a),
      this.df() && ui(this.Ob(), this.Hg && this.Oa),
      b || this.dispatchEvent(this.Oa ? "aftershow" : "afterhide"));
    return !0;
  }
  return !1;
};
...
d.fk = function(a) {
  this.Hg != a &&
    ...
    (a
      ? ((this.Hg = !0),
        Th(this, function(a) {
          a.yt ? delete a.yt : a.fk(!0);
        }))
      : (Th(this, function(a) {
          a.isEnabled() ? a.fk(!1) : (a.yt = !0);
        }),
        (this.mi = this.Hg = !1)),
    this.df() && ui(this.Ob(), a && this.Oa));
};
d.df = function() {
  return this.Jg;
};
d.kf = function(a) {
  a != this.Jg && this.za && Qi(this, a);
  this.Jg = a;
...
d.V = function(a) {
  var b = a.pc().V("DIV", this.nj(a).join(" "), aj(this, a.Ic(), a.pc()));
  bj(this, a, b, !!(a.Bb & 8) || !!(a.Bb & 16));
  return b;
};
d.Zc = function(a) {
...
function bj(a, b, c, e) {
  ...
  Bi(a, b, c);
  e != cj(a, c) &&
    (e ? ni(c, "goog-option") : pi(c, "goog-option"),
    (c = a.Zc(c)),
    e
      ? ((a = $i(a, 1)),
        c.insertBefore(b.pc().V("DIV", a), c.firstChild || null))
...
d.zc = function(a, b) {
  dj.s.zc.call(this, a, b);
  switch (a) {
    case 8:
      this.Ha & 16 && !b && Gi(this, !1);
      (a = this.F()) && this.ma.dt(this, a, b);
      break;
    case 16:
...
d.ul = function() {
  ...
  return u(a)
    ? ((a = ta(a, function(a) {
        return ha(a) &&
          1 == a.nodeType &&
          (mi(a, "goog-menuitem-accel") ||
            mi(a, "goog-menuitem-mnemonic-separator"))
          ? ""
          : oe(a);
      }).join("")),
      Ha(a))
...
d.ai = function(a) {
  ...
  if (b) {
    var c = b.Ls;
    b.Ls = null;
    if (c && t(a.clientX) && sc(c, new D(a.clientX, a.clientY))) return;
  }
  dj.s.ai.call(this, a);
};
d.Lg = function(a) {
  return a.keyCode == this.rs && this.ag(a) ? !0 : dj.s.Lg.call(this, a);
};
d.Yv = function() {
  return this.rs;
};
...
dj.prototype.getParent = function() {
  return T.prototype.getParent.call(this);
};
dj.prototype.El = function() {
  return T.prototype.El.call(this);
};
function ej() {}
y(ej, wi);
da(ej);
ej.prototype.V = function(a) {
  return a.pc().V("DIV", this.Ka());
};
...
d.Ir = function() {
  return this.X() ? gh(this.F()) : null;
};
d.oa = function(a, b, c) {
  (b = hj.s.oa.call(this, a, b)) &&
    a &&
    this.za &&
    this.Ok &&
    this.Ob().focus();
  this.Ls = a && c && t(c.clientX) ? new D(c.clientX, c.clientY) : null;
  return b;
};
d.ao = function(a) {
  this.Ok && this.Ob().focus();
  return hj.s.ao.call(this, a);
};
d.yq = function(a) {
  return (this.Ku || a.isEnabled()) && a.X() && !!(a.Bb & 2);
};
d.Lg = function(a) {
  var b = hj.s.Lg.call(this, a);
  b ||
    Th(
      this,
      function(c) {
        !b &&
          c.Yv &&
          c.rs == a.keyCode &&
          (this.isEnabled() && this.Wb(c), (b = c.Ad(a)));
      },
      this
    );
  return b;
...
d.jc = function(a) {
  ...
  if ((a = R(this, a))) {
    ...
    if (!A || 9 <= Number(xb)) {
      ...
      h = new pg(parseFloat(l), parseFloat(h), parseFloat(m), parseFloat(k));
    } else {
    ...
    c == ae(document)
      ? ((k = e.x - c.scrollLeft),
        (e = e.y - c.scrollTop),
        !A || 10 <= Number(xb) || ((k += h.left), (e += h.top)))
...
z.ba.al = null;
z.ba.Ar = null;
z.ba.show = function(a, b, c) {
  z.H.show(z.ba, c, null);
  if (b.length) {
    var e = z.ba.om(b, c);
    dc(e, "action", z.ba.Fa);
    z.ba.Mc(e, a, c);
...
z.ba.Sk = function(a, b) {
  return function() {
    ...
    z.j.isEnabled() && !c.hb && z.j.U(new z.j.Fk(c));
    c.select();
  };
};
z.ba.Pu = function(a) {
  ...
  return {
    text:
      1 == b ? z.g.DELETE_BLOCK : z.g.DELETE_X_BLOCKS.replace("%1", String(b)),
    enabled: !0,
    eb: function() {
      z.j.R(!0);
      a.A(!0, !0);
...
z.ba.Ru = function(a) {
  return {
    enabled: !(v(a.Pb) ? !a.Pb() : !a.Pb),
    text: z.g.HELP,
    eb: function() {
      var b = v(a.Pb) ? a.Pb() : a.Pb;
      b && window.open(b);
    }
  };
};
z.ba.Qu = function(a) {
  var b = !0;
  xc(a, !1).length > fd(a.o) && (b = !1);
  return {
    text: z.g.DUPLICATE_BLOCK,
    enabled: b,
    eb: function() {
      z.xr(a);
    }
...
z.ba.Ou = function(a) {
  var b = { enabled: !A };
  a.Sa
    ? ((b.text = z.g.REMOVE_COMMENT),
      (b.eb = function() {
        a.fh(null);
      }))
    : ((b.text = z.g.ADD_COMMENT),
      (b.eb = function() {
        a.fh("");
      }));
  return b;
...
z.ba.SB = function(a, b) {
  var c = { enabled: !0 };
  c.text = z.g.ay;
  c.eb = function() {
    var c = new xf(a, z.g.xB, 100, 100);
    if (!a.no)
      for (var f = a.w; f; ) {
        if (
          -1 !=
...
d.Qc = null;
d.wc = function() {
  for (var a = 0, b; (b = this.W[a]); a++) b.L();
  b = pf(this);
  ...
  this.o.options.readOnly ||
    this.Mn ||
    z.O(this.ga(), "mousedown", this, this.gf);
  this.Mn = !0;
  this.ga().parentNode || this.o.Ma.appendChild(this.ga());
};
d.select = function() {
  if (this.hb && this.getParent()) this.getParent().select();
  else if (z.selected != this) {
    var a = null;
    if (z.selected) {
      a = z.selected.id;
      z.j.disable();
  ...
  if (a != b) {
    ...
    if (!this.o.po && c) {
      ...
      a
        ? (a.ga().appendChild(c),
          (a = this.la()),
          gf(this, a.x - e.x, a.y - e.y))
        : b &&
          z.selected != this &&
          (this.o.Ma.appendChild(c), this.translate(e.x, e.y));
    }
  }
};
d.la = function() {
  ...
  if (e) {
    do {
      ...
      this.Je &&
        ...
        ((f = this.o.zb.Gl()), (a += f.x), (b += f.y));
      e = e.parentNode;
    } while (e && e != this.o.Ma && e != c);
  }
  return new D(a, b);
};
d.moveBy = function(a, b) {
  var c = z.j.isEnabled();
  if (c) var e = new z.j.Gi(this);
  var f = this.la();
...
d.em = function(a) {
  this.Je
    ? this.o.zb.qf(a.x, a.y)
    : ((this.w.rf = "translate(" + a.x + "," + a.y + ")"),
      this.w.setAttribute("transform", this.w.rf + this.w.kh));
};
function Sg(a) {
  if (a.o && !a.o.pb() && !a.getParent() && !a.tb) {
    var b = a.o.zd;
    if (b && b.Bx) {
      var c = b.Gp,
        e = c / 2,
...
d.ig = function(a) {
  if (this.fe != a) {
    ...
    if (a) {
      ...
      P(Q(this, "_TEMP_COLLAPSED_INPUT"), c).L();
    } else this.Ab("_TEMP_COLLAPSED_INPUT"), this.Ee(null);
    N.s.ig.call(this, a);
    b.length || (b[0] = this);
    if (this.P) for (c = 0; (a = b[c]); c++) a.Z();
  }
};
d.Np = function(a, b) {
  for (var c = [], e = 0, f; (f = this.W[e]); e++) {
    for (var h = 0, k; (k = f.Ja[h]); h++) k instanceof ij && c.push(k);
  ...
  (c = c[b ? a + 1 : a - 1])
    ? c instanceof ph
      ? c.Fd()
      : c.Np(null, b)
    : (c = this.getParent()) && c.Np(this, b);
};
d.gf = function(a) {
  var b = this.o && this.o.qe(a);
  b && (Tf(b, this), (b.Lc = a));
};
d.xi = function(a) {
    ...
    if (this.ec() && this.we() && !b.tb) {
      ...
      if (!this.fe)
        for (var e = 1; e < this.W.length; e++)
          if (this.W[e - 1].type != z.Qa && this.W[e].type != z.Qa) {
            e = { enabled: !0 };
            var f = bh(this);
      ...
      this.o.options.collapse &&
        (this.fe
          ? ((e = { enabled: !0 }),
            (e.text = z.g.EXPAND_BLOCK),
            (e.eb = function() {
              b.ig(!1);
            }),
            c.push(e))
          : ((e = { enabled: !0 }),
            (e.text = z.g.COLLAPSE_BLOCK),
            (e.eb = function() {
              b.ig(!0);
            }),
            c.push(e)));
      this.o.options.disable &&
        ((e = {
          text: this.disabled ? z.g.ENABLE_BLOCK : z.g.DISABLE_BLOCK,
          enabled: !Eh(this),
          eb: function() {
            b.Nc(!b.disabled);
          }
...
function gf(a, b, c) {
  if (a.P) {
    for (var e = a.pe(!1), f = 0; f < e.length; f++) e[f].moveBy(b, c);
    e = pf(a);
    for (f = 0; f < e.length; f++) He(e[f]);
    for (f = 0; f < a.Re.length; f++) gf(a.Re[f], b, c);
  }
}
d.jg = function(a) {
  if (a) {
    ...
    z.i.mb(this.w, "blocklyDragging");
  } else (z.ll = []), z.i.Rb(this.w, "blocklyDragging");
  for (b = 0; b < this.Re.length; b++) this.Re[b].jg(a);
};
d.hh = function(a) {
  N.s.hh.call(this, a);
  yf(this);
...
d.A = function(a, b) {
  if (this.o) {
    ...
    z.ba.al == this && z.ba.Fa();
    b && this.P && (Ee(this, a), z.Ea.Gv(this));
    this.P = !1;
    if (this.Qc) {
      for (var f in this.Qc) clearTimeout(this.Qc[f]);
      this.Qc = null;
    }
    z.j.disable();
    try {
  ...
  if (!this.disabled) {
    ...
    if (this.hb)
      (b = kj([255, 255, 255], b, 0.6)),
        (a = lj(b)),
        (this.mg.style.display = "none"),
        this.nk.setAttribute("fill", a);
    else {
      this.mg.style.display = "";
      var c = lj(kj([255, 255, 255], b, 0.3));
      b = lj(kj([0, 0, 0], b, 0.2));
      this.mg.setAttribute("stroke", c);
      this.nk.setAttribute("fill", b);
    }
    this.Gd.setAttribute("fill", a);
    a = pf(this);
    for (c = 0; c < a.length; c++) a[c].sf();
    for (a = 0; (c = this.W[a]); a++) {
      b = 0;
      for (var e; (e = c.Ja[b]); b++) e.lj();
    }
  }
};
function mf(a) {
  a.disabled || Eh(a)
    ? z.i.mb(a.w, "blocklyDisabled") &&
      a.Gd.setAttribute("fill", "url(#" + a.o.options.fj + ")")
    : z.i.Rb(a.w, "blocklyDisabled") && a.sf();
  a = a.If(!1);
  for (var b = 0, c; (c = a[b]); b++) mf(c);
}
d.wl = function() {
  return this.Sa
    ? this.Sa.Ib()
...
d.fh = function(a) {
  var b = !1;
  q(a)
    ? (this.Sa || ((this.Sa = new Ie(this)), (b = !0)), this.Sa.vb(a))
    : this.Sa && (this.Sa.A(), (b = !0));
...
d.Ee = function(a, b) {
  ...
  else for (var e in this.Qc) clearTimeout(this.Qc[e]), delete this.Qc[e];
  if (this.o.pb()) {
    var f = this;
    this.Qc[c] = setTimeout(function() {
      f.o && (delete f.Qc[c], f.Ee(a, c));
    }, 100);
  } else {
    this.tb && (a = null);
    b = Dh(this);
    ...
    b = !1;
    q(a)
      ? (this.md || ((this.md = new Ke(this)), (b = !0)), this.md.vb(a, c))
      : this.md && !c
      ? (this.md.A(), (b = !0))
      : this.md &&
        ((b = this.md.Ib()),
        this.md.vb("", c),
        (e = this.md.Ib()) || this.md.A(),
        (b = b != e));
    b && this.P && (this.Z(), this.ob());
  }
};
...
d.Nc = function(a) {
  this.disabled != a && (N.s.Nc.call(this, a), this.P && mf(this));
};
d.Wb = function(a) {
  this.P &&
    (a
      ? (this.Gd.setAttribute("filter", "url(#" + this.o.options.zr + ")"),
        (this.mg.style.display = "none"))
      : (z.i.removeAttribute(this.Gd, "filter"), delete this.mg.style.display));
};
d.Kh = function() {
  z.i.mb(this.w, "blocklySelected");
};
...
d.De = function(a, b) {
  N.s.De.call(this, a, b);
  this.P && (this.Z(), this.ob());
};
d.Ce = function(a, b) {
  N.s.Ce.call(this, a, b);
  this.P && (this.Z(), this.ob());
};
d.Ed = function(a, b) {
  N.s.Ed.call(this, a, b);
  this.P && (this.Z(), this.ob());
};
d.Dd = function(a) {
  N.s.Dd.call(this, a);
...
d.Ab = function(a, b) {
  N.s.Ab.call(this, a, b);
  this.P && (this.Z(), this.ob());
};
d.Co = function(a, b) {
  N.s.Co.call(this, a, b);
  this.P && (this.Z(), this.ob());
};
d.ce = function(a, b) {
  a = N.s.ce.call(this, a, b);
  this.P && (this.Z(), this.ob());
  return a;
};
d.pe = function(a) {
  ...
  if (a || this.P)
    if (
      (this.N && b.push(this.N),
      this.Y && b.push(this.Y),
...
d.ob = function() {
  if (this.o && !this.o.pb()) {
    var a = cf(this);
    if (!a.tb)
      for (var b = this.pe(!1), c = 0, e; (e = b[c]); c++) {
        e.isConnected() && Re(e) && J(e).ob();
        for (var f = e.ys(z.Tc), h = 0, k; (k = f[h]); h++)
          (e.isConnected() && k.isConnected()) ||
            (cf(k.v) != a && (Re(e) ? Oe(k, e) : Oe(e, k)));
      }
  }
};
function wf(a) {
...
N.prototype.Z = function(a) {
  ...
  var b = 10;
  this.u && (b = -b);
  for (var c = pf(this), e = 0; e < c.length; e++) {
    var f = c[e];
    if (f.Iq && f.T.isCollapsed()) f.vc.setAttribute("display", "none");
    else {
  ...
  for (
    ...
    if (w.X()) {
      if (r && p && p != z.Qa && w.type != z.Qa) var C = c[c.length - 1];
      else
        (p = w.type),
          (C = []),
          (C.type = r && w.type != z.Qa ? -1 : w.type),
          (C.height = 0),
          c.push(C);
      C.push(w);
      w.eg = 25;
      w.Tb = r && w.type == z.Wa ? M + 12.5 : 0;
      if (w.connection && w.connection.isConnected()) {
        var Ja = J(w.connection).Hb();
        w.eg = Math.max(w.eg, Ja.height);
        w.Tb = Math.max(w.Tb, Ja.width);
      }
      r || x != l.length - 1
        ? !r && w.type == z.Wa && l[x + 1] && l[x + 1].type == z.Qa && w.eg--
        : w.eg--;
      ...
      -1 != C.type &&
        (C.type == z.Qa
          ? ((m = !0), (f = Math.max(f, w.Md)))
          : (C.type == z.Wa ? (h = !0) : C.type == z.Le && (n = !0),
            (e = Math.max(e, w.Md))));
    }
  for (k = 0; (C = c[k]); k++)
    if (((C.st = !1), -1 == C.type))
  ...
  this.N
    ? (this.Hp = this.Dm = !0)
    : ((this.Hp = this.Dm = !1),
      this.Y && (b = J(this.Y)) && Lc(b) == this && (this.Dm = !0),
      Lc(this) && (this.Hp = !0));
  h = [];
  m = [];
  b = [];
    ...
    if (this.isCollapsed())
      ...
      for (l = 0; (k = C[l]); l++)
        (r = n),
          ...
          k.type == z.Wa &&
            ...
            m.push("z"),
            this.u
              ? (e.push("M", p - 10 - 2.5 + M - k.Tb + "," + (n + 5 + 0.5)),
                e.push(oj),
                e.push("v", k.eg - 20 + 2.5),
                e.push("h", k.Tb - M + 2))
              : (e.push("M", p - 10 + 0.5 + "," + (n + 5 + 0.5)),
                e.push("v", k.eg + 1),
                e.push("h", M - 2 - k.Tb),
                e.push("M", p - k.Tb - 10 + 0.9 + "," + (n + 5 + 20 - 0.7)),
                e.push("l", 0.46 * M + ",-2.1")),
            (r = this.u ? -p - M + 10 + k.Tb + 1 : p + M - 10 - k.Tb - 1),
            (x = n + 5 + 1),
            ef(k.connection, r, x));
      p = Math.max(p, c.Nb);
      ...
      C.type == z.Wa
        ? ((k = C[0]),
          ...
          k.align != z.Fi &&
            ((l = c.Nb - k.Md - M - 20),
            k.align == z.yh ? (p += l) : k.align == z.Ck && (p += l / 2)),
          sj(this, k.Ja, p, r),
          h.push(hf),
          (l = C.height - 20),
          h.push("v", l),
        ...
        : C.type == z.Qa &&
          ((k = C[0]),
          0 == w && (h.push("v", 10), this.u && b.push("v", 9), (n += 10)),
          (r = n),
          k.align != z.Fi &&
            ((l = c.Fm - k.Md - 20),
            k.align == z.yh ? (p += l) : k.align == z.Ck && (p += l / 2)),
          ...
          h.push("v", C.height - 16),
          h.push("a 8,8 0 0,0 8,8"),
          h.push("H", c.Nb),
          this.u
            ? (b.push("M", p - 30 + nj + "," + (n + nj)),
              b.push(qj),
              b.push("v", C.height - 16),
              b.push("a 8.5,8.5 0 0,0 8.5,8.5"))
            : (b.push("M", p - 30 + nj + "," + (n + C.height - nj)),
              b.push(rj)),
          b.push("H", c.Nb - 0.5),
          (r = this.u ? -p : p + 1),
          ef(k.connection, r, n + 1),
          k.connection.isConnected() &&
            (this.width = Math.max(
              this.width,
              c.Fm + J(k.connection).Hb().width
            )),
          w == c.length - 1 || c[w + 1].type == z.Qa) &&
  ...
  this.N
    ? (ef(this.N, 0, 0),
      ...
      (this.width += M))
    : this.u || (this.Dm ? b.push("V", 0.5) : b.push("V", 8));
  h.push("z");
  c = h.join(" ") + "\n" + m.join(" ");
  ...
  this.u &&
    (this.Gd.setAttribute("transform", "scale(-1 1)"),
    this.mg.setAttribute("transform", "scale(-1 1)"),
    this.nk.setAttribute("transform", "translate(1,1) scale(-1 1)"));
  c = this.la();
  this.Y && df(this.Y, c);
  this.N && df(this.N, c);
...
ij.ia = function(a) {
  var b = z.i.ic(a.text);
  b = new ij(b, a["class"]);
  "boolean" === typeof a.spellcheck && (b.kk = a.spellcheck);
  return b;
};
var tj = null;
d = ij.prototype;
...
d.vb = function(a) {
  null !== a &&
    ...
    a !== this.va &&
      (this.v &&
        z.j.isEnabled() &&
        z.j.U(new z.j.Cc(this.v, "field", this.name, this.va, a)),
      ph.prototype.vb.call(this, a)));
};
d.Fd = function(a) {
  this.m = this.v.o;
  a = a || !1;
  if (!a && (mb || ob || qb)) uj(this);
    ...
    z.H.show(this, this.v.u, vj(this));
    var b = z.H.ha,
      c = F("INPUT", "blocklyHtmlInput");
    c.setAttribute("spellcheck", this.kk);
...
function uj(a) {
  z.prompt(z.g.CHANGE_VALUE_TITLE, a.va, function(b) {
    a.v && (b = Ce(a, b));
    a.setValue(b);
  });
}
d.Zw = function(a) {
  ...
  13 == a.keyCode
    ? z.H.Fa()
    : 27 == a.keyCode
    ? ((b.value = b.defaultValue), z.H.Fa())
    : 9 == a.keyCode &&
      (z.H.Fa(), this.v.Np(this, !a.shiftKey), a.preventDefault());
};
d.Fs = function() {
  var a = tj,
    b = a.value;
...
function wj(a) {
  ...
  a.v && (b = Ce(a, c.value));
  null === b
    ? z.i.mb(c, "blocklyInvalidInput")
    : z.i.Rb(c, "blocklyInvalidInput");
}
d.bk = function() {
  var a = z.H.ha,
    b = xh(this);
...
function vj(a) {
  return function() {
    var b = tj,
      ...
      e = c.value;
    a.v &&
      ((e = Ce(a, e)), null === e ? (e = c.defaultValue) : a.Ko && a.Ko(e));
    a.vb(e);
    a.v.P && a.v.Z();
    z.Da(b.$w);
    z.Da(b.ex);
...
d.Be = function() {
  this.Oa
    ? ((this.xa.textContent = vh(this)),
      this.v.u
        ? this.xa.insertBefore(this.Mp, this.xa.firstChild)
        : this.xa.appendChild(this.Mp),
      this.Ak())
    : (this.sa.width = 0);
};
d.Gf = function() {
...
d.jm = function(a) {
  var b = this.mj.ownerSVGElement.getBoundingClientRect(),
...
d.xk = function() {
  if (this.mj) {
    var a = ((Number(this.Ib()) + 0) * Math.PI) / 180,
      b = ["M ", 50, ",", 50],
      c = 50,
      e = 50;
    if (!isNaN(a)) {
      ...
      b.push(
        ...
        49,
        " 0 ",
        Math.abs(Math.floor((a - f) / Math.PI) % 2),
        " ",
        Number(!1),
        " ",
        c,
...
rh("field_angle", xj);
function yj(a, b) {
  yj.s.constructor.call(this, "", b);
  this.setValue(a);
}
y(yj, ph);
yj.ia = function(a) {
  return new yj(a.checked ? "TRUE" : "FALSE");
};
d = yj.prototype;
d.Hk = "default";
d.L = function() {
  this.Ua ||
    ...
    this.Tk.appendChild(document.createTextNode("\u2713")),
    (this.Tk.style.display = this.Ha ? "block" : "none"));
};
d.getValue = function() {
...
d.setValue = function(a) {
  ...
  this.Ha !== a &&
    (this.v &&
      z.j.isEnabled() &&
      z.j.U(new z.j.Cc(this.v, "field", this.name, this.Ha, a)),
    (this.Ha = a),
    this.Tk && (this.Tk.style.display = a ? "block" : "none"));
};
d.Fd = function() {
  var a = !this.Ha;
  this.v && (a = Ce(this, a));
...
function Aj(a) {
  ...
  if (Bj.test(c)) return (b.eo = Cj(c)), (b.type = "hex"), b;
  a: {
    var e = a.match(Dj);
    if (e) {
      c = Number(e[1]);
  ...
  if (c.length) return (b.eo = lj(c)), (b.type = "rgb"), b;
  if (zj && (c = zj[a.toLowerCase()])) return (b.eo = c), (b.type = "named"), b;
  throw Error(a + " is not a valid color string");
}
var Ej = /#(.)(.)(.)/;
function Cj(a) {
  if (!Bj.test(a)) throw Error("'" + a + "' is not a valid hex color");
  4 == a.length && (a = a.replace(Ej, "#$1$1$2$2$3$3"));
...
Hj.prototype.mq = function() {
  return this;
};
function Ij(a) {
  if (a instanceof Hj) return a;
  if ("function" == typeof a.mq) return a.mq();
  if (fa(a)) {
    var b = 0,
      c = new Hj();
    c.next = function() {
      for (;;) {
        if (b >= a.length) throw Gj;
...
function Kj(a, b, c, e, f) {
  ...
  this.cd && (this.depth *= -1);
}
y(Kj, Hj);
Kj.prototype.setPosition = function(a, b, c) {
  if ((this.node = a))
    this.mf = t(b) ? b : 1 != this.node.nodeType ? 0 : this.cd ? -1 : 1;
  t(c) && (this.depth = c);
};
Kj.prototype.clone = function() {
  return new Kj(this.node, this.cd, !this.Nq, this.mf, this.depth);
};
Kj.prototype.next = function() {
  if (this.nt) {
    if (!this.node || (this.Nq && 0 == this.depth)) throw Gj;
    var a = this.node;
    var b = this.cd ? -1 : 1;
    if (this.mf == b) {
      var c = this.cd ? a.lastChild : a.firstChild;
      c ? this.setPosition(c) : this.setPosition(a, -1 * b);
    } else
      (c = this.cd ? a.previousSibling : a.nextSibling)
        ? this.setPosition(c)
        : this.setPosition(a.parentNode, -1 * b);
    this.depth += this.mf * (this.cd ? -1 : 1);
  } else this.nt = !0;
  a = this.node;
  if (!this.node) throw Gj;
  return a;
};
Kj.prototype.splice = function(a) {
  var b = this.node,
    c = this.cd ? 1 : -1;
  this.mf == c &&
    ((this.mf = -1 * c), (this.depth += this.mf * (this.cd ? -1 : 1)));
  this.cd = !this.cd;
  Kj.prototype.next.call(this);
  this.cd = !this.cd;
  c = fa(arguments[0]) ? arguments[0] : arguments;
  for (var e = c.length - 1; 0 <= e; e--) fe(c[e], b);
  G(b);
};
function Lj(a, b, c, e) {
  Kj.call(this, a, b, c, null, e);
}
y(Lj, Kj);
Lj.prototype.next = function() {
  do Lj.s.next.call(this);
  while (-1 == this.mf);
  return this.node;
};
function Mj() {}
...
Mj.prototype.Pq = function(a, b) {
  a = b.V("TABLE", this.Ka() + "-table", b.V("TBODY", this.Ka() + "-body", a));
  a.cellSpacing = "0";
  a.cellPadding = "0";
  return a;
};
...
function Pj(a, b, c) {
  a = c.V("TD", { class: a.Ka() + "-cell", id: a.Ka() + "-cell-" + Nj++ }, b);
  Zh(a, "gridcell");
  S(a, "selected", !1);
  if (!me(a) && !$h(a, "label")) {
    var e;
    b = new Lj(a);
    for (c = ""; !c && (e = Jj(b)); )
      1 == e.nodeType && (c = $h(e, "label") || e.title);
    (e = c) && S(a, "label", e);
  }
  return a;
}
Mj.prototype.Cd = function(a, b) {
  if (a) {
    var c = Wd(this.Ka() + "-body", a)[0];
    if (c) {
      var e = 0;
      ...
      if (e < b.length) {
        for (
          var f = [], h = Td(a), k = c.rows[0].cells.length;
          e < b.length;
          ...
          f.push(Pj(this, l, h));
          f.length == k &&
            ((l = Qj(this, f, h)), c.appendChild(l), (f.length = 0));
        }
        if (0 < f.length) {
          for (; f.length < k; ) f.push(Pj(this, "", h));
          l = Qj(this, f, h);
          c.appendChild(l);
        }
      }
...
d.removeItem = function(a) {
  a &&
    xa(this.ii, a) &&
    a == this.ub &&
    ((this.ub = null), this.dispatchEvent("select"));
};
d.se = function() {
  return this.ub;
};
d.dd = function(a) {
  a != this.ub && (this.ck(this.ub, !1), (this.ub = a), this.ck(a, !0));
  this.dispatchEvent("select");
};
d.qj = function() {
  var a = this.ub;
  return a ? qa(this.ii, a) : -1;
};
d.hk = function(a) {
  this.dd(this.Hr(a));
};
...
d.ck = function(a, b) {
  a &&
    ("function" == typeof this.op
      ? this.op(a, b)
      : "function" == typeof a.wp && a.wp(b));
};
function Uj(a, b, c) {
  T.call(this, a, b || Mj.re(), c);
  this.jn &= -89;
  this.dj = new Vj();
  this.dj.Am(this);
  this.to = -1;
...
d.xm = function(a) {
  ...
  Wj(this);
  this.Vb
    ? (this.Vb.clear(), Tj(this.Vb, a))
    : ((this.Vb = new Sj(a)),
      (a = na(this.ck, this)),
      (this.Vb.op = a),
      Rh(this).na(this.Vb, "select", this.kw));
  this.ua = -1;
};
d.ul = function() {
  return "";
...
d.wj = function(a) {
  Uj.s.wj.call(this, a);
  var b = Rj(this.ma, this, a.target);
  (b && a.relatedTarget && ge(b, a.relatedTarget)) ||
    (b != Xj(this) && Yj(this, b));
};
d.bf = function(a) {
  Uj.s.bf.call(this, a);
  this.Ha & 4 &&
    ((a = Rj(this.ma, this, a.target)), a != Xj(this) && Yj(this, a));
};
d.ag = function(a) {
  var b = Xj(this);
  return b
    ? (a &&
        (this.se() ? "mouseup" != a.type || Rj(this.ma, this, a.target) : 1) &&
        this.dd(b),
      Uj.s.ag.call(this, a))
    : !1;
};
d.Ad = function(a) {
  ...
  switch (a.keyCode) {
    ...
    case 40:
      if ((-1 == e && (e = -c), e < b - c))
        return this.jc(e + c), a.preventDefault(), !0;
  }
  return !1;
};
d.kw = function() {};
...
d.qj = function() {
  return this.Vb ? this.Vb.qj() : -1;
};
d.se = function() {
  return this.Vb ? this.Vb.se() : null;
};
d.hk = function(a) {
  this.Vb && this.Vb.hk(a);
};
d.dd = function(a) {
  this.Vb && this.Vb.dd(a);
};
function Zj(a, b, c) {
  if (a.F()) {
    var e = a.Ic();
    if (e && 0 <= b && b < e.length) {
      var f = (f = Xj(a)) ? f.parentNode : null;
      a.dj.F() != f && (a.dj.S = f);
      f = a.dj;
      f.Wb(c);
      !!(f.Ha & 2) == c &&
        ...
        c ? ni(b, e) : pi(b, e),
        c
          ? S(a.S, "activedescendant", b.id)
          : b.id == $h(a.S, "activedescendant") &&
            a.S.removeAttribute("aria-activedescendant"));
    }
  }
}
d.Wb = function(a) {
  a && -1 == this.ua ? this.jc(-1 < this.to ? this.to : 0) : a || this.jc(-1);
  Uj.s.Wb.call(this, a);
};
d.ck = function(a, b) {
  if (this.F() && a) {
...
function Wj(a) {
  ...
  if (b)
    if (a.sa && a.sa.width) {
      if (
        ((b = Math.ceil(b.length / a.sa.width)),
        !t(a.sa.height) || a.sa.height < b)
      )
        a.sa.height = b;
    } else (b = Math.ceil(Math.sqrt(b.length))), (a.sa = new Sd(b, b));
  ...
  if (a) {
    ...
    if ("undefined" !== typeof b) a = b;
      ...
      if (!c) {
        ...
        void 0 === a.style[e] &&
          ((e =
            (B ? "Webkit" : lb ? "Moz" : A ? "ms" : jb ? "O" : null) + Ya(e)),
...
function dk(a, b) {
  Oh.call(this, a);
  this.Ra = b || null;
  Rh(this).na(this, "action", this.Vw);
}
y(dk, Oh);
d = dk.prototype;
d.Jg = !0;
d.wm = function(a) {
  this.Ra ? this.Ra.wm(a) : ek(this, a);
};
d.Bm = function(a) {
  this.Ra || ek(this, []);
  this.Ra.Bm(a);
...
d.af = function() {
  return this.Ra ? this.Ra.af() : null;
};
d.qj = function() {
  return this.Ra ? this.Ra.qj() : -1;
};
d.hk = function(a) {
  this.Ra && this.Ra.hk(a);
};
d.Wn = function() {
  return this.Ra ? this.Ra.Wn() : null;
};
d.xp = function(a) {
  this.Ra && this.Ra.xp(a);
};
d.df = function() {
  return this.Jg;
};
...
d.setValue = function(a) {
  this.v &&
    z.j.isEnabled() &&
    this.ge != a &&
    z.j.U(new z.j.Cc(this.v, "field", this.name, this.ge, a));
  this.ge = a;
...
d.Fd = function() {
  z.H.show(this, this.v.u, ik);
  var a = z.i.$n(),
    b = xh(this),
    c = this.bj(),
    e = ih(c.F());
  z.H.Uo(a, b, e, this.v.u);
  var f = this;
  hk = dc(c, "change", function(a) {
    a = a.target.Wn() || "#000000";
    z.H.Fa();
    f.v && (a = Ce(f, a));
    null !== a && f.setValue(a);
  });
...
function Fh(a, b) {
  ...
  if (u(a)) {
    for (var c = !1, e = 0; e < a.length; e++) {
      ...
      "string" == typeof f
        ? (a[e][0] = z.i.ic(f))
        : (null != f.alt && (a[e][0].alt = z.i.ic(f.alt)), (c = !0));
    }
    if (!(c || 2 > a.length)) {
      f = [];
...
function mk(a) {
  Rh(a).na(a.F(), "touchstart", function(a) {
    Ri(this, a.target).bf(a);
  });
}
function nk(a) {
  Rh(a).na(a.F(), "touchend", function(a) {
    Ri(this, a.target).ag(a);
  });
}
d.bj = function(a) {
  a.Z(z.H.ha);
...
d.setValue = function(a) {
  if (null !== a && a !== this.Ia) {
    this.v &&
      z.j.isEnabled() &&
      z.j.U(new z.j.Cc(this.v, "field", this.name, this.Ia, a));
    this.Ia = a;
    for (var b = this.getOptions(), c = 0; c < b.length; c++)
      if (b[c][1] == a) {
        a = b[c][0];
        "object" == typeof a
          ? ((this.ve = a), (this.va = a.alt))
          : ((this.ve = null), (this.va = a));
        this.lj();
        return;
      }
    this.va = a;
...
d.Be = function() {
  if (this.Oa) {
    ...
    if (this.ve) {
      this.sb = z.i.B(
        "image",
        { y: 5, height: this.ve.height + "px", width: this.ve.width + "px" },
        this.Ua
      );
      this.sb.setAttributeNS(
        "http://www.w3.org/1999/xlink",
        "xlink:href",
        this.ve.src
      );
      ...
      this.v.u
        ? (this.sb.setAttribute("x", a), this.xa.setAttribute("x", -1))
        : (this.xa.setAttribute("text-anchor", "end"),
          this.xa.setAttribute("x", this.sa.width + 1));
    } else
      (a = document.createTextNode(vh(this))),
        this.xa.appendChild(a),
        this.v.u
          ? this.xa.insertBefore(this.zf, this.xa.firstChild)
          : this.xa.appendChild(this.zf),
        this.xa.setAttribute("text-anchor", "start"),
        this.xa.setAttribute("x", 0),
        (this.sa.height = 25),
        (this.sa.width = wh(this.xa));
...
d.Ak = function() {
  if (this.ve && (A || kb)) {
    ...
    this.sa.width = a;
  } else ph.prototype.Ak.call(this);
};
d.A = function() {
  z.H.zj(this);
  Fh.s.A.call(this);
...
d.L = function() {
  this.Ua ||
    ...
    (this.sb = z.i.B(
      "image",
      { height: this.Ca + "px", width: this.ka + "px" },
      this.Ua
    )),
    this.setValue(this.gt),
    this.v.ga().appendChild(this.Ua),
    this.La(this.v),
    z.C.Cg(this.sb),
    this.rn && (this.dm = z.O(this.Ua, "mousedown", this, this.gf)));
};
d.A = function() {
  G(this.Ua);
...
function pk(a, b, c, e, f) {
  ...
  this.setValue(Ce(this, this.getValue()));
}
y(pk, ij);
pk.ia = function(a) {
  return new pk(a.value, a.min, a.max, a.precision);
};
pk.prototype.Uk = function(a) {
  if (null === a) return null;
  a = String(a);
  a = a.replace(/O/gi, "0");
  a = a.replace(/,/g, "");
...
y(qk, Fh);
qk.ia = function(a) {
  var b = z.i.ic(a.variable);
  return new qk(b, null, a.variableTypes, a.defaultType);
};
d = qk.prototype;
d.L = function() {
  this.Ua || (qk.s.L.call(this), this.Pg());
};
d.Pg = function() {
  if (!this.Zd) {
    this.m = this.v.o;
    var a = z.G.Dl(this.m, null, this.wv, this.vv);
    z.j.disable();
    try {
      this.setValue(a.$());
    } finally {
...
d.setValue = function(a) {
  ...
  this.v &&
    z.j.isEnabled() &&
    ((c = this.Zd ? this.Zd.$() : null),
    z.j.U(new z.j.Cc(this.v, "field", this.name, c, a)));
  this.Zd = b;
  this.Ia = a;
  this.vb(b.name);
};
...
function rk() {
  ...
  c.sort(sg);
  b = [];
  for (f = 0; f < c.length; f++) b[f] = [c[f].name, c[f].$()];
  b.push([z.g.RENAME_VARIABLE, z.hq]);
  z.g.DELETE_VARIABLE && b.push([z.g.DELETE_VARIABLE.replace("%1", a), z.$p]);
  return b;
}
d.Gs = function(a) {
  a = a.getValue();
...
function uk(a, b) {
  if (!b) return "";
  if (b.disabled) return uk(a, Lc(b));
  var c = a[b.type].call(b, b);
  if (u(c)) return [a.vm(b, c[0]), c[1]];
  if (q(c)) {
...
function xk(a, b) {
  ...
  c.Ih && (a += vk(c.Ih.replace(/%1/g, "'" + b + "'"), c.Me));
  return a;
}
d.Vm = "";
function yk(a) {
...
d.pd = "{leCUI8hutHZI4480Dc}";
function zk(a, b) {
  var c = z.h;
  if (!c.Df[a]) {
    var e = Ak(c.Va, a, z.qa.Xa);
    c.Qn[a] = e;
    b = b.join("\n").replace(c.Qt, e);
    for (var f; f != b; )
...
function Bk() {
  var a = z.h.Vm;
  this.wt = "";
  this.Ys = Object.create(null);
  if (a) {
    a = a.split(",");
    for (var b = 0; b < a.length; b++) this.Ys[a[b]] = !0;
  }
  this.reset();
}
...
function Ak(a, b, c) {
  b
    ...
    : (b = "unnamed");
  for (var e = ""; a.gr[b + e] || b + e in a.Ys; ) e = e ? e + 1 : 2;
  b += e;
  a.gr[b] = !0;
  return (c == z.G.Xa || "DEVELOPER_VARIABLE" == c ? a.wt : "") + b;
}
function Tc(a, b) {
...
z.qa.Ss = function(a, b) {
  return a[0].toLowerCase().localeCompare(b[0].toLowerCase());
};
z.qa.Pv = function(a, b) {
  if (b.tb) return a;
  for (; !z.qa.yw(a, b.o, b); ) {
    var c = a.match(/^(.*?)(\d+)$/);
...
z.qa.yw = function(a, b, c) {
  return !z.qa.Aw(a, b, c);
};
z.qa.Aw = function(a, b, c) {
  b = Qc(b);
  for (var e = 0; e < b.length; e++)
    if (b[e] != c && b[e].$e) {
      var f = b[e].$e();
      if (Tc(f[0], a)) return !0;
    }
  return !1;
};
z.qa.cp = function(a) {
  a = a.replace(/^[\s\xa0]+|[\s\xa0]+$/g, "");
  var b = z.qa.Pv(a, this.v),
    c = this.va;
  if (c != a && c != b) {
    a = Qc(this.v.o);
    for (var e = 0; e < a.length; e++) a[e].$j && a[e].$j(c, b);
  }
  return b;
};
z.qa.Hf = function(a) {
  ...
  z.J.procedures_defreturn &&
    ...
    e.setAttribute("gap", 16),
    (f = F("field", null, z.g.PROCEDURES_DEFRETURN_PROCEDURE)),
    f.setAttribute("name", "NAME"),
    e.appendChild(f),
    c.push(e));
...
z.qa.Do = function(a) {
  ...
  for (var f; (f = a[c]); c++) {
    ...
    h != k &&
      ((z.j.hc = !1),
      z.j.U(new z.j.Cc(f, "mutation", null, h, k)),
      (z.j.hc = b));
  }
};
z.qa.xl = function(a, b) {
  b = cd(b, !1);
  for (var c = 0; c < b.length; c++)
    if (b[c].$e) {
      var e = b[c].$e();
      if (e && Tc(e[0], a)) return b[c];
    }
  return null;
};
function Ck(a, b, c, e) {
  ...
  this.Sg && a
    ? console.warn("Labels should not have callbacks. Label text: " + this.va)
    : this.Sg || (a && Wg(b, a))
    ? (this.qn = Wg(b, a))
    : console.warn("Buttons should have callbacks. Button text: " + this.va);
  this.Sq = c.getAttribute("web-class") || null;
}
d = Ck.prototype;
d.width = 0;
d.height = 0;
...
d.V = function() {
  ...
  var c = z.i.B(
    "text",
    {
      class: this.Sg ? "blocklyFlyoutLabelText" : "blocklyText",
      x: 0,
      y: 0,
      "text-anchor": "middle"
    },
...
d.vr = 70;
d.V = function(a) {
  this.w = z.i.B(a, { class: "blocklyFlyout", style: "display: none" }, null);
  this.ed = z.i.B("path", { class: "blocklyFlyoutBackground" }, this.w);
  this.w.appendChild(this.m.V());
  return this.w;
};
d.L = function(a) {
  this.ta = a;
...
d.wk = function() {
  var a = this.Dg ? this.X() : !1;
  this.w.style.display = a ? "block" : "none";
  this.Ub.gh(a);
};
function Fk(a, b, c, e, f) {
  a.w.setAttribute("width", b);
  a.w.setAttribute("height", c);
  "svg" == a.w.tagName
    ? z.i.dk(a.w, "translate(" + e + "px," + f + "px)")
    : a.w.setAttribute("transform", "translate(" + e + "," + f + ")");
  a.Ub && ((a.Ub.Oo = new D(e, f)), a.Ub.resize());
}
d.Fa = function() {
  if (this.X()) {
    this.oa(!1);
    for (var a = 0, b; (b = this.yc[a]); a++) z.Da(b);
    this.yc.length = 0;
  ...
  for (var b = [], c = [], e = (this.So.length = 0), f; (f = a[e]); e++)
    if (f.tagName) {
      ...
      if ("BLOCK" == h)
        ...
        (f = new Ck(this.m, this.ta, f, "LABEL" == h)),
          b.push({ type: "button", button: f }),
          c.push(k);
    }
  this.hs(b, c);
  this.yc.push(
    z.O(this.ed, "mouseover", this, function() {
      for (var a = cd(this.m, !1), b = 0, c; (c = a[b]); b++) c.dh();
    })
  );
...
function Gk(a) {
  for (var b = cd(a.m, !1), c = 0, e; (e = b[c]); c++)
    e.o == a.m && e.A(!1, !1);
  for (c = 0; c < a.cm.length; c++) (b = a.cm[c]) && G(b);
  for (c = a.cm.length = 0; (b = a.Ti[c]); c++) b.A();
  a.Ti.length = 0;
  a.m.si.clear();
}
function Hk(a, b, c, e) {
  a.yc.push(z.O(b, "mousedown", null, Ik(a, c)));
...
function Of(a, b) {
  ...
  b = z.G.Fr(a.ta, e);
  if (z.j.isEnabled())
    for (z.j.R(!0), z.j.U(new yc(c)), e = 0; e < b.length; e++)
      z.j.U(new Cc(b[e]));
  a.Lh ? a.Fa() : a.Nn();
  return c;
}
...
d.Nn = function() {
  for (var a = fd(this.ta), b = cd(this.m, !1), c = 0, e; (e = b[c]); c++)
    if (-1 == this.So.indexOf(e)) {
      var f = xc(e, !1);
      e.Nc(f.length > a);
    }
};
d.ap = function() {
  this.cg && this.m.dg(this.cg);
  this.Ws();
  this.cg && this.m.Fc(this.cg);
};
function Mf(a) {
  return a.Ub ? a.Ub.X() : !1;
}
function Ng(a) {
  a.rb = this.Ze.bind(this);
  a.kg = this.zm.bind(this);
...
d.Ze = function() {
  ...
  this.nf == z.Ag && (b = 0);
  var e = this.Ca;
  this.nf == z.yf && (e -= this.yg);
  return {
    cb: e,
    ya: this.ka - 2 * this.yg,
    mc: (a.height + 2 * this.qd) * this.m.scale,
    Hc: (a.width + 2 * this.qd) * this.m.scale,
    Ke: -this.m.scrollY,
    Cb: -this.m.scrollX,
    nc: a.y,
    Gc: a.x,
...
d.zm = function(a) {
  var b = this.Ze();
  b &&
    (t(a.x) && (this.m.scrollX = -b.Hc * a.x),
    this.m.translate(this.m.scrollX + b.lb, this.m.scrollY + b.xb));
};
d.position = function() {
  if (this.X()) {
    var a = this.ta.rb();
    if (a) {
      this.ka = a.ya;
      this.rp(a.ya - 2 * this.pa, this.Ca - this.pa);
      var b = a.lb,
        c = a.xb;
...
d.rp = function(a, b) {
  var c = this.nf == z.yf,
    e = ["M 0," + (c ? 0 : this.pa)];
  c
    ? (e.push("h", a + 2 * this.pa),
      e.push("v", b),
      e.push("a", this.pa, this.pa, 0, 0, 1, -this.pa, this.pa),
      e.push("h", -1 * a),
      e.push("a", this.pa, this.pa, 0, 0, 1, -this.pa, -this.pa))
    : (e.push("a", this.pa, this.pa, 0, 0, 1, this.pa, -this.pa),
      e.push("h", a),
...
d.mp = function() {
  this.Ub.set(this.u ? Infinity : 0);
};
d.zt = function(a) {
  var b = a.deltaX;
  if (b) {
    lb && 1 === a.deltaMode && (b *= 10);
    var c = this.Ze();
    b = c.Cb + b;
...
d.hs = function(a, b) {
  ...
  for (var f = 0, h; (h = a[f]); f++)
    if ("block" == h.type) {
      h = h.block;
      for (var k = xc(h, !1), l = 0, m; (m = k[l]); l++) m.tb = !0;
      h.Z();
      k = h.ga();
      l = h.Hb();
      m = h.N ? M : 0;
      ...
      "button" == h.type &&
        (Jk(this, h.button, e, c), (e += h.button.width + b[f]));
};
d.Zr = function(a) {
...
d.Uh = function() {
  ...
  var a = this.w.getBoundingClientRect(),
    b = a.top;
  a = a.height;
  if (this.nf == z.yf) return new qg(-1e9, b - 1e9, 2e9, 1e9 + a);
  if (this.nf == z.Ag) return new qg(-1e9, b, 2e9, 1e9 + a);
};
d.Ws = function() {
  this.m.scale = this.ta.scale;
  for (var a = 0, b = cd(this.m, !1), c = 0, e; (e = b[c]); c++)
    a = Math.max(a, e.Hb().height);
  a += 1.5 * this.qd;
  a *= this.m.scale;
  a += H;
  if (this.Ca != a) {
    for (c = 0; (e = b[c]); c++) e.ol && Lk(this, e.ol, e);
    this.Ca = a;
    this.ta.resize();
  }
};
...
d.Ze = function() {
  ...
  return {
    cb: c,
    ya: e,
    mc: a.height * this.m.scale + 2 * this.qd,
    Hc: a.width * this.m.scale + 2 * this.qd,
    Ke: -this.m.scrollY + a.y,
    Cb: -this.m.scrollX,
    nc: a.y,
    Gc: a.x,
    xb: b,
...
d.position = function() {
  if (this.X()) {
    ...
    if (a) {
      this.Ca = a.cb;
      this.rp(this.ka - this.pa, a.cb - 2 * this.pa);
      var b = a.xb,
        c = a.lb;
...
d.hs = function(a, b) {
  this.m.scale = this.ta.scale;
  for (var c = this.qd, e = this.u ? c : c + M, f = 0, h; (h = a[f]); f++)
    if ("block" == h.type) {
      h = h.block;
      for (var k = xc(h, !1), l = 0, m; (m = k[l]); l++) m.tb = !0;
      h.Z();
      ...
      "button" == h.type &&
        (Jk(this, h.button, e, c), (c += h.button.height + b[f]));
};
d.Zr = function(a) {
  a = (Math.atan2(a.y, a.x) / Math.PI) * 180;
  var b = this.vr;
...
d.Uh = function() {
  ...
  var a = this.w.getBoundingClientRect(),
    b = a.left;
  a = a.width;
  if (this.nf == z.xf) return new qg(b - 1e9, -1e9, 1e9 + a, 2e9);
  if (lb && this.ta && this.ta.Jj) {
    var c = this.ta.w.getBoundingClientRect().x;
    10 > Math.abs(c - b) && (b += this.Cw * this.ta.options.Lb.scale);
  }
  return new qg(b, -1e9, 1e9 + a, 2e9);
};
d.Ws = function() {
  this.m.scale = this.ta.scale;
  for (var a = 0, b = cd(this.m, !1), c = 0, e; (e = b[c]); c++) {
  ...
  if (this.ka != a) {
    for (c = 0; (e = b[c]); c++)
      this.u &&
        ((f = e.la().x), e.moveBy(a / this.m.scale - this.qd - M - f, 0)),
        e.ol && Lk(this, e.ol, e);
    if (this.u)
      for (c = 0; (e = this.Ti[c]); c++)
        (b = e.Ir().y), e.moveTo(a / this.m.scale - e.width - this.qd - M, b);
    this.ka = a;
    this.ta.resize();
  }
};
...
d.Ol = function() {
  ...
  if (a) {
    ...
    (b = this.yl()) && Zh(b, "presentation");
    if ((b = Sk(this)))
      if ((Zh(b, "group"), b.hasChildNodes()))
        for (S(a, "expanded", !1), a = Uh(this), b = 1; b <= a; b++) {
          var c = R(this, b - 1).F();
          S(c, "setsize", a);
          S(c, "posinset", b);
        }
...
d.V = function() {
  ...
  A ? (Rd(a, Od(Qd, b)), a.removeChild(a.firstChild)) : Rd(a, b);
...
d.Jh = function(a, b) {
  ...
  Uk(a, this.Vh() + 1);
  if ((b = this.F()))
    if ((this.Di(), S(b, "expanded", this.qc()), this.qc())) {
      b = Sk(this);
      a.F() || a.V();
      var f = a.F(),
        h = e && e.F();
...
d.removeChild = function(a) {
  var b = this.uc(),
    c = b ? b.se() : null;
  if (c == a || a.contains(c))
    b.hasFocus() ? (this.select(), uf(this.px, 10, this)) : this.select();
  ...
  if (b && (b.removeNode(a), this.za)) {
    ...
    c && (c = R(this, Uh(this) - 1)) && c.Di();
    Wh(this) ||
      ((b.style.display = "none"),
      this.Di(),
      (this.zl().className = this.tl()),
...
d.Vh = function() {
  var a = this.dl;
  0 > a && ((a = (a = this.getParent()) ? a.Vh() + 1 : 0), Uk(this, a));
  return a;
};
function Uk(a, b) {
  if (b != a.dl) {
...
function Xk(a, b) {
  if (a.np != b) {
    ...
    c &&
      (S(c, "selected", b),
      b && ((b = a.uc().F()), S(b, "activedescendant", a.$())));
  }
}
d.qc = function() {
  return this.ij;
...
d.Vd = function(a) {
  ...
  if (!b || this.dispatchEvent(a ? "beforeexpand" : "beforecollapse")) {
    ...
    var e = this.F();
    if (Wh(this)) {
      if ((!a && c && this.contains(c.se()) && this.select(), e)) {
        if ((c = Sk(this)))
          if (
            (kh(c, a), S(e, "expanded", a), a && this.za && !c.hasChildNodes())
          ) {
            var f = [];
            Th(this, function(a) {
              f.push(a.Hm());
...
d.Hm = function() {
  ...
  a = Nd("div", b, c);
  return Nd("div", { class: this.$a.$q, id: this.$() }, [$k(this), a]);
};
function Wk(a) {
  return Math.max(0, (a.Vh() - 1) * a.$a.lo);
}
function $k(a) {
  var b = {};
  b["padding-" + (Vh(a) ? "right" : "left")] = Wk(a) + "px";
  b = { class: a.pj(), style: b };
  var c = a.Un(),
    e = Nd("span", { style: { display: "inline-block" }, class: a.tl() }),
    f = Nd("span", { class: a.$a.cr, title: a.Lx || null }, a.Cj);
  a = Od(f, Nd("span", {}, a.Fu));
  return Nd("div", b, [c, e, a]);
}
d.pj = function() {
  return this.$a.zn + (this.Ul() ? " " + this.$a.er : "");
};
d.Un = function() {
  return Nd("span", {
    type: "expand",
...
function al(a) {
  ...
  } else c ? f.append(e.Vq) : a.Rd ? f.append(e.Xq) : f.append(e.Wq);
  return f.toString();
}
function Zk(a) {
  var b = a.qc() && Wh(a);
  return yd({ "background-position": bl(a), display: b ? null : "none" });
}
function bl(a) {
  return (a.Rd ? (a.Vh() - 1) * a.$a.lo : "-100") + "px 0";
}
d.F = function() {
  var a = Ok.s.F.call(this);
  a || (this.S = a = this.pc().F(this.$()));
  return a;
};
function Vk(a) {
...
d.Di = function() {
  var a = this.yl();
  a && (a.className = al(this));
  if ((a = Sk(this))) a.style.backgroundPosition = bl(this);
};
d.Hs = function(a) {
  "expand" == a.target.getAttribute("type") && Wh(this)
    ? this.Kj && this.toggle()
    : (this.select(), Yk(this));
};
d.Jo = function(a) {
...
function dl(a) {
  return a.qc() && Wh(a) ? dl(R(a, Uh(a) - 1)) : a;
}
function Tk(a, b) {
  a.pg != b &&
    ((a.pg = b),
...
y(el, Ok);
el.prototype.uc = function() {
  if (this.pg) return this.pg;
  var a = this.getParent();
  return a && (a = a.uc()) ? (Tk(this, a), a) : null;
};
el.prototype.tl = function() {
  var a = this.qc(),
    b = this.Lv;
  if (a && b) return b;
  b = this.sw;
  ...
  b = this.$a;
  if (Wh(this)) {
    if (a && b.xn) return b.Eg + " " + b.xn;
    if (!a && b.Tq) return b.Eg + " " + b.Tq;
  } else if (b.yn) return b.Eg + " " + b.yn;
  return "";
};
function fl(a) {
  if (a.rj && "function" == typeof a.rj) return a.rj();
...
function gl(a) {
  ...
  this.bc = {};
  if (a) {
    if (a.Cl && "function" == typeof a.Cl) var b = a.Cl();
...
d.get = function(a) {
  a: {
    for (var b = this, c = 0; c < a.length; c++)
      if (((b = b.bc[a.charAt(c)]), !b)) {
        a = void 0;
        break a;
      }
    a = b;
  }
  return a ? a.Ia : void 0;
};
d.rj = function() {
  var a = [];
  il(this, a);
...
function il(a, b) {
  void 0 !== a.Ia && b.push(a.Ia);
  for (var c in a.bc) il(a.bc[c], b);
}
d.Cl = function(a) {
  var b = [];
  if (a) {
...
function jl(a, b, c) {
  void 0 !== a.Ia && c.push(b);
  for (var e in a.bc) jl(a.bc[e], b + e, c);
}
d.clear = function() {
  this.bc = {};
  this.Ia = void 0;
...
function ll(a, b) {
  ...
  if (c && !Ga(null == c ? "" : String(c))) {
    ...
    var e = a.Xg.get(c);
    if (e) {
      for (var f = Uh(b), h = 0; h < f; h++) ll(a, R(b, h));
      xa(e, b);
...
function ml(a, b) {
  ...
  (b = a.Xg.Cl(b)) &&
    b.length &&
    ((a.li = 0), (a.Pj = 0), (c = a.Xg.get(b[0])), (c = nl(a, c))) &&
    (a.Ao = b);
  return c;
}
function nl(a, b) {
...
function ol(a, b, c) {
  ...
  this.kj = !1;
  this.Rv = null;
  this.Ep = this.jh = this.Cp = this.ik = !0;
  if (A)
    try {
...
d.qc = function() {
  return !this.jh || ol.s.qc.call(this);
};
d.Vd = function(a) {
  this.jh ? ol.s.Vd.call(this, a) : (this.ij = a);
};
d.Un = function() {
  return Pd;
};
...
d.Di = function() {};
d.pj = function() {
  return ol.s.pj.call(this) + (this.jh ? "" : " " + this.$a.Zq);
};
d.tl = function() {
  var a = this.qc(),
    b = this.Lv;
  ...
  if (!a && b) return b;
  b = this.$a;
  return a && b.Yq ? b.Eg + " " + b.Yq : !a && b.Uq ? b.Eg + " " + b.Uq : "";
};
d.dd = function(a) {
  if (this.ub != a) {
    var b = !1;
    this.ub && ((b = this.ub == this.Rv), Xk(this.ub, !1));
    if ((this.ub = a)) Xk(a, !0), b && a.select();
    this.dispatchEvent("change");
  }
};
d.se = function() {
...
function pl(a) {
  0 != a.ik && ((a.ik = !1), a.za && ql(a));
}
function ql(a) {
  function b(a) {
    var h = Sk(a);
    if (h) {
      var l = !e || (c == a.getParent() && !f) ? a.$a.Rq : a.$a.Qq;
      h.className = l;
      if ((h = a.yl())) h.className = al(a);
    }
    Th(a, b);
  }
  var c = a,
...
d.Gb = function() {
  ...
  a = this.F();
  a.tabIndex = 0;
  var b = (this.fc = new ei(a)),
    c = (this.Pn = new Mk(a));
  Rh(this)
    .na(c, "focusout", this.Zv)
    .na(c, "focusin", this.dw)
    .na(b, "key", this.Ad)
    .na(a, "mousedown", this.bo)
    .na(a, "click", this.bo)
    .na(a, "dblclick", this.bo);
  this.Ol();
};
d.xd = function() {
  ol.s.xd.call(this);
...
d.Ad = function(a) {
  ...
  switch (a.keyCode) {
    ...
    case 38:
      if (a.ctrlKey) {
        ...
        if (e) {
          ...
          if (b.bm) {
            var k = b.li + c;
            0 <= k && k < b.bm.length ? ((b.li = k), (f = b.bm)) : (h = !0);
          }
          f ||
            ((k = b.Pj + c),
            0 <= k && k < e.length && (b.Pj = k),
            e.length > b.Pj && (f = b.Xg.get(e[b.Pj])),
            f && f.length && h && (b.li = -1 == c ? f.length - 1 : 0));
          nl(b, f) && (b.Ao = e);
        }
        c = !0;
      }
    ...
    case 8:
      ...
      c = !0;
      0 < e
        ? ((b.Db = b.Db.substring(0, e)), ml(b, b.Db))
        : 0 == e
        ? (b.Db = "")
        : (c = !1);
      break;
...
d.createNode = function(a) {
  return new el(a || Pd, this.$a, this.pc());
};
function cl(a, b) {
  a = a.tk;
  var c = b.Ib();
...
function Kg(a) {
  ...
  this.$a = {
    ...
    cr: "blocklyTreeLabel",
    Eg: "blocklyTreeIcon",
    xn: "blocklyTreeIconOpen",
    yn: "blocklyTreeIconNone",
    er: "blocklyTreeSelected"
  };
  this.tt = { zn: "blocklyTreeSeparator" };
  this.Od &&
    ((this.$a.cssTreeRow += a.u
...
d.L = function() {
  ...
  z.O(
    ...
    this,
    function(a) {
      z.i.Uf(a) || a.target == this.Dc ? z.Qb(!1) : z.Qb(!0);
      z.Touch.Te();
    },
    !1,
    !0
  ...
  if (a) {
    ...
    this.Od
      ? ((a.style.left = "0"),
        ...
        this.Ba == z.yf ? (a.style.top = "0") : (a.style.bottom = "0"))
      : (this.Ba == z.$d ? (a.style.right = "0") : (a.style.left = "0"),
...
d.om = function(a) {
  ...
  this.Hd.ee = [];
  this.Pr = !1;
  a = vl(this, a, this.Hd, this.m.options.Sd);
  if (this.Hd.ee.length)
    ...
    if (l.tagName)
      switch (l.tagName.toUpperCase()) {
        case "CATEGORY":
          ...
          q(m)
            ? ((h.fo = /^#[0-9a-fA-F]{6}$/.test(m) ? m : z.Ur(Number(m))),
              (a.Pr = !0))
            : (h.fo = "");
          "true" == l.getAttribute("expanded")
            ? (h.ee.length && (f = h), h.Vd(!0))
            : h.Vd(!1);
          h = l;
          break;
        case "SEP":
...
function Tg(a, b) {
  ...
  for (var c = 0, e; (e = b[c]); c++) {
    var f = Vk(e);
    if (f) {
      var h = a.Pr ? "8px solid " + (e.fo || "#ddd") : "none";
...
d.Uh = function() {
  ...
  var a = this.Dc.getBoundingClientRect(),
    b = a.left,
    c = a.top,
    e = a.width;
  a = a.height;
  return this.Ba == z.xf
    ? new qg(-1e7, -1e7, 1e7 + b + e, 2e7)
    : this.Ba == z.$d
    ? new qg(b, -1e7, 1e7 + e, 2e7)
    : this.Ba == z.yf
    ? new qg(-1e7, -1e7, 2e7, 1e7 + c + a)
    : new qg(0, c, 2e7, 1e7 + e);
};
function ul(a, b) {
  this.ea = a;
  ol.call(this, Pd, b);
...
ul.prototype.createNode = function(a) {
  a = a ? Id(a) : Pd;
  return new xl(this.ea, a, this.$a, this.pc());
};
ul.prototype.dd = function(a) {
  var b = this.ea;
  if (a != this.ub && a != b.Hd) {
    b.Mj && (Vk(b.Mj).style.backgroundColor = "");
    if (a) {
      var c = a.fo || "#57e";
    ...
    a && a.ee && a.ee.length
      ? (b.I.show(a.ee), b.Mj != a && b.I.mp())
      : b.I.Fa();
    c != a &&
      c != this &&
      ((c = new Fc(null, "category", c && Hd(c.Cj), a && Hd(a.Cj))),
      (c.Bc = b.m.id),
      z.j.U(c));
    a && (b.Mj = a);
  }
...
d.Lo = function(a) {
  ...
  return xl.s.Lo.call(this, a);
};
function wl(a) {
  xl.call(this, null, Pd, a);
}
y(wl, xl);
z.od = {};
z.od.FB = "";
...
z.H.V = function() {
  z.H.ha ||
    ((z.H.ha = F("DIV", "blocklyWidgetDiv")),
    document.body.appendChild(z.H.ha));
};
z.H.show = function(a, b, c) {
  z.H.Fa();
  z.H.Vj = a;
  z.H.Gf = c;
...
z.H.position = function(a, b, c, e, f) {
  b < e.y && (b = e.y);
  f ? a > c.width + e.x && (a = c.width + e.x) : a < e.x && (a = e.x);
  z.H.Ps(a, b, c.height);
};
z.H.Ps = function(a, b, c) {
  z.H.ha.style.left = a + "px";
  z.H.ha.style.top = b + "px";
  z.H.ha.style.height = c + "px";
};
z.H.Uo = function(a, b, c, e) {
  z.H.Ps(z.H.Tu(a, b, c, e), z.H.Uu(a, b, c), c.height);
};
z.H.Tu = function(a, b, c, e) {
  if (e)
    return (
...
d.qf = function(a, b) {
  this.lk = new D(a * this.gg, b * this.gg);
  a = this.lk.x;
  b = this.lk.y;
  a = a.toFixed(0);
  b = b.toFixed(0);
...
d.Gl = function() {
  var a = z.i.tc(this.wa);
  return new D(a.x / this.gg, a.y / this.gg);
};
d.rc = function() {
  return this.je;
};
d.Ui = function(a) {
  a
    ? a.appendChild(this.je.firstChild)
...
z.Qf = function(a, b) {
  ...
  if (!ge(document, a)) throw "Error: container is not in current document.";
  b = new Yf(b || {});
  var c = F("DIV", "injectionDiv");
  a.appendChild(c);
  a = z.$i(c, b);
  var e = new yl(c);
  c = new xg(c);
...
z.$i = function(a, b) {
  ...
  z.i.B("path", { d: "M 0 0 L 10 10 M 10 0 L 0 10", stroke: "#cc0" }, f);
  b.fj = f.id;
  f = b.Jr;
  c = z.i.B(
    "pattern",
  ...
  0 < f.length && 0 < f.spacing
    ? (z.i.B("line", { stroke: f.colour }, c),
      1 < f.length && z.i.B("line", { stroke: f.colour }, c))
    : z.i.B("line", {}, c);
  b.Kr = c;
  return a;
};
...
z.ww = function(a) {
  var b = a.options,
    c = L(a);
  z.O(c.parentNode, "contextmenu", null, function(a) {
    z.i.Vl(a) || a.preventDefault();
  });
  c = z.O(window, "resize", null, function() {
    z.Qb(!0);
    z.ph(a);
  });
  a.tm = c;
  ...
  b.xe &&
    (a.ea
      ...
      : a.I &&
        (a.I.L(a),
        a.I.show(b.xe.childNodes),
        a.I.mp(),
        (a.scrollX = a.I.ka),
        b.Ba == z.$d && (a.scrollX *= -1),
...
z.Qf.Nu = function() {
  z.Hv ||
    (z.O(document, "keydown", null, z.ax),
    z.Zb(document, "touchend", null, z.Xf),
    z.Zb(document, "touchcancel", null, z.Xf),
    qb &&
      z.O(window, "orientationchange", document, function() {
        z.ph(z.Yh());
      }));
  z.Hv = !0;
};
  ...
  if (!z.Yf.options.readOnly && !z.i.Vl(a)) {
    ...
    if (27 == a.keyCode) z.Qb();
      ...
      z.selected &&
        ...
        z.selected.we() &&
        (67 == a.keyCode
          ? (z.Qb(), z.wn(z.selected))
          : 88 != a.keyCode || z.selected.o.Pd || (z.wn(z.selected), (b = !0)));
      86 == a.keyCode
        ? z.Wi && (z.j.R(!0), (a = z.Wk), a.Pd && (a = a.qh), Qg(a), z.j.R(!1))
        : 90 == a.keyCode && (z.Qb(), z.Yf.Pp(a.shiftKey));
    }
    b &&
      !z.selected.o.Pd &&
      (z.j.R(!0), z.Qb(), z.selected.A(!0, !0), z.j.R(!1));
  }
};
z.wn = function(a) {
  if (a.Yr) var b = a.qk();
...
z.alert = function(a, b) {
  window.alert(a);
  b && b();
};
z.confirm = function(a, b) {
  b(window.confirm(a));
};
z.prompt = function(a, b, c) {
  c(window.prompt(a, b));
};
z.Bw = function(a) {
  return function() {
...
z.O = function(a, b, c, e, f, h) {
  function k(a) {
    ...
    for (var h = 0, k; (k = a[h]); h++)
      if (!b || z.Touch.Bp(k)) z.Touch.zx(k), c ? e.call(c, k) : e(k), (l = !0);
  }
  var l = !1,
    m = [];
  if (g.PointerEvent && b in z.Touch.ae)
    for (var n = 0, p; (p = z.Touch.ae[b][n]); n++)
      a.addEventListener(p, k, !1), m.push([a, p, k]);
  else if ((a.addEventListener(b, k, !1), m.push([a, b, k]), b in z.Touch.ae)) {
    var r = function(a) {
      k(a);
      var b = !h;
      l && b && a.preventDefault();
    };
    for (n = 0; (p = z.Touch.ae[b][n]); n++)
...
z.Zb = function(a, b, c, e) {
  ...
  var h = [],
    k = g.window;
  if (k && k.PointerEvent && b in z.Touch.ae) {
    k = 0;
    for (var l; (l = z.Touch.ae[b][k]); k++)
      a.addEventListener(l, f, !1), h.push([a, l, f]);
  } else if (
    (a.addEventListener(b, f, !1), h.push([a, b, f]), b in z.Touch.ae)
  ) {
    var m = function(a) {
...
z.Wu = function() {
  ...
  z.ac("LISTS_HUE", ["Constants", "Lists", "HUE"], 260);
...
z.ac = function(a, b, c) {
  for (var e = "Blockly", f = z, h = 0; h < b.length; ++h)
    (e += "." + b[h]), f && (f = f[b[h]]);
  f &&
    f !== c &&
    ((a = (void 0 === c
...
var Al = {
  ...
  Fl = Number,
  Gl,
  Hl = window.location.search.match(/[?&]level=([^&]+)/);
...
z.g.HB = {};
z.g.ADD_COMMENT = "A\u00f1adir comentario";
z.g.CANNOT_DELETE_VARIABLE_PROCEDURE =
  'No se puede eliminar la variable "%1" porque es parte de la definici\u00f3n de la funci\u00f3n "%2"';
z.g.CHANGE_VALUE_TITLE = "Cambiar el valor:";
z.g.CLEAN_UP = "Limpiar los bloques";
z.g.COLLAPSE_ALL = "Contraer bloques";
z.g.COLLAPSE_BLOCK = "Contraer bloque";
z.g.COLOUR_BLEND_COLOUR1 = "color 1";
z.g.COLOUR_BLEND_COLOUR2 = "color 2";
z.g.COLOUR_BLEND_HELPURL = "http://meyerweb.com/eric/tools/color-blend/";
z.g.COLOUR_BLEND_RATIO = "proporci\u00f3n";
z.g.COLOUR_BLEND_TITLE = "combinar";
z.g.COLOUR_BLEND_TOOLTIP =
  "Combina dos colores con una proporci\u00f3n determinada (0,0\u20131,0).";
z.g.COLOUR_PICKER_HELPURL = "https://es.wikipedia.org/wiki/Color";
z.g.COLOUR_PICKER_TOOLTIP = "Elige un color de la paleta.";
z.g.COLOUR_RANDOM_HELPURL = "http://randomcolour.com";
z.g.COLOUR_RANDOM_TITLE = "color aleatorio";
z.g.COLOUR_RANDOM_TOOLTIP = "Elige un color al azar.";
z.g.COLOUR_RGB_BLUE = "azul";
z.g.COLOUR_RGB_GREEN = "verde";
z.g.COLOUR_RGB_HELPURL = "http://www.december.com/html/spec/colorper.html";
z.g.COLOUR_RGB_RED = "rojo";
z.g.COLOUR_RGB_TITLE = "colorear con";
z.g.COLOUR_RGB_TOOLTIP =
  "Crea un color con cantidades espec\u00edficas de rojo, verde y azul. Todos los valores deben encontrarse entre 0 y 100.";
z.g.CONTROLS_FLOW_STATEMENTS_HELPURL =
  "https://github.com/google/blockly/wiki/Loops#loop-termination-blocks";
z.g.CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK = "romper el bucle";
z.g.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "continuar con la siguiente iteraci\u00f3n del bucle";
z.g.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK = "Romper el bucle que lo contiene.";
z.g.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "Saltar el resto de este bucle, y continuar con la siguiente iteraci\u00f3n.";
z.g.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Atenci\u00f3n: este bloque puede usarse solamente dentro de un bucle.";
z.g.CONTROLS_FOREACH_HELPURL = "https://es.wikipedia.org/wiki/Foreach";
z.g.CONTROLS_FOREACH_TITLE = "para cada elemento %1 en la lista %2";
z.g.CONTROLS_FOREACH_TOOLTIP =
  "Para cada elemento en una lista, establecer la variable '%1' al elemento y luego hacer algunas declaraciones.";
z.g.CONTROLS_FOR_HELPURL =
  "https://github.com/google/blockly/wiki/Loops#count-with";
z.g.CONTROLS_FOR_TITLE = "contar con %1 desde %2 hasta %3 de a %4";
z.g.CONTROLS_FOR_TOOLTIP =
...
z.g.CONTROLS_IF_ELSEIF_TOOLTIP = "Agregar una condici\u00f3n a este bloque.";
z.g.CONTROLS_IF_ELSE_TOOLTIP =
  "Agregar una condici\u00f3n general final a este bloque.";
z.g.CONTROLS_IF_HELPURL = "https://github.com/google/blockly/wiki/IfElse";
z.g.CONTROLS_IF_IF_TOOLTIP =
  "Agregar, eliminar o reordenar las secciones para reconfigurar este bloque.";
z.g.CONTROLS_IF_MSG_ELSE = "sino";
z.g.CONTROLS_IF_MSG_ELSEIF = "sino si";
z.g.CONTROLS_IF_MSG_IF = "si";
z.g.CONTROLS_IF_TOOLTIP_1 =
  "Si un valor es verdadero, entonces hacer algunas declaraciones.";
z.g.CONTROLS_IF_TOOLTIP_2 =
...
z.g.CONTROLS_REPEAT_HELPURL = "https://es.wikipedia.org/wiki/Bucle_for";
z.g.CONTROLS_REPEAT_INPUT_DO = "hacer";
z.g.CONTROLS_REPEAT_TITLE = "repetir %1 veces";
z.g.CONTROLS_REPEAT_TOOLTIP = "Hacer algunas declaraciones varias veces.";
z.g.CONTROLS_WHILEUNTIL_HELPURL =
  "https://github.com/google/blockly/wiki/Loops#repeat";
z.g.CONTROLS_WHILEUNTIL_OPERATOR_UNTIL = "repetir hasta";
z.g.CONTROLS_WHILEUNTIL_OPERATOR_WHILE = "repetir mientras";
z.g.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Mientras un valor sea falso, entonces hacer algunas declaraciones.";
z.g.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Mientras un valor sea verdadero, entonces hacer algunas declaraciones.";
z.g.DELETE_ALL_BLOCKS = "\u00bfEliminar todos los %1 bloques?";
z.g.DELETE_BLOCK = "Eliminar bloque";
z.g.DELETE_VARIABLE = 'Borrar la variable "%1"';
z.g.DELETE_VARIABLE_CONFIRMATION = '\u00bfBorrar %1 usos de la variable "%2"?';
z.g.DELETE_X_BLOCKS = "Eliminar %1 bloques";
z.g.DISABLE_BLOCK = "Desactivar bloque";
z.g.DUPLICATE_BLOCK = "Duplicar";
z.g.DUPLICATE_COMMENT = "Duplicar comentario";
z.g.ENABLE_BLOCK = "Activar bloque";
z.g.EXPAND_ALL = "Expandir bloques";
z.g.EXPAND_BLOCK = "Expandir bloque";
z.g.EXTERNAL_INPUTS = "Entradas externas";
z.g.HELP = "Ayuda";
z.g.INLINE_INPUTS = "Entradas en l\u00ednea";
z.g.IOS_CANCEL = "Cancelar";
z.g.IOS_ERROR = "Error";
z.g.IOS_OK = "Aceptar";
z.g.IOS_PROCEDURES_ADD_INPUT = "+ A\u00f1adir entrada";
z.g.IOS_PROCEDURES_ALLOW_STATEMENTS = "Permitir declaraciones";
z.g.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Esta funci\u00f3n tiene entradas duplicadas.";
z.g.IOS_PROCEDURES_INPUTS = "ENTRADAS";
z.g.IOS_VARIABLES_ADD_BUTTON = "A\u00f1adir";
z.g.IOS_VARIABLES_ADD_VARIABLE = "+ A\u00f1adir variable";
z.g.IOS_VARIABLES_DELETE_BUTTON = "Borrar";
z.g.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "No puedes usar un nombre de variable vac\u00edo.";
z.g.IOS_VARIABLES_RENAME_BUTTON = "Renombrar";
z.g.IOS_VARIABLES_VARIABLE_NAME = "Nombre de la variable";
z.g.LISTS_CREATE_EMPTY_HELPURL =
  "https://github.com/google/blockly/wiki/Lists#create-empty-list";
z.g.LISTS_CREATE_EMPTY_TITLE = "crear lista vac\u00eda";
z.g.LISTS_CREATE_EMPTY_TOOLTIP =
  "Devuelve una lista, de longitud 0, sin ning\u00fan dato";
z.g.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = "lista";
z.g.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  "Agregar, eliminar o reorganizar las secciones para reconfigurar este bloque de lista.";
z.g.LISTS_CREATE_WITH_HELPURL =
  "https://github.com/google/blockly/wiki/Lists#create-list-with";
z.g.LISTS_CREATE_WITH_INPUT_WITH = "crear lista con";
z.g.LISTS_CREATE_WITH_ITEM_TOOLTIP = "Agregar un elemento a la lista.";
z.g.LISTS_CREATE_WITH_TOOLTIP =
  "Crear una lista con cualquier n\u00famero de elementos.";
z.g.LISTS_GET_INDEX_FIRST = "primero";
z.g.LISTS_GET_INDEX_FROM_END = "# del final";
z.g.LISTS_GET_INDEX_FROM_START = "#";
z.g.LISTS_GET_INDEX_GET = "obtener";
z.g.LISTS_GET_INDEX_GET_REMOVE = "obtener y eliminar";
z.g.LISTS_GET_INDEX_LAST = "\u00faltimo";
z.g.LISTS_GET_INDEX_RANDOM = "aleatorio";
z.g.LISTS_GET_INDEX_REMOVE = "eliminar";
z.g.LISTS_GET_INDEX_TAIL = "";
z.g.LISTS_GET_INDEX_TOOLTIP_GET_FIRST =
  "Devuelve el primer elemento de una lista.";
z.g.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "Devuelve el elemento en la posici\u00f3n especificada en una lista.";
z.g.LISTS_GET_INDEX_TOOLTIP_GET_LAST =
...
z.g.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST =
  "Elimina y devuelve el primer elemento de una lista.";
z.g.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM =
  "Elimina y devuelve el elemento en la posici\u00f3n especificada en una lista.";
z.g.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_LAST =
  "Elimina y devuelve el \u00faltimo elemento de una lista.";
z.g.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_RANDOM =
...
z.g.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM =
  "Elimina el elemento en la posici\u00f3n especificada en una lista.";
z.g.LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST =
  "Elimina el \u00faltimo elemento de una lista.";
z.g.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM =
  "Elimina un elemento aleatorio en una lista.";
z.g.LISTS_GET_SUBLIST_END_FROM_END = "hasta # del final";
z.g.LISTS_GET_SUBLIST_END_FROM_START = "hasta #";
z.g.LISTS_GET_SUBLIST_END_LAST = "hasta el \u00faltimo";
z.g.LISTS_GET_SUBLIST_HELPURL =
  "https://github.com/google/blockly/wiki/Lists#getting-a-sublist";
z.g.LISTS_GET_SUBLIST_START_FIRST = "obtener sublista desde el primero";
z.g.LISTS_GET_SUBLIST_START_FROM_END = "obtener sublista desde # del final";
z.g.LISTS_GET_SUBLIST_START_FROM_START = "obtener sublista desde #";
z.g.LISTS_GET_SUBLIST_TAIL = "";
z.g.LISTS_GET_SUBLIST_TOOLTIP =
  "Crea una copia de la parte especificada de una lista.";
z.g.LISTS_INDEX_FROM_END_TOOLTIP = "%1 es el \u00faltimo elemento.";
z.g.LISTS_INDEX_FROM_START_TOOLTIP = "%1 es el primer elemento.";
z.g.LISTS_INDEX_OF_FIRST = "encontrar la primera aparici\u00f3n del elemento";
z.g.LISTS_INDEX_OF_HELPURL =
  "https://github.com/google/blockly/wiki/Lists#getting-items-from-a-list";
z.g.LISTS_INDEX_OF_LAST =
  "encontrar la \u00faltima aparici\u00f3n del elemento";
z.g.LISTS_INDEX_OF_TOOLTIP =
  "Devuelve el \u00edndice de la primera/\u00faltima aparici\u00f3n del elemento en la lista. Devuelve %1 si el elemento no se encuentra.";
z.g.LISTS_INLIST = "en la lista";
z.g.LISTS_ISEMPTY_HELPURL =
  "https://github.com/google/blockly/wiki/Lists#is-empty";
z.g.LISTS_ISEMPTY_TITLE = "%1 est\u00e1 vac\u00eda";
z.g.LISTS_ISEMPTY_TOOLTIP =
  "Devuelve verdadero si la lista est\u00e1 vac\u00eda.";
z.g.LISTS_LENGTH_HELPURL =
  "https://github.com/google/blockly/wiki/Lists#length-of";
z.g.LISTS_LENGTH_TITLE = "longitud de %1";
z.g.LISTS_LENGTH_TOOLTIP = "Devuelve la longitud de una lista.";
z.g.LISTS_REPEAT_HELPURL =
  "https://github.com/google/blockly/wiki/Lists#create-list-with";
z.g.LISTS_REPEAT_TITLE = "crear lista con el elemento %1 repetido %2 veces";
z.g.LISTS_REPEAT_TOOLTIP =
  "Crea una lista que consta de un valor dado repetido el n\u00famero de veces especificado.";
z.g.LISTS_REVERSE_HELPURL =
  "https://github.com/google/blockly/wiki/Lists#reversing-a-list";
z.g.LISTS_REVERSE_MESSAGE0 = "invertir %1";
z.g.LISTS_REVERSE_TOOLTIP = "Invertir una copia de una lista.";
z.g.LISTS_SET_INDEX_HELPURL =
  "https://github.com/google/blockly/wiki/Lists#in-list--set";
z.g.LISTS_SET_INDEX_INPUT_TO = "como";
z.g.LISTS_SET_INDEX_INSERT = "insertar en";
z.g.LISTS_SET_INDEX_SET = "establecer";
z.g.LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST =
...
z.g.LISTS_SET_INDEX_TOOLTIP_INSERT_LAST =
  "A\u00f1ade el elemento al final de una lista.";
z.g.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM =
  "Inserta el elemento aleatoriamente en una lista.";
z.g.LISTS_SET_INDEX_TOOLTIP_SET_FIRST =
  "Establece el primer elemento de una lista.";
z.g.LISTS_SET_INDEX_TOOLTIP_SET_FROM =
  "Establece el elemento en la posici\u00f3n especificada en una lista.";
z.g.LISTS_SET_INDEX_TOOLTIP_SET_LAST =
  "Establece el \u00faltimo elemento de una lista.";
z.g.LISTS_SET_INDEX_TOOLTIP_SET_RANDOM =
  "Establece un elemento aleatorio en una lista.";
z.g.LISTS_SORT_HELPURL =
  "https://github.com/google/blockly/wiki/Lists#sorting-a-list";
z.g.LISTS_SORT_ORDER_ASCENDING = "ascendente";
z.g.LISTS_SORT_ORDER_DESCENDING = "descendente";
z.g.LISTS_SORT_TITLE = "orden %1 %2 %3";
z.g.LISTS_SORT_TOOLTIP = "Ordenar una copia de una lista.";
z.g.LISTS_SORT_TYPE_IGNORECASE =
  "alfab\u00e9tico, ignorar may\u00fascula/min\u00fascula";
z.g.LISTS_SORT_TYPE_NUMERIC = "num\u00e9rico";
z.g.LISTS_SORT_TYPE_TEXT = "alfab\u00e9tico";
z.g.LISTS_SPLIT_HELPURL =
  "https://github.com/google/blockly/wiki/Lists#splitting-strings-and-joining-lists";
z.g.LISTS_SPLIT_LIST_FROM_TEXT = "hacer lista a partir de texto";
z.g.LISTS_SPLIT_TEXT_FROM_LIST = "hacer texto a partir de lista";
z.g.LISTS_SPLIT_TOOLTIP_JOIN =
  "Unir una lista de textos en un solo texto, separado por un delimitador.";
z.g.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Dividir el texto en una lista de textos, separando en cada delimitador.";
z.g.LISTS_SPLIT_WITH_DELIMITER = "con delimitador";
z.g.LOGIC_BOOLEAN_FALSE = "falso";
z.g.LOGIC_BOOLEAN_HELPURL =
  "https://github.com/google/blockly/wiki/Logic#values";
z.g.LOGIC_BOOLEAN_TOOLTIP = "Devuelve verdadero o falso.";
z.g.LOGIC_BOOLEAN_TRUE = "verdadero";
z.g.LOGIC_COMPARE_HELPURL =
  "https://es.wikipedia.org/wiki/Desigualdad_matem\u00e1tica";
z.g.LOGIC_COMPARE_TOOLTIP_EQ =
  "Devuelve verdadero si ambas entradas son iguales.";
z.g.LOGIC_COMPARE_TOOLTIP_GT =
  "Devuelve verdadero si la primera entrada es mayor que la segunda entrada.";
z.g.LOGIC_COMPARE_TOOLTIP_GTE =
  "Devuelve verdadero si la primera entrada es mayor o igual a la segunda entrada.";
z.g.LOGIC_COMPARE_TOOLTIP_LT =
  "Devuelve verdadero si la primera entrada es menor que la segunda entrada.";
z.g.LOGIC_COMPARE_TOOLTIP_LTE =
  "Devuelve verdadero si la primera entrada es menor que o igual a la segunda entrada.";
z.g.LOGIC_COMPARE_TOOLTIP_NEQ =
...
z.g.LOGIC_NEGATE_TITLE = "no %1";
z.g.LOGIC_NEGATE_TOOLTIP =
...
z.g.LOGIC_NULL_TOOLTIP = "Devuelve nulo.";
z.g.LOGIC_OPERATION_AND = "y";
z.g.LOGIC_OPERATION_HELPURL =
  "https://github.com/google/blockly/wiki/Logic#logical-operations";
z.g.LOGIC_OPERATION_OR = "o";
z.g.LOGIC_OPERATION_TOOLTIP_AND =
  "Devuelve verdadero si ambas entradas son verdaderas.";
z.g.LOGIC_OPERATION_TOOLTIP_OR =
  "Devuelve verdadero si al menos una de las entradas es verdadera.";
z.g.LOGIC_TERNARY_CONDITION = "prueba";
z.g.LOGIC_TERNARY_HELPURL = "https://en.wikipedia.org/wiki/%3F:";
z.g.LOGIC_TERNARY_IF_FALSE = "si es falso";
z.g.LOGIC_TERNARY_IF_TRUE = "si es verdadero";
z.g.LOGIC_TERNARY_TOOLTIP =
...
z.g.MATH_ARITHMETIC_HELPURL = "https://es.wikipedia.org/wiki/Aritm\u00e9tica";
z.g.MATH_ARITHMETIC_TOOLTIP_ADD = "Devuelve la suma de ambos n\u00fameros.";
z.g.MATH_ARITHMETIC_TOOLTIP_DIVIDE =
  "Devuelve el cociente de ambos n\u00fameros.";
z.g.MATH_ARITHMETIC_TOOLTIP_MINUS =
  "Devuelve la diferencia de ambos n\u00fameros.";
z.g.MATH_ARITHMETIC_TOOLTIP_MULTIPLY =
  "Devuelve el producto de ambos n\u00fameros.";
z.g.MATH_ARITHMETIC_TOOLTIP_POWER =
  "Devuelve el primer n\u00famero elevado a la potencia del segundo.";
z.g.MATH_CHANGE_HELPURL =
  "https://en.wikipedia.org/wiki/Programming_idiom#Incrementing_a_counter";
z.g.MATH_CHANGE_TITLE = "a\u00f1adir %2 a %1";
z.g.MATH_CHANGE_TOOLTIP =
  "A\u00f1adir un n\u00famero a la variable \u00ab%1\u00bb.";
z.g.MATH_CONSTANT_HELPURL =
  "https://es.wikipedia.org/wiki/Anexo:Constantes_matem\u00e1ticas";
z.g.MATH_CONSTANT_TOOLTIP =
  "Devuelve una de las constantes comunes: \u03c0 (3.141\u2026), e (2.718\u2026), \u03c6 (1.618\u2026), sqrt(2) (1.414\u2026), sqrt(\u00bd) (0.707\u2026) o \u221e (infinito).";
z.g.MATH_CONSTRAIN_HELPURL =
  "https://en.wikipedia.org/wiki/Clamping_(graphics)";
z.g.MATH_CONSTRAIN_TITLE = "limitar %1 entre %2 y %3";
z.g.MATH_CONSTRAIN_TOOLTIP =
  "Limitar un n\u00famero entre los l\u00edmites especificados (inclusive).";
z.g.MATH_DIVISION_SYMBOL = "\u00f7";
z.g.MATH_IS_DIVISIBLE_BY = "es divisible por";
z.g.MATH_IS_EVEN = "es par";
z.g.MATH_IS_NEGATIVE = "es negativo";
z.g.MATH_IS_ODD = "es impar";
z.g.MATH_IS_POSITIVE = "es positivo";
z.g.MATH_IS_PRIME = "es primo";
z.g.MATH_IS_TOOLTIP =
...
z.g.MATH_IS_WHOLE = "es entero";
z.g.MATH_MODULO_HELPURL = "https://en.wikipedia.org/wiki/Modulo_operation";
z.g.MATH_MODULO_TITLE = "resto de %1 \u00f7 %2";
z.g.MATH_MODULO_TOOLTIP = "Devuelve el resto al dividir los dos n\u00fameros.";
z.g.MATH_MULTIPLICATION_SYMBOL = "\u00d7";
z.g.MATH_NUMBER_HELPURL = "https://es.wikipedia.org/wiki/N\u00famero";
z.g.MATH_NUMBER_TOOLTIP = "Un n\u00famero.";
z.g.MATH_ONLIST_HELPURL = "";
z.g.MATH_ONLIST_OPERATOR_AVERAGE = "promedio de la lista";
z.g.MATH_ONLIST_OPERATOR_MAX = "m\u00e1ximo de la lista";
z.g.MATH_ONLIST_OPERATOR_MEDIAN = "mediana de la lista";
z.g.MATH_ONLIST_OPERATOR_MIN = "m\u00ednimo de la lista";
z.g.MATH_ONLIST_OPERATOR_MODE = "modas de la lista";
z.g.MATH_ONLIST_OPERATOR_RANDOM = "elemento aleatorio de la lista";
z.g.MATH_ONLIST_OPERATOR_STD_DEV = "desviaci\u00f3n est\u00e1ndar de la lista";
z.g.MATH_ONLIST_OPERATOR_SUM = "suma de la lista";
z.g.MATH_ONLIST_TOOLTIP_AVERAGE =
  "Devuelve el promedio (media aritm\u00e9tica) de los valores num\u00e9ricos en la lista.";
z.g.MATH_ONLIST_TOOLTIP_MAX =
  "Devuelve el n\u00famero m\u00e1s grande en la lista.";
z.g.MATH_ONLIST_TOOLTIP_MEDIAN = "Devuelve la mediana en la lista.";
z.g.MATH_ONLIST_TOOLTIP_MIN =
  "Devuelve el n\u00famero m\u00e1s peque\u00f1o en la lista.";
z.g.MATH_ONLIST_TOOLTIP_MODE =
  "Devuelve una lista de los elementos m\u00e1s comunes en la lista.";
z.g.MATH_ONLIST_TOOLTIP_RANDOM = "Devuelve un elemento aleatorio de la lista.";
z.g.MATH_ONLIST_TOOLTIP_STD_DEV =
  "Devuelve la desviaci\u00f3n est\u00e1ndar de la lista.";
z.g.MATH_ONLIST_TOOLTIP_SUM =
  "Devuelve la suma de todos los n\u00fameros en la lista.";
z.g.MATH_POWER_SYMBOL = "^";
z.g.MATH_RANDOM_FLOAT_HELPURL =
  "https://es.wikipedia.org/wiki/Generador_de_n\u00fameros_aleatorios";
z.g.MATH_RANDOM_FLOAT_TITLE_RANDOM = "fracci\u00f3n aleatoria";
z.g.MATH_RANDOM_FLOAT_TOOLTIP =
  "Devuelve una fracci\u00f3n aleatoria entre 0,0 (ambos inclusive) y 1.0 (exclusivo).";
z.g.MATH_RANDOM_INT_HELPURL =
  "https://es.wikipedia.org/wiki/Generador_de_n\u00fameros_aleatorios";
z.g.MATH_RANDOM_INT_TITLE = "entero aleatorio de %1 a %2";
z.g.MATH_RANDOM_INT_TOOLTIP =
  "Devuelve un entero aleatorio entre los dos l\u00edmites especificados, inclusive.";
z.g.MATH_ROUND_HELPURL = "https://es.wikipedia.org/wiki/Redondeo";
z.g.MATH_ROUND_OPERATOR_ROUND = "redondear";
z.g.MATH_ROUND_OPERATOR_ROUNDDOWN = "redondear a la baja";
z.g.MATH_ROUND_OPERATOR_ROUNDUP = "redondear al alza";
z.g.MATH_ROUND_TOOLTIP = "Redondear un n\u00famero al alza o a la baja.";
z.g.MATH_SINGLE_HELPURL = "https://es.wikipedia.org/wiki/Ra%C3%ADz_cuadrada";
z.g.MATH_SINGLE_OP_ABSOLUTE = "absoluto";
z.g.MATH_SINGLE_OP_ROOT = "ra\u00edz cuadrada";
z.g.MATH_SINGLE_TOOLTIP_ABS = "Devuelve el valor absoluto de un n\u00famero.";
z.g.MATH_SINGLE_TOOLTIP_EXP = "Devuelve e a la potencia de un n\u00famero.";
z.g.MATH_SINGLE_TOOLTIP_LN = "Devuelve el logaritmo natural de un n\u00famero.";
z.g.MATH_SINGLE_TOOLTIP_LOG10 =
  "Devuelve el logaritmo base 10 de un n\u00famero.";
z.g.MATH_SINGLE_TOOLTIP_NEG = "Devuelve la negaci\u00f3n de un n\u00famero.";
z.g.MATH_SINGLE_TOOLTIP_POW10 = "Devuelve 10 a la potencia de un n\u00famero.";
z.g.MATH_SINGLE_TOOLTIP_ROOT =
...
z.g.MATH_TRIG_HELPURL =
  "https://es.wikipedia.org/wiki/Funci\u00f3n_trigonom\u00e9trica";
z.g.MATH_TRIG_SIN = "sin";
z.g.MATH_TRIG_TAN = "tan";
z.g.MATH_TRIG_TOOLTIP_ACOS = "Devuelve el arcocoseno de un n\u00famero.";
z.g.MATH_TRIG_TOOLTIP_ASIN = "Devuelve el arcoseno de un n\u00famero.";
z.g.MATH_TRIG_TOOLTIP_ATAN = "Devuelve el arcotangente de un n\u00famero.";
z.g.MATH_TRIG_TOOLTIP_COS = "Devuelve el coseno de un grado (no radi\u00e1n).";
z.g.MATH_TRIG_TOOLTIP_SIN = "Devuelve el seno de un grado (no radi\u00e1n).";
z.g.MATH_TRIG_TOOLTIP_TAN =
...
z.g.NEW_VARIABLE = "Crear variable\u2026";
z.g.NEW_VARIABLE_TITLE = "Nombre de variable nueva:";
z.g.NEW_VARIABLE_TYPE_TITLE = "New variable type:";
z.g.ORDINAL_NUMBER_SUFFIX = "";
z.g.PROCEDURES_ALLOW_STATEMENTS = "permitir declaraciones";
z.g.PROCEDURES_BEFORE_PARAMS = "con:";
z.g.PROCEDURES_CALLNORETURN_HELPURL = "https://es.wikipedia.org/wiki/Subrutina";
z.g.PROCEDURES_CALLNORETURN_TOOLTIP =
  "Ejecuta la funci\u00f3n definida por el usuario '%1'.";
z.g.PROCEDURES_CALLRETURN_HELPURL = "https://es.wikipedia.org/wiki/Subrutina";
z.g.PROCEDURES_CALLRETURN_TOOLTIP =
  "Ejecuta la funci\u00f3n definida por el usuario '%1' y usa su salida.";
z.g.PROCEDURES_CALL_BEFORE_PARAMS = "con:";
z.g.PROCEDURES_CREATE_DO = "Crear '%1'";
z.g.PROCEDURES_DEFNORETURN_COMMENT = "Describe esta funci\u00f3n...";
z.g.PROCEDURES_DEFNORETURN_DO = "";
z.g.PROCEDURES_DEFNORETURN_HELPURL = "https://en.wikipedia.org/wiki/Subroutine";
z.g.PROCEDURES_DEFNORETURN_PROCEDURE = "hacer algo";
z.g.PROCEDURES_DEFNORETURN_TITLE = "para";
z.g.PROCEDURES_DEFNORETURN_TOOLTIP = "Crea una funci\u00f3n sin salida.";
z.g.PROCEDURES_DEFRETURN_HELPURL = "https://en.wikipedia.org/wiki/Subroutine";
z.g.PROCEDURES_DEFRETURN_RETURN = "devuelve";
z.g.PROCEDURES_DEFRETURN_TOOLTIP = "Crea una funci\u00f3n con una salida.";
z.g.PROCEDURES_DEF_DUPLICATE_WARNING =
  "Advertencia: Esta funci\u00f3n tiene par\u00e1metros duplicados.";
z.g.PROCEDURES_HIGHLIGHT_DEF = "Destacar definici\u00f3n de la funci\u00f3n";
z.g.PROCEDURES_IFRETURN_HELPURL = "http://c2.com/cgi/wiki?GuardClause";
z.g.PROCEDURES_IFRETURN_TOOLTIP =
  "Si un valor es verdadero, entonces devuelve un segundo valor.";
z.g.PROCEDURES_IFRETURN_WARNING =
  "Advertencia: Este bloque solo puede ser utilizado dentro de la definici\u00f3n de una funci\u00f3n.";
z.g.PROCEDURES_MUTATORARG_TITLE = "nombre de entrada:";
z.g.PROCEDURES_MUTATORARG_TOOLTIP =
  "A\u00f1adir una entrada a la funci\u00f3n.";
z.g.PROCEDURES_MUTATORCONTAINER_TITLE = "entradas";
z.g.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "A\u00f1adir, eliminar o reordenar entradas para esta funci\u00f3n.";
z.g.REDO = "Rehacer";
z.g.REMOVE_COMMENT = "Eliminar comentario";
z.g.RENAME_VARIABLE = "Renombrar la variable\u2026";
z.g.RENAME_VARIABLE_TITLE = "Renombrar todas las variables \u00ab%1\u00bb a:";
z.g.TEXT_APPEND_HELPURL =
  "https://github.com/google/blockly/wiki/Text#text-modification";
z.g.TEXT_APPEND_TITLE = "a %1 a\u00f1ade el texto %2";
z.g.TEXT_APPEND_TOOLTIP = "A\u00f1adir texto a la variable '%1'.";
z.g.TEXT_CHANGECASE_HELPURL =
  "https://github.com/google/blockly/wiki/Text#adjusting-text-case";
z.g.TEXT_CHANGECASE_OPERATOR_LOWERCASE = "a min\u00fasculas";
z.g.TEXT_CHANGECASE_OPERATOR_TITLECASE = "a May\u00fasculas Cada Palabra";
z.g.TEXT_CHANGECASE_OPERATOR_UPPERCASE = "a MAY\u00daSCULAS";
z.g.TEXT_CHANGECASE_TOOLTIP =
  "Devuelve una copia del texto en un tama\u00f1o diferente.";
z.g.TEXT_CHARAT_FIRST = "obtener la primera letra";
z.g.TEXT_CHARAT_FROM_END = "obtener la letra # del final";
z.g.TEXT_CHARAT_FROM_START = "obtener la letra #";
z.g.TEXT_CHARAT_HELPURL =
  "https://github.com/google/blockly/wiki/Text#extracting-text";
z.g.TEXT_CHARAT_LAST = "obtener la \u00faltima letra";
z.g.TEXT_CHARAT_RANDOM = "obtener letra aleatoria";
z.g.TEXT_CHARAT_TAIL = "";
z.g.TEXT_CHARAT_TITLE = "en el texto %1 %2";
z.g.TEXT_CHARAT_TOOLTIP = "Devuelve la letra en la posici\u00f3n especificada.";
z.g.TEXT_COUNT_HELPURL =
  "https://github.com/google/blockly/wiki/Text#counting-substrings";
z.g.TEXT_COUNT_MESSAGE0 = "contar %1 en %2";
z.g.TEXT_COUNT_TOOLTIP = "Cuantas veces aparece un texto dentro de otro texto.";
z.g.TEXT_CREATE_JOIN_ITEM_TOOLTIP = "Agregar un elemento al texto.";
z.g.TEXT_CREATE_JOIN_TITLE_JOIN = "unir";
z.g.TEXT_CREATE_JOIN_TOOLTIP =
  "Agregar, eliminar o reordenar las secciones para reconfigurar este bloque de texto.";
z.g.TEXT_GET_SUBSTRING_END_FROM_END = "hasta la letra # del final";
z.g.TEXT_GET_SUBSTRING_END_FROM_START = "hasta la letra #";
z.g.TEXT_GET_SUBSTRING_END_LAST = "hasta la \u00faltima letra";
z.g.TEXT_GET_SUBSTRING_HELPURL =
  "https://github.com/google/blockly/wiki/Text#extracting-a-region-of-text";
z.g.TEXT_GET_SUBSTRING_INPUT_IN_TEXT = "en el texto";
z.g.TEXT_GET_SUBSTRING_START_FIRST = "obtener subcadena desde la primera letra";
z.g.TEXT_GET_SUBSTRING_START_FROM_END =
  "obtener subcadena desde la letra # del final";
z.g.TEXT_GET_SUBSTRING_START_FROM_START = "obtener subcadena desde la letra #";
z.g.TEXT_GET_SUBSTRING_TAIL = "";
z.g.TEXT_GET_SUBSTRING_TOOLTIP =
  "Devuelve una porci\u00f3n determinada del texto.";
z.g.TEXT_INDEXOF_HELPURL =
  "https://github.com/google/blockly/wiki/Text#finding-text";
z.g.TEXT_INDEXOF_OPERATOR_FIRST =
  "encontrar la primera aparici\u00f3n del texto";
z.g.TEXT_INDEXOF_OPERATOR_LAST =
  "encontrar la \u00faltima aparici\u00f3n del texto";
z.g.TEXT_INDEXOF_TITLE = "en el texto %1 %2 %3";
z.g.TEXT_INDEXOF_TOOLTIP =
...
z.g.TEXT_ISEMPTY_HELPURL =
  "https://github.com/google/blockly/wiki/Text#checking-for-empty-text";
z.g.TEXT_ISEMPTY_TITLE = "%1 est\u00e1 vac\u00edo";
z.g.TEXT_ISEMPTY_TOOLTIP =
  "Devuelve verdadero si el texto proporcionado est\u00e1 vac\u00edo.";
z.g.TEXT_JOIN_HELPURL =
  "https://github.com/google/blockly/wiki/Text#text-creation";
z.g.TEXT_JOIN_TITLE_CREATEWITH = "crear texto con";
z.g.TEXT_JOIN_TOOLTIP =
  "Crear un fragmento de texto al unir cualquier n\u00famero de elementos.";
z.g.TEXT_LENGTH_HELPURL =
  "https://github.com/google/blockly/wiki/Text#text-modification";
z.g.TEXT_LENGTH_TITLE = "longitud de %1";
z.g.TEXT_LENGTH_TOOLTIP =
  "Devuelve el n\u00famero de letras (espacios incluidos) del texto proporcionado.";
z.g.TEXT_PRINT_HELPURL =
  "https://github.com/google/blockly/wiki/Text#printing-text";
z.g.TEXT_PRINT_TITLE = "imprimir %1";
z.g.TEXT_PRINT_TOOLTIP =
  "Imprimir el texto, n\u00famero u otro valor especificado.";
z.g.TEXT_PROMPT_HELPURL =
  "https://github.com/google/blockly/wiki/Text#getting-input-from-the-user";
z.g.TEXT_PROMPT_TOOLTIP_NUMBER = "Solicitar al usuario un n\u00famero.";
z.g.TEXT_PROMPT_TOOLTIP_TEXT = "Solicitar al usuario un texto.";
z.g.TEXT_PROMPT_TYPE_NUMBER = "solicitar n\u00famero con el mensaje";
z.g.TEXT_PROMPT_TYPE_TEXT = "solicitar texto con el mensaje";
z.g.TEXT_REPLACE_HELPURL =
  "https://github.com/google/blockly/wiki/Text#replacing-substrings";
z.g.TEXT_REPLACE_MESSAGE0 = "reemplazar %1 con %2 en %3";
z.g.TEXT_REPLACE_TOOLTIP =
  "Reemplazar todas las veces que un texto dentro de otro texto.";
z.g.TEXT_REVERSE_HELPURL =
  "https://github.com/google/blockly/wiki/Text#reversing-text";
z.g.TEXT_REVERSE_MESSAGE0 = "invertir %1";
z.g.TEXT_REVERSE_TOOLTIP = "Invierte el orden de los caracteres en el texto.";
z.g.TEXT_TEXT_HELPURL = "https://es.wikipedia.org/wiki/Cadena_de_caracteres";
z.g.TEXT_TEXT_TOOLTIP = "Una letra, palabra o l\u00ednea de texto.";
z.g.TEXT_TRIM_HELPURL =
  "https://github.com/google/blockly/wiki/Text#trimming-removing-spaces";
z.g.TEXT_TRIM_OPERATOR_BOTH = "quitar espacios de ambos lados de";
z.g.TEXT_TRIM_OPERATOR_LEFT = "quitar espacios iniciales de";
z.g.TEXT_TRIM_OPERATOR_RIGHT = "quitar espacios finales de";
z.g.TEXT_TRIM_TOOLTIP =
  "Devuelve una copia del texto sin los espacios de uno o ambos extremos.";
z.g.TODAY = "Hoy";
z.g.UNDO = "Deshacer";
z.g.VARIABLES_DEFAULT_NAME = "elemento";
z.g.VARIABLES_GET_CREATE_SET = "Crear 'establecer %1'";
z.g.VARIABLES_GET_HELPURL =
  "https://github.com/google/blockly/wiki/Variables#get";
z.g.VARIABLES_GET_TOOLTIP = "Devuelve el valor de esta variable.";
z.g.VARIABLES_SET = "establecer %1 a %2";
z.g.VARIABLES_SET_CREATE_GET = "Crear 'obtener %1'";
z.g.VARIABLES_SET_HELPURL =
  "https://github.com/google/blockly/wiki/Variables#set";
z.g.VARIABLES_SET_TOOLTIP =
  "Establece esta variable para que sea igual a la entrada.";
z.g.VARIABLE_ALREADY_EXISTS = 'Ya existe una variable llamada "%1".';
z.g.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "Ya existe una variable nombrada '%1' para otra variable del tipo: '%2'.";
z.g.WORKSPACE_COMMENT_DEFAULT_TEXT = "Di algo\u2026";
...
var Y = {
  ...
  L: function() {
    ...
    "BlocklyStorage" in window
      ? ((BlocklyStorage.HTTPREQUEST_ERROR = W("Games_httpRequestError")),
        ...
        (BlocklyStorage.alert = X.ot.bind(X, a)),
        a && Nl(a, BlocklyStorage.link))
      : a && (a.style.display = "none");
    (a = document.getElementById("languageMenu")) &&
      a.addEventListener("change", Y.Vu, !0);
    z.J && (z.J.ou = !1);
    z.h && (z.h.ou = !1);
  },
  Gw: function(a, b) {
    if ("BlocklyStorage" in window && 1 < window.location.hash.length)
      ...
      var c = null;
      try {
        c = window.sessionStorage.ns;
      } catch (h) {}
      c && delete window.sessionStorage.ns;
      var e = Kl(V),
        f = b && Kl(V - 1);
  ...
  ct: function(a) {
    Y.Sh
      ? Y.Sh.setValue(a, -1)
      : ((a = z.D.fd(a)), O.clear(), z.D.ie(a, O), O.Gq());
  },
  Tn: function() {
  ...
  xx: function() {
    window.localStorage && (window.localStorage[Ml + V] = Y.Tn());
  },
  Nl: function() {
    window.location = (El ? "index.html" : "./") + "?lang=" + Cl;
  },
  Vu: function() {
    if (window.sessionStorage) {
      if (Y.Sh) var a = Y.Sh.getValue();
      else (a = z.D.Rp(O)), (a = z.D.wd(a));
      window.sessionStorage.ns = a;
    }
    a = document.getElementById("languageMenu");
  ...
  mo: function(a, b) {
    ...
    a.firstChild ||
      ((a = z.Qf(a, { rtl: -1 != Bl.indexOf(Cl), readOnly: !0 })),
  ...
  ke: function(a) {
    if (
      ("click" == a.type &&
        "touchend" == Y.ke.Yo &&
        Y.ke.Xo + 2e3 > Date.now()) ||
      (Y.ke.Yo == a.type && Y.ke.Xo + 400 > Date.now())
    )
...
var X = {
  ...
  yi: function(a, b, c, e, f, h) {
    ...
    e &&
      ...
      (e.id = "dialogHeader"),
      l.appendChild(e),
      (X.Bn = z.Zb(e, "mousedown", null, X.Cv)));
    l.appendChild(a);
    a.className = a.className.replace("dialogHiddenContent", "");
    c && b ? (X.am(b, !1, 0.2), X.am(l, !0, 0.8), setTimeout(k, 175)) : k();
  },
  nr: 0,
  pr: 0,
  Cv: function(a) {
  ...
  ad: function(a) {
    ...
    if (X.Qg) {
      ...
      e.style.opacity = 0;
      c && a ? (X.am(a, !1, 0.8), X.am(c, !0, 0.2), setTimeout(b, 175)) : b();
  ...
  Du: function() {
    if (!Kl(V))
      if (X.Qg || O.pb()) setTimeout(X.Du, 15e3);
        ...
        b.addEventListener("touchend", Y.Nl, !0);
        X.yi(
          a,
          null,
          !1,
          ...
          function() {
            document.body.removeEventListener("keydown", X.nq, !0);
          }
        );
  ...
  Dp: function() {
    ...
    if (!X.Dp.wx) {
      ...
      b.addEventListener("touchend", X.Rn, !0);
      X.Dp.wx = !0;
    }
    b = document.getElementById("submitButton");
    X.yi(a, b, !0, !0, { width: "40%", left: "30%", top: "3em" }, function() {
      document.body.removeEventListener("keydown", X.Dr, !0);
    });
  ...
  hv: function() {
    ...
    c =
      10 > V
        ? W("Games_nextLevel").replace("%1", String(V + 1))
        : W("Games_finalLevel");
    ...
    X.yi(
      ...
      { width: "40%", left: "30%", top: "3em" },
      function() {
        document.body.removeEventListener("keydown", X.Lq, !0);
      }
    );
  ...
  lr: function(a) {
    !X.Qg ||
      ...
      (X.ad(!0), a.stopPropagation(), a.preventDefault());
  },
  Ip: function() {
    document.body.addEventListener("keydown", X.lr, !0);
  },
  Jp: function() {
    document.body.removeEventListener("keydown", X.lr, !0);
  },
  Lq: function(a) {
  ...
  Dr: function(a) {
    27 == a.keyCode ? X.ad(!0) : 13 == a.keyCode && X.Rn();
  },
  Rn: function() {
...
z.J.lists_create_with = {
  L: function() {
    this.Pb = z.g.LISTS_CREATE_WITH_HELPURL;
  ...
  Ga: function() {
    ...
    a.setAttribute("items", this.Qd);
    return a;
  },
  fb: function(a) {
    this.Qd = parseInt(a.getAttribute("items"), 10);
    this.ld();
  },
  We: function(a) {
    ...
    for (var c = K(b, "STACK").connection, e = 0; e < this.Qd; e++) {
      var f = a.ef("lists_create_with_item");
      f.wc();
      c.connect(f.Y);
      c = f.K;
    }
  ...
  Ue: function(a) {
    var b = Jh(a, "STACK");
    for (a = []; b; ) a.push(b.Qp), (b = b.K && J(b.K));
    for (b = 0; b < this.Qd; b++) {
      var c = K(this, "ADD" + b).connection.Na;
      c && -1 == a.indexOf(c) && c.disconnect();
    }
    this.Qd = a.length;
    this.ld();
    for (b = 0; b < this.Qd; b++) Zg(a[b], this, "ADD" + b);
  },
  um: function(a) {
    a = Jh(a, "STACK");
    for (var b = 0; a; ) {
  ...
  ld: function() {
    ...
    for (var a = 0; a < this.Qd; a++)
      if (!K(this, "ADD" + a)) {
        var b = Gh(this, "ADD" + a);
        0 == a && P(b, z.g.LISTS_CREATE_WITH_INPUT_WITH);
      }
    for (; K(this, "ADD" + a); ) this.Ab("ADD" + a), a++;
  }
};
z.J.lists_create_with_container = {
  L: function() {
    this.qb(z.g.LISTS_HUE);
...
z.J.lists_indexOf = {
  L: function() {
    ...
    var b = this;
    this.La(function() {
      return z.g.LISTS_INDEX_OF_TOOLTIP.replace(
        "%1",
        b.o.options.ye ? "0" : "-1"
      );
    });
...
z.J.lists_getIndex = {
  L: function() {
    ...
    this.qb(z.g.LISTS_HUE);
    a = new Fh(a, function(a) {
      this.v.vt("REMOVE" == a);
    });
    P(Gh(this, "VALUE").bb("Array"), z.g.LISTS_GET_INDEX_INPUT_IN_LIST);
    ...
    this.La(function() {
      ...
      switch (a + " " + e) {
        ...
        case "GET LAST":
          ...
          break;
        case "GET RANDOM":
          f = z.g.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM;
          break;
        ...
        case "REMOVE FROM_END":
          ...
          break;
        case "REMOVE FIRST":
          f = z.g.LISTS_GET_INDEX_TOOLTIP_REMOVE_FIRST;
          break;
        case "REMOVE LAST":
      ...
      if ("FROM_START" == e || "FROM_END" == e)
        f +=
          "  " +
          ("FROM_START" == e
            ? z.g.LISTS_INDEX_FROM_START_TOOLTIP
            : z.g.LISTS_INDEX_FROM_END_TOOLTIP
          ).replace("%1", b.o.options.ye ? "#1" : "#0");
      return f;
    });
  },
  Ga: function() {
    ...
    a.setAttribute("at", K(this, "AT").type == z.Wa);
    return a;
  },
  fb: function(a) {
  ...
  vt: function(a) {
    a != !this.N &&
      (Ee(this, !0),
      a
        ? (this.Ed(!1), this.De(!0), this.Ce(!0))
        : (this.De(!1), this.Ce(!1), this.Ed(!0)));
  },
  kd: function(a) {
    this.Ab("AT");
    this.Ab("ORDINAL", !0);
    a
      ? (Gh(this, "AT").bb("Number"),
        z.g.ORDINAL_NUMBER_SUFFIX &&
          P(Q(this, "ORDINAL"), z.g.ORDINAL_NUMBER_SUFFIX))
      : Q(this, "AT");
...
z.J.lists_setIndex = {
  L: function() {
    ...
    Q(this, "AT");
    P(Gh(this, "TO"), z.g.LISTS_SET_INDEX_INPUT_TO);
    this.Dd(!0);
    this.De(!0);
    this.Ce(!0);
    ...
    this.La(function() {
      ...
      switch (a + " " + e) {
        ...
        case "INSERT FROM_END":
          f = z.g.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM;
          break;
        case "INSERT FIRST":
      ...
      if ("FROM_START" == e || "FROM_END" == e)
        f +=
          "  " +
          z.g.LISTS_INDEX_FROM_START_TOOLTIP.replace(
            "%1",
            b.o.options.ye ? "#1" : "#0"
          );
      return f;
...
z.J.lists_getSublist = {
  L: function() {
    ...
    Q(this, "AT2");
    z.g.LISTS_GET_SUBLIST_TAIL &&
      P(Q(this, "TAIL"), z.g.LISTS_GET_SUBLIST_TAIL);
    this.Dd(!0);
    this.Ed(!0, "Array");
    this.kd(1, !0);
    this.kd(2, !0);
  ...
  Ga: function() {
    ...
    a.setAttribute("at2", K(this, "AT2").type == z.Wa);
    return a;
  },
  fb: function(a) {
  ...
  kd: function(a, b) {
    ...
    this.Ab("ORDINAL" + a, !0);
    b
      ? (Gh(this, "AT" + a).bb("Number"),
        z.g.ORDINAL_NUMBER_SUFFIX &&
          P(Q(this, "ORDINAL" + a), z.g.ORDINAL_NUMBER_SUFFIX))
      : Q(this, "AT" + a);
    var c = new Fh(this["WHERE_OPTIONS_" + a], function(c) {
      var e = "FROM_START" == c || "FROM_END" == c;
      if (e != b) {
        var h = this.v;
        h.kd(a, e);
        I(h, "WHERE" + a).setValue(c);
        return null;
      }
    });
    ...
    1 == a &&
      (Ih(this, "AT1", "AT2"),
      K(this, "ORDINAL1") && Ih(this, "ORDINAL1", "AT2"));
...
z.J.lists_sort = {
  L: function() {
    Hh(this, {
      ...
      output: "Array",
      colour: z.g.LISTS_HUE,
      tooltip: z.g.LISTS_SORT_TOOLTIP,
      helpUrl: z.g.LISTS_SORT_HELPURL
    });
  }
};
z.J.lists_split = {
  ...
  zk: function(a) {
    "SPLIT" == a
      ? (this.N.bb("Array"), K(this, "INPUT").bb("String"))
      : (this.N.bb("String"), K(this, "INPUT").bb("Array"));
  },
  Ga: function() {
    var a = document.createElement("mutation");
...
z.aa.Sc.Jt = {
  ...
  Ld: 0,
  Ga: function() {
    if (!this.Xc && !this.Ld) return null;
    var a = document.createElement("mutation");
    this.Xc && a.setAttribute("elseif", this.Xc);
    this.Ld && a.setAttribute("else", 1);
    return a;
  },
  fb: function(a) {
    this.Xc = parseInt(a.getAttribute("elseif"), 10) || 0;
  ...
  We: function(a) {
    ...
    b.wc();
    for (var c = b.K, e = 1; e <= this.Xc; e++) {
      var f = a.ef("controls_if_elseif");
      f.wc();
      c.connect(f.Y);
      c = f.K;
    }
    this.Ld && ((a = a.ef("controls_if_else")), a.wc(), c.connect(a.Y));
    return b;
  },
  Ue: function(a) {
    var b = J(a.K);
    ...
    this.ld();
    for (b = 1; b <= this.Xc; b++)
      Zg(a[b], this, "IF" + b), Zg(c[b], this, "DO" + b);
    Zg(e, this, "ELSE");
  },
  um: function(a) {
    a = J(a.K);
  ...
  ld: function() {
    K(this, "ELSE") && this.Ab("ELSE");
    for (var a = 1; K(this, "IF" + a); )
      this.Ab("IF" + a), this.Ab("DO" + a), a++;
    for (a = 1; a <= this.Xc; a++)
      P(Gh(this, "IF" + a).bb("Boolean"), z.g.CONTROLS_IF_MSG_ELSEIF),
        P(this.ce(z.Qa, "DO" + a), z.g.CONTROLS_IF_MSG_THEN);
    this.Ld && P(this.ce(z.Qa, "ELSE"), z.g.CONTROLS_IF_MSG_ELSE);
  }
};
z.M.bp("controls_if_mutator", z.aa.Sc.Jt, null, [
  "controls_if_elseif",
  "controls_if_else"
]);
z.aa.Sc.Kt = function() {
  this.La(
    function() {
      if (this.Xc || this.Ld) {
        if (!this.Xc && this.Ld) return z.g.CONTROLS_IF_TOOLTIP_2;
        if (this.Xc && !this.Ld) return z.g.CONTROLS_IF_TOOLTIP_3;
        if (this.Xc && this.Ld) return z.g.CONTROLS_IF_TOOLTIP_4;
      } else return z.g.CONTROLS_IF_TOOLTIP_1;
      return "";
    }.bind(this)
  );
};
...
z.aa.Sc.eu = {
  onchange: function(a) {
    ...
    b &&
      ...
      (z.j.R(a.group),
      (a = this.Wj[0]),
      a !== b && (Ee(b), a && !a.hb && K(this, "A").connection.connect(a.N)),
      (b = this.Wj[1]),
      b !== c && (Ee(c), b && !b.hb && K(this, "B").connection.connect(b.N)),
      this.ob(),
      z.j.R(!1));
    this.Wj[0] = Jh(this, "A");
    this.Wj[1] = Jh(this, "B");
    ...
    if ((b || c) && e)
      for (var f = 0; 2 > f; f++) {
        ...
        h &&
          !Ne(h.N, e) &&
          (z.j.R(a.group),
          e === this.Qs ? (Ee(this), e.v.ob()) : (Ee(h), h.ob()),
          z.j.R(!1));
      }
    this.Qs = e;
  }
...
z.M.register(
  ...
  z.M.on("%{BKY_CONTROLS_FOREACH_TOOLTIP}")
);
z.aa.Ne.Lt = {
  iu: [
    "controls_repeat",
  ...
  onchange: function() {
    if (this.o.pb && !this.o.pb()) {
      ...
      a
        ? (this.Ee(null), this.tb || this.Nc(!1))
        : (this.Ee(z.g.CONTROLS_FLOW_STATEMENTS_WARNING),
          this.tb || Eh(this) || this.Nc(!0));
    }
  }
};
...
z.aa.Math.Zt = function() {
  uh(I(this, "PROPERTY"), function(a) {
...
z.aa.Math.cu = {
  zk: function(a) {
    "MODE" == a ? this.N.bb("Array") : this.N.bb("Number");
  },
  Ga: function() {
    var a = document.createElement("mutation");
  ...
  fb: function(a) {
    this.zk(a.getAttribute("op"));
  }
};
z.aa.Math.bu = function() {
  uh(
    I(this, "OP"),
    function(a) {
      this.zk(a);
...
z.J.procedures_defnoreturn = {
  L: function() {
    ...
    (this.o.options.Xi ||
      (this.o.options.Lb && this.o.options.Lb.options.Xi)) &&
      z.g.PROCEDURES_DEFNORETURN_COMMENT &&
      this.fh(z.g.PROCEDURES_DEFNORETURN_COMMENT);
  ...
  lg: function(a) {
    this.Ml !== a &&
      (a
        ? (P(this.ce(z.Qa, "STACK"), z.g.PROCEDURES_DEFNORETURN_DO),
          K(this, "RETURN") && Ih(this, "STACK", "RETURN"))
        : this.Ab("STACK", !0),
      (this.Ml = a));
  },
  yk: function() {
    for (var a = !1, b = {}, c = 0; c < this.ca.length; c++) {
      if (b["arg_" + this.ca[c].toLowerCase()]) {
        a = !0;
        break;
      }
      b["arg_" + this.ca[c].toLowerCase()] = !0;
    }
    a ? this.Ee(z.g.PROCEDURES_DEF_DUPLICATE_WARNING) : this.Ee(null);
    a = "";
    this.ca.length &&
      (a = z.g.PROCEDURES_BEFORE_PARAMS + " " + this.ca.join(", "));
    z.j.disable();
    try {
      I(this, "PARAMS").setValue(a);
    } finally {
      z.j.enable();
    }
  },
  Ga: function(a) {
    ...
    a && b.setAttribute("name", E(this, "NAME"));
    for (var c = 0; c < this.yb.length; c++) {
    ...
    this.Ml || b.setAttribute("statements", "false");
    return b;
  },
  fb: function(a) {
    this.ca = [];
  ...
  We: function(a) {
    var b = a.ef("procedures_mutatorcontainer");
    b.wc();
    K(this, "RETURN")
      ? I(b, "STATEMENTS").setValue(this.Ml ? "TRUE" : "FALSE")
      : K(b, "STATEMENT_INPUT").oa(!1);
    for (var c = K(b, "STACK").connection, e = 0; e < this.ca.length; e++) {
      var f = a.ef("procedures_mutatorarg");
      f.wc();
  ...
  Ue: function(a) {
    ...
    z.qa.Do(this);
    a = E(a, "STATEMENTS");
    if (null !== a && ((a = "TRUE" == a), this.Ml != a))
      if (a) this.lg(!0), Zg(this.He, this, "STACK"), (this.He = null);
      else {
        a = K(this, "STACK").connection;
        if ((this.He = a.Na)) (a = J(a)), Ee(a), a.ob();
        this.lg(!1);
      }
  },
  $e: function() {
    return [E(this, "NAME"), this.ca, !1];
  },
  Zn: function() {
    return this.ca;
  },
  ...
  ak: function(a, b) {
    ...
    if ("" == c.type) {
      c = c.name;
      b = this.o.Nd(b);
      for (var e = !1, f = 0; f < this.yb.length; f++)
        this.yb[f].$() == a &&
          ((this.ca[f] = b.name), (this.yb[f] = b), (e = !0));
      e && this.il(c, b.name);
    }
  },
  Jm: function(a) {
    for (var b = a.name, c = !1, e = 0; e < this.yb.length; e++)
      if (this.yb[e].$() == a.$()) {
        var f = this.ca[e];
        this.ca[e] = b;
        c = !0;
  ...
  il: function(a, b) {
    this.yk();
    if (this.bd.X())
      for (var c = Qc(this.bd.m), e = 0, f; (f = c[e]); e++)
  ...
  Ve: function(a) {
    if (!this.tb) {
      ...
      for (var f = 0; f < this.ca.length; f++)
        (c = F("arg")), c.setAttribute("name", this.ca[f]), e.appendChild(c);
      c = F("block", null, e);
      c.setAttribute("type", this.xq);
      b.eb = z.ba.Sk(this, c);
      a.push(b);
      if (!this.isCollapsed())
        for (f = 0; f < this.yb.length; f++)
          (b = { enabled: !0 }),
            (e = this.yb[f]),
            (c = e.name),
            (b.text = z.g.VARIABLES_SET_CREATE_GET.replace("%1", c)),
            (c = z.G.Er(e)),
            (c = F("block", null, c)),
...
z.J.procedures_defreturn = {
  L: function() {
    ...
    (this.o.options.Xi ||
      (this.o.options.Lb && this.o.options.Lb.options.Xi)) &&
      z.g.PROCEDURES_DEFRETURN_COMMENT &&
      this.fh(z.g.PROCEDURES_DEFRETURN_COMMENT);
    this.qb(z.g.PROCEDURES_HUE);
...
z.J.procedures_mutatorcontainer = {
  L: function() {
    P(Q(this), z.g.PROCEDURES_MUTATORCONTAINER_TITLE);
    this.ce(z.Qa, "STACK");
    P(
      P(Q(this, "STATEMENT_INPUT"), z.g.PROCEDURES_ALLOW_STATEMENTS),
      new yj("TRUE"),
      "STATEMENTS"
    );
    this.qb(z.g.PROCEDURES_HUE);
...
z.J.procedures_mutatorarg = {
  ...
  xv: function(a) {
    var b = $g(this.v.o);
    if (b)
      for (var c = 0; c < this.cj.length; c++) {
        var e = this.cj[c];
        e.name != a && b.Ff(e.$());
      }
  }
      ...
      if (Da(this.ca, a)) this.Ud = b;
        ...
        for (var f = 0; f < this.ca.length; f++) {
          ...
          h &&
            ...
            e &&
              h &&
              -1 == b.indexOf(this.Ud[f]) &&
              (h.disconnect(), h.v.ob()));
        }
        this.ca = [].concat(a);
        this.yb = [];
        for (f = 0; f < this.ca.length; f++)
          (a = z.G.Dl(this.o, null, this.ca[f], "")), this.yb.push(a);
        this.ld();
        if ((this.Ud = b))
          for (f = 0; f < this.ca.length; f++)
            (b = this.Ud[f]),
              b in this.ah &&
                ((h = this.ah[b]), Zg(h, this, "ARG" + f) || delete this.ah[b]);
        (this.P = c) && this.Z();
      }
  },
  ld: function() {
    for (var a = 0; a < this.ca.length; a++) {
      var b = I(this, "ARGNAME" + a);
      if (b) {
        z.j.disable();
        try {
          b.setValue(this.ca[a]);
        } finally {
          z.j.enable();
        }
      } else
        (b = new yh(this.ca[a])),
          P(Bh(Gh(this, "ARG" + a), z.yh), b, "ARGNAME" + a).L();
    }
    for (; K(this, "ARG" + a); ) this.Ab("ARG" + a), a++;
    if ((a = K(this, "TOPROW")))
      if (this.ca.length)
        I(this, "WITH") ||
          (P(a, z.g.PROCEDURES_CALL_BEFORE_PARAMS, "WITH"), a.L());
      else if (I(this, "WITH")) {
        b = 0;
        for (var c; (c = a.Ja[b]); b++)
          if ("WITH" === c.name) {
            c.A();
            a.Ja.splice(b, 1);
            a.v.P && (a.v.Z(), a.v.ob());
  ...
  onchange: function(a) {
    if (this.o && !this.o.Pd)
      if (a.type == z.j.Ct && -1 != a.cf.indexOf(this.id)) {
        ...
        !b ||
          (b.type == this.An &&
            JSON.stringify(b.ca) == JSON.stringify(this.ca)) ||
          (b = null);
        if (!b) {
          z.j.R(a.group);
          a = F("xml");
        ...
        a.type == z.j.Dt &&
          ((b = this.yd()),
          (b = z.qa.xl(b, this.o)),
          b || (z.j.R(a.group), this.A(!0, !1), z.j.R(!1)));
  },
  Ve: function(a) {
    var b = { enabled: !0 };
...
z.J.procedures_ifreturn = {
  L: function() {
    P(Gh(this, "CONDITION").bb("Boolean"), z.g.CONTROLS_IF_MSG_IF);
  ...
  Ga: function() {
    var a = document.createElement("mutation");
    a.setAttribute("value", Number(this.Nf));
    return a;
  },
  fb: function(a) {
    this.Nf = 1 == a.getAttribute("value");
    this.Nf ||
      (this.Ab("VALUE"), P(Q(this, "VALUE"), z.g.PROCEDURES_DEFRETURN_RETURN));
  },
  onchange: function() {
    if (this.o.pb && !this.o.pb()) {
      var a = !1,
      ...
      a
        ? ("procedures_defnoreturn" == b.type && this.Nf
            ? (this.Ab("VALUE"),
              P(Q(this, "VALUE"), z.g.PROCEDURES_DEFRETURN_RETURN),
              (this.Nf = !1))
          ...
          this.Ee(null),
          this.tb || this.Nc(!1))
        : (this.Ee(z.g.PROCEDURES_IFRETURN_WARNING),
          this.tb || Eh(this) || this.Nc(!0));
    }
  },
...
z.aa.G.Nt = {
  Ve: function(a) {
    if (!this.tb) {
      ...
      else (b = "variables_get"), (c = z.g.VARIABLES_SET_CREATE_GET);
      var e = { enabled: 0 < fd(this.o) },
        f = I(this, "VAR").Ib();
...
d.Fd = function() {
  Ol.s.Fd.call(this, mb || ob || qb);
  var a = z.H.ha;
  a.firstChild &&
    ((this.sb = document.createElement("div")),
    (this.sb.id = "notePicker"),
    a.appendChild(this.sb),
    (this.Vi = z.Zb(this.sb, "click", this, z.H.Fa)),
    (this.xs = z.Zb(this.sb, "mousemove", this, this.jm)),
    this.xk());
};
d.jm = function(a) {
  var b = this.sb.getBoundingClientRect();
...
d.setValue = function(a) {
  if (null !== a && a !== this.Ia) {
    this.Ia = a;
    var b = Pl[Number(a)];
    if (void 0 === b) throw "Invalid note value: " + a;
    this.vb(b);
  }
};
d.xk = function() {
...
z.h.L = function(a) {
  z.h.Df = Object.create(null);
  z.h.Qn = Object.create(null);
  z.h.Va ? z.h.Va.reset() : (z.h.Va = new Bk());
  z.h.Va.ra = a.ra;
  for (var b = [], c = z.G.Gu(a), e = 0; e < c.length; e++)
    b.push(z.h.Va.getName(c[e], "DEVELOPER_VARIABLE"));
  a = z.G.pq(a);
  for (e = 0; e < a.length; e++) b.push(z.h.Va.getName(a[e].$(), z.G.Xa));
  b.length && (z.h.Df.variables = "var " + b.join(", ") + ";");
};
z.h.finish = function(a) {
  var b = [],
    c;
  for (c in z.h.Df) b.push(z.h.Df[c]);
  delete z.h.Df;
  delete z.h.Qn;
  z.h.Va.reset();
  return b.join("\n\n") + "\n\n\n" + a;
...
z.h.oe = function(a, b, c, e, f) {
  c = c || 0;
  f = f || z.h.Ec;
  a.o.options.ye && c--;
  var h = a.o.options.ye ? "1" : "0";
  a =
    0 < c
      ? U(a, b, z.h.wg) || h
      : 0 > c
      ...
      ? U(a, b, z.h.Oi) || h
      : U(a, b, f) || h;
  if (z.Tf(a)) (a = parseFloat(a) + c), e && (a = -a);
  else {
    if (0 < c) {
      a = a + " + " + c;
      var k = z.h.wg;
    } else 0 > c && ((a = a + " - " + -c), (k = z.h.Gh));
    e && ((a = c ? "-(" + a + ")" : "-" + a), (k = z.h.Oi));
    k = Math.floor(k);
    f = Math.floor(f);
    k && f >= k && (a = "(" + a + ")");
...
z.h.zo = {};
z.h.lists_create_empty = function() {
  return ["[]", z.h.vf];
};
z.h.lists_create_with = function(a) {
  for (var b = Array(a.Qd), c = 0; c < a.Qd; c++)
    b[c] = U(a, "ADD" + c, z.h.kc) || "null";
  return ["[" + b.join(", ") + "]", z.h.vf];
};
z.h.lists_repeat = function(a) {
  var b = zk("listsRepeat", [
      "function " + z.h.pd + "(value, n) {",
      "  var array = [];",
      "  for (var i = 0; i < n; i++) {",
      "    array[i] = value;",
      "  }",
...
z.h.lists_length = function(a) {
  return [(U(a, "VALUE", z.h.kb) || "[]") + ".length", z.h.kb];
};
z.h.lists_isEmpty = function(a) {
  return ["!" + (U(a, "VALUE", z.h.kb) || "[]") + ".length", z.h.Mi];
};
z.h.lists_indexOf = function(a) {
  var b = "FIRST" == E(a, "END") ? "indexOf" : "lastIndexOf",
    c = U(a, "FIND", z.h.Ec) || "''";
  b = (U(a, "VALUE", z.h.kb) || "[]") + "." + b + "(" + c + ")";
  return a.o.options.ye ? [b + " + 1", z.h.wg] : [b, z.h.Ya];
};
z.h.lists_getIndex = function(a) {
  ...
  switch (c) {
    ...
    case "RANDOM":
      e =
        zk("listsGetRandomItem", [
          "function " + z.h.pd + "(list, remove) {",
...
z.h.lists_setIndex = function(a) {
  function b() {
    if (c.match(/^\w+$/)) return "";
    var a = Ak(z.h.Va, "tmpList", z.G.Xa),
      b = "var " + a + " = " + c + ";\n";
    c = a;
    return b;
  }
...
z.h.lists_sort = function(a) {
  ...
  a = E(a, "TYPE");
  var e = zk("listsGetSortCompare", [
    "function " + z.h.pd + "(type, direction) {",
    "  var compareFuncs = {",
...
z.h.lists_split = function(a) {
  var b = U(a, "INPUT", z.h.kb),
    c = U(a, "DELIM", z.h.Ec) || "''";
  a = E(a, "MODE");
...
z.h.lists_reverse = function(a) {
  return [(U(a, "LIST", z.h.Ya) || "[]") + ".slice().reverse()", z.h.Ya];
};
z.h.Iw = {};
z.h.controls_if = function(a) {
  var b = 0,
    c = "";
  do {
    var e = U(a, "IF" + b, z.h.Ec) || "false";
    var f = wk(a, "DO" + b);
    c += (0 < b ? " else " : "") + "if (" + e + ") {\n" + f + "}";
    ++b;
  } while (K(a, "IF" + b));
...
z.h.logic_operation = function(a) {
  var b = "AND" == E(a, "OP") ? "&&" : "||",
    c = "&&" == b ? z.h.Sm : z.h.Tm,
    e = U(a, "A", c);
  a = U(a, "B", c);
...
z.h.logic_negate = function(a) {
  var b = z.h.Mi;
  return ["!" + (U(a, "BOOL", b) || "true"), b];
};
z.h.logic_boolean = function(a) {
  return ["TRUE" == E(a, "BOOL") ? "true" : "false", z.h.vf];
};
z.h.logic_null = function() {
  return ["null", z.h.vf];
};
z.h.logic_ternary = function(a) {
  var b = U(a, "IF", z.h.Lk) || "false",
    c = U(a, "THEN", z.h.Lk) || "null";
  a = U(a, "ELSE", z.h.Lk) || "null";
  return [b + " ? " + c + " : " + a, z.h.Lk];
};
z.h.Kw = {};
z.h.controls_repeat_ext = function(a) {
  var b = I(a, "TIMES")
  ...
  c = xk(c, a.id);
  a = "";
  var e = Ak(z.h.Va, "count", z.G.Xa),
    f = b;
  b.match(/^\w+$/) ||
    z.Tf(b) ||
    ((f = Ak(z.h.Va, "repeat_end", z.G.Xa)),
    (a += "var " + f + " = " + b + ";\n"));
  return (
    a +
    ("for (var " +
...
z.h.controls_whileUntil = function(a) {
  var b = "UNTIL" == E(a, "MODE"),
...
z.h.controls_for = function(a) {
  ...
  if (z.Tf(c) && z.Tf(e) && z.Tf(f)) {
    ...
    (a = ""),
      ...
      c.match(/^\w+$/) ||
        z.Tf(c) ||
        ((k = Ak(z.h.Va, b + "_start", z.G.Xa)),
        (a += "var " + k + " = " + c + ";\n")),
      (c = e),
      e.match(/^\w+$/) ||
        z.Tf(e) ||
        ((c = Ak(z.h.Va, b + "_end", z.G.Xa)),
        (a += "var " + c + " = " + e + ";\n")),
      (e = Ak(z.h.Va, b + "_inc", z.G.Xa)),
      (a += "var " + e + " = "),
      (a = z.Tf(f)
        ? a + (Math.abs(f) + ";\n")
        : a + ("Math.abs(" + f + ");\n")),
...
z.h.controls_forEach = function(a) {
  var b = z.h.Va.getName(E(a, "VAR"), z.G.Xa),
    c = U(a, "LIST", z.h.xg) || "[]",
    e = wk(a, "DO");
  e = xk(e, a.id);
  ...
  var f = c;
  c.match(/^\w+$/) ||
    ((f = Ak(z.h.Va, b + "_list", z.G.Xa)),
    (a += "var " + f + " = " + c + ";\n"));
  c = Ak(z.h.Va, b + "_index", z.G.Xa);
  e = z.h.Me + b + " = " + f + "[" + c + "];\n" + e;
  return a + ("for (var " + c + " in " + f + ") {\n" + e + "}\n");
};
z.h.controls_flow_statements = function(a) {
  switch (E(a, "FLOW")) {
    case "BREAK":
      return "break;\n";
    case "CONTINUE":
...
z.h.Lw = {};
z.h.math_number = function(a) {
  a = parseFloat(E(a, "NUM"));
  return [a, 0 <= a ? z.h.vf : z.h.Oi];
};
z.h.math_arithmetic = function(a) {
  var b = {
      ADD: [" + ", z.h.wg],
      MINUS: [" - ", z.h.Gh],
      MULTIPLY: [" * ", z.h.Um],
  ...
  var e = U(a, "A", b) || "0";
  a = U(a, "B", b) || "0";
  return c ? [e + c + a, b] : ["Math.pow(" + e + ", " + a + ")", z.h.Ya];
};
...
z.h.math_constant = function(a) {
  return {
    PI: ["Math.PI", z.h.kb],
    E: ["Math.E", z.h.kb],
    GOLDEN_RATIO: ["(1 + Math.sqrt(5)) / 2", z.h.Mk],
    SQRT2: ["Math.SQRT2", z.h.kb],
    SQRT1_2: ["Math.SQRT1_2", z.h.kb],
    INFINITY: ["Infinity", z.h.vf]
  }[E(a, "CONSTANT")];
};
...
z.h.math_change = function(a) {
  var b = U(a, "DELTA", z.h.wg) || "0";
  a = z.h.Va.getName(E(a, "VAR"), z.G.Xa);
...
z.h.math_on_list = function(a) {
  ...
  switch (b) {
    ...
    case "MODE":
      ...
      break;
    case "STD_DEV":
      b = zk("mathStandardDeviation", [
        "function " + z.h.pd + "(numbers) {",
...
z.h.math_modulo = function(a) {
  var b = U(a, "DIVIDEND", z.h.Ni) || "0";
  a = U(a, "DIVISOR", z.h.Ni) || "0";
  return [b + " % " + a, z.h.Ni];
};
z.h.math_constrain = function(a) {
  var b = U(a, "VALUE", z.h.kc) || "0",
    c = U(a, "LOW", z.h.kc) || "0";
  a = U(a, "HIGH", z.h.kc) || "Infinity";
  return ["Math.min(Math.max(" + b + ", " + c + "), " + a + ")", z.h.Ya];
};
z.h.math_random_int = function(a) {
  var b = U(a, "FROM", z.h.kc) || "0";
  a = U(a, "TO", z.h.kc) || "0";
  return [
    zk("mathRandomInt", [
      "function " + z.h.pd + "(a, b) {",
...
z.h.math_random_float = function() {
  return ["Math.random()", z.h.Ya];
};
z.h.tx = {};
z.h.procedures_defreturn = function(a) {
  var b = z.h.Va.getName(E(a, "NAME"), z.qa.Xa),
    c = wk(a, "STACK");
  if (z.h.Ih) {
    var e = a.id.replace(/\$/g, "$$$$");
    c = vk(z.h.Ih.replace(/%1/g, "'" + e + "'"), z.h.Me) + c;
  }
  z.h.Jk && (c = z.h.Jk.replace(/%1/g, "'" + a.id + "'") + c);
  (e = U(a, "RETURN", z.h.Ec) || "") && (e = z.h.Me + "return " + e + ";\n");
  for (var f = [], h = 0; h < a.ca.length; h++)
    f[h] = z.h.Va.getName(a.ca[h], z.G.Xa);
  c = "function " + b + "(" + f.join(", ") + ") {\n" + c + e + "}";
  c = z.h.vm(a, c);
  z.h.Df["%" + b] = c;
  return null;
...
z.h.procedures_callreturn = function(a) {
  for (
    var b = z.h.Va.getName(E(a, "NAME"), z.qa.Xa), c = [], e = 0;
    e < a.ca.length;
    e++
  )
    c[e] = U(a, "ARG" + e, z.h.kc) || "null";
  return [b + "(" + c.join(", ") + ")", z.h.Ya];
};
z.h.procedures_callnoreturn = function(a) {
  for (
    var b = z.h.Va.getName(E(a, "NAME"), z.qa.Xa), c = [], e = 0;
    e < a.ca.length;
    e++
...
z.h.procedures_ifreturn = function(a) {
  var b = "if (" + (U(a, "CONDITION", z.h.Ec) || "false") + ") {\n";
  a.Nf
    ? ((a = U(a, "VALUE", z.h.Ec) || "null"),
      (b += z.h.Me + "return " + a + ";\n"))
    : (b += z.h.Me + "return;\n");
  return b + "}\n";
};
z.h.Sx = {};
z.h.variables_get = function(a) {
  return [z.h.Va.getName(E(a, "VAR"), z.G.Xa), z.h.vf];
};
z.h.variables_set = function(a) {
  var b = U(a, "VALUE", z.h.xg) || "0";
  return z.h.Va.getName(E(a, "VAR"), z.G.Xa) + " = " + b + ";\n";
}; /*
...
z.J.music_pitch = {
  L: function() {
    P(Q(this), new Ol("7"), "PITCH");
    this.Ed(!0, "Number");
    this.qb(z.g.MATH_HUE);
    this.La(W("Music_pitchTooltip"));
  }
};
z.h.music_pitch = function(a) {
  return [E(a, "PITCH"), z.h.vf];
};
z.J.music_note = {
  L: function() {
    var a = [
...
z.h.music_note = function(a) {
  var b = U(a, "PITCH", z.h.kc) || "7";
  return (
    "play(" + E(a, "DURATION") + ", " + b + ", 'block_id_" + a.id + "');\n"
  );
};
z.J.music_rest_whole = {
  L: function() {
    Hh(this, {
      ...
      nextStatement: null,
      colour: 160,
      tooltip: W("Music_restWholeTooltip")
    });
  }
};
z.h.music_rest_whole = function(a) {
...
z.h.music_rest = function(a) {
  return "rest(" + E(a, "DURATION") + ", 'block_id_" + a.id + "');\n";
};
z.J.music_instrument = {
  L: function() {
    Hh(this, {
      message0: W("Music_setInstrument"),
      args0: [
        {
          type: "field_dropdown",
          name: "INSTRUMENT",
      ...
      nextStatement: null,
      colour: 160,
      tooltip: W("Music_setInstrumentTooltip")
    });
  }
};
z.h.music_instrument = function(a) {
  return (
    "setInstrument('" + E(a, "INSTRUMENT") + "', 'block_id_" + a.id + "');\n"
  );
};
z.J.music_start = {
  L: function() {
    Hh(this, {
      message0: W("Music_start"),
      args0: [
        {
          type: "field_image",
          src: "music/play.png",
      ...
      colour: 0,
      tooltip: W("Music_startTooltip")
    });
  }
};
z.h.music_start = function(a) {
  Rl++;
  a = wk(a, "STACK");
...
10 > V &&
  ((z.J.procedures_defnoreturn.L = function() {
    var a = new ij("", z.qa.cp);
    a.kk = !1;
    P(P(P(Q(this), z.g.PROCEDURES_DEFNORETURN_TITLE), a, "NAME"), "", "PARAMS");
    this.qb(z.g.PROCEDURES_HUE);
  ...
  delete z.J.procedures_defreturn,
  delete z.J.procedures_ifreturn);
var Sl = {},
  Tl = {};
function Ul() {
  throw Error("Do not instantiate directly");
}
Ul.prototype.un = null;
...
Ul.prototype.Hm = function() {
  if (this.vn === Tl) return Id(this.toString());
  if (this.vn !== Sl)
    throw Error("Sanitized content was not of kind TEXT or HTML.");
  return Jd(this.toString(), this.un || null);
};
function Vl(a) {
  if (null != a)
    switch (a.un) {
...
Wl.prototype.vn = Sl;
function Xl(a) {
  return null != a && a.vn === Sl
    ? a
    : Yl(String(String(a)).replace(Zl, $l), Vl(a));
}
var Yl = (function(a) {
    function b() {}
...
function cm() {
  ...
  return (
    ...
    ('<div id="dialogStorage" class="dialogHiddenContent"><div id="containerStorage"></div>' +
      bm() +
      "</div>") +
    '<div id="helpUseFunctions" class="dialogHiddenContent"><div style="padding-bottom: 0.7ex">Tu soluci\u00f3n funciona, pero podr\u00eda ser mejor. Utiliza funciones para reducir la cantidad de c\u00f3digo repetido.</div>' +
    bm() +
    '</div><div id="help" class="dialogHiddenContent"><div style="padding-bottom: 0.7ex">' +
    (1 == V
      ? "Componga las primeras cuatro notas de 'Fr\u00e8re Jacques'.<p>C4 - D4 - E4 - C4</p>"
      : 2 == V
      ...
      ? "Compose anything you want. You've got a huge number of new blocks you can explore. Have fun!" +
        (El
          ? ""
          : "<br><br>Utiliza el bot\u00f3n \u00abVer galer\u00eda\u00bb para ver lo que otras personas han compuesto. Si compones una pieza interesante, utiliza el bot\u00f3n \u00abEnviar a la galer\u00eda\u00bb para publicarla.")
      : "") +
    "</div>" +
    bm() +
    "</div>"
...
function dm(a) {
  ...
  for (this.setValue(0.5); a && "svg" != a.nodeName.toLowerCase(); )
    a = a.parentNode;
  this.wa = a;
  gm(this.so, "mousedown", this, this.bs);
...
dm.prototype.bs = function(a) {
  ...
  lm = om(this, a).x;
  mm = 0;
  var b = this.ds.getAttribute("transform");
...
function im(a) {
  ...
  if (b) {
    ...
    a = om(b, a).x - lm + mm;
    b.setValue((a - b.Ah) / (b.Pm - b.Ah));
  }
}
dm.prototype.ux = function(a) {
  if ("touchstart" == a.type) {
    if (1 != a.changedTouches.length) return;
    nm(a);
  }
...
dm.prototype.getValue = function() {
  return this.Ia;
};
function pm(a, b) {
  function c(c) {
  ...
  for (; a.hn.length; ) clearTimeout(a.hn.pop());
  for (var e = a.getValue(), f = 0; 10 > f; f++)
    a.hn.push(setTimeout(c(f), (200 * f) / 10));
}
dm.prototype.setValue = function(a) {
  this.Ia = rc(a, 0, 1);
...
window.addEventListener("load", function() {
  ...
  O = z.Qf("blockly", {
    ...
    rtl: b,
    toolbox: l,
    zoom: { maxScale: 2, controls: !0, wheel: !0, startScale: k }
  });
  O.Fc(z.j.Ev);
  O.Fc(ym);
  yk(
  ...
  for (k = 0; k < l.length; k++)
    for (var n = 0; n < Pl.length; n++)
      m.push({ src: l[k] + "/" + Pl[n] + ".mp3", id: l[k] + n });
...
function Gm(a) {
  rm = a;
  for (var b = document.getElementById("staveBox"), c = 1; c <= a; c++) {
    var e = Hm(c, a),
...
function Im(a, b, c, e, f) {
  ...
  if ("0" == c || "12" == c)
    (c = document.createElement("img")),
      (c.src = "music/black1x1.gif"),
      (c.className = f + " ledgerLine"),
      (c.style.top = a + 32 + "px"),
      (c.style.left = b - 5 + "px"),
      h.appendChild(c);
}
...
function ym(a) {
  ...
  if (c) {
    var e = Km ? Km.length : 4,
      f = Rl;
    if (a instanceof yc) {
      for (var h = [], k = cd(O, !1), l = 0, m; (m = k[l]); l++)
        "music_start" == m.type && h.push(m);
      if (e < h.length)
        for (l = 0; (k = a.cf[l]); l++) {
          m = 0;
          for (var n; (n = h[m]); m++) n.id == k && n.Nc(!0);
        }
      e <= h.length
        ? (c.setAttribute("disabled", "true"), O.Im(b), (Rl = e))
        : (Rl = h.length);
      ...
      k = cd(O, !0);
      for (l = 0; (m = k[l]); l++)
        "music_start" == m.type && (m.disabled ? h : a).push(m);
      for (; e > a.length && h.length; ) (m = h.shift()), m.Nc(!1), a.push(m);
...
function Cm() {
  ...
  if (Km) {
    ...
    for (a = 0; a < Km.length; a++) {
      b = Km[a];
      for (var c = 0, e = 0; e < b.length; e += 2) {
        var f = b[e + 1];
...
function Om(a, b) {
  var c = function(a, b, c) {
    if (Z.kp) {
      for (var e = Infinity, f = 0, h; (h = um[f]); f++)
        h.kp && h.Xd < e && (e = h.Xd);
      for (f = 0; (h = um[f]); f++)
        if (e == h.Xd) {
          f = Z.Xd;
    ...
    if (10 > V) {
      ...
      var n = Z.Oc;
      f = n.length - 2;
      if (h[f] != n[f] || h[f + 1] != n[f + 1]) e = !0;
    }
    Im(Z.Xd, wm / 64, String(b), a, e ? "wrong" : "");
    Pm(c);
  };
  ...
  c = function(a, b) {
    Lm(Z);
    Z.mm = 64 * a + wm;
    1 < Z.Oc.length && -1 == Z.Oc[Z.Oc.length - 2]
      ? (Z.Oc[Z.Oc.length - 1] += a)
      : (Z.Oc.push(-1), Z.Oc.push(a));
    var c = !1;
    if (10 > V) {
      var e = Km[Z.Xd - 1],
        f = Z.Oc,
        m = f.length - 2;
      if (e[m] != f[m] || e[m + 1] < f[m + 1]) c = !0;
    }
    Im(Z.Xd, wm / 64, "-1", a, c ? "wrong" : "");
    Pm(b);
  };
...
function Nm() {
  if ("Interpreter" in window) {
    ...
    var a = tk();
    0 == Rl && Em();
    tm = new Interpreter(a, Om);
    for (a = 1; a <= Rl; a++) {
      var b = new Interpreter("");
      b.stateStack[0].scope = tm.global;
      b.appendCode("start" + a + "();\n");
      um.push(new Qm(a, b.stateStack));
    }
    setTimeout(Rm, 100);
  } else setTimeout(Nm, 250);
}
function Rm() {
  var a = (1e3 * (2.5 - 2 * Ql.getValue())) / 64;
  vm || (vm = Date.now() - wm * a);
  for (var b = !0, c = 0, e; (e = um[c]); c++)
    if (!e.done && ((b = !1), e.mm <= wm))
      a: {
        var f = void 0;
        Z = e;
        tm.stateStack = e.stateStack;
        tm.stateStack = e.stateStack;
        do {
          try {
            f = tm.step();
        ...
        Lm(e);
        e.ci && (Y.Aj(e.ci, !1), (e.ci = null));
        e.done = !0;
      }
  b
    ? (Sm() && (Y.xx(), 10 > V && ((Rl = 0), X.hv())),
      (document.getElementById("spinner").style.visibility = "hidden"),
      Pg(null),
      (xm = !0))
    : (Mm(), wm++, (qm = setTimeout(Rm, vm + wm * a - Date.now())));
}
function Lm(a) {
  var b = a.Fp;
...
function Mm() {
  var a = document.getElementById("musicBox"),
    ...
    e = 10 > V ? 200 : 100;
  e = wm ? Math.round((wm / 64) * 256 + 10 + e) : a.scrollWidth + e;
  for (c.width = e; sm < Math.floor(e / 256); )
    for (sm++, c = 1; c <= rm; c++) {
      var f = Hm(c, rm),
  ...
  a.scrollLeft = 4 * wm - 182;
}
function Pm(a) {
  a && (Z.ci && Y.Aj(Z.ci, !1), Y.Aj(a, !0), (Z.ci = a));
}
var Km = void 0;
function Bm() {
  function a(a) {
    return (b = b.concat(a).concat(a));
  }
  var b = [],
    c = [a([7, 0.25, 8, 0.25, 9, 0.25, 7, 0.25])],
  ...
  Km = [
    ...
    l,
    [b, [-1, 2].concat(b)],
    [b, [-1, 2].concat(b), [-1, 4].concat(b), [-1, 6].concat(b)],
    void 0
  ][V];
}
function Sm() {
  if (!Km) return !0;
  if (Km.length != um.length)
    return (
      console.log("Expected " + Km.length + " voices, found " + um.length), !1
    );
  for (var a = 0; a < Km.length; a++)
    if (um[a].Xd == a + 1 && !Da(Km[a], um[a].Oc)) return !1;
  if (
    6 == V &&
    ((a = tk()), -1 == a.indexOf("setInstrument") || -1 != a.indexOf("piano"))
  )
    return !1;
  ...
  a = 0;
  for (var f; (f = e[a]); a++)
    "music_instrument" == f.type || f.disabled || Eh(f) || c++;
  return b && c > b
    ? (console.log("Too many blocks.  Found: " + c + " Max: " + b),
      (a = document.getElementById("helpUseFunctions")),
      X.yi(a, null, !1, !0, { width: "30%", left: "35%", top: "12em" }, X.Jp),
      X.Ip(),
      !1)
    : !0;
}
