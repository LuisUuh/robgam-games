...
function L() {
    ...
    return '<div style="display: none"><span id="title">Juegos de Blockly</span><span id="Index_clear">\u00bfBorrar todas tus soluciones?</span></div><div id="header"><img id="banner" src="index/title-beta.png" height="51" width="244" alt="Blockly Games"><div id="subtitle">Juegos para los programadores del futuro. &nbsp;' + (a.j ? '<a href="about.html?lang=' + G(a.lang) + '">' : '<a href="about?lang=' + G(a.lang) + '">') + 'M\u00e1s informaci\u00f3n...</a></div></div><svg height="100%" width="100%" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g transform="translate(-80,-60)"><svg height="100%" width="100%" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 100 100" preserveAspectRatio="none" x=80 y=60><path id="path" d="M 10,15 C 15,60 35,100 50,70 S 80,20 90,85"' +
        (a.m ? 'transform="translate(100) scale(-1, 1)"' : "") + "/></svg>" + M({
            ...
            x: 83,
            y: 55,
            h: "Tutor del estanque"
        }, a) + M({
            g: "pond-duck",
            x: 90,
            y: 85,
            h: "Estanque"
        }, a) + '</g></svg><select id="languageMenu"></select><p id="clearDataPara" style="visibility: hidden">\u00bfQuieres empezar de nuevo?<button class="secondary" id="clearData">Borrar datos</span></button></p>'
}
