...
function Sa(a) {
  ...
  return a.replace(Ta, function(a, f) {
    var e = b[a];
    if (e) return e;
    "#" == f.charAt(0) &&
...
function hb(a) {
  var b = arguments.length;
  if (1 == b && u(arguments[0])) return hb.apply(null, arguments[0]);
...
yb =
  zb && A
    ? sb() || ("CSS1Compat" == zb.compatMode ? parseInt(tb, 10) : 5)
    : void 0;
...
Hb.prototype.A = function() {
  if (!this.ei && ((this.ei = !0), this.Na(), 0 != Ib)) {
    var a = ia(this);
    if (0 != Ib && this.sf && 0 < this.sf.length)
      throw Error(
        this +
...
function Kb(a, b) {
  a.ei
    ? aa(void 0)
      ? b.call(void 0)
      : b()
    : (a.sf || (a.sf = []), a.sf.push(aa(void 0) ? na(b, void 0) : b));
}
Hb.prototype.Na = function() {
  if (this.sf) for (; this.sf.length; ) this.sf.shift()();
};
function Lb(a) {
...
function Nb(a) {
  return C ? "webkit" + a : lb ? "o" + a.toLowerCase() : a.toLowerCase();
}
var Ob = {
    lz: "click",
    EB: "rightclick",
...
Qb.prototype.stopPropagation = function() {
  Qb.s.stopPropagation.call(this);
  this.Ae.stopPropagation
    ? this.Ae.stopPropagation()
    : (this.Ae.cancelBubble = !0);
};
Qb.prototype.preventDefault = function() {
  Qb.s.preventDefault.call(this);
  var a = this.Ae;
  if (a.preventDefault) a.preventDefault();
  else if (((a.returnValue = !1), Cb))
    try {
...
Zb.prototype.add = function(a, b, c, e, f) {
  var h = a.toString();
  a = this.Gc[h];
  a || ((a = this.Gc[h] = []), this.Mk++);
  var k = $b(a, b, e, f);
  -1 < k
    ? ((b = a[k]), c || (b.kl = !1))
    : ((b = new Xb(b, this.src, h, !!e, f)), (b.kl = c), a.push(b));
  return b;
};
Zb.prototype.remove = function(a, b, c, e) {
  a = a.toString();
  if (!(a in this.Gc)) return !1;
  var f = this.Gc[a];
  b = $b(f, b, c, e);
  return -1 < b
    ? (Yb(f[b]),
      Array.prototype.splice.call(f, b, 1),
      0 == f.length && (delete this.Gc[a], this.Mk--),
      !0)
    : !1;
};
function ac(a, b) {
  ...
  c in a.Gc &&
    ya(a.Gc[c], b) &&
    (Yb(b), 0 == a.Gc[c].length && (delete a.Gc[c], a.Mk--));
}
Zb.prototype.removeAll = function(a) {
  ...
  for (c in this.Gc)
    if (!a || c == a) {
      for (var e = this.Gc[c], f = 0; f < e.length; f++) ++b, Yb(e[f]);
      delete this.Gc[c];
      this.Mk--;
    }
  return b;
};
Zb.prototype.Fj = function(a, b, c, e) {
  a = this.Gc[a.toString()];
  var f = -1;
  a && (f = $b(a, b, c, e));
  return -1 < f ? a[f] : null;
};
function $b(a, b, c, e) {
  for (var f = 0; f < a.length; ++f) {
    var h = a[f];
    if (!h.Ji && h.listener == b && h.capture == !!c && h.bm == e) return f;
  }
  return -1;
}
...
function ec(a, b, c, e, f) {
  if (e && e.once) return fc(a, b, c, e, f);
  if (u(b)) {
    for (var h = 0; h < b.length; h++) ec(a, b[h], c, e, f);
    return null;
  }
  c = gc(c);
  return Vb(a)
...
function fc(a, b, c, e, f) {
  if (u(b)) {
    for (var h = 0; h < b.length; h++) fc(a, b[h], c, e, f);
    return null;
  }
  c = gc(c);
  return Vb(a)
    ? a.zs(b, c, ha(e) ? !!e.capture : !!e, f)
    : hc(a, b, c, !0, e, f);
}
function mc(a, b, c, e, f) {
  if (u(b)) for (var h = 0; h < b.length; h++) mc(a, b[h], c, e, f);
  else
    (e = ha(e) ? !!e.capture : !!e),
      (c = gc(c)),
      Vb(a)
        ? a.sd(b, c, e, f)
        : a && (a = ic(a)) && (b = a.Fj(b, c, e, f)) && nc(b);
}
function nc(a) {
  if (!r(a) && a && !a.Ji) {
    var b = a.src;
    if (Vb(b)) ac(b.jf, a);
      ...
      b.removeEventListener
        ...
        : b.detachEvent
        ? b.detachEvent(kc(c), e)
        : b.addListener && b.removeListener && b.removeListener(e);
      dc--;
      (c = ic(b))
        ? (ac(c, a), 0 == c.Mk && ((c.src = null), (b[bc] = null)))
        : Yb(a);
    }
  }
}
...
function lc(a, b) {
  ...
  if (!Bb) {
    ...
    if (!(0 > e.keyCode || void 0 != e.returnValue)) {
      ...
      a = a.type;
      for (f = e.length - 1; !b.rh && 0 <= f; f--) {
        b.currentTarget = e[f];
        var h = oc(e[f], a, !0, b);
        c = c && h;
      }
      for (f = 0; !b.rh && f < e.length; f++)
        (b.currentTarget = e[f]), (h = oc(e[f], a, !1, b)), (c = c && h);
    }
    return c;
  }
...
x.mg = function() {
  x.pm && (clearTimeout(x.pm), (x.pm = 0));
};
x.Touch.df = function() {
  x.Touch.Kk = null;
};
x.Touch.Tp = function(a) {
  return !x.Touch.nx(a) || x.Touch.Iv(a);
};
x.Touch.Zl = function(a) {
...
x.Touch.Iv = function(a) {
  var b = x.Touch.Zl(a);
  return void 0 != x.Touch.Kk && null != x.Touch.Kk
    ? x.Touch.Kk == b
    : "mousedown" == a.type || "touchstart" == a.type || "pointerdown" == a.type
    ? ((x.Touch.Kk = b), !0)
    : !1;
};
x.Touch.ky = function(a) {
  if (Ea(a.type, "touch")) {
...
x.j.Xi = [];
x.j.V = function(a) {
  x.j.isEnabled() && (x.j.Xi.length || setTimeout(x.j.vw, 0), x.j.Xi.push(a));
};
x.j.vw = function() {
  for (
    var a = x.j.filter(x.j.Xi, !0), b = (x.j.Xi.length = 0), c;
    (c = a[b]);
    b++
  ) {
    var e = zc[c.Kc] || null;
    if (e) {
      var f = c;
      f.oc &&
        (e.Gh.push(f), (e.rk.length = 0), e.Gh.length > e.Lu && e.Gh.unshift());
      for (var h = 0; (c = e.Hc[h]); h++) c(f);
    }
  }
};
x.j.filter = function(a, b) {
  ...
  for (var c = [], e = Object.create(null), f = 0, h; (h = a[f]); f++)
    if (!h.ui()) {
      var k = [h.type, h.fc, h.Kc].join(" "),
        l = e[k];
      l
        ? h.type == x.j.aj
          ? ((l.oh = h.oh), (l.nh = h.nh), (l.pg = h.pg))
          : h.type == x.j.Nh && h.element == l.element && h.name == l.name
  ...
  b || a.reverse();
  for (f = 1; (h = a[f]); f++)
    h.type == x.j.Nh && "mutation" == h.element && a.unshift(a.splice(f, 1)[0]);
  return a;
};
x.j.Kv = function() {
  for (var a = 0, b; (b = x.j.Xi[a]); a++) b.oc = !1;
};
x.j.disable = function() {
  x.j.Xn++;
};
x.j.enable = function() {
  x.j.Xn--;
};
x.j.isEnabled = function() {
  return 0 == x.j.Xn;
};
x.j.Ac = function() {
  return x.j.$l;
...
x.j.S = function(a) {
  x.j.$l = "boolean" == typeof a ? (a ? x.i.Be() : "") : a;
};
x.j.Ur = function(a) {
  var b = [];
  a = Ac(a, !1);
...
x.j.vC = function(a) {
  if (a.type == x.j.aj || a.type == x.j.Wk) {
    var b = zc[a.Kc] || null;
    if ((a = Nc(b, a.fc)))
      if (a.getParent() && !a.getParent().disabled) {
        b = Ac(a, !1);
        a = 0;
        for (var c; (c = b[a]); a++) c.Pd(!1);
      } else if ((a.M || a.$) && !b.sb()) {
        do a.Pd(!0), (a = Oc(a));
        while (a);
      }
...
Pc.prototype.la = function(a) {
  this.group = a.group;
};
Pc.prototype.ui = function() {
  return !1;
};
...
function Rc(a) {
  Rc.s.constructor.call(this);
  this.Ig = a.ba();
  this.Kc = a.o.id;
}
w(Rc, Pc);
Rc.prototype.Ca = function() {
  var a = Rc.s.Ca.call(this);
  a.varId = this.Ig;
  return a;
};
Rc.prototype.la = function(a) {
  Rc.s.Ca.call(this);
  this.Ig = a.varId;
};
function Fc(a) {
  a && (Fc.s.constructor.call(this, a), (this.Kh = a.type), (this.Jh = a.name));
}
w(Fc, Rc);
Fc.prototype.type = x.j.Aq;
Fc.prototype.Ca = function() {
  var a = Fc.s.Ca.call(this);
  a.varType = this.Kh;
  a.varName = this.Jh;
  return a;
};
Fc.prototype.la = function(a) {
  Fc.s.la.call(this, a);
  this.Kh = a.varType;
  this.Jh = a.varName;
};
...
function Gc(a) {
  a && (Gc.s.constructor.call(this, a), (this.Kh = a.type), (this.Jh = a.name));
}
w(Gc, Rc);
Gc.prototype.type = x.j.Bq;
Gc.prototype.Ca = function() {
  var a = Gc.s.Ca.call(this);
  a.varType = this.Kh;
  a.varName = this.Jh;
  return a;
};
Gc.prototype.la = function(a) {
  Gc.s.la.call(this, a);
  this.Kh = a.varType;
  this.Jh = a.varName;
};
Gc.prototype.run = function(a) {
  var b = Qc(this);
  a ? b.Tf(this.Ig) : b.ed(this.Jh, this.Kh, this.Ig);
};
function Hc(a, b) {
  a && (Hc.s.constructor.call(this, a), (this.bp = a.name), (this.Yo = b));
}
w(Hc, Rc);
Hc.prototype.type = x.j.Cq;
Hc.prototype.Ca = function() {
  var a = Hc.s.Ca.call(this);
  a.oldName = this.bp;
  a.newName = this.Yo;
  return a;
};
Hc.prototype.la = function(a) {
  Hc.s.la.call(this, a);
  this.bp = a.oldName;
  this.Yo = a.newName;
};
...
d.xp = function(a, b) {
  ...
  try {
    if (c && c.ba() != a.ba()) {
      var f = a.type;
      b != c.name && Uc(c, b, e);
      for (b = 0; b < e.length; b++) e[b].wk(a.ba(), c.ba());
      x.j.V(new Gc(a));
      this.ua[f].splice(this.Kj(f).indexOf(a), 1);
    } else Uc(a, b, e);
  } finally {
    x.j.S(!1);
  }
...
d.ed = function(a, b, c) {
  ...
  this.ua[b] ? this.ua[b].push(e) : (this.ua[b] = [e]);
  return e;
};
d.Tf = function(a) {
  var b = this.fe(a);
  if (b) {
    ...
    for (var f; (f = e[a]); a++)
      if (
        ...
        a = F(f, "NAME");
        c = x.g.CANNOT_DELETE_VARIABLE_PROCEDURE.replace("%1", c).replace(
          "%2",
          a
        );
        x.alert(c);
    ...
    var h = this;
    1 < e.length
      ? ((c = x.g.DELETE_VARIABLE_CONFIRMATION.replace(
          "%1",
          String(e.length)
        ).replace("%2", c)),
        x.confirm(c, function(a) {
          a && h.Al(b, e);
        }))
      : h.Al(b, e);
...
d.Sc = function(a, b) {
  if ((b = this.ua[b || ""]))
    for (var c = 0, e; (e = b[c]); c++) if (Wc(e.name, a)) return e;
  return null;
};
d.fe = function(a) {
  for (var b = Object.keys(this.ua), c = 0; c < b.length; c++)
...
d.uo = function() {
  for (var a = Object.keys(this.ua), b = !1, c = 0; c < a.length; c++)
    "" == a[c] && (b = !0);
  b || a.push("");
  return a;
};
d.kf = function() {
  for (var a = [], b = Object.keys(this.ua), c = 0; c < b.length; c++)
    a = a.concat(this.ua[b[c]]);
  return a;
};
d.vo = function(a) {
  for (var b = [], c = Tc(this.o), e = 0; e < c.length; e++) {
    var f = c[e].Wf();
    if (f) for (var h = 0; h < f.length; h++) f[h].ba() == a && b.push(c[e]);
  }
  return b;
};
function Xc(a) {
...
Xc.prototype.Ca = function() {
  var a = { type: this.type };
  this.group && (a.group = this.group);
  this.Yd && (a.commentId = this.Yd);
  return a;
};
Xc.prototype.la = function(a) {
  this.Yd = a.commentId;
  this.group = a.group;
};
function Kc(a, b, c) {
  a && (Kc.s.constructor.call(this, a), (this.Ns = b), (this.vm = c));
}
w(Kc, Xc);
d = Kc.prototype;
d.type = x.j.jq;
d.Ca = function() {
  var a = Kc.s.Ca.call(this);
  a.newContents = this.vm;
  return a;
};
d.la = function(a) {
  Kc.s.la.call(this, a);
...
d.ui = function() {
  return this.Ns == this.vm;
};
d.run = function(a) {
  var b = Yc(Qc(this), this.Yd);
  b
    ? b.Od(a ? this.vm : this.Ns)
    : console.warn("Can't change non-existent comment: " + this.Yd);
};
function Jc(a) {
  a && (Jc.s.constructor.call(this, a), (this.xml = a.Jk()));
}
w(Jc, Xc);
Jc.prototype.type = x.j.kq;
Jc.prototype.Ca = function() {
  var a = Jc.s.Ca.call(this);
  a.xml = x.F.Gd(this.xml);
  return a;
};
Jc.prototype.la = function(a) {
  Jc.s.la.call(this, a);
  this.xml = x.F.Xc("<xml>" + a.xml + "</xml>").firstChild;
};
Jc.prototype.run = function(a) {
  var b = Qc(this);
  a
    ? ((a = G("xml")), a.appendChild(this.xml), x.F.ae(a, b))
    : (b = Yc(b, this.Yd))
    ? b.A(!1, !1)
    : console.warn("Can't uncreate non-existent comment: " + this.Yd);
};
function Mc(a) {
  a && (Mc.s.constructor.call(this, a), (this.xml = a.Jk()));
}
w(Mc, Xc);
Mc.prototype.type = x.j.lq;
Mc.prototype.Ca = function() {
  return Mc.s.Ca.call(this);
};
Mc.prototype.la = function(a) {
  Mc.s.la.call(this, a);
};
Mc.prototype.run = function(a) {
  var b = Qc(this);
  a
    ? (b = Yc(b, this.Yd))
      ? b.A(!1, !1)
...
d.type = x.j.mq;
d.Ca = function() {
  var a = Lc.s.Ca.call(this);
  this.mh &&
    (a.newCoordinate = Math.round(this.mh.x) + "," + Math.round(this.mh.y));
  return a;
};
d.la = function(a) {
  Lc.s.la.call(this, a);
  a.newCoordinate &&
    ...
    (this.mh = new D(parseFloat(a[0]), parseFloat(a[1]))));
};
d.ui = function() {
  return vc(this.ap, this.mh);
};
d.run = function(a) {
  var b = Yc(Qc(this), this.Yd);
  if (b) {
  ...
  } else console.warn("Can't move non-existent comment: " + this.Yd);
};
function Zc(a, b, c, e, f) {
  this.id = f && !Yc(a, f) ? f : x.i.Be();
  a.Ri.push(this);
  a.vl[this.id] &&
    console.warn(
...
d.A = function() {
  if (this.o) {
    x.j.isEnabled() && x.j.V(new Mc(this));
    var a = this.o;
    if (!ya(a.Ri, this))
...
d.Je = function() {
  return this.lk && !(this.o && this.o.options.readOnly);
};
d.xh = function(a) {
  this.lk = a;
};
...
d.Od = function(a) {
  this.dd != a && (x.j.V(new Kc(this, this.dd, a)), (this.dd = a));
};
d.Jk = function(a) {
  a = ad(this, a);
...
function bd(a) {
  ...
  return {
    ...
    Zr: b ? parseInt(b, 10) : 100,
    Ut: c ? parseInt(c, 10) : 100,
...
function Tc(a) {
  var b = fd(a, !1);
  for (a = 0; a < b.length; a++) b.push.apply(b, b[a].Vf(!1));
  return b;
}
d.clear = function() {
  this.Jo = !0;
  try {
    var a = x.j.Ac();
    for (a || x.j.S(!0); this.Qi.length; ) this.Qi[0].A();
    for (; this.Ri.length; ) this.Ri[this.Ri.length - 1].A();
    a || x.j.S(!1);
    this.ua.clear();
...
d.rf = function(a, b) {
  return new hd(this, a, b);
};
function id(a) {
  return isNaN(a.options.Ds) ? Infinity : a.options.Ds - Tc(a).length;
}
d.eq = function(a) {
  var b = a ? this.rk : this.Gh,
    c = a ? this.Gh : this.rk,
    e = b.pop();
  if (e) {
...
nd.prototype.toString = function() {
  return "Const{" + this.Zp + "}";
};
function pd(a) {
  return a instanceof nd && a.constructor === nd && a.Zu === od
    ? a.Zp
    : "type_error:Const";
}
var od = {};
...
qd.prototype.dg = !0;
qd.prototype.Ge = function() {
  return this.gt;
};
qd.prototype.Fo = !0;
qd.prototype.mi = function() {
  return 1;
};
var rd = {};
function sd() {
...
sd.prototype.Fo = !0;
sd.prototype.mi = function() {
  return 1;
};
function ud(a) {
  if (a instanceof sd && a.constructor === sd && a.Vu === td) return a.qh;
  ea(a);
...
function wd(a) {
  ...
  vd.test(a) || (a = "about:invalid#zClosurez");
  return xd(a);
}
var td = {};
function xd(a) {
...
yd.prototype.dg = !0;
var zd = {};
yd.prototype.Ge = function() {
  return this.tp;
};
yd.prototype.fm = function(a) {
  this.tp = a;
  return this;
};
var Ad = new yd().fm("");
function Bd(a) {
  ...
  for (c in a) {
    ...
    var e = a[c];
    null != e &&
      ((e = u(e) ? ua(e, Cd).join(" ") : Cd(e)), (b += c + ":" + e + ";"));
  }
  return b ? new yd().fm(b) : Ad;
}
function Cd(a) {
  if (a instanceof sd)
    a =
    ...
    a = String(a);
    var b = a.replace(Dd, "$1").replace(Ed, "url");
    if ((b = Fd.test(b))) {
...
function Gd(a) {
  return a.replace(Ed, function(a, c, e, f) {
    var b = "";
...
function Kd(a) {
  if (a instanceof Id && a.constructor === Id && a.Tu === Jd) return a.qh;
  ea(a);
...
function Ld(a) {
  ...
  var b = null;
  a.Fo && (b = a.mi());
  return Md(Ja(a.dg ? a.Ge() : String(a)), b);
}
var Nd = /^[a-zA-Z0-9-]+$/,
  Od = {
    action: !0,
    ...
    for (n in b) {
      ...
      if (null != k) {
        ...
        if (k instanceof nd) k = pd(k);
          ...
          k instanceof yd && k.constructor === yd && k.Uu === zd
            ? (k = k.tp)
          ...
          if (m.toLowerCase() in Od)
            if (k instanceof qd)
              k instanceof qd && k.constructor === qd && k.av === rd
                ? (k = k.gt)
...
var Jd = {};
function Md(a, b) {
  return new Id().fm(a, b);
}
Id.prototype.fm = function(a, b) {
  this.qh = a;
  this.Gr = b;
  return this;
};
...
function Wd(a) {
  return a ? new Xd(Yd(a)) : qa || (qa = new Xd());
}
function Zd(a, b, c, e) {
  a = e || a;
  ...
  if (c) {
    ...
    for (h = f = 0; (k = a[h]); h++)
      (b = k.className),
        "function" == typeof b.split && xa(b.split(/\s+/), c) && (e[f++] = k);
    e.length = f;
    return e;
  }
  return a;
...
function ce(a) {
  ...
  return A && xb("10") && a.pageYOffset != b.scrollTop
...
function ee(a, b) {
  var c = String(b[0]),
    e = b[1];
  if (!jd && e && (e.name || e.type)) {
    c = ["<", c];
    e.name && c.push(' name="', Ja(e.name), '"');
    if (e.type) {
      c.push(' type="', Ja(e.type), '"');
      var f = {};
      fb(f, e);
      delete f.type;
      e = f;
  ...
  c = a.createElement(c);
  e &&
    (q(e) ? (c.className = e) : u(e) ? (c.className = e.join(" ")) : $d(c, e));
  2 < b.length && fe(a, c, b, 2);
  return c;
}
function fe(a, b, c, e) {
  function f(c) {
  ...
  for (; e < c.length; e++) {
    var h = c[e];
    !fa(h) || (ha(h) && 0 < h.nodeType) ? f(h) : sa(ge(h) ? Aa(h) : h, f);
  }
}
function he(a) {
...
function ke(a, b) {
  ...
  } else he(a), a.appendChild(Yd(a).createTextNode(String(b)));
}
...
function Xd(a) {
  this.fd = a || g.document || document;
}
d = Xd.prototype;
d.Yb = Wd;
d.G = function(a) {
  return q(a) ? this.fd.getElementById(a) : a;
};
d.getElementsByTagName = function(a, b) {
  return (b || this.fd).getElementsByTagName(String(a));
};
d.setProperties = $d;
d.T = function(a, b, c) {
  return ee(this.fd, arguments);
};
d.createElement = function(a) {
  return this.fd.createElement(String(a));
};
...
d.qf = function(a) {
  ...
  (b =
    ...
    "SELECT" == a.tagName ||
    "BUTTON" == a.tagName
      ? !a.disabled && (!oe(a) || pe(a))
      : ne(a)) && A
    ? ((a =
        !v(a.getBoundingClientRect) || (A && null == a.parentElement)
...
function ue(a, b, c, e, f, h) {
  ...
  this.wg && we(this);
  (f && h) ||
    ((b = this.dd.getBBox()), (f = b.width + 2 * xe), (h = b.height + 2 * xe));
  this.yg(f, h);
  we(this);
  ye(this);
  this.wg = !0;
  a.options.readOnly ||
    (x.O(this.hj, "mousedown", this, this.Av),
    this.Mb && x.O(this.Mb, "mousedown", this, this.zp));
}
var xe = 6,
  ve = 20,
  ze = null,
...
d.oj = function(a, b) {
  ...
  var c = { filter: "url(#" + this.m.options.Nr + ")" };
  -1 != Ya.indexOf("JavaFX") && (c = {});
  c = x.i.B("g", c, this.cd);
  this.Dn = x.i.B("path", {}, c);
  this.hj = x.i.B(
    "rect",
    { class: "blocklyDraggable", x: 0, y: 0, rx: xe, ry: xe },
    c
  );
  b
    ? ((this.Mb = x.i.B(
...
function De(a, b) {
  a.cd.dataset && (a.cd.dataset.fc = b);
}
d.Av = function(a) {
  var b = this.m.Ee(a);
...
d.zp = function(a) {
  ...
  Be();
  x.i.jg(a) ||
    (this.m.Vm(a, new D(this.m.u ? -this.ma : this.ma, this.Fa)),
    (ze = x.O(document, "mouseup", this, Ce)),
    (Ae = x.O(document, "mousemove", this, this.Ap)),
    x.Qb());
  a.stopPropagation();
};
d.Ap = function(a) {
...
function Ee(a) {
  var b = a.cd.parentNode;
  return b.lastChild !== a.cd ? (b.appendChild(a.cd), !0) : !1;
}
function we(a) {
  var b = a.Bd.x;
  b = a.m.u ? b - (a.Ii + a.ma) : b + a.Ii;
  a.moveTo(b, a.tk + a.Bd.y);
}
d.moveTo = function(a, b) {
  this.cd.setAttribute("transform", "translate(" + a + "," + b + ")");
};
d.ah = function() {
  return { width: this.ma, height: this.Fa };
};
d.yg = function(a, b) {
  var c = 2 * xe;
  a = Math.max(a, c + 45);
  ...
  if (this.wg) {
    if (this.il) {
      ...
      this.m.u
        ? e - c.Cb - a - this.ma < I
          ? (a = e - c.Cb - this.ma - I)
          : e - c.Cb - a > c.Aa && (a = e - c.Cb - c.Aa)
        : e + a < c.Cb
        ? (a = c.Cb - e)
        : c.Cb + c.Aa < e + a + this.ma + 10 + I &&
          (a = c.Cb + c.Aa - e - this.ma - I);
...
d.tm = function(a, b) {
  a ? a.Ff(b.x, b.y) : this.moveTo(b.x, b.y);
  this.Ii = this.m.u ? this.Bd.x - b.x - this.ma : b.x - this.Bd.x;
  this.tk = b.y - this.Bd.y;
  ye(this);
};
d.oa = function() {
  return new D(this.Bd.x + this.Ii, this.Bd.y + this.tk);
};
d.ut = function(a) {
  this.il = a;
};
function Ge(a) {
  Ge.s.constructor.call(this);
  this.fc = a.id;
  this.Kc = a.o.id;
}
w(Ge, Pc);
Ge.prototype.Ca = function() {
  var a = Ge.s.Ca.call(this);
  a.blockId = this.fc;
  return a;
};
    ...
    switch (
      ...
      case "mutation":
        ...
        if (b.hb) {
          ...
          var e = x.F.Xc("<xml>" + a + "</xml>");
          b.hb(e.firstChild);
        }
        x.j.V(new Dc(b, "mutation", null, c, a));
        break;
      default:
...
function Bc(a) {
  a &&
    (Bc.s.constructor.call(this, a),
    (this.xml = a.o.R ? x.F.Cn(a) : x.F.Rf(a)),
    (this.cg = x.j.Ur(a)));
}
w(Bc, Ge);
x.j.Vk = Bc;
...
Bc.prototype.Ca = function() {
  var a = Bc.s.Ca.call(this);
  a.xml = x.F.Gd(this.xml);
  a.ids = this.cg;
  return a;
};
Bc.prototype.la = function(a) {
  Bc.s.la.call(this, a);
  this.xml = x.F.Xc("<xml>" + a.xml + "</xml>").firstChild;
  this.cg = a.ids;
};
Bc.prototype.run = function(a) {
  var b = Qc(this);
  if (a) (a = G("xml")), a.appendChild(this.xml), x.F.ae(a, b);
  else {
    a = 0;
    for (var c; (c = this.cg[a]); a++) {
      var e = Nc(b, c);
      e
        ? e.A(!1, !1)
        : c == this.fc &&
...
Cc.prototype.run = function(a) {
  ...
  if (a) {
    ...
    for (var c; (c = this.cg[a]); a++) {
      ...
      e
        ? e.A(!1, !1)
        : c == this.fc && console.warn("Can't delete non-existent block: " + c);
    }
  } else (a = G("xml")), a.appendChild(this.Ix), x.F.ae(a, b);
};
function Ec(a) {
  a &&
    (Ec.s.constructor.call(this, a),
    (a = Je(this)),
    (this.Ps = a.at),
    (this.Os = a.os),
    (this.$o = a.dr));
...
d.type = x.j.aj;
d.Ca = function() {
  var a = Ec.s.Ca.call(this);
  this.oh && (a.newParentId = this.oh);
  this.nh && (a.newInputName = this.nh);
  this.pg &&
    (a.newCoordinate = Math.round(this.pg.x) + "," + Math.round(this.pg.y));
  return a;
};
d.la = function(a) {
  Ec.s.la.call(this, a);
  ...
  a.newCoordinate &&
    ((a = a.newCoordinate.split(",")),
    (this.pg = new D(parseFloat(a[0]), parseFloat(a[1]))));
};
d.vf = function() {
  var a = Je(this);
  this.oh = a.at;
  ...
  if (c) {
    ...
    a: {
      for (var e = 0, f; (f = c.X[e]); e++)
        if (f.connection && J(f.connection) == b) {
          b = f;
          break a;
        }
      b = null;
...
d.ui = function() {
  return this.Ps == this.oh && this.Os == this.nh && vc(this.$o, this.pg);
};
d.run = function(a) {
  var b = Qc(this),
    c = Nc(b, this.fc);
  if (c) {
    var e = a ? this.oh : this.Ps,
      f = a ? this.nh : this.Os;
    a = a ? this.pg : this.$o;
    var h = null;
    if (e && ((h = Nc(b, e)), !h)) {
    ...
    c.getParent() && Ke(c);
    if (a) (f = c.oa()), c.moveBy(a.x - f.x, a.y - f.y);
    else {
      c = c.M || c.$;
      if (f) {
        if ((b = K(h, f))) var k = b.connection;
      } else c.type == x.Lf && (k = h.L);
      k
        ? c.connect(k)
        : console.warn("Can't connect to non-existent input: " + f);
    }
  } else console.warn("Can't move non-existent block: " + this.fc);
};
function Ic(a, b, c, e) {
  Ic.s.constructor.call(this);
  this.fc = a ? a.id : null;
...
Ic.prototype.Ca = function() {
  var a = Ic.s.Ca.call(this);
  a.element = this.element;
  void 0 !== this.newValue && (a.newValue = this.newValue);
  this.fc && (a.blockId = this.fc);
  return a;
};
Ic.prototype.la = function(a) {
  Ic.s.la.call(this, a);
  this.element = a.element;
  this.newValue = a.newValue;
  this.fc = a.blockId;
...
function Me(a) {
  a.Dc ||
    ((a.Dc = x.i.B("g", { class: "blocklyIconGroup" }, null)),
    a.U.vb && x.i.pb(a.Dc, "blocklyIconGroupReadonly"),
    a.co(a.Dc),
    a.U.ha().appendChild(a.Dc),
    x.O(a.Dc, "mouseup", a, a.Eo),
    a.If());
}
d.A = function() {
  H(this.Dc);
...
d.Eo = function(a) {
  this.U.o.sb() || this.U.vb || x.i.jg(a) || this.pa(!this.Y());
};
d.Hf = function() {
  this.Y() && this.bb.Ha(this.U.we);
};
function Ne(a) {
  var b = a.U.oa(),
    c = x.i.Bc(a.Dc);
...
d.Fa = 80;
d.co = function(a) {
  x.i.B("circle", { class: "blocklyIconShape", r: "8", cx: "8", cy: "8" }, a);
  x.i.B(
    "path",
    {
...
d.pj = function() {
  ...
  x.O(b, "wheel", this, function(a) {
    a.stopPropagation();
  });
  x.O(b, "change", this, function() {
    this.ya != b.value &&
      (x.j.V(new x.j.Mc(this.U, "comment", null, this.ya, b.value)),
      (this.ya = b.value));
  });
  setTimeout(function() {
    b.focus();
...
d.pa = function(a) {
  if (a != this.Y())
    if (
      (x.j.V(new Ic(this.U, "commentOpen", !a, a)),
      (!Pe(this.U) && !this.xb) || A)
    )
      Qe.prototype.pa.call(this, a);
    else {
      var b = this.Ib(),
        c = this.ah();
      a
        ? ((this.bb = new ue(
          ...
          (this.bb.yp = a),
          this.Hf())
        : (this.bb.A(), (this.gd = this.xb = this.bb = null));
      this.Ob(b);
      this.yg(c.width, c.height);
    }
};
d.Ay = function() {
  Ee(this.bb) && this.xb.focus();
};
d.ah = function() {
  return this.Y() ? this.bb.ah() : { width: this.ma, height: this.Fa };
};
d.yg = function(a, b) {
  this.xb ? this.bb.yg(a, b) : ((this.ma = a), (this.Fa = b));
};
d.Ib = function() {
  return this.xb ? this.xb.value : this.ya;
};
d.Ob = function(a) {
  this.ya != a &&
    (x.j.V(new x.j.Mc(this.U, "comment", null, this.ya, a)), (this.ya = a));
  this.xb && (this.xb.value = a);
};
d.A = function() {
  x.j.isEnabled() && this.Ob("");
  this.U.Ya = null;
...
function Re(a, b) {
  ...
  this.type = b;
  a.o.Ln &&
    ((this.Ed = a.o.Ln[b]), (this.zl = a.o.Ln[x.Th[b]]), (this.Do = !this.Ed));
}
d = Re.prototype;
d.Ia = null;
d.Wd = null;
...
d.wl = function(a) {
  ...
  if (b.isConnected()) {
    ...
    if (f.jb) (h = x.F.Rf(f)), f.A(), (f = null);
      ...
      if (!f.M) throw "Orphan block does not have an output connection.";
      var k = Se(e, f);
      k && (f.M.connect(k), (f = null));
    } else if (b.type == x.yb) {
      if (!f.$) throw "Orphan block does not have a previous connection.";
      for (k = e; k.L; ) {
        var l = Oc(k);
        if (l && !l.jb) k = l;
        else {
          Te(f.$, k.L) && (k.L.connect(f.$), (f = null));
          break;
        }
      }
    }
    if (f && (b.disconnect(), x.j.oc)) {
      ...
      setTimeout(function() {
        f.o &&
          !f.getParent() &&
          (x.j.S(m), f.M ? Ue(f.M, b) : f.$ && Ue(f.$, b), x.j.S(!1));
      }, x.Uk);
    }
    b.Qe = h;
  }
...
d.gm = function(a) {
  if (0 != Ye(this, a)) return !1;
  if (a.type == x.Vh || a.type == x.Lf)
    if (a.isConnected() || this.isConnected()) return !1;
  return (a.type == x.$a && a.isConnected() && !J(a).Je() && !J(a).jb) ||
    (this.type == x.Lf && a.isConnected() && !this.v.L && !J(a).jb && J(a).L) ||
    -1 != x.Gl.indexOf(a)
    ? !1
    : !0;
};
    ...
    switch (Ye(this, a)) {
      ...
      case 4:
        throw "Connection checks failed. " +
          (this + " expected " + this.Wd + ", found " + a.Wd);
      case 6:
        throw "Connecting non-shadow to shadow block.";
      default:
        throw "Unknown connection failure: this should never happen!";
    }
    Xe(this) ? this.wl(a) : a.wl(this);
  }
};
function Ve(a, b) {
  a.Ia = b;
...
function Se(a, b) {
  for (var c; (c = Ze(a, b)); ) if (((a = J(c)), !a || a.jb)) return c;
  return null;
}
...
function J(a) {
  return a.isConnected() ? a.Ia.v : null;
}
function Te(a, b) {
  if (!a.Wd || !b.Wd) return !0;
  for (var c = 0; c < a.Wd.length; c++)
    if (-1 != b.Wd.indexOf(a.Wd[c])) return !0;
  return !1;
}
d.Rs = function() {
  this.isConnected() && !Te(this, this.Ia) && Ke(Xe(this) ? J(this) : this.v);
};
d.Ua = function(a) {
  a ? (u(a) || (a = [a]), (this.Wd = a), this.Rs()) : (this.Wd = null);
  return this;
};
d.Ms = function() {
  return [];
...
af.prototype = [];
function bf(a, b) {
  if (b.eg) throw "Connection already in database.";
...
function df(a, b) {
  ...
  for (var e = b.Wa, f = c; 0 <= f && a[f].Wa == e; ) {
    if (a[f] == b) return f;
    f--;
  }
  for (; c < a.length && a[c].Wa == e; ) {
    if (a[c] == b) return c;
    c++;
  }
  return -1;
...
function We(a, b) {
  if (!b.eg) throw "Connection not in database.";
  var c = df(a, b);
...
function ef(a, b, c) {
  ...
  for (var l = (b = f.length - 2); a < l; )
    f[l].Wa < k ? (a = l) : (b = l), (l = Math.floor((a + b) / 2));
  var m = [];
  b = a = l;
  if (f.length) {
    for (; 0 <= a && e(a); ) a--;
...
x.Ja.Ir = function(a, b, c, e) {
  ...
  1 < f
    ...
    : (a.setAttribute(
        "transform",
        "translate(" +
          (a.Ey + (((b ? -1 : 1) * a.Iq.width * e) / 2) * f) +
          "," +
          (a.Fy + a.Iq.height * e * f) +
          ") scale(" +
          (1 - f) * e +
          ")"
      ),
      setTimeout(x.Ja.Ir, 10, a, b, c, e));
};
x.Ja.Rv = function(a) {
  var b = a.o,
    c = b.scale;
...
x.Ja.$q = function(a, b, c) {
  var e = (new Date() - b) / 150;
  1 < e
    ? H(a)
    : (a.setAttribute("r", 25 * e * c),
      (a.style.opacity = 1 - e),
      (x.Ja.Zn = setTimeout(x.Ja.$q, 10, a, b, c)));
};
x.Ja.kw = function(a) {
  a.o.Pf.play("disconnect");
  if (!(1 > a.o.scale)) {
    var b = a.Hb().height;
...
x.Ja.Hr = function(a, b, c) {
  ...
  1 < e
    ...
    : ((a.Ah =
      ...
      (x.Ja.Dl = a),
      (x.Ja.Zn = setTimeout(x.Ja.Hr, 10, a, b, c)));
  a.setAttribute("transform", a.Gf + a.Ah);
};
x.Ja.$n = function() {
  if (x.Ja.Dl) {
    clearTimeout(x.Ja.Zn);
    var a = x.Ja.Dl;
    a.Ah = "";
...
function gf(a, b) {
  gf.s.constructor.call(this, a, b);
  this.xm = new D(0, 0);
}
w(gf, Re);
function hf(a, b) {
...
d.moveBy = function(a, b) {
  this.moveTo(this.$c + a, this.Wa + b);
};
function kf(a, b) {
  a.moveTo(b.x + a.xm.x, b.y + a.xm.y);
}
function lf(a, b, c) {
  a.xm.x = b;
  a.xm.y = c;
...
d.closest = function(a, b) {
  ...
  if (c.length) {
    ...
    var h = cf(c, this);
    b = null;
    for (var k = a, l, m = h - 1; 0 <= m && Math.abs(c[m].Wa - this.Wa) <= a; )
      (l = c[m]), this.gm(l, k) && ((b = l), (k = hf(l, this))), m--;
    for (; h < c.length && Math.abs(c[h].Wa - this.Wa) <= a; )
      (l = c[h]), this.gm(l, k) && ((b = l), (k = hf(l, this))), h++;
    this.$c = f;
    this.Wa = e;
    a = { connection: b, mt: k };
  } else a = { connection: null, mt: a };
  return a;
};
d.ks = function() {
  var a =
    this.type == x.$a || this.type == x.Vh
      ? "m 0,0 " + of + " v 5"
...
function pf(a) {
  qf(a, !1);
  var b = [];
  if (a.type != x.$a && a.type != x.yb) return b;
  if ((a = J(a))) {
    if (a.isCollapsed()) {
      var c = [];
      a.M && c.push(a.M);
    ...
    for (var e = 0; e < c.length; e++) b.push.apply(b, pf(c[e]));
    b.length || (b[0] = a);
  }
  return b;
}
...
function qf(a, b) {
  (a.Do = b) && a.eg ? We(a.Ed, a) : b || a.eg || bf(a.Ed, a);
}
d.gm = function(a, b) {
  return hf(this, a) > b ? !1 : gf.s.gm.call(this, a);
};
d.Yn = function(a, b) {
  gf.s.Yn.call(this, a, b);
  a.R && a.aa();
  b.R && (sf(b), b.aa());
};
d.Cp = function() {
...
d.Rs = function() {
  this.isConnected() &&
    !Te(this, this.Ia) &&
    (Ke(Xe(this) ? J(this) : this.v), this.v.qb());
};
function tf(a) {
  this.Fg = x.selected = a;
  this.m = a.o;
  a = this.Fg.De(!1);
  var b;
  a: {
...
tf.prototype.update = function(a, b) {
  ...
  this.zi = this.jc = null;
  this.up = x.bd;
  for (var f = 0; f < this.An.length; f++) {
    var h = this.An[f],
      k = h.closest(this.up, a);
    k.connection && ((this.jc = k.connection), (this.zi = h), (this.up = k.mt));
  }
  (a = e != this.jc) && c && rf();
  c = !!this.jc && b != x.oq;
  this.Kg = (b = !!b && !this.Fg.getParent() && this.Fg.lc()) && !c;
  b && this.jc && (rf(), (this.jc = null));
  !this.Kg && a && this.jc && this.jc && this.jc.ks();
};
function uf(a, b) {
  this.ib = a;
  this.m = b;
  ...
  for (var c = 0, e; (e = a[c]); c++) {
    ...
    for (var f = 0; f < e.length; f++)
      b.push({ location: e[f].gh, icon: e[f] });
  }
  this.Fl = b;
}
uf.prototype.A = function() {
  this.lb = this.m = this.ib = null;
  this.Fl.length = 0;
...
function wf(a, b, c) {
  c = a.Ei(c);
  a.ib.tm(yc(a.Se, c));
  for (var e = 0; e < a.Fl.length; e++) {
    var f = a.Fl[e],
      h = f.icon;
    f = yc(f.location, c);
    h.gh = f;
    h.Y() && ((h = h.bb), (h.Bd = f), h.wg && we(h));
  }
  a.Vg = xf(a.m, b);
  a.ii.update(c, a.Vg);
  a.Kg = a.ii.Kg;
...
function zf(a, b, c) {
  ...
  a.Kg ||
    ...
    b.jc &&
      (b.zi.connect(b.jc),
      b.Fg.R && (x.Ja.Rv((Xe(b.zi) ? b.jc : b.zi).v), Bf(jf(b.Fg))),
      b.jc && rf()),
    a.ib.aa(),
    a.Aj(),
    Cf(a.ib));
  a.m.Tb(!0);
  (b = a.m.ga) &&
    x.i.Rb(b.Nc, a.ib.lc() ? "blocklyToolboxDelete" : "blocklyToolboxGrab");
  x.j.S(!1);
}
uf.prototype.Aj = function() {
  var a = new x.j.Wi(this.ib);
  a.$o = this.Se;
  a.vf();
  x.j.V(a);
};
uf.prototype.Ei = function(a) {
  a = new D(a.x / this.m.scale, a.y / this.m.scale);
  this.m.ak && (a = a.scale(1 / this.m.options.Lb.scale));
  return a;
};
function Df(a, b, c, e, f) {
  this.w = x.i.B("g", { class: "blocklyComment" }, null);
  this.w.Gf = "";
  this.Ik = x.i.B("rect", {
...
d.Ec = function() {
  this.o.options.readOnly ||
    this.fo ||
    (x.O(this.Eg, "mousedown", this, this.bt),
    x.O(this.Dh, "mousedown", this, this.bt));
  this.fo = !0;
  Ef(this);
...
d.select = function() {
  if (x.selected != this) {
    ...
    a = new Ic(null, "selected", a, this.id);
    a.Kc = this.o.id;
    x.j.V(a);
    x.selected = this;
    this.Zh();
...
d.Hh = function() {
  if (x.selected == this) {
    var a = new Ic(null, "selected", this.id, null);
    a.Kc = this.o.id;
    x.j.V(a);
    x.selected = null;
    this.uh();
...
d.Zh = function() {
  x.i.pb(this.w, "blocklySelected");
  this.Lp();
};
d.uh = function() {
  x.i.Rb(this.w, "blocklySelected");
  Ff(this);
};
d.oa = function() {
  var a = 0,
  ...
  if (e) {
    do {
      ...
      b += f.y;
      this.Ue &&
        this.o.Ab.ye.firstChild == e &&
        ((f = this.o.Ab.Yl()), (a += f.x), (b += f.y));
      e = e.parentNode;
    } while (e && e != this.o.qe && e != c);
  }
  return (this.vd = new D(a, b));
};
d.moveBy = function(a, b) {
  var c = new Lc(this),
    e = this.oa();
...
d.Js = function(a) {
  this.Ue && (this.translate(a.x, a.y), this.o.Ab.jj(this.o.Va));
};
d.tm = function(a, b) {
  a
    ? a.Ff(b.x, b.y)
    : ((this.w.Gf = "translate(" + b.x + "," + b.y + ")"),
      this.w.setAttribute("transform", this.w.Gf + this.w.Ah));
};
d.moveTo = function(a, b) {
  this.translate(a, b);
};
d.no = function() {
  var a = this.oa(),
    b = this.Hb();
  if (this.u) {
    var c = new D(a.x - b.width, a.y);
    a = new D(a.x, a.y + b.height);
  } else (c = new D(a.x, a.y)), (a = new D(a.x + b.width, a.y + b.height));
  return { rd: c, Ud: a };
};
function Ef(a) {
  a.Je() ? x.i.pb(a.w, "blocklyDraggable") : x.i.Rb(a.w, "blocklyDraggable");
}
d.xh = function(a) {
  Df.s.xh.call(this, a);
  Ef(this);
...
d.Ag = function(a) {
  a
    ? ((a = this.ha()),
      (a.Gf = ""),
      (a.Ah = ""),
      x.i.pb(this.w, "blocklyDragging"))
    : x.i.Rb(this.w, "blocklyDragging");
};
d.ha = function() {
  return this.w;
};
d.Rc = function() {
  return this.xb ? this.xb.value : this.dd;
};
d.Od = function(a) {
  Df.s.Od.call(this, a);
  this.xb && (this.xb.value = a);
...
d.Ak = function(a) {
  a
    ? x.i.pb(this.w, "blocklyDraggingDelete")
    : x.i.Rb(this.w, "blocklyDraggingDelete");
};
d.ut = function() {};
function If(a, b, c) {
  x.j.disable();
...
function Jf(a, b) {
  ...
  this.an = !1;
  this.Se = this.Fb.oa();
  this.Xg = x.i.hg() && b.Ab ? b.Ab : null;
}
Jf.prototype.A = function() {
  this.Xg = this.m = this.Fb = null;
};
function Kf(a, b, c) {
  c = a.Ei(c);
...
function Lf(a, b, c) {
  ...
  a.m.ga &&
    x.i.Rb(
      a.m.ga.Nc,
      a.Fb.lc() ? "blocklyToolboxDelete" : "blocklyToolboxGrab"
    );
  x.j.S(!1);
}
Jf.prototype.Aj = function() {
  if (this.Fb.rs) {
    var a = new Lc(this.Fb);
    a.ap = this.Se;
    a.vf();
    x.j.V(a);
  }
};
Jf.prototype.Ei = function(a) {
  a = new D(a.x / this.m.scale, a.y / this.m.scale);
  this.m.ak && (a = a.scale(1 / this.m.options.Lb.scale));
  return a;
};
Jf.prototype.um = function() {
  this.Fb.moveTo(0, 0);
...
function Mf(a) {
  this.m = a;
  this.ty = a.ub();
  this.vy = new D(a.scrollX, a.scrollY);
}
Mf.prototype.A = function() {
  this.m = null;
};
Mf.prototype.Vm = function() {
  x.selected && x.selected.Hh();
  Nf(this.m);
};
function Of(a, b) {
  var c = a.ty,
...
Mf.prototype.Pt = function(a, b) {
  this.m.kb.set(a, b);
};
function Pf(a) {
  Pf.s.constructor.call(this, a.Lj());
  this.$b = a.$b;
  this.ge = a.ge;
}
w(Pf, Mf);
Pf.prototype.Pt = function(a, b) {
  this.ge ? this.$b.set(a) : this.$b.set(b);
};
x.C = {};
x.C.visible = !1;
x.C.ai = !1;
...
x.C.T = function() {
  x.C.na ||
    ((x.C.na = G("DIV", "blocklyTooltipDiv")),
    document.body.appendChild(x.C.na));
};
x.C.Rg = function(a) {
  x.Oc(a, "mouseover", null, x.C.Xx);
  x.Oc(a, "mouseout", null, x.C.Wx);
  a.addEventListener("mousemove", x.C.Vx, !1);
};
x.C.Xx = function(a) {
  if (!x.C.ai) {
    for (a = a.target; !q(a.qd) && !v(a.qd); ) a = a.qd;
...
x.C.Vx = function(a) {
  if (x.C.P && x.C.P.qd && !x.K.Y() && !x.C.ai)
    if (x.C.visible) {
      var b = x.C.Po - a.pageX;
      a = x.C.Qo - a.pageY;
      Math.sqrt(b * b + a * a) > x.C.Ru && x.C.Pa();
    } else
      x.C.Am != x.C.P &&
        (clearTimeout(x.C.Dk),
        (x.C.Po = a.pageX),
        (x.C.Qo = a.pageY),
        (x.C.Dk = setTimeout(x.C.ly, x.C.xu)));
};
x.C.Pa = function() {
  x.C.visible &&
    ((x.C.visible = !1), x.C.na && (x.C.na.style.display = "none"));
...
x.C.ly = function() {
  if (!x.C.ai && ((x.C.Am = x.C.P), x.C.na)) {
    ...
    var e = x.C.Qo + x.C.vq;
    e + x.C.na.offsetHeight > b.height + window.scrollY &&
      (e -= x.C.na.offsetHeight + 2 * x.C.vq);
    a
      ? (c = Math.max(x.C.hn - window.scrollX, c))
      : c + x.C.na.offsetWidth > b.width + window.scrollX - 2 * x.C.hn &&
        (c = b.width - x.C.na.offsetWidth - 2 * x.C.hn);
    x.C.na.style.top = e + "px";
    x.C.na.style.left = c + "px";
  }
};
function Qf(a, b) {
  this.lb = this.cc = this.Bh = this.Ch = this.Jc = this.wc = this.Hs = null;
  this.Uv = b;
...
function Rf(a, b) {
  ...
  if (a.eh) var c = !1;
    ...
    (c = a.wc),
      (a.eh = Math.sqrt(c.x * c.x + c.y * c.y) > (a.J ? x.pu : x.qq)),
      (c = a.eh);
  if (c) {
    if (a.Jc) {
      a.Zj = !0;
      ...
      var e = c.m.ga;
      e &&
        x.i.pb(e.Nc, c.Fb.lc() ? "blocklyToolboxDelete" : "blocklyToolboxGrab");
      Kf(a.af, a.Uc, a.wc);
      c = !0;
    } else c = !1;
    if (!c) {
      if (a.cc)
        if (
          ...
          c.m.Tb(!1);
          x.Ja.$n();
          if (c.ib.getParent() || (f && c.ib.L && J(c.ib.L)))
            Ke(c.ib, f),
              (e = c.Ei(e)),
              (e = yc(c.Se, e)),
              c.ib.translate(e.x, e.y),
              x.Ja.kw(c.ib);
          c.ib.Ag(!0);
          c.ib.um();
          (e = c.m.ga) &&
            x.i.pb(
              e.Nc,
              c.ib.lc() ? "blocklyToolboxDelete" : "blocklyToolboxGrab"
            );
          wf(a.$e, a.Uc, a.wc);
          c = !0;
        } else c = !1;
      ...
      !c &&
        (a.J ? Sf(a.J) : a.lb && a.lb.kb) &&
        ((a.Jg = a.J ? new Pf(a.J) : new Mf(a.lb)), (a.$j = !0), a.Jg.Vm());
    }
    x.mg();
  }
  a.Uc = b;
...
d.wj = function(a) {
  x.i.km(a)
    ...
    : ((this.hs = !0),
      x.Ja.$n(),
      Tf(this.lb),
      this.lb.ak && this.lb.resize(),
      Vf(this.lb),
      (this.Uc = a),
      x.Qb(!!this.J),
      x.C.block(),
      this.cc && this.cc.select(),
      x.i.jg(a)
        ? rc(this, a)
        : (("touchstart" == a.type.toLowerCase() ||
            ("pointerdown" == a.type.toLowerCase() &&
              "mouse" != a.pointerType)) &&
            x.xx(a, this),
          (this.Hs = new D(a.clientX, a.clientY)),
          (this.js = a.altKey || a.ctrlKey || a.metaKey),
          this.Rg(a)));
};
d.Rg = function(a) {
  this.ym = x.O(document, "mousemove", null, this.Qj.bind(this));
...
d.Qj = function(a) {
  ...
  this.$j
    ? Of(this.Jg, this.wc)
    : this.jh
    ? wf(this.$e, this.Uc, this.wc)
    : this.Zj && Kf(this.af, this.Uc, this.wc);
  a.preventDefault();
  a.stopPropagation();
};
d.am = function(a) {
  ...
  if (this.im) console.log("Trying to end a gesture recursively.");
    ...
    if (this.Zj) Lf(this.af, a, this.wc);
      ...
      this.Jc && !this.eh
        ? (this.Jc.Lp && this.Jc.Lp(), this.Jc.select && this.Jc.select())
        : Xf(this)
        ? (this.Ch.Re(), Yf(this))
        : !this.Bh || this.eh || Xf(this)
        ? this.Bh ||
          this.Jc ||
          this.Ch ||
          this.eh ||
        ...
        : (this.J && this.J.$h
            ? this.cc.disabled ||
              (x.j.Ac() || x.j.S(!0), Cf(Uf(this.J, this.cc)))
            : x.j.V(new Ic(this.Bh, "click", void 0, void 0)),
          Yf(this),
          x.j.S(!1));
    a.preventDefault();
    a.stopPropagation();
...
d.cancel = function() {
  if (!this.im) {
    x.mg();
    if (this.Zj) Lf(this.af, this.Uc, this.wc);
...
function rc(a, b) {
  a.cc
    ? (Yf(a), x.Qb(a.J), a.cc.Oi(b))
    : a.Jc
    ? a.Jc.Oi(b)
    : a.lb && !a.J && (x.Qb(), a.lb.Oi(b));
  b.preventDefault();
  b.stopPropagation();
  a.A();
}
...
function Zf(a, b) {
  a.Bh || a.Jc || ((a.Bh = b), b.vb && b != jf(b) ? $f(a, jf(b)) : $f(a, b));
}
function $f(a, b) {
  b.jb ? $f(a, b.getParent()) : (a.cc = b);
}
function Xf(a) {
  if (a.Ch) {
    var b = a.Ch;
  ...
  return b && !a.eh && (!a.J || !a.J.$h);
}
d.sb = function() {
  return this.$j || this.jh || this.Zj;
};
x.i = {};
x.i.removeAttribute = function(a, b) {
  A && xb("10.0") ? a.setAttribute(b, null) : a.removeAttribute(b);
};
x.i.pb = function(a, b) {
...
x.i.Bc = function(a) {
  ...
  if ((c = (c = a.getAttribute("transform")) && c.match(x.i.Bc.fv)))
    (b.x += parseFloat(c[1])), c[3] && (b.y += parseFloat(c[3]));
  (a = a.getAttribute("style")) &&
    -1 < a.indexOf("translate") &&
    ((c = a.match(x.i.Bc.dv)) || (c = a.match(x.i.Bc.ev)),
...
x.i.B = function(a, b, c) {
  a = document.createElementNS(x.sn, a);
...
x.i.Pq = function(a) {
  for (var b = x.g, c = /%{(BKY_[A-Z][A-Z0-9_]*)}/gi, e = c.exec(a); e; ) {
    var f = e[1];
    f = f.toUpperCase();
    "BKY_" != f.substr(0, 4)
      ? console.log(
        ...
        ("" == l
          ...
          : ((f = a.join("")),
            /[a-zA-Z][a-zA-Z0-9_]*/.test(f)
              ? ((l = f.toUpperCase()),
                (l = Ea(l, "BKY_") ? l.substring(4) : null) && l in x.g
                  ? ((f = x.g[l]),
                    q(f)
                      ? Array.prototype.push.apply(c, x.i.cq(f, b))
                      : b
                      ? c.push(String(f))
                      : c.push(f))
                  : c.push("%{" + f + "}"))
...
x.i.Be = function() {
  for (var a = x.i.Be.zt.length, b = [], c = 0; 20 > c; c++)
    b[c] = x.i.Be.zt.charAt(Math.random() * a);
  return b.join("");
};
x.i.Be.zt =
...
x.i.Yt = function(a, b) {
  a = a.split("\n");
  for (var c = 0; c < a.length; c++) a[c] = x.i.Qy(a[c], b);
  return a.join("\n");
};
x.i.Qy = function(a, b) {
...
x.i.Zt = function(a, b, c) {
  for (var e = x.i.hq(a, b, c), f, h = 0; h < b.length - 1; h++)
    if (b[h] != b[h + 1]) {
      var k = [].concat(b);
      k[h] = !k[h];
      k[h + 1] = !k[h + 1];
...
bg.prototype.moveTo = function(a, b) {
  this.pi.setAttribute("x", a);
...
function dg(a) {
  ...
  b.jk = void 0 === a.minScale ? 0.3 : parseFloat(a.minScale);
...
function fg(a) {
  ...
  this.nj = x.i.B(
    "rect",
    { height: I, width: I, class: "blocklyScrollbarBackground" },
    null
  );
  x.i.Xj(this.nj, a.qe);
}
fg.prototype.eb = null;
...
fg.prototype.resize = function() {
  ...
  if (a) {
    ...
    b && this.Yf.resize(a);
    c && this.Hg.resize(a);
    (this.eb && this.eb.Aa == a.Aa && this.eb.ob == a.ob) ||
      this.nj.setAttribute("x", this.Hg.Wc.x);
    (this.eb && this.eb.fb == a.fb && this.eb.zb == a.zb) ||
      this.nj.setAttribute("y", this.Yf.Wc.y);
    this.eb = a;
  }
};
...
function gg(a, b, c, e) {
  ...
  a = I;
  b
    ? (this.pd.setAttribute("height", a),
      this.Me.setAttribute("height", a),
      this.Te.setAttribute("height", a - 5),
      this.Te.setAttribute("y", 2.5),
      (this.fk = "width"),
      (this.dt = "x"))
    : (this.pd.setAttribute("width", a),
      this.Me.setAttribute("width", a),
      this.Te.setAttribute("width", a - 5),
      this.Te.setAttribute("x", 2.5),
      (this.fk = "height"),
      (this.dt = "y"));
  this.Ws = x.O(this.pd, "mousedown", this, this.Sx);
  this.Xs = x.O(this.Te, "mousedown", this, this.Tx);
}
var ig, jg;
d = gg.prototype;
d.ip = new D(0, 0);
...
function lg(a, b) {
  ...
  a.pd.setAttribute(a.fk, a.Md);
}
fg.prototype.wh = function(a) {
  this.Yf.wh(a);
  this.Hg.wh(a);
};
function mg(a, b, c) {
  ...
  x.i.zk(
    a.Me,
    "translate(" + (a.Wc.x + a.ip.x) + "px," + (a.Wc.y + a.ip.y) + "px)"
  );
}
d = gg.prototype;
d.resize = function(a) {
  ...
  if (
    ...
    if (this.fh) {
      ...
      mg(this, b, a.zb + a.fb - I - 0.5);
      this.Di || this.pa(this.Md < a.Qc);
      this.nc = this.Md / a.Qc;
      if (-Infinity == this.nc || Infinity == this.nc || isNaN(this.nc))
        this.nc = 0;
      ...
      this.nc = this.Md / a.uc;
      if (-Infinity == this.nc || Infinity == this.nc || isNaN(this.nc))
        this.nc = 0;
      this.Zf = Math.max(0, a.fb * this.nc);
      this.Te.setAttribute(this.fk, this.Zf);
      hg(this, ng(this, (a.Ve - a.vc) * this.nc));
    }
    og(this);
  }
};
d.oj = function(a) {
  var b = "blocklyScrollbar" + (this.fh ? "Horizontal" : "Vertical");
  a && (b += " " + a);
...
d.pa = function(a) {
  var b = a != this.Y();
  if (this.Di) throw "Unable to toggle visibility of paired scrollbars.";
  this.dk = a;
  b && this.Nk();
};
d.Nk = function() {
  this.Sg && this.Y()
    ? this.Me.setAttribute("display", "block")
    : this.Me.setAttribute("display", "none");
};
d.Sx = function(a) {
  Vf(this.m);
  x.Touch.df();
  kg();
  if (x.i.jg(a)) a.stopPropagation();
  else {
    var b = x.i.kk(a, L(this.m), pg(this.m));
    b = this.fh ? b.x : b.y;
    var c = x.i.Sl(this.Te);
    c = this.fh ? c.x : c.y;
    var e = this.Rj,
      f = 0.95 * this.Zf;
...
d.Tx = function(a) {
  ...
  x.i.jg(a)
    ...
    : ((this.sy = this.Rj),
      Nf(this.m),
      (this.Ct = this.fh ? a.clientX : a.clientY),
      (ig = x.O(document, "mouseup", this, this.Yx)),
      (jg = x.O(document, "mousemove", this, this.Ux)),
      a.stopPropagation(),
      a.preventDefault());
};
d.Ux = function(a) {
  hg(this, ng(this, this.sy + ((this.fh ? a.clientX : a.clientY) - this.Ct)));
  og(this);
};
d.Yx = function() {
  Wf(this.m);
...
function ng(a, b) {
  return (b = 0 >= b || isNaN(b) || a.Md < a.Zf ? 0 : Math.min(b, a.Md - a.Zf));
}
function og(a) {
  var b = a.Rj / a.Md;
  isNaN(b) && (b = 0);
...
d.set = function(a) {
  hg(this, ng(this, a * this.nc));
  og(this);
};
function qg(a, b) {
  qg.s.constructor.call(this, a, b);
  this.jm = !1;
  this.Dd = {};
  this.Bt = this.pk = 0;
  this.hp = null;
...
d.wj = function(a) {
  qg.s.wj.call(this, a);
  !this.im && x.Touch.lm(a) && rg(this, a);
};
d.Rg = function(a) {
  this.hp = x.O(document, "mousedown", null, this.Rw.bind(this), !0);
...
d.Rw = function(a) {
  !this.sb() && x.Touch.lm(a) && (rg(this, a), this.jm && x.mg());
};
d.Qj = function(a) {
  if (this.sb()) x.Touch.Tp(a) && qg.s.Qj.call(this, a);
  else if (this.jm) {
    if (x.Touch.lm(a)) {
      this.Dd[x.Touch.Zl(a)] = sg(this, a);
      var b = Object.keys(this.Dd);
      if (2 == b.length) {
        b = wc(this.Dd[b[0]], this.Dd[b[1]]) / this.Bt;
        if (0 < this.pk && Infinity > this.pk) {
          var c = b - this.pk;
          c = 0 < c ? 5 * c : 6 * c;
          var e = this.lb,
            f = x.i.kk(a, L(e), pg(e));
    ...
    x.mg();
  } else qg.s.Qj.call(this, a);
};
d.am = function(a) {
  if (x.Touch.lm(a) && !this.sb()) {
    var b = x.Touch.Zl(a);
    this.Dd[b] && delete this.Dd[b];
    2 > Object.keys(this.Dd).length && ((this.Dd = {}), (this.pk = 0));
  }
  !this.jm || this.sb()
    ? x.Touch.Tp(a) && qg.s.am.call(this, a)
...
function rg(a, b) {
  a.Dd[x.Touch.Zl(b)] = sg(a, b);
  var c = Object.keys(a.Dd);
  2 == c.length &&
    ((a.Bt = wc(a.Dd[c[0]], a.Dd[c[1]])), (a.jm = !0), b.preventDefault());
}
function sg(a, b) {
  return a.lb
    ? new D(
...
d.dispatchEvent = function(a) {
  ...
  f = !0;
  if (b)
    for (var h = b.length - 1; !a.rh && 0 <= h; h--) {
  ...
  a.rh ||
    ...
    a.rh || (f = ug(k, e, !1, a) && f));
  if (b)
    for (h = 0; !a.rh && h < b.length; h++)
      (k = a.currentTarget = b[h]), (f = ug(k, e, !1, a) && f);
  return f;
};
d.Na = function() {
  tg.s.Na.call(this);
...
d.ia = function(a, b, c, e) {
  return this.jf.add(String(a), b, !1, c, e);
};
d.zs = function(a, b, c, e) {
  return this.jf.add(String(a), b, !0, c, e);
};
d.sd = function(a, b, c, e) {
  return this.jf.remove(String(a), b, c, e);
};
d.removeAllListeners = function(a) {
  return this.jf ? this.jf.removeAll(a) : 0;
};
function ug(a, b, c, e) {
  b = a.jf.Gc[String(b)];
  if (!b) return !0;
...
d.Fj = function(a, b, c, e) {
  return this.jf.Fj(String(a), b, c, e);
};
function Af(a, b, c) {
  if (v(a)) c && (a = na(a, c));
...
d.I = function(a) {
  this.gj = this.jn + a;
  yf(this, !1);
  return this.gj + this.Tk + this.Oh;
};
d.A = function() {
...
d.position = function() {
  ...
  a &&
    (this.m.u
      ? ((this.Jb = this.Yi + I),
        a.Ea == x.Mf && ((this.Jb += a.Kl), this.m.ga && (this.Jb += a.ob)))
      : ((this.Jb = a.Aa + a.ob - this.Qg - this.Yi - I),
        a.Ea == x.se && (this.Jb -= a.Kl)),
    (this.Ef = a.fb + a.zb - (this.Tk + this.Oh) - this.gj),
    a.Ea == x.Pg && (this.Ef -= a.Qr),
    this.w.setAttribute(
      "transform",
      "translate(" + this.Jb + "," + this.Ef + ")"
    ));
};
d.ki = function() {
  ...
  return new wg(
    a.left + this.qn - this.$k,
    a.top + this.rn - this.$k,
    this.Qg + 2 * this.$k,
    this.Oh + this.Tk + 2 * this.$k
  );
};
function yf(a, b) {
  a.wi != b && (g.clearTimeout(a.Ro), (a.wi = b), a.xn());
}
d.xn = function() {
  this.lg += this.wi ? 0.2 : -0.2;
  this.lg = sc(this.lg, 0, 1);
  var a = 45 * this.lg;
  this.Xm.setAttribute(
    ...
    "rotate(" +
      (this.m.u ? -a : a) +
      "," +
      (this.m.u ? 4 : this.Qg - 4) +
      "," +
      (this.Oh - 2) +
      ")"
  );
  this.w.style.opacity = 0.4 + 0.4 * this.lg;
...
d.click = function() {
  var a = this.m.uy - this.m.scrollX,
...
x.H.io = function(a) {
  ...
  if (0 < a.length) {
    var c = a[0];
    if (x.D.variables_set) {
      var e = x.D.math_change ? 8 : 24;
      e =
...
x.H.bi = function(a, b, c) {
  function e(c) {
    x.H.jt(x.g.NEW_VARIABLE_TITLE, c, function(c) {
      if (c) {
        var h = x.H.Dx(c, a);
        if (h) {
          var k = c.toLowerCase();
          if (h.type == f) var n = x.g.VARIABLE_ALREADY_EXISTS.replace("%1", k);
          else
            (n = x.g.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE),
...
x.H.xp = function(a, b) {
  function c(e) {
    var f = x.g.RENAME_VARIABLE_TITLE.replace("%1", b.name);
    x.H.jt(f, e, function(e) {
      if (e) {
        var f = x.H.Ex(e, b.type, a);
        f
          ? ((f = x.g.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE.replace(
              "%1",
              e.toLowerCase()
            ).replace("%2", f.type)),
            x.alert(f, function() {
...
x.H.jt = function(a, b, c) {
  x.prompt(a, b, function(a) {
    a &&
      ((a = a.replace(/[\s\xa0]+/g, " ").replace(/^ | $/g, "")),
      a == x.g.RENAME_VARIABLE || a == x.g.NEW_VARIABLE) &&
      (a = null);
    c(a);
  });
};
x.H.Ex = function(a, b, c) {
  c = c.ua.kf();
  a = a.toLowerCase();
...
x.H.Sr = function(a) {
  a = "<xml>" + x.H.ji(a) + "</xml>";
  return x.F.Xc(a).firstChild;
};
x.H.Vl = function(a, b, c, e) {
  var f = x.H.Sc(a, b, c, e);
  f || (f = x.H.Tv(a, b, c, e));
  return f;
};
x.H.Sc = function(a, b, c, e) {
  var f = a.Gi;
  if (b) {
    var h = a.fe(b);
    !h && f && (h = f.fe(b));
...
x.H.Tv = function(a, b, c, e) {
  var f = a.Gi;
  c || (c = x.H.xw(a.je ? a.Fh : a));
...
x.zd = {};
x.zd.Mx = function(a) {
  x.H.bi(a.xa, null, "String");
};
x.zd.Lx = function(a) {
  x.H.bi(a.xa, null, "Number");
};
x.zd.Kx = function(a) {
  x.H.bi(a.xa, null, "Colour");
};
x.zd.Uf = function(a) {
  var b = [],
    c = G("button");
  ...
  a.Zg.CREATE_VARIABLE_COLOUR = x.zd.Kx;
  a = x.zd.io(a);
  return (b = b.concat(a));
};
x.zd.io = function(a) {
...
function Ag(a) {
  this.lp = a;
  this.ej = Object.create(null);
}
d = Ag.prototype;
d.Oo = null;
d.A = function() {
  this.ej = this.lp = null;
};
d.load = function(a, b) {
  if (a.length) {
    try {
    ...
    e && e.play && (this.ej[b] = e);
  }
};
d.preload = function() {
  for (var a in this.ej) {
    var b = this.ej[a];
    b.volume = 0.01;
    b.play();
    b.pause();
...
d.play = function(a, b) {
  ...
  c
    ? ((a = new Date()),
      (null != this.Oo && a - this.Oo < x.Wu) ||
        ((this.Oo = a),
        (c = (yb && 9 === yb) || rb || pb ? c : c.cloneNode()),
        (c.volume = void 0 === b ? 1 : b),
        c.play()))
    : this.lp && this.lp.Pf.play(a, b);
};
d = Df.prototype;
d.Hb = function() {
  return { width: this.hd(), height: this.ni() };
};
d.aa = function() {
  if (!this.wg) {
    var a = this.Hb();
    ...
    this.lc() &&
      ((this.Sf = x.i.B("g", { class: "blocklyCommentDeleteIcon" }, this.w)),
      (this.Br = x.i.B(
        "circle",
    ...
    this.Mb && x.O(this.Mb, "mousedown", this, this.zp);
    this.lc() &&
      (x.O(this.Sf, "mousedown", this, this.ew),
      x.O(this.Sf, "mouseout", this, this.fw),
      x.O(this.Sf, "mouseup", this, this.gw));
  }
};
d.pj = function() {
  this.gd = x.i.B(
...
d.zp = function(a) {
  Cg(this);
  x.i.jg(a) ||
    (this.o.Vm(a, new D(this.o.u ? -this.ma : this.ma, this.Fa)),
    (this.Ci = x.O(document, "mouseup", this, this.hy)),
    (this.gp = x.O(document, "mousemove", this, this.Ap)),
    x.Qb());
  a.stopPropagation();
};
d.ew = function(a) {
  x.i.pb(this.Br, "blocklyDeleteIconHighlighted");
  a.stopPropagation();
};
d.fw = function() {
  x.i.Rb(this.Br, "blocklyDeleteIconHighlighted");
};
d.gw = function(a) {
  this.A(!0, !0);
  a.stopPropagation();
...
function Bg(a, b, c) {
  ...
  a.u &&
    (a.Ik.setAttribute("transform", "scale(-1 1)"),
    a.Eg.setAttribute("transform", "scale(-1 1)"));
  a.Mb &&
    (a.u
      ? (a.Mb.setAttribute(
          "transform",
      ...
      : (a.Mb.setAttribute(
        ...
        a.Sf.setAttribute("transform", "translate(" + (b - 8) + ",-8)")));
  b = a.Hb();
...
d.Lp = function() {
  ...
  setTimeout(function() {
    ...
    x.i.pb(a.Dh, "blocklyCommentHandleTargetFocused");
  }, 0);
};
function Ff(a) {
  a.Bj = !1;
  setTimeout(function() {
    ...
    x.i.Rb(a.Dh, "blocklyCommentHandleTargetFocused");
  }, 0);
}
function Dg(a) {
  this.mj = a;
...
d.Yl = function() {
  return x.i.Bc(this.ab);
};
d.jj = function(a) {
  if (!a)
    throw "Couldn't clear and hide the drag surface: missing new surface.";
  var b = this.ab.childNodes[0],
    c = this.ab.childNodes[1];
  if (
    !(
      b &&
      c &&
      x.i.ds(b, "blocklyBlockCanvas") &&
      x.i.ds(c, "blocklyBubbleCanvas")
    )
  )
...
x.F.gq = function(a, b) {
  var c = G("xml");
  c.appendChild(x.F.My(x.H.Gq(a)));
  for (var e = gd(a, !0), f = 0, h; (h = e[f]); f++) c.appendChild(h.Jk(b));
  a = fd(a, !0);
  for (f = 0; (e = a[f]); f++) c.appendChild(x.F.Cn(e, b));
  return c;
};
x.F.My = function(a) {
  for (var b = G("variables"), c = 0, e; (e = a[c]); c++) {
    var f = G("variable", null, e.name);
...
x.F.tw = function(a) {
  if (a.name && a.Mg) {
    if (a.sh()) return x.F.sw(a);
    var b = G("field", null, a.getValue());
...
x.F.Rf = function(a, b) {
  ...
  if ((e = a.Ol())) {
    e = G("comment", null, e);
    if ("object" == typeof a.Ya) {
      e.setAttribute("pinned", a.Ya.Y());
      var f = a.Ya.ah();
  ...
  a.data && ((e = G("data", null, a.data)), c.appendChild(e));
  f = 0;
  for (var h; (h = a.X[f]); f++) {
    var k,
      l = !0;
    if (h.type != x.We) {
      var m = J(h.connection);
      h.type == x.$a
        ? (k = G("value"))
        : h.type == x.yb && (k = G("statement"));
      e = h.connection.Qe;
  ...
  if ((f = Oc(a))) (k = G("next", null, x.F.Rf(f, b))), c.appendChild(k);
  e = a.L && a.L.Qe;
  ...
  for (var b = (a = a.cloneNode(!0)), c; b; )
    if (b.firstChild) b = b.firstChild;
      ...
      for (; b && !b.nextSibling; )
        (c = b),
          (b = b.parentNode),
          3 == c.nodeType && "" == c.data.trim() && b.firstChild != c && H(c);
      b &&
        ((c = b),
        (b = b.nextSibling),
        3 == c.nodeType && "" == c.data.trim() && H(c));
    }
  return a;
};
x.F.Gd = function(a) {
...
x.F.nC = function(a, b) {
  ...
  if (e && e.height) {
    ...
    var m;
    b.u && (m = b.hd());
    for (e = 0; e < a.length; e++) Nc(b, a[e]).moveBy(b.u ? m - f : f, c);
  }
  return a;
};
x.F.gi = function(a, b) {
  ...
  try {
    ...
    if (b.R) {
      Hg(e, !0);
      for (var h = f.length - 1; 0 <= h; h--) f[h].Ec();
      for (h = f.length - 1; 0 <= h; h--) f[h].aa(!1);
      setTimeout(function() {
        e.o && Hg(e, !1);
      }, 1);
      sf(e);
      Gf(b);
    } else for (h = f.length - 1; 0 <= h; h--) f[h].hh();
  } finally {
    x.j.enable();
  }
  if (x.j.isEnabled()) {
    a = x.H.Tr(b, c);
    for (h = 0; h < a.length; h++) x.j.V(new Fc(a[h]));
    x.j.V(new x.j.Vk(e));
  }
  return e;
};
    ...
    if (3 != k.nodeType) {
      ...
      switch (k.nodeName.toLowerCase()) {
        ...
        case "statement":
          ...
          h &&
            ((h = x.F.ao(h, b)),
            h.M ? k.connection.connect(h.M) : h.$ && k.connection.connect(h.$));
          break;
        case "next":
          l && c.L && (c.L.Qe = l);
          h && ((h = x.F.ao(h, b)), c.L.connect(h.$));
          break;
        default:
...
x.F.ow = function(a, b, c) {
  var e = He(a, b);
  e
    ? ((a = a.o),
      (b = c.textContent),
      e.sh() ? x.F.nw(a, c, b, e) : e.setValue(b))
...
d.Ef = 0;
d.T = function() {
  this.w = x.i.B("g", { class: "blocklyZoom" }, null);
  var a = String(Math.random()).substring(2);
  Jg(this, a);
  Kg(this, a);
  Lg(this, a);
...
d.position = function() {
  ...
  a &&
    (this.m.u
      ...
      : ((this.Jb = a.Aa + a.ob - this.Qg - this.Yi - I),
        a.Ea == x.se && (this.Jb -= a.Kl)),
    (this.Ef = a.fb + a.zb - this.rq - this.gj),
    a.Ea == x.Pg && (this.Ef -= a.Qr),
    this.w.setAttribute(
      "transform",
      "translate(" + this.Jb + "," + this.Ef + ")"
...
function Ng(a, b, c) {
  ...
  x.ra && x.ra.Uf && (this.Pi[x.xq] = x.ra.Uf);
}
w(Ng, dd);
d = Ng.prototype;
d.Jm = null;
...
function pg(a) {
  if (a.Yj) {
    var b = L(a).getScreenCTM();
    b && ((a.ps = b.inverse()), (a.Yj = !1));
  }
  return a.ps;
}
function ff(a, b) {
  var c = 0,
    e = 0,
    f = 1;
  if (je(a.Va, b) || je(a.qe, b)) f = a.scale;
  do {
    var h = x.i.Bc(b);
    if (b == a.Va || b == a.qe) f = 1;
    c += h.x * f;
    e += h.y * f;
    b = b.parentNode;
  } while (b && b != L(a));
...
d.T = function(a) {
  ...
  a &&
    ...
    "blocklyMainBackground" == a &&
      this.Kd &&
      (this.pd.style.fill = "url(#" + this.Kd.pi.id + ")"));
  ...
  this.options.dc &&
    this.options.dc.controls &&
    ((this.Mh = new Ig(this)),
    (b = this.Mh.T()),
    this.w.appendChild(b),
    this.Mh.I(a));
  this.je ||
    (x.O(this.w, "mousedown", this, this.tf, !1, !0),
    this.options.dc &&
      this.options.dc.Oy &&
      x.O(this.w, "wheel", this, this.$x));
...
function Gf(a) {
  a.Bp && a.R && (a.kb && a.kb.resize(), (a.Yj = !0));
}
d.resize = function() {
  this.ga && this.ga.position();
...
d.pa = function(a) {
  this.kb && this.kb.wh(a);
  (this.J || (this.ga && this.ga.J)) &&
    (this.J ? this.J : this.ga ? this.ga.J : null).wh(a);
  L(this).style.display = a ? "block" : "none";
  this.ga && (this.ga.Nc.style.display = a ? "block" : "none");
  a ? (this.aa(), this.ga && this.ga.position()) : x.Qb(!0);
};
d.aa = function() {
  for (var a = Tc(this), b = a.length - 1; 0 <= b; b--) a[b].aa(!1);
};
function Vg(a) {
  var b = x.kj;
  if (a.R && !(b.getElementsByTagName("block").length >= id(a)))
    if ((a.Eb && a.Eb.cancel(), "comment" == b.tagName.toLowerCase())) {
      x.j.disable();
      try {
        var c = If(b, a),
        ...
        if (!isNaN(k) && !isNaN(l)) {
          ...
          do {
            ...
            if (!b) {
              ...
              c = 0;
              for (var y; (y = t[c]); c++)
                if (y.closest(x.bd, new D(k, l)).connection) {
                  b = !0;
                  break;
                }
            }
            b && ((k = a.u ? k - x.bd : k + x.bd), (l += 2 * x.bd));
          } while (b);
          h.moveBy(k, l);
        }
      } finally {
      ...
      x.j.isEnabled() && !h.jb && x.j.V(new x.j.Vk(h));
      h.select();
    }
}
function Wg(a) {
  if ((a = a.je ? a.Fh : a) && !a.Eb && a.ga && a.ga.J) {
    a = a.ga;
    var b = a.Sd.Fe();
    b && b.ue && a.J.show(b.ue);
  }
}
d.vh = function(a, b) {
  Ng.s.vh.call(this, a, b);
  Wg(this);
};
d.Tf = function(a) {
  Ng.s.Tf.call(this, a);
...
d.ed = function(a, b, c) {
  a = Ng.s.ed.call(this, a, b, c);
  Wg(this);
  return a;
};
function Rg(a) {
  a.Ar = a.Yc && a.w.parentNode ? a.Yc.ki() : null;
  a.zr = a.J ? a.J.ki() : a.ga ? a.ga.ki() : null;
}
function xf(a, b) {
  b = new D(b.clientX, b.clientY);
  return a.Ar && a.Ar.contains(b)
    ? x.gn
    : a.zr && a.zr.contains(b)
    ? x.oq
    : x.nq;
}
d.tf = function(a) {
...
d.sb = function() {
  return null != this.Eb && this.Eb.sb();
};
d.$x = function(a) {
  this.Eb && this.Eb.cancel();
  var b = -a.deltaY / 50,
...
function Gg(a) {
  ...
  for (var c = 1; c < b.length; c++) {
    ...
    e.Ud.y > a.Ud.y && (a.Ud.y = e.Ud.y);
  }
  return {
    x: a.rd.x,
    y: a.rd.y,
    width: a.Ud.x - a.rd.x,
    height: a.Ud.y - a.rd.y
  };
}
d.Jv = function() {
  this.Tb(!1);
  x.j.S(!0);
  for (var a = fd(this, !0), b = 0, c = 0, e; (e = a[c]); c++) {
    var f = e.oa();
    e.moveBy(-f.x, b - f.y);
    Xg(e);
    b = e.oa().y + e.Hb().height + 25;
  }
  x.j.S(!1);
  this.Tb(!0);
};
d.Oi = function(a) {
  ...
  if (!this.options.readOnly && !this.je) {
    ...
    this.kb &&
      ...
      (l.gb = this.Jv.bind(this)),
      e.push(l));
    if (this.options.collapse) {
      for (var m = (l = !1), n = 0; n < f.length; n++)
        for (var p = f[n]; p; )
          p.isCollapsed() ? (l = !0) : (m = !0), (p = Oc(p));
      var t = function(a) {
        for (var b = 0, c = 0; c < f.length; c++)
          for (var e = f[c]; e; )
            setTimeout(e.zg.bind(e, a), b), (e = Oc(e)), (b += 10);
      };
      m = { enabled: m };
    ...
    l = {
      text:
        1 == y.length
          ? x.g.DELETE_BLOCK
          : x.g.DELETE_X_BLOCKS.replace("%1", String(y.length)),
      enabled: 0 < y.length,
      gb: function() {
        k.Eb && k.Eb.cancel();
        2 > y.length
          ? c()
          : x.confirm(x.g.DELETE_ALL_BLOCKS.replace("%1", y.length), function(
              a
            ) {
              a && c();
            });
...
d.Rt = function(a) {
  if ((a = eg(a))) {
    ...
    if (a.getElementsByTagName("category").length) {
      ...
      if (!this.J) throw "Existing toolbox has categories.  Can't change mode.";
      this.options.Ke = a;
      this.J.show(a.childNodes);
    }
  } else if (this.options.Ke) throw "Can't nullify an existing toolbox.";
};
function Vf(a) {
  if (a.options.Lb) Vf(a.options.Lb);
  else {
    x.ng = a;
    ...
    try {
      ...
      try {
        L(a).parentNode.setActive();
      } catch (c) {
        L(a).parentNode.focus();
      }
    }
  }
}
d.zoom = function(a, b, c) {
  var e = this.options.dc.jy,
    f = this.ub(),
  ...
  e = Math.pow(e, c);
  c = this.scale * e;
  c > this.options.dc.ik
    ? (e = this.options.dc.ik / this.scale)
    : c < this.options.dc.jk && (e = this.options.dc.jk / this.scale);
  this.scale != c &&
    (this.kb &&
      ((a = h
        .getCTM()
        ...
        .scale(e)),
      (this.scrollX = a.e - f.ob),
      (this.scrollY = a.f - f.zb)),
    this.setScale(c));
};
function Mg(a, b) {
  var c = a.ub();
  a.zoom(c.Aa / 2, c.fb / 2, b);
}
d.setScale = function(a) {
  this.options.dc.ik && a > this.options.dc.ik
    ? (a = this.options.dc.ik)
    : this.options.dc.jk && a < this.options.dc.jk && (a = this.options.dc.jk);
  this.scale = a;
  this.Kd && this.Kd.update(this.scale);
...
function zg(a, b) {
  a.Zg.CREATE_VARIABLE = b;
}
function ah(a, b) {
  return (a = a.Zg[b]) ? a : null;
}
function bh(a, b) {
  return (a = a.Pi[b]) ? a : null;
}
d.Ee = function(a) {
  var b =
      "mousedown" == a.type ||
  ...
  return c
    ? b && c.hs
      ...
      : c
    : b
    ? (this.Eb = new qg(a, this))
    : null;
};
Ng.prototype.setVisible = Ng.prototype.pa;
function ch(a) {
  ch.s.constructor.call(this, null);
  this.kt = a;
}
w(ch, Le);
d = ch.prototype;
...
d.Eo = function(a) {
  Pe(this.U) && Le.prototype.Eo.call(this, a);
};
d.pj = function() {
  this.Gk = x.i.B("svg", { x: xe, y: xe }, null);
  if (this.kt.length)
    for (var a = G("xml"), b = 0, c; (c = this.kt[b]); b++)
      a.appendChild(G("block", { type: c }));
  else a = null;
  a = {
    Ke: a,
    Lb: this.U.o,
    le: this.U.o.options.le,
    u: this.U.u,
    Ea: this.U.u ? x.se : x.Mf,
    He: !1,
    ub: this.Bw.bind(this),
    Bg: null
  };
  this.m = new Ng(a);
  this.m.ak = !0;
  ...
  this.Gk.appendChild(b);
  return this.Gk;
};
d.If = function() {
  this.U.vb ||
    (Pe(this.U)
      ? this.Dc && x.i.Rb(this.Dc, "blocklyIconGroupReadonly")
      : (this.pa(!1), this.Dc && x.i.pb(this.Dc, "blocklyIconGroupReadonly")));
  Le.prototype.If.call(this);
};
d.Hm = function() {
  var a = 2 * xe,
  ...
  if (this.m.J) {
    var e = this.m.J.lf();
    b = Math.max(b, e.uc + 20);
  }
  c += 3 * a;
  if (Math.abs(this.Ui - c) > a || Math.abs(this.Rk - b) > a)
    (this.Ui = c),
      (this.Rk = b),
      this.bb.yg(c + a, b + a),
      this.Gk.setAttribute("width", this.Ui),
      this.Gk.setAttribute("height", this.Rk);
  this.U.u &&
    this.m.Va.setAttribute("transform", "translate(" + this.Ui + ",0)");
  this.m.resize();
};
d.pa = function(a) {
  if (a != this.Y())
    if ((x.j.V(new Ic(this.U, "mutatorOpen", !a, a)), a)) {
      ...
      De(this.bb, this.U.id);
      if ((a = this.m.options.Ke))
        this.m.J.I(this.m), this.m.J.show(a.childNodes);
      ...
      (this.Gk = null),
        ...
        (this.bb = null),
        (this.Rk = this.Ui = 0),
        this.Sm && (this.U.o.ug(this.Sm), (this.Sm = null));
};
d.Py = function() {
  if (!this.m.sb())
    for (var a = fd(this.m, !1), b = 0, c; (c = a[b]); b++) {
      var e = c.oa(),
        f = c.Hb();
  ...
  if (this.wf.o == this.m) {
    ...
    b = (b = c.Ka()) && x.F.Gd(b);
    if (a != b) {
      x.j.V(new x.j.Mc(c, "mutation", null, a, b));
      var h = x.j.Ac();
      setTimeout(function() {
        x.j.S(h);
        c.qb();
...
d.Bw = function() {
  return { fb: this.Rk, Aa: this.Ui, zb: 0, ob: 0 };
};
d.A = function() {
  this.U.kd = null;
  Le.prototype.A.call(this);
...
function eh(a) {
  ...
  if (a && a.options) {
    var c = a.options.Lb;
    a.je ? c && c.options && (b = c.options.Lb) : c && (b = c);
  }
  return b;
}
g.Blockly || (g.Blockly = {});
...
x.N = {};
x.N.cn = {};
x.N.register = function(a, b) {
  if (!q(a) || Ga(a)) throw Error('Error: Invalid extension name "' + a + '"');
  if (x.N.cn[a])
    throw Error('Error: Extension "' + a + '" is already registered.');
  if (!v(b)) throw Error('Error: Extension "' + a + '" must be a function');
  x.N.cn[a] = b;
};
x.N.Em = function(a, b) {
  if (!ha(b)) throw Error('Error: Mixin "' + a + '" must be a object');
  x.N.register(a, function() {
    fh(this, b);
  });
};
x.N.wp = function(a, b, c, e) {
  var f = 'Error when registering mutator "' + a + '": ';
  x.N.Oq(f, b.hb, "domToMutation");
  x.N.Oq(f, b.Ka, "mutationToDom");
  var h = x.N.Qq(b, f);
  if (c && !v(c)) throw Error('Extension "' + a + '" is not a function');
  x.N.register(a, function() {
    h && this.Cg(new ch(e));
    fh(this, b);
    c && c.apply(this);
...
x.N.apply = function(a, b, c) {
  var e = x.N.cn[a];
  if (!v(e)) throw Error('Error: Extension "' + a + '" not found.');
  if (c) x.N.Hv(a, b);
  else var f = x.N.ro(b);
  e.apply(b);
  if (c) x.N.Fv('Error after applying mutator "' + a + '": ', b);
  else if (!x.N.Cx(f, b))
    throw Error(
...
x.N.jl = function(a, b) {
  ...
  "object" == typeof document &&
    x.i.st(function() {
      for (var a in b) x.i.Pq(b[a]);
    });
  return function() {
    this.type &&
      -1 === c.indexOf(this.type) &&
      (x.N.Gv(this, a, b), c.push(this.type));
    this.ka(
      function() {
        var e = F(this, a),
          f = b[e];
...
x.N.En = function(a) {
  ...
  return function() {
    this.ka(
      function() {
        var b = He(this, "VAR");
        return x.i.pc(a).replace("%1", b ? b.Ib() : "");
      }.bind(this)
    );
  };
};
...
function ag() {
  var a = document,
    b = a.body;
  a = a.documentElement;
  return new D(b.scrollLeft || a.scrollLeft, b.scrollTop || a.scrollTop);
}
function kh(a) {
  try {
...
function lh(a) {
  var b = Yd(a),
    c = new D(0, 0);
  var e = b ? Yd(b) : document;
  e =
    !A || 9 <= Number(yb) || "CSS1Compat" == Wd(e).fd.compatMode
      ? e.documentElement
      : e.body;
  if (a == e) return c;
  a = kh(a);
...
function nh(a) {
  var b = oh;
  if ("none" != jh(a, "display")) return b(a);
  var c = a.style,
    e = c.display,
    f = c.visibility,
    h = c.position;
...
function oh(a) {
  ...
  return (aa(b) && !e) || !a.getBoundingClientRect
    ? new Vd(b, c)
    : ((a = kh(a)), new Vd(a.right - a.left, a.bottom - a.top));
}
function ph(a, b) {
...
function rh(a, b, c) {
  ...
  if (qh) {
    if (((b = b ? "none" : ""), a.style && (a.style[qh] = b), c)) {
      a = 0;
      for (var e; (e = c[a]); a++) e.style && (e.style[qh] = b);
    }
  } else if (A || lb)
...
var vh = {};
function wh(a, b) {
  if (!q(a) || Ga(a)) throw Error('Invalid field type "' + a + '"');
  if (!ha(b) || !v(b.la))
...
d.I = function() {
  this.Za ||
    ((this.Za = x.i.B("g", {}, null)),
    this.Ma || (this.Za.style.display = "none"),
    (this.Cd = x.i.B(
      "rect",
    ...
    (this.Ba = x.i.B(
      "text",
      { class: "blocklyText", y: this.wa.height - 12.5 },
      this.Za
    )),
    this.If(),
    this.v.ha().appendChild(this.Za),
    (this.sm = x.O(this.Za, "mousedown", this, this.tf)),
    this.Ne());
};
d.hh = function() {};
d.A = function() {
  this.sm && (x.Qa(this.sm), (this.sm = null));
  this.v = null;
  H(this.Za);
...
d.If = function() {
  ...
  this.Mg &&
    a &&
    (Pe(this.v)
      ? (x.i.pb(a, "blocklyEditableText"),
        x.i.Rb(a, "blocklyNonEditableText"),
        (this.Za.style.cursor = this.Xk))
      : (x.i.pb(a, "blocklyNonEditableText"),
        x.i.Rb(a, "blocklyEditableText"),
        (this.Za.style.cursor = "")));
};
d.Y = function() {
  return this.Ma;
};
...
d.Ne = function() {
  this.Ma ? ((this.Ba.textContent = Ah(this)), this.Qk()) : (this.wa.width = 0);
};
d.Qk = function() {
  var a = Bh(this.Ba);
...
function Bh(a) {
  var b = a.textContent + "\n" + a.className.baseVal,
    c;
  if (xh && (c = xh[b])) return c;
  try {
    c = A || mb ? a.getBBox().width : a.getComputedTextLength();
  } catch (e) {
...
d.Ob = function(a) {
  null !== a && ((a = String(a)), a !== this.ya && ((this.ya = a), this.Cj()));
};
d.Cj = function() {
  this.wa.width = 0;
...
d.setValue = function(a) {
  if (null !== a) {
    ...
    b != a &&
      (this.v &&
        x.j.isEnabled() &&
        x.j.V(new x.j.Mc(this.v, "field", this.name, b, a)),
      this.Ob(a));
  }
};
d.tf = function(a) {
  this.v && this.v.o && (a = this.v.o.Ee(a)) && !a.Ch && (a.Ch = this);
};
d.ka = function() {};
d.sh = function() {
  return !1;
...
d.I = function() {
  this.Ba ||
    ((this.Ba = x.i.B(
      "text",
      { class: "blocklyText", y: this.wa.height - 5 },
      null
    )),
    this.Sq && x.i.pb(this.Ba, this.Sq),
    this.Ma || (this.Ba.style.display = "none"),
    this.v.ha().appendChild(this.Ba),
    (this.Ba.qd = this.v),
    x.C.Rg(this.Ba),
    this.Ne());
};
...
d.Ma = !0;
function O(a, b, c) {
  Fh(a, a.Oa.length, b, c);
  return a;
}
function Fh(a, b, c, e) {
  if (0 > b || b > a.Oa.length) throw Error("index " + b + " out of bounds.");
  if (!c && !e) return b;
  q(c) && (c = new Dh(c));
  c.Qp(a.v);
  a.v.R && c.I();
...
d.pa = function(a) {
  var b = [];
  if (this.Ma == a) return b;
  for (
    var c = (this.Ma = a) ? "block" : "none", e = 0, f;
    (f = this.Oa[e]);
    e++
  )
    f.pa(a);
  if (this.connection) {
    if (a) b = pf(this.connection);
    else if (((e = this.connection), qf(e, !0), e.Ia))
      for (e = Ac(J(e), !1), f = 0; f < e.length; f++) {
        for (var h = e[f], k = h.De(!0), l = 0; l < k.length; l++) qf(k[l], !0);
        h = vf(h);
        for (l = 0; l < h.length; l++) h[l].pa(!1);
      }
    if ((e = J(this.connection))) (e.ha().style.display = c), a || (e.R = !1);
  }
  return b;
};
d.Ua = function(a) {
  if (!this.connection) throw "This input does not have a connection.";
  this.connection.Ua(a);
  return this;
};
function Hh(a, b) {
  a.align = b;
...
d.I = function() {
  if (this.v.o.R) for (var a = 0; a < this.Oa.length; a++) this.Oa[a].I();
};
d.A = function() {
  for (var a = 0, b; (b = this.Oa[a]); a++) b.A();
  this.connection && this.connection.A();
  this.v = null;
};
function Qe(a) {
  Qe.s.constructor.call(this, a);
  Me(this);
  this.ya = {};
}
w(Qe, Le);
...
d.pa = function(a) {
  if (a != this.Y())
    if ((x.j.V(new Ic(this.U, "warningOpen", !a, a)), a)) {
      ...
      a = x.i.B(
        "text",
        { class: "blocklyText blocklyBubbleText", y: xe },
        null
      );
      b = b.split("\n");
      for (var c = 0; c < b.length; c++)
        x.i
          .B("tspan", { dy: "1em", x: xe }, a)
      ...
      if (this.U.u) {
        ...
        for (var e; (e = a.childNodes[c]); c++)
          e.setAttribute("text-anchor", "end"), e.setAttribute("x", b + xe);
      }
      this.Hf();
      a = this.bb.ah();
...
d.Ob = function(a, b) {
  this.ya[b] != a &&
    (a ? (this.ya[b] = a) : delete this.ya[b],
    this.Y() && (this.pa(!1), this.pa(!0)));
};
d.Ib = function() {
  var a = [],
    b;
  for (b in this.ya) a.push(this.ya[b]);
  return a.join("\n");
};
d.A = function() {
  this.U.ud = null;
...
function hd(a, b, c) {
  "undefined" !== typeof Ih.prototype[b] &&
    console.warn(
  ...
  if (x.j.isEnabled()) {
    (a = x.j.Ac()) || x.j.S(!0);
    try {
      x.j.V(new x.j.Vk(this));
    } finally {
      a || x.j.S(!1);
    }
  }
  if (v(this.onchange)) {
    if ((a = this.onchange) && !v(a))
      throw Error("onchange must be a function.");
    this.mk && this.o.ug(this.mk);
    if ((this.onchange = a)) (this.mk = a.bind(this)), this.o.Ad(this.mk);
  }
}
d = hd.prototype;
d.data = null;
...
d.A = function(a) {
  if (this.o) {
    ...
    x.j.disable();
    try {
      this.o && (ed(this.o, this), delete this.o.Bn[this.id], (this.o = null));
      x.selected == this && (x.selected = null);
      for (var b = this.bf.length - 1; 0 <= b; b--) this.bf[b].A(!1);
      b = 0;
      for (var c; (c = this.X[b]); b++) c.A();
      this.X.length = 0;
      var e = this.De(!0);
...
function Ke(a, b) {
  if (a.M) a.M.isConnected() && a.M.disconnect();
  else if (a.$) {
    var c = null;
    a.$.isConnected() && ((c = a.$.Ia), a.$.disconnect());
    var e = Oc(a);
    b && e && ((a = a.L.Ia), a.disconnect(), c && Te(c, a) && c.connect(a));
  }
}
d.De = function() {
  var a = [];
...
d.Vf = function(a) {
  ...
  for (var b = 0, c; (c = this.X[b]); b++)
    c.connection && (c = J(c.connection)) && a.push(c);
  (b = Oc(this)) && a.push(b);
  return a;
};
d.yh = function(a) {
...
function Ac(a, b) {
  var c = [a];
  a = a.Vf(b);
  for (var e, f = 0; (e = a[f]); f++) c.push.apply(c, Ac(e, b));
  return c;
}
d.lc = function() {
  return this.uj && !this.jb && !(this.o && this.o.options.readOnly);
};
d.Jp = function(a) {
  this.uj = a;
};
d.Je = function() {
  return this.lk && !this.jb && !(this.o && this.o.options.readOnly);
};
d.xh = function(a) {
  this.lk = a;
};
...
function Hg(a, b) {
  if (!b && a.isCollapsed()) {
    ...
    a = a.De(!0);
    for (var e = 0; (c = a[e]); e++) qf(c, b), Xe(c) && (c = J(c)) && Hg(c, b);
  }
}
d.ka = function(a) {
  this.qd = a;
...
d.Ha = function(a) {
  var b = q(a) ? x.i.pc(a) : a,
    c = Number(b);
  if (!isNaN(c) && 0 <= c && 360 >= c) this.we = x.ns(c);
...
function He(a, b) {
  for (var c = 0, e; (e = a.X[c]); c++)
    for (var f = 0, h; (h = e.Oa[f]); f++) if (h.name === b) return h;
  return null;
}
d.wo = function() {
  for (var a = [], b = 0, c; (c = this.X[b]); b++)
    for (var e = 0, f; (f = c.Oa[e]); e++) f.sh() && a.push(f.getValue());
  return a;
};
d.Wf = function() {
  for (var a = [], b = 0, c; (c = this.X[b]); b++)
    for (var e = 0, f; (f = c.Oa[e]); e++)
      f.sh() && (f = this.o.fe(f.getValue())) && a.push(f);
  return a;
};
d.Zm = function(a) {
  for (var b = 0, c; (c = this.X[b]); b++)
    for (var e = 0, f; (f = c.Oa[e]); e++)
      f.sh() && a.ba() == f.getValue() && f.Ob(a.name);
};
d.wk = function(a, b) {
  for (var c = 0, e; (e = this.X[c]); c++)
    for (var f = 0, h; (h = e.Oa[f]); f++)
      h.sh() && a == h.getValue() && h.setValue(b);
};
function F(a, b) {
  return (a = He(a, b)) ? a.getValue() : null;
}
function Kh(a, b, c) {
  He(a, c).setValue(b);
}
d.nd = function(a, b) {
  a
    ? (void 0 === b && (b = null),
      this.$ || (this.$ = this.gk(x.Lf)),
      this.$.Ua(b))
    : this.$ && (this.$.A(), (this.$ = null));
};
d.md = function(a, b) {
  a
    ? (void 0 === b && (b = null),
      this.L || (this.L = this.gk(x.yb)),
      this.L.Ua(b))
...
d.Ic = function(a, b) {
  a
    ? (void 0 === b && (b = null),
      this.M || (this.M = this.gk(x.Vh)),
      this.M.Ua(b))
    : this.M && (this.M.A(), (this.M = null));
};
d.bc = function(a) {
  this.gg != a &&
    (x.j.V(new x.j.Mc(this, "inline", null, this.gg, a)), (this.gg = a));
};
function gh(a) {
  if (void 0 != a.gg) return a.gg;
  for (var b = 1; b < a.X.length; b++)
    if (a.X[b - 1].type == x.We && a.X[b].type == x.We) return !1;
  for (b = 1; b < a.X.length; b++)
    if (a.X[b - 1].type == x.$a && a.X[b].type == x.We) return !0;
  return !1;
}
d.Pd = function(a) {
  this.disabled != a &&
    (x.j.V(new x.j.Mc(this, "disabled", null, this.disabled, a)),
    (this.disabled = a));
};
function Lh(a) {
  for (a = Jh(a); a; ) {
...
d.zg = function(a) {
  this.ve != a &&
    (x.j.V(new x.j.Mc(this, "collapsed", null, this.ve, a)), (this.ve = a));
};
d.toString = function(a, b) {
  var c = [],
    e = b || "?";
  if (this.ve) c.push(K(this, "_TEMP_COLLAPSED_INPUT").Oa[0].ya);
  else
    for (var f = 0, h; (h = this.X[f]); f++) {
      for (var k = 0, l; (l = h.Oa[k]); k++)
        l instanceof P && !l.getValue() ? c.push(e) : c.push(l.Ib());
      h.connection &&
        ((h = J(h.connection)) ? c.push(h.toString(void 0, b)) : c.push(e));
    }
  c = Ia(c.join(" ")) || "???";
...
function Nh(a, b) {
    ...
    for (t = 0; t < p.length; t++)
      if (((m = p[t]), "string" == typeof m)) h.push([m, void 0]);
        ...
        if (y) h.push([y, m.name]);
          ...
          m.check && l.Ua(m.check);
          m.align && Hh(l, k[m.align]);
          for (m = 0; m < h.length; m++) O(l, h[m][0], h[m][1]);
          h.length = 0;
        }
      }
    e++;
  ...
  void 0 !== b.mutator && x.N.apply(b.mutator, a, !0);
...
function Oh(a, b, c) {
  if (b != c) {
    for (var e = -1, f = c ? -1 : a.X.length, h = 0, k; (k = a.X[h]); h++)
      if (k.name == b) {
        if (((e = h), -1 != f)) break;
  ...
  for (var b = 0, c; (c = this.X[b]); b++)
    if (c.name == a) {
      c.connection &&
        ...
        ((c.connection.Qe = null), (a = J(c.connection)), a.jb ? a.A() : Ke(a));
      c.A();
      this.X.splice(b, 1);
      break;
    }
...
function K(a, b) {
  for (var c = 0, e; (e = a.X[c]); c++) if (e.name == b) return e;
  return null;
}
function Ph(a, b) {
  return (a = K(a, b)) && a.connection && J(a.connection);
}
d.Ol = function() {
  return this.Ya || "";
};
d.xf = function(a) {
  this.Ya != a &&
    (x.j.V(new x.j.Mc(this, "comment", null, this.Ya, a || "")), (this.Ya = a));
};
d.Pe = function() {};
d.Cg = function() {};
d.oa = function() {
...
x.i.Si = {};
x.i.Si.nf = function(a) {
  a = a.G();
  var b = nh(a);
  b.height = a.scrollHeight;
  return b;
};
x.i.Si.Fq = function(a, b, c) {
  b.left += c.width;
  b.right += c.width;
  a.left += c.width;
  a.right += c.width;
...
d = Qh.prototype;
d.ia = function(a, b, c, e) {
  u(b) || (b && (Rh[0] = b.toString()), (b = Rh));
  for (var f = 0; f < b.length; f++) {
    var h = ec(a, b[f], c || this.handleEvent, e || !1, this.ti || this);
    if (!h) break;
    this.yi[h.key] = h;
  }
  return this;
...
d.zs = function(a, b, c, e) {
  return Sh(this, a, b, c, e);
};
function Sh(a, b, c, e, f, h) {
  if (u(c)) for (var k = 0; k < c.length; k++) Sh(a, b, c[k], e, f, h);
  else {
    b = fc(b, c, e || a.handleEvent, f, h || a.ti || a);
    if (!b) return a;
    a.yi[b.key] = b;
  }
  return a;
}
d.sd = function(a, b, c, e, f) {
  if (u(b)) for (var h = 0; h < b.length; h++) this.sd(a, b[h], c, e, f);
  else
...
d = Uh.prototype;
d.ba = function() {
  return this.ag || (this.ag = ":" + (this.ex.Fx++).toString(36));
};
function Xh(a, b) {
  if (a.Vc && a.Vc.Xd) {
    var c = a.Vc.Xd,
...
d.yh = function(a) {
  ...
  if (a && this.Vc && this.ag && Zh(this.Vc, this.ag) && this.Vc != a)
...
d.Pm = function(a) {
  if (this.Vc && this.Vc != a) throw Error("Method not supported");
  Uh.s.Pm.call(this, a);
};
d.Yb = function() {
  return this.Wg;
...
d.T = function() {
  this.P = this.Wg.createElement("DIV");
};
d.aa = function(a) {
  this.Ne(a);
};
...
d.Yh = function(a, b, c) {
  ...
  a.za && this.za && a.getParent() == this
    ...
    ? (this.P || this.T(),
      (b = S(this, b + 1)),
      a.Ne(this.yc(), b ? b.P : null))
    : this.za &&
      !a.za &&
      a.P &&
      a.P.parentNode &&
      1 == a.P.parentNode.nodeType &&
      a.rb();
};
d.yc = function() {
  return this.P;
...
function bi(a) {
  null == a.Ki && (a.Ki = "rtl" == jh(a.za ? a.P : a.Wg.fd.body, "direction"));
  return a.Ki;
}
d.Af = function(a) {
  if (this.za) throw Error("Component already rendered");
...
function ai(a) {
  return a.ic ? a.ic.length : 0;
}
function Zh(a, b) {
  a.Xd && b
    ? ((a = a.Xd), (b = (null !== a && b in a ? a[b] : void 0) || null))
    : (b = null);
  return b;
}
function S(a, b) {
  return a.ic ? a.ic[b] || null : null;
}
function $h(a, b, c) {
  a.ic && sa(a.ic, b, c);
}
function di(a, b) {
  return a.ic && b ? ra(a.ic, b) : -1;
}
...
d.ot = function(a) {
  for (var b = []; ci(this); ) b.push(this.removeChild(S(this, 0), a));
  return b;
};
var ei;
hb(
...
function hi(a, b, c, e, f, h) {
  if (C && !xb("525")) return !0;
  if (ob && f) return ii(a);
  if (f && !e) return !1;
  if (!B) {
    r(b) && (b = ji(b));
    var k = 17 == b || 18 == b || (ob && 91 == b);
    if (((!c || ob) && k) || (ob && 16 == b && (e || h))) return !1;
  }
  if ((C || mb) && e && c)
    switch (a) {
      case 220:
...
d.Lw = function(a) {
  ...
  pi && !hi(a.keyCode, this.Tc, a.shiftKey, a.ctrlKey, a.altKey, a.metaKey)
    ? this.handleEvent(a)
    : ((this.kg = ji(a.keyCode)), qi && (this.wn = a.altKey));
};
d.Mw = function(a) {
  this.kg = this.Tc = -1;
  this.wn = a.altKey;
...
d.handleEvent = function(a) {
  ...
  if (A && "keypress" == a.type) {
    ...
    (C || mb) && "keypress" == a.type
      ? ((e = this.kg),
        (f = 0 <= b.charCode && 63232 > b.charCode && ii(e) ? b.charCode : 0))
      : lb && !C
      ? ((e = this.kg), (f = ii(e) ? b.keyCode : 0))
      : ((e = b.keyCode || this.kg),
        (f = b.charCode || 0),
        qi && "keypress" == a.type && (c = this.wn),
        ob && 63 == f && 224 == e && (e = 191));
  var h = (e = ji(e));
  e
    ? 63232 <= e && e in ni
      ? (h = ni[e])
      : 25 == e && a.shiftKey && (h = 9)
    : b.keyIdentifier && b.keyIdentifier in oi && (h = oi[b.keyIdentifier]);
  (B &&
    pi &&
    "keypress" == a.type &&
    !hi(h, this.Tc, a.shiftKey, a.ctrlKey, c, a.metaKey)) ||
    ((a = h == this.Tc),
    (this.Tc = h),
    (b = new ri(h, f, a, b)),
    (b.altKey = c),
...
function ui(a, b) {
  return a.classList ? a.classList.contains(b) : xa(si(a), b);
}
function vi(a, b) {
  a.classList
    ? a.classList.add(b)
    : ui(a, b) || (a.className += 0 < a.className.length ? " " + b : b);
}
function wi(a, b) {
  if (a.classList)
    sa(b, function(b) {
...
function xi(a, b) {
  a.classList
    ...
    : ui(a, b) &&
      (a.className = ta(si(a), function(a) {
        return a != b;
      }).join(" "));
}
function yi(a, b) {
...
d.T = function(a) {
  return a.Yb().T("DIV", this.bh(a).join(" "));
};
d.yc = function(a) {
  return a;
};
...
d.Rp = function(a, b, c) {
  b == c + "-disabled"
    ...
    : b == c + "-horizontal"
    ? a.setOrientation(Fi)
    : b == c + "-vertical" && a.setOrientation(Gi);
};
function Ei(a, b, c) {
  if (c)
    for (var e = c.firstChild, f; e && e.parentNode == c; ) {
      ...
      if (1 == e.nodeType) {
        var h = a.po(e);
        h && ((h.P = e), b.isEnabled() || h.yf(!1), b.Xh(h), h.Fd(e));
      } else (e.nodeValue && "" != Ia(e.nodeValue)) || c.removeChild(e);
      e = f;
    }
}
d.po = function(a) {
...
d.Ej = function() {};
d.T = function(a) {
  return a.Yb().T("DIV", this.bh(a).join(" "), a.Rc());
};
d.yc = function(a) {
  return a;
};
...
d.Fd = function(a, b) {
  ...
  var c = this.yc(b);
  c && c.firstChild
    ? a.Li(c.firstChild.nextSibling ? Aa(c.childNodes) : c.firstChild)
    : a.Li(null);
  var e = 0,
    f = this.sa(),
    h = this.sa(),
  ...
  k || (n.push(f), h == f && (l = !0));
  l || n.push(h);
  (a = a.ce) && n.push.apply(n, a);
  if (A && !xb("7")) {
    var p = Ki(n);
    0 < p.length && (n.push.apply(n, p), (m = !0));
  }
  (k && l && !a && !m) || ti(b, n.join(" "));
  return b;
};
...
function Li(a, b, c) {
  if ((a = c || a.Ej()))
    (c = b.getAttribute("role") || null), a != c && fi(b, a);
}
function Mi(a, b, c) {
  var e = b.Hq;
  null != e && a.Hp(c, e);
...
d.Af = function(a, b) {
  this.xj(a, this.sa() + "-rtl", b);
};
d.qf = function(a) {
  var b;
  return a.Bb & 32 && (b = a.Pb()) ? ne(b) : !1;
};
d.zf = function(a, b) {
  var c;
  if (a.Bb & 32 && (c = a.Pb())) {
...
function Ni(a, b, c) {
  Ii || (Ii = { 1: "disabled", 8: "selected", 16: "checked", 64: "expanded" });
  b = Ii[b];
    ...
    b &&
      (q(b)
        ...
        : ((a = function(a) {
          ...
          u(b) ? sa(b, a) : !fa(b) || "nodeType" in b ? a(b) : sa(Aa(b), a))));
};
d.Pb = function(a) {
  return a.G();
};
...
function Ki(a, b) {
  ...
  b && (a = za(a, [b]));
  sa([], function(e) {
    !va(e, oa(xa, a)) || (b && !xa(e, b)) || c.push(e.join("_"));
  });
  return c;
}
d.Nl = function(a) {
...
d.Xl = function(a) {
  this.Ht || (this.ql || Oi(this), (this.Ht = db(this.ql)));
  a = parseInt(this.Ht[a], 10);
  return isNaN(a) ? 0 : a;
};
function Oi(a) {
  var b = a.sa();
...
d.ey = null;
d.Pb = function() {
  return this.Z.Pb(this);
};
d.Tl = function() {
  return this.mc || (this.mc = new li());
};
d.xj = function(a, b) {
  b
    ? a &&
      (this.ce ? xa(this.ce, a) || this.ce.push(a) : (this.ce = [a]),
      this.Z.xj(this, a, !0))
    : a &&
      this.ce &&
      ya(this.ce, a) &&
      (0 == this.ce.length && (this.ce = null), this.Z.xj(this, a, !1));
};
d.T = function() {
  var a = this.Z.T(this);
  this.P = a;
...
d.yc = function() {
  return this.Z.yc(this.G());
};
d.Vd = function(a) {
  return this.Z.Vd(a);
};
d.tj = function(a) {
  this.P = a = this.Z.Fd(this, a);
  Li(this.Z, a, this.Gj());
  this.hl || this.Z.Mm(a, !1);
...
d.rb = function() {
  ...
  this.Z.Wj(this);
  if (this.Bb & -2 && (this.Oj && Pi(this, !0), this.Bb & 32)) {
    var a = this.Pb();
    if (a) {
      var b = this.Tl();
      mi(b, a);
...
function Pi(a, b) {
  ...
  b
    ? (e
        ...
        .ia(f, [c.Sh, c.Qh], a.si)
        .ia(f, c.Zi, a.Ao),
      a.Fi && e.ia(f, "gotpointercapture", a.Cm),
      a.ri != ca && e.ia(f, "contextmenu", a.ri),
      A &&
        (xb(9) || e.ia(f, "dblclick", a.$r),
        a.Vj || ((a.Vj = new Qi(a)), Kb(a, oa(Lb, a.Vj)))))
    : (e
        .sd(f, c.$i, a.Pj)
        .sd(f, c.Rh, a.pf)
        .sd(f, [c.Sh, c.Qh], a.si)
        .sd(f, c.Zi, a.Ao),
      a.Fi && e.sd(f, "gotpointercapture", a.Cm),
      a.ri != ca && e.sd(f, "contextmenu", a.ri),
      A && (xb(9) || e.sd(f, "dblclick", a.$r), Lb(a.Vj), (a.Vj = null)));
}
d.Hd = function() {
  U.s.Hd.call(this);
...
d.pa = function(a, b) {
  return b || (this.Ma != a && this.dispatchEvent(a ? "show" : "hide"))
    ? ((b = this.G()) && this.Z.pa(b, a),
      this.isEnabled() && this.Z.zf(this, a),
      (this.Ma = a),
      !0)
    : !1;
};
...
d.yf = function(a) {
  ...
  (b && "function" == typeof b.isEnabled && !b.isEnabled()) ||
    !Ri(this, 1, !a) ||
    (a || (this.setActive(!1), this.Sb(!1)),
    this.Y() && this.Z.zf(this, a),
    this.Qd(1, !a, !0));
};
d.Sb = function(a) {
  Ri(this, 2, a) && this.Qd(2, a);
};
d.qs = function() {
  return !!(this.La & 4);
};
d.setActive = function(a) {
  Ri(this, 4, a) && this.Qd(4, a);
};
d.bk = function() {
  return !!(this.La & 8);
};
d.Mi = function(a) {
  Ri(this, 8, a) && this.Qd(8, a);
};
function Si(a, b) {
  Ri(a, 16, b) && a.Qd(16, b);
}
...
d.Qd = function(a, b, c) {
  c || 1 != a
    ? this.Bb & a &&
      b != !!(this.La & a) &&
      (this.Z.Qd(this, a, b), (this.La = b ? this.La | a : this.La & ~a))
    : this.yf(!b);
};
d.rc = function(a, b) {
  if (this.za && this.La & a && !b) throw Error("Component already rendered");
  !b && this.La & a && this.Qd(a, !1);
  this.Bb = b ? this.Bb | a : this.Bb & ~a;
};
function Ui(a, b) {
  return !!(a.zn & b) && !!(a.Bb & b);
}
function Ri(a, b, c) {
  return (
    !!(a.Bb & b) &&
    !!(a.La & b) != c &&
    (!(a.Bf & b) || a.dispatchEvent(Wh(b, c))) &&
    !a.ei
  );
}
d.Pj = function(a) {
...
d.Ao = function(a) {
  !Vi(a, this.G()) &&
    ...
    (Ui(this, 4) && this.setActive(!1), Ui(this, 2) && this.Sb(!1));
};
d.Cm = function(a) {
  var b = a.target;
...
d.pf = function(a) {
  this.isEnabled() &&
    ...
    !Tb(a) ||
      (C && ob && a.ctrlKey) ||
      (Ui(this, 4) && this.setActive(!0),
      this.Z && this.Z.qf(this) && this.Pb().focus()));
  this.hl || !Tb(a) || (C && ob && a.ctrlKey) || a.preventDefault();
};
d.si = function(a) {
  this.isEnabled() &&
    (Ui(this, 2) && this.Sb(!0),
    this.qs() && this.sg(a) && Ui(this, 4) && this.setActive(!1));
};
d.$r = function(a) {
  this.isEnabled() && this.sg(a);
};
d.sg = function(a) {
  Ui(this, 16) && Si(this, !(this.La & 16));
  Ui(this, 8) && this.Mi(!0);
  Ui(this, 64) && Ti(this, !this.wi());
...
function Qi(a) {
  ...
  a = this.xl.P;
  this.ti
    .ia(a, "mousedown", this.Nw)
    .ia(a, "mouseup", this.Ow)
    .ia(a, "click", this.Gw);
}
w(Qi, Hb);
var Xi = !A || 9 <= Number(yb);
Qi.prototype.Nw = function() {
  this.rl = !1;
};
Qi.prototype.Ow = function() {
  this.rl = !0;
};
function Yi(a, b) {
  if (!Xi) return (a.button = 0), (a.type = b), a;
...
Qi.prototype.Gw = function(a) {
  if (this.rl) this.rl = !1;
  else {
    var b = a.Ae,
      c = b.button,
      e = b.type,
...
d.cf = null;
d.Pb = function() {
  return this.Lo || this.Z.Pb(this);
};
d.Tl = function() {
  return this.mc || (this.mc = new li(this.Pb()));
};
d.T = function() {
  this.P = this.Z.T(this);
};
d.yc = function() {
  return this.Z.yc(this.G());
};
...
d.rb = function() {
  ...
  var b = this.Fi ? Pb : Ob;
  Yh(this)
    .ia(this, "enter", this.yo)
    .ia(this, "highlight", this.Kw)
    .ia(this, "unhighlight", this.Xw)
    .ia(this, "open", this.Pw)
    .ia(this, "close", this.Hw)
    .ia(a, b.Rh, this.pf)
    .ia(Yd(a), [b.Sh, b.Qh], this.Iw)
    .ia(a, [b.Rh, b.Sh, b.Qh, b.$i, b.Zi, "contextmenu"], this.Fw);
...
d.Kw = function(a) {
  ...
  if (-1 < b && b != this.va) {
    ...
    this.by &&
      this.Kb &&
      c != this.Kb &&
      (c.Bb & 64 ? Ti(c, !0) : Ti(this.Kb, !1));
  }
  b = this.G();
  null != a.target.G() && T(b, "activedescendant", a.target.G().id);
};
d.Xw = function(a) {
  a.target == S(this, this.va) && (this.va = -1);
...
d.Pw = function(a) {
  (a = a.target) &&
    a != this.Kb &&
    a.getParent() == this &&
    (this.Kb && Ti(this.Kb, !1), (this.Kb = a));
};
d.Hw = function(a) {
  ...
  b &&
    a.target.La & 2 &&
    c &&
    ((a = ""), c && (a = c.id), T(b, "activedescendant", a));
};
d.pf = function(a) {
  this.Yg && (this.Bi = !0);
  var b = this.Pb();
...
d.dh = function(a) {
  ...
  if (
    (b && "function" == typeof b.Ld && b.Ld(a)) ||
    (this.Kb &&
      this.Kb != b &&
      "function" == typeof this.Kb.Ld &&
      this.Kb.Ld(a))
  )
    return !0;
...
d.Xh = function(a, b) {
  Zi.s.Xh.call(this, a, b);
};
d.Yh = function(a, b, c) {
  a.Bf |= 2;
  a.Bf |= 64;
  (!this.qf() && this.ov) || a.rc(32, !1);
  a.za && 0 != a.Oj && Pi(a, !1);
  a.Oj = !1;
  var e = a.getParent() == this ? di(this, a) : -1;
  Zi.s.Yh.call(this, a, b, c);
  a.za && this.za && $i(this, a);
  a = e;
  -1 == a && (a = ai(this));
  a == this.va
    ? (this.va = Math.min(ai(this) - 1, b))
    : a > this.va && b <= this.va
    ? this.va++
    : a < this.va && b > this.va && this.va--;
};
d.removeChild = function(a, b) {
  if ((a = q(a) ? Zh(this, a) : a)) {
    var c = di(this, a);
    -1 != c &&
      (c == this.va ? (a.Sb(!1), (this.va = -1)) : c < this.va && this.va--);
    var e = a.G();
    e && e.id && this.cf && ((c = this.cf), (e = e.id), e in c && delete c[e]);
  }
  b = a = Zi.s.removeChild.call(this, a, b);
  b.za && 1 != b.Oj && Pi(b, !0);
  b.Oj = !0;
  return a;
};
...
d.pa = function(a, b) {
  if (b || (this.Ma != a && this.dispatchEvent(a ? "show" : "hide"))) {
    ...
    c &&
      (ph(c, a),
      this.qf() && Di(this.Pb(), this.Yg && this.Ma),
      b || this.dispatchEvent(this.Ma ? "aftershow" : "afterhide"));
    return !0;
  }
  return !1;
};
...
d.yf = function(a) {
  this.Yg != a &&
    ...
    (a
      ? ((this.Yg = !0),
        $h(this, function(a) {
          a.Wt ? delete a.Wt : a.yf(!0);
        }))
      : ($h(this, function(a) {
          a.isEnabled() ? a.yf(!1) : (a.Wt = !0);
        }),
        (this.Bi = this.Yg = !1)),
    this.qf() && Di(this.Pb(), a && this.Ma));
};
d.qf = function() {
  return this.$g;
};
d.zf = function(a) {
  a != this.$g && this.za && aj(this, a);
  this.$g = a;
...
d.T = function(a) {
  var b = a.Yb().T("DIV", this.bh(a).join(" "), lj(this, a.Rc(), a.Yb()));
  mj(this, a, b, !!(a.Bb & 8) || !!(a.Bb & 16));
  return b;
};
d.yc = function(a) {
...
d.Fd = function(a, b) {
  if (aa(b.firstElementChild)) var c = b.firstElementChild;
  else for (c = b.firstChild; c && 1 != c.nodeType; ) c = c.nextSibling;
  var e = kj(this, 2);
  (c && ui(c, e)) || b.appendChild(lj(this, b.childNodes, a.Yb()));
  ui(b, "goog-option") && (a.yk(!0), this.yk(a, b, !0));
  return jj.s.Fd.call(this, a, b);
};
d.Od = function(a, b) {
  var c = this.yc(a),
...
function mj(a, b, c, e) {
  ...
  Mi(a, b, c);
  e != nj(a, c) &&
    (e ? vi(c, "goog-option") : xi(c, "goog-option"),
    (c = a.yc(c)),
    e
      ? ((a = kj(a, 1)),
        c.insertBefore(b.Yb().T("DIV", a), c.firstChild || null))
...
d.rc = function(a, b) {
  oj.s.rc.call(this, a, b);
  switch (a) {
    case 8:
      this.La & 16 && !b && Si(this, !1);
      (a = this.G()) && this.Z.wt(this, a, b);
      break;
    case 16:
...
d.Ml = function() {
  ...
  return u(a)
    ? ((a = ua(a, function(a) {
        return ha(a) &&
          1 == a.nodeType &&
          (ui(a, "goog-menuitem-accel") ||
            ui(a, "goog-menuitem-mnemonic-separator"))
          ? ""
          : te(a);
      }).join("")),
      Ha(a))
...
d.si = function(a) {
  ...
  if (b) {
    var c = b.$s;
    b.$s = null;
    if (c && r(a.clientX) && vc(c, new D(a.clientX, a.clientY))) return;
  }
  oj.s.si.call(this, a);
};
d.dh = function(a) {
  return a.keyCode == this.Gs && this.sg(a) ? !0 : oj.s.dh.call(this, a);
};
d.Dw = function() {
  return this.Gs;
};
zi("goog-menuitem", function() {
  return new oj(null);
});
oj.prototype.Gj = function() {
  return this.Bb & 16
    ? "menuitemcheckbox"
    : this.Bb & 8
    ? "menuitemradio"
...
oj.prototype.getParent = function() {
  return U.prototype.getParent.call(this);
};
oj.prototype.Wl = function() {
  return U.prototype.Wl.call(this);
};
function pj() {}
w(pj, Hi);
da(pj);
pj.prototype.T = function(a) {
  return a.Yb().T("DIV", this.sa());
};
pj.prototype.Fd = function(a, b) {
  b.id && Xh(a, b.id);
  if ("HR" == b.tagName) {
    var c = b;
    b = this.T(a);
...
zi("goog-menuseparator", function() {
  return new qj();
});
function rj(a) {
  this.yn = a || "menu";
...
w(rj, Ci);
da(rj);
rj.prototype.Vd = function(a) {
  return "UL" == a.tagName || rj.s.Vd.call(this, a);
};
rj.prototype.po = function(a) {
  return "HR" == a.tagName ? new qj() : rj.s.po.call(this, a);
};
rj.prototype.sa = function() {
  return "goog-menu";
};
rj.prototype.Wj = function(a) {
  rj.s.Wj.call(this, a);
  a = a.G();
  T(a, "haspopup", "true");
};
...
d.Wr = function() {
  return this.Y() ? lh(this.G()) : null;
};
d.pa = function(a, b, c) {
  (b = sj.s.pa.call(this, a, b)) &&
    a &&
    this.za &&
    this.fl &&
    this.Pb().focus();
  this.$s = a && c && r(c.clientX) ? new D(c.clientX, c.clientY) : null;
  return b;
};
d.yo = function(a) {
  this.fl && this.Pb().focus();
  return sj.s.yo.call(this, a);
};
d.Nq = function(a) {
  return (this.pv || a.isEnabled()) && a.Y() && !!(a.Bb & 2);
};
d.tj = function(a) {
  var b = this.Z;
  var c = this.Yb();
  c = Zd(c.fd, "DIV", b.sa() + "-content", a);
  for (var e = c.length, f = 0; f < e; f++) Ei(b, this, c[f]);
  sj.s.tj.call(this, a);
};
d.dh = function(a) {
  var b = sj.s.dh.call(this, a);
  b ||
    $h(
      this,
      function(c) {
        !b &&
          c.Dw &&
          c.Gs == a.keyCode &&
          (this.isEnabled() && this.Sb(c), (b = c.Ld(a)));
      },
      this
    );
  return b;
...
d.qc = function(a) {
  ...
  if ((a = S(this, a))) {
    ...
    var e = lh(b),
      f = lh(c);
    if (!A || 9 <= Number(yb)) {
      k = ih(c, "borderLeftWidth");
      var h = ih(c, "borderRightWidth");
      l = ih(c, "borderTopWidth");
      m = ih(c, "borderBottomWidth");
      h = new vg(parseFloat(l), parseFloat(h), parseFloat(m), parseFloat(k));
    } else {
      var k = th(c, "borderLeft");
      h = th(c, "borderRight");
      var l = th(c, "borderTop"),
        m = th(c, "borderBottom");
      h = new vg(l, h, m, k);
    }
    c == de(document)
      ? ((k = e.x - c.scrollLeft),
        (e = e.y - c.scrollTop),
        !A || 10 <= Number(yb) || ((k += h.left), (e += h.top)))
...
x.ea.yl = null;
x.ea.Or = null;
x.ea.show = function(a, b, c) {
  x.K.show(x.ea, c, null);
  if (b.length) {
    var e = x.ea.Bm(b, c);
    ec(e, "action", x.ea.Pa);
    x.ea.Wc(e, a, c);
...
x.ea.ll = function(a, b) {
  return function() {
    ...
    x.j.isEnabled() && !c.jb && x.j.V(new x.j.Vk(c));
    c.select();
  };
};
x.ea.xv = function(a) {
  ...
  return {
    text:
      1 == b ? x.g.DELETE_BLOCK : x.g.DELETE_X_BLOCKS.replace("%1", String(b)),
    enabled: !0,
    gb: function() {
      x.j.S(!0);
      a.A(!0, !0);
...
x.ea.zv = function(a) {
  return {
    enabled: !(v(a.Ta) ? !a.Ta() : !a.Ta),
    text: x.g.HELP,
    gb: function() {
      var b = v(a.Ta) ? a.Ta() : a.Ta;
      b && window.open(b);
    }
  };
};
x.ea.yv = function(a) {
  var b = !0;
  Ac(a, !1).length > id(a.o) && (b = !1);
  return {
    text: x.g.DUPLICATE_BLOCK,
    enabled: b,
    gb: function() {
      x.Lr(a);
    }
...
x.ea.wv = function(a) {
  var b = { enabled: !A };
  a.Ya
    ? ((b.text = x.g.REMOVE_COMMENT),
      (b.gb = function() {
        a.xf(null);
      }))
    : ((b.text = x.g.ADD_COMMENT),
      (b.gb = function() {
        a.xf("");
      }));
  return b;
...
x.ea.LC = function(a, b) {
  var c = { enabled: !0 };
  c.text = x.g.Uy;
  c.gb = function() {
    var c = new Df(a, x.g.lC, 100, 100);
    if (!a.Ho)
      for (var f = a.w; f; ) {
        if (
          -1 !=
    ...
    f = new D(b.clientX - f.left, b.clientY - f.top);
    var h = x.i.Sl(a.Va);
    f = xc(f, h).scale(1 / a.scale);
    c.moveBy(f.x, f.y);
    a.R && (c.Ec(), c.aa(!1), c.select());
  };
  return c;
};
function N(a, b, c) {
...
d.Zc = null;
d.Ec = function() {
  for (var a = 0, b; (b = this.X[a]); a++) b.I();
  b = vf(this);
  ...
  this.o.options.readOnly ||
    this.fo ||
    x.O(this.ha(), "mousedown", this, this.tf);
  this.fo = !0;
  this.ha().parentNode || this.o.Va.appendChild(this.ha());
};
d.select = function() {
  if (this.jb && this.getParent()) this.getParent().select();
  else if (x.selected != this) {
    var a = null;
    if (x.selected) {
      a = x.selected.id;
      x.j.disable();
  ...
  if (a != b) {
    ...
    if (!this.o.Jo && c) {
      ...
      a
        ? (a.ha().appendChild(c),
          (a = this.oa()),
          nf(this, a.x - e.x, a.y - e.y))
        : b &&
          x.selected != this &&
          (this.o.Va.appendChild(c), this.translate(e.x, e.y));
    }
  }
};
d.oa = function() {
  ...
  if (e) {
    do {
      ...
      this.Ue &&
        ...
        ((f = this.o.Ab.Yl()), (a += f.x), (b += f.y));
      e = e.parentNode;
    } while (e && e != this.o.Va && e != c);
  }
  return new D(a, b);
};
d.moveBy = function(a, b) {
  var c = x.j.isEnabled();
  if (c) var e = new x.j.Wi(this);
  var f = this.oa();
...
d.tm = function(a) {
  this.Ue
    ? this.o.Ab.Ff(a.x, a.y)
    : ((this.w.Gf = "translate(" + a.x + "," + a.y + ")"),
      this.w.setAttribute("transform", this.w.Gf + this.w.Ah));
};
function Xg(a) {
  if (a.o && !a.o.sb() && !a.getParent() && !a.vb) {
    var b = a.o.Kd;
    if (b && b.ny) {
      var c = b.Xp,
        e = c / 2,
...
d.no = function() {
  var a = this.oa(),
    ...
    c = this.Hb();
  if (this.u) {
    var e = new D(a.x - (c.width - b), a.y);
    a = new D(a.x + b, a.y + c.height);
  } else
    (e = new D(a.x - b, a.y)), (a = new D(a.x + c.width - b, a.y + c.height));
  return { rd: e, Ud: a };
};
d.zg = function(a) {
  if (this.ve != a) {
    for (var b = [], c = 0, e; (e = this.X[c]); c++) b.push.apply(b, e.pa(!a));
    if (a) {
      e = vf(this);
      for (c = 0; c < e.length; c++) e[c].pa(!1);
      c = this.toString(x.eu);
      O(R(this, "_TEMP_COLLAPSED_INPUT"), c).I();
    } else this.Ga("_TEMP_COLLAPSED_INPUT"), this.Pe(null);
    N.s.zg.call(this, a);
    b.length || (b[0] = this);
    if (this.R) for (c = 0; (a = b[c]); c++) a.aa();
  }
};
d.bq = function(a, b) {
  for (var c = [], e = 0, f; (f = this.X[e]); e++) {
    for (var h = 0, k; (k = f.Oa[h]); h++) k instanceof tj && c.push(k);
    f.connection && (f = J(f.connection)) && c.push(f);
  }
  a = c.indexOf(a);
  -1 == a && (a = b ? -1 : c.length);
  (c = c[b ? a + 1 : a - 1])
    ? c instanceof uh
      ? c.Re()
      : c.bq(null, b)
    : (c = this.getParent()) && c.bq(this, b);
};
d.tf = function(a) {
  var b = this.o && this.o.Ee(a);
  b && (Zf(b, this), (b.Uc = a));
};
d.Oi = function(a) {
    ...
    if (this.lc() && this.Je() && !b.vb) {
      ...
      if (!this.ve)
        for (var e = 1; e < this.X.length; e++)
          if (this.X[e - 1].type != x.yb && this.X[e].type != x.yb) {
            e = { enabled: !0 };
            var f = gh(this);
      ...
      this.o.options.collapse &&
        (this.ve
          ? ((e = { enabled: !0 }),
            (e.text = x.g.EXPAND_BLOCK),
            (e.gb = function() {
              b.zg(!1);
            }),
            c.push(e))
          : ((e = { enabled: !0 }),
            (e.text = x.g.COLLAPSE_BLOCK),
            (e.gb = function() {
              b.zg(!0);
            }),
            c.push(e)));
      this.o.options.disable &&
        ((e = {
          text: this.disabled ? x.g.ENABLE_BLOCK : x.g.DISABLE_BLOCK,
          enabled: !Lh(this),
          gb: function() {
            b.Pd(!b.disabled);
          }
...
function nf(a, b, c) {
  if (a.R) {
    for (var e = a.De(!1), f = 0; f < e.length; f++) e[f].moveBy(b, c);
    e = vf(a);
    for (f = 0; f < e.length; f++) Ne(e[f]);
    for (f = 0; f < a.bf.length; f++) nf(a.bf[f], b, c);
  }
}
d.Ag = function(a) {
  if (a) {
    ...
    x.i.pb(this.w, "blocklyDragging");
  } else (x.Gl = []), x.i.Rb(this.w, "blocklyDragging");
  for (b = 0; b < this.bf.length; b++) this.bf[b].Ag(a);
};
d.xh = function(a) {
  N.s.xh.call(this, a);
  Ef(this);
...
d.Kp = function(a) {
  N.s.Kp.call(this, a);
  a = vf(this);
  for (var b = 0; b < a.length; b++) a[b].If();
};
d.Pp = function(a) {
  N.s.Pp.call(this, a);
  this.Hf();
...
d.A = function(a, b) {
  if (this.o) {
    ...
    x.ea.yl == this && x.ea.Pa();
    b && this.R && (Ke(this, a), x.Ja.lw(this));
    this.R = !1;
    if (this.Zc) {
      for (var f in this.Zc) clearTimeout(this.Zc[f]);
      this.Zc = null;
    }
    x.j.disable();
    try {
...
d.Hf = function() {
  if (!this.disabled) {
    var a = this.we,
      b = uj(a);
    if (this.jb)
      (b = vj([255, 255, 255], b, 0.6)),
        (a = wj(b)),
        (this.Dg.style.display = "none"),
        this.Hk.setAttribute("fill", a);
    else {
      this.Dg.style.display = "";
      var c = wj(vj([255, 255, 255], b, 0.3));
      b = wj(vj([0, 0, 0], b, 0.2));
      this.Dg.setAttribute("stroke", c);
      this.Hk.setAttribute("fill", b);
    }
    this.Rd.setAttribute("fill", a);
    a = vf(this);
    for (c = 0; c < a.length; c++) a[c].Hf();
    for (a = 0; (c = this.X[a]); a++) {
      b = 0;
      for (var e; (e = c.Oa[b]); b++) e.Cj();
    }
  }
};
function sf(a) {
  a.disabled || Lh(a)
    ? x.i.pb(a.w, "blocklyDisabled") &&
      a.Rd.setAttribute("fill", "url(#" + a.o.options.vj + ")")
    : x.i.Rb(a.w, "blocklyDisabled") && a.Hf();
  a = a.Vf(!1);
  for (var b = 0, c; (c = a[b]); b++) sf(c);
}
d.Ol = function() {
  return this.Ya
    ? this.Ya.Ib()
...
d.xf = function(a) {
  var b = !1;
  q(a)
    ? (this.Ya || ((this.Ya = new Oe(this)), (b = !0)), this.Ya.Ob(a))
    : this.Ya && (this.Ya.A(), (b = !0));
...
d.Pe = function(a, b) {
  ...
  else for (var e in this.Zc) clearTimeout(this.Zc[e]), delete this.Zc[e];
  if (this.o.sb()) {
    var f = this;
    this.Zc[c] = setTimeout(function() {
      f.o && (delete f.Zc[c], f.Pe(a, c));
    }, 100);
  } else {
    this.vb && (a = null);
    b = Jh(this);
    ...
    b = !1;
    q(a)
      ? (this.ud || ((this.ud = new Qe(this)), (b = !0)), this.ud.Ob(a, c))
      : this.ud && !c
      ? (this.ud.A(), (b = !0))
      : this.ud &&
        ((b = this.ud.Ib()),
        this.ud.Ob("", c),
        (e = this.ud.Ib()) || this.ud.A(),
        (b = b != e));
    b && this.R && (this.aa(), this.qb());
  }
};
d.Cg = function(a) {
  this.kd && this.kd !== a && this.kd.A();
  a && ((a.U = this), (this.kd = a), Me(a));
};
d.Pd = function(a) {
  this.disabled != a && (N.s.Pd.call(this, a), this.R && sf(this));
};
d.Sb = function(a) {
  this.R &&
    (a
      ? (this.Rd.setAttribute("filter", "url(#" + this.o.options.Nr + ")"),
        (this.Dg.style.display = "none"))
      : (x.i.removeAttribute(this.Rd, "filter"), delete this.Dg.style.display));
};
d.Zh = function() {
  x.i.pb(this.w, "blocklySelected");
};
...
d.nd = function(a, b) {
  N.s.nd.call(this, a, b);
  this.R && (this.aa(), this.qb());
};
d.md = function(a, b) {
  N.s.md.call(this, a, b);
  this.R && (this.aa(), this.qb());
};
d.Ic = function(a, b) {
  N.s.Ic.call(this, a, b);
  this.R && (this.aa(), this.qb());
};
d.bc = function(a) {
  N.s.bc.call(this, a);
...
d.Ga = function(a, b) {
  N.s.Ga.call(this, a, b);
  this.R && (this.aa(), this.qb());
};
d.Wo = function(a, b) {
  N.s.Wo.call(this, a, b);
  this.R && (this.aa(), this.qb());
};
d.fj = function(a, b) {
  a = N.s.fj.call(this, a, b);
  this.R && (this.aa(), this.qb());
  return a;
};
d.De = function(a) {
...
d.qb = function() {
  if (this.o && !this.o.sb()) {
    var a = jf(this);
    if (!a.vb)
      for (var b = this.De(!1), c = 0, e; (e = b[c]); c++) {
        e.isConnected() && Xe(e) && J(e).qb();
        for (var f = e.Ms(x.bd), h = 0, k; (k = f[h]); h++)
          (e.isConnected() && k.isConnected()) ||
            (jf(k.v) != a && (Xe(e) ? Ue(k, e) : Ue(e, k)));
      }
  }
};
function Cf(a) {
...
var M = 8,
  xj = 7.5 * (1 - Math.SQRT1_2) + 0.5,
  yj = 8.5 * (1 - Math.SQRT1_2) - 0.5,
  ...
  zj =
    ...
    ",-1.9 v 1.4",
  Aj = "m " + xj + "," + xj,
  Bj = "a 8,8 0 0,0 " + (-yj - 0.5) + "," + (8 - yj),
  Cj = "a 8.5,8.5 0 0,0 " + (8 - yj) + "," + (yj + 0.5);
N.prototype.Hb = function() {
  var a = this.height,
    b = this.width,
    c = Oc(this);
  c
    ? ((c = c.Hb()), (a += c.height - 4), (b = Math.max(b, c.width)))
    : this.L || this.M || (a += 2);
...
N.prototype.aa = function(a) {
  ...
  var b = 10;
  this.u && (b = -b);
  for (var c = vf(this), e = 0; e < c.length; e++) {
    var f = c[e];
    if (f.Wq && f.U.isCollapsed()) f.Dc.setAttribute("display", "none");
    else {
  ...
  for (
    ...
    if (z.Y()) {
      if (t && p && p != x.yb && z.type != x.yb) var E = c[c.length - 1];
      else
        (p = z.type),
          (E = []),
          (E.type = t && z.type != x.yb ? -1 : z.type),
          (E.height = 0),
          c.push(E);
      E.push(z);
      z.vg = 25;
      z.Zb = t && z.type == x.$a ? M + 12.5 : 0;
      if (z.connection && z.connection.isConnected()) {
        var Fa = J(z.connection).Hb();
        z.vg = Math.max(z.vg, Fa.height);
        z.Zb = Math.max(z.Zb, Fa.width);
      }
      t || y != l.length - 1
        ? !t && z.type == x.$a && l[y + 1] && l[y + 1].type == x.yb && z.vg--
        : z.vg--;
      ...
      -1 != E.type &&
        (E.type == x.yb
          ? ((m = !0), (f = Math.max(f, z.ee)))
          : (E.type == x.$a ? (h = !0) : E.type == x.We && (n = !0),
            (e = Math.max(e, z.ee))));
    }
  for (k = 0; (E = c[k]); k++)
    if (((E.Lt = !1), -1 == E.type))
  ...
  h
    ? (c.Nb = Math.max(c.Nb, e + 20 + M))
    : n && (c.Nb = Math.max(c.Nb, e + 20));
  c.ax = h;
  c.zC = m;
  c.yC = n;
  f = b;
  ...
  this.M
    ? (this.Yp = this.Um = !0)
    : ((this.Yp = this.Um = !1),
      this.$ && (b = J(this.$)) && Oc(b) == this && (this.Um = !0),
      Oc(this) && (this.Yp = !0));
  h = [];
  m = [];
  b = [];
    ...
    if (this.isCollapsed())
      ...
      for (l = 0; (k = E[l]); l++)
        (t = n),
          ...
          k.type == x.$a &&
            ...
            m.push("z"),
            this.u
              ? (e.push("M", p - 10 - 2.5 + M - k.Zb + "," + (n + 5 + 0.5)),
                e.push(zj),
                e.push("v", k.vg - 20 + 2.5),
                e.push("h", k.Zb - M + 2))
              : (e.push("M", p - 10 + 0.5 + "," + (n + 5 + 0.5)),
                e.push("v", k.vg + 1),
                e.push("h", M - 2 - k.Zb),
                e.push("M", p - k.Zb - 10 + 0.9 + "," + (n + 5 + 20 - 0.7)),
                e.push("l", 0.46 * M + ",-2.1")),
            (t = this.u ? -p - M + 10 + k.Zb + 1 : p + M - 10 - k.Zb - 1),
            (y = n + 5 + 1),
            lf(k.connection, t, y));
      p = Math.max(p, c.Nb);
      ...
      E.type == x.$a
        ? ((k = E[0]),
          ...
          k.align != x.Vi &&
            ((l = c.Nb - k.ee - M - 20),
            k.align == x.Lg ? (p += l) : k.align == x.Sk && (p += l / 2)),
          Dj(this, k.Oa, p, t),
          h.push(of),
          (l = E.height - 20),
          h.push("v", l),
          this.u
            ? (b.push(zj), b.push("v", l + 0.5))
            : (b.push("M", c.Nb - 5 + "," + (n + 20 - 0.7)),
              b.push("l", 0.46 * M + ",-2.1")),
          (t = this.u ? -c.Nb - 1 : c.Nb + 1),
          lf(k.connection, t, n),
          k.connection.isConnected() &&
            (this.width = Math.max(
              this.width,
              c.Nb + J(k.connection).Hb().width - M + 1
            )))
        : E.type == x.We
        ? ((k = E[0]),
          (t = n),
        ...
        : E.type == x.yb &&
          ((k = E[0]),
          0 == z && (h.push("v", 10), this.u && b.push("v", 9), (n += 10)),
          (t = n),
          k.align != x.Vi &&
            ((l = c.Wm - k.ee - 20),
            k.align == x.Lg ? (p += l) : k.align == x.Sk && (p += l / 2)),
          ...
          h.push("v", E.height - 16),
          h.push("a 8,8 0 0,0 8,8"),
          h.push("H", c.Nb),
          this.u
            ? (b.push("M", p - 30 + yj + "," + (n + yj)),
              b.push(Bj),
              b.push("v", E.height - 16),
              b.push("a 8.5,8.5 0 0,0 8.5,8.5"))
            : (b.push("M", p - 30 + yj + "," + (n + E.height - yj)),
              b.push(Cj)),
          b.push("H", c.Nb - 0.5),
          (t = this.u ? -p : p + 1),
          lf(k.connection, t, n + 1),
          k.connection.isConnected() &&
            (this.width = Math.max(
              this.width,
              c.Wm + J(k.connection).Hb().width
            )),
          z == c.length - 1 || c[z + 1].type == x.yb) &&
  ...
  this.M
    ? (lf(this.M, 0, 0),
      h.push("V", 20),
      h.push(
        "c 0,-10 -" + M + ",8 -" + M + ",-7.5 s " + M + ",2.5 " + M + ",-7.5"
      ),
      this.u
        ? (b.push("M", -0.25 * M + ",8.4"), b.push("l", -0.45 * M + ",-2.1"))
        : (b.push("V", 18.5),
          b.push("m", -0.92 * M + ",-0.5 q " + -0.19 * M + ",-5.5 0,-11"),
          b.push("m", 0.92 * M + ",1 V 0.5 H 1")),
      (this.width += M))
    : this.u || (this.Um ? b.push("V", 0.5) : b.push("V", 8));
  h.push("z");
  c = h.join(" ") + "\n" + m.join(" ");
  ...
  this.u &&
    (this.Rd.setAttribute("transform", "scale(-1 1)"),
    this.Dg.setAttribute("transform", "scale(-1 1)"),
    this.Hk.setAttribute("transform", "translate(1,1) scale(-1 1)"));
  c = this.oa();
  this.$ && kf(this.$, c);
  this.M && kf(this.M, c);
...
x.g = {};
function tj(a, b) {
  tj.s.constructor.call(this, a, b);
}
w(tj, uh);
tj.la = function(a) {
  var b = x.i.pc(a.text);
  b = new tj(b, a["class"]);
  "boolean" === typeof a.spellcheck && (b.Tm = a.spellcheck);
  return b;
};
var Ej = null;
d = tj.prototype;
...
d.setValue = function(a) {
  if (null !== a) {
    ...
    uh.prototype.setValue.call(this, a);
  }
};
d.Ob = function(a) {
  null !== a &&
    ...
    a !== this.ya &&
      (this.v &&
        x.j.isEnabled() &&
        x.j.V(new x.j.Mc(this.v, "field", this.name, this.ya, a)),
      uh.prototype.Ob.call(this, a)));
};
d.Re = function(a) {
  this.m = this.v.o;
  a = a || !1;
  if (!a && (nb || pb || rb)) Fj(this);
  else {
    x.K.show(this, this.v.u, Gj(this));
    var b = x.K.na,
      c = G("INPUT", "blocklyHtmlInput");
    c.setAttribute("spellcheck", this.Tm);
...
function Fj(a) {
  x.prompt(x.g.CHANGE_VALUE_TITLE, a.ya, function(b) {
    a.v && (b = Ie(a, b));
    a.setValue(b);
  });
}
d.Nx = function(a) {
  ...
  13 == a.keyCode
    ? x.K.Pa()
    : 27 == a.keyCode
    ? ((b.value = b.defaultValue), x.K.Pa())
    : 9 == a.keyCode &&
      (x.K.Pa(), this.v.bq(this, !a.shiftKey), a.preventDefault());
};
d.Ts = function() {
  var a = Ej,
    b = a.value;
...
function Hj(a) {
  ...
  a.v && (b = Ie(a, c.value));
  null === b
    ? x.i.pb(c, "blocklyInvalidInput")
    : x.i.Rb(c, "blocklyInvalidInput");
}
d.Im = function() {
  var a = x.K.na,
    b = Ch(this);
...
function Gj(a) {
  return function() {
    var b = Ej,
      ...
      e = c.value;
    a.v &&
      ((e = Ie(a, e)), null === e ? (e = c.defaultValue) : a.ep && a.ep(e));
    a.Ob(e);
    a.v.R && a.v.aa();
    x.Qa(b.Ox);
    x.Qa(b.Rx);
...
w(Ij, tj);
Ij.la = function(a) {
  return new Ij(a.angle);
};
d = Ij.prototype;
d.Ne = function() {
  this.Ma
    ? ((this.Ba.textContent = Ah(this)),
      this.v.u
        ? this.Ba.insertBefore(this.aq, this.Ba.firstChild)
        : this.Ba.appendChild(this.aq),
      this.Qk())
    : (this.wa.width = 0);
};
d.di = function() {
...
d.Ys = function(a) {
  var b = this.Dj.ownerSVGElement.getBoundingClientRect(),
...
wh("field_angle", Ij);
function Kj(a, b) {
  Kj.s.constructor.call(this, "", b);
  this.setValue(a);
}
w(Kj, uh);
Kj.la = function(a) {
  return new Kj(a.checked ? "TRUE" : "FALSE");
};
d = Kj.prototype;
d.Xk = "default";
d.I = function() {
  this.Za ||
    ...
    this.ml.appendChild(document.createTextNode("\u2713")),
    (this.ml.style.display = this.La ? "block" : "none"));
};
d.getValue = function() {
  return String(this.La).toUpperCase();
};
d.setValue = function(a) {
  ...
  this.La !== a &&
    (this.v &&
      x.j.isEnabled() &&
      x.j.V(new x.j.Mc(this.v, "field", this.name, this.La, a)),
    (this.La = a),
    this.ml && (this.ml.style.display = a ? "block" : "none"));
};
d.Re = function() {
  var a = !this.La;
  this.v && (a = Ie(this, a));
...
function Mj(a) {
  ...
  if (Nj.test(c)) return (b.Bo = Oj(c)), (b.type = "hex"), b;
  a: {
    var e = a.match(Pj);
    if (e) {
      c = Number(e[1]);
  ...
  if (c.length) return (b.Bo = wj(c)), (b.type = "rgb"), b;
  if (Lj && (c = Lj[a.toLowerCase()])) return (b.Bo = c), (b.type = "named"), b;
  throw Error(a + " is not a valid color string");
}
var Qj = /#(.)(.)(.)/;
function Oj(a) {
  if (!Nj.test(a)) throw Error("'" + a + "' is not a valid hex color");
  4 == a.length && (a = a.replace(Qj, "#$1$1$2$2$3$3"));
...
Tj.prototype.Dq = function() {
  return this;
};
function Uj(a) {
  if (a instanceof Tj) return a;
  if ("function" == typeof a.Dq) return a.Dq();
  if (fa(a)) {
    var b = 0,
      c = new Tj();
    c.next = function() {
      for (;;) {
        if (b >= a.length) throw Sj;
...
function Wj(a, b, c, e, f) {
  ...
  this.ld && (this.depth *= -1);
}
w(Wj, Tj);
Wj.prototype.setPosition = function(a, b, c) {
  if ((this.node = a))
    this.Cf = r(b) ? b : 1 != this.node.nodeType ? 0 : this.ld ? -1 : 1;
  r(c) && (this.depth = c);
};
Wj.prototype.clone = function() {
  return new Wj(this.node, this.ld, !this.cr, this.Cf, this.depth);
};
Wj.prototype.next = function() {
  if (this.Gt) {
    if (!this.node || (this.cr && 0 == this.depth)) throw Sj;
    var a = this.node;
    var b = this.ld ? -1 : 1;
    if (this.Cf == b) {
      var c = this.ld ? a.lastChild : a.firstChild;
      c ? this.setPosition(c) : this.setPosition(a, -1 * b);
    } else
      (c = this.ld ? a.previousSibling : a.nextSibling)
        ? this.setPosition(c)
        : this.setPosition(a.parentNode, -1 * b);
    this.depth += this.Cf * (this.ld ? -1 : 1);
  } else this.Gt = !0;
  a = this.node;
  if (!this.node) throw Sj;
  return a;
};
Wj.prototype.splice = function(a) {
  var b = this.node,
    c = this.ld ? 1 : -1;
  this.Cf == c &&
    ((this.Cf = -1 * c), (this.depth += this.Cf * (this.ld ? -1 : 1)));
  this.ld = !this.ld;
  Wj.prototype.next.call(this);
  this.ld = !this.ld;
  c = fa(arguments[0]) ? arguments[0] : arguments;
  for (var e = c.length - 1; 0 <= e; e--) ie(c[e], b);
  H(b);
};
function Xj(a, b, c, e) {
  Wj.call(this, a, b, c, null, e);
}
w(Xj, Wj);
Xj.prototype.next = function() {
  do Xj.s.next.call(this);
  while (-1 == this.Cf);
  return this.node;
};
function Yj() {}
...
d.er = function(a, b) {
  a = b.T("TABLE", this.sa() + "-table", b.T("TBODY", this.sa() + "-body", a));
  a.cellSpacing = "0";
  a.cellPadding = "0";
  return a;
};
...
function bk(a, b, c) {
  a = c.T("TD", { class: a.sa() + "-cell", id: a.sa() + "-cell-" + Zj++ }, b);
  fi(a, "gridcell");
  T(a, "selected", !1);
  if (!re(a) && !gi(a, "label")) {
    var e;
    b = new Xj(a);
    for (c = ""; !c && (e = Vj(b)); )
      1 == e.nodeType && (c = gi(e, "label") || e.title);
    (e = c) && T(a, "label", e);
  }
  return a;
}
...
d.Od = function(a, b) {
  if (a) {
    var c = Zd(document, "TBODY", this.sa() + "-body", a)[0];
    if (c) {
      var e = 0;
      ...
      if (e < b.length) {
        for (
          var f = [], h = Wd(a), k = c.rows[0].cells.length;
          e < b.length;
          ...
          f.push(bk(this, l, h));
          f.length == k &&
            ((l = ck(this, f, h)), c.appendChild(l), (f.length = 0));
        }
        if (0 < f.length) {
          for (; f.length < k; ) f.push(bk(this, "", h));
          l = ck(this, f, h);
          c.appendChild(l);
        }
      }
...
function dk(a, b, c) {
  for (b = b.G(); c && 1 == c.nodeType && c != b; ) {
    if ("TD" == c.tagName && ui(c, a.sa() + "-cell")) return c.firstChild;
    c = c.parentNode;
  }
  return null;
}
...
d.removeItem = function(a) {
  a &&
    ya(this.xi, a) &&
    a == this.wb &&
    ((this.wb = null), this.dispatchEvent("select"));
};
d.Fe = function() {
  return this.wb;
};
d.od = function(a) {
  a != this.wb && (this.xk(this.wb, !1), (this.wb = a), this.xk(a, !0));
  this.dispatchEvent("select");
};
d.Ij = function() {
  var a = this.wb;
  return a ? ra(this.xi, a) : -1;
};
d.Bk = function(a) {
  this.od(this.Vr(a));
};
...
d.xk = function(a, b) {
  a &&
    ("function" == typeof this.Gp
      ? this.Gp(a, b)
      : "function" == typeof a.Mi && a.Mi(b));
};
function gk(a, b, c) {
  U.call(this, a, b || Yj.Id(), c);
  this.zn &= -89;
  this.sj = new hk();
  this.sj.Pm(this);
  this.Mo = -1;
...
d.Li = function(a) {
  ...
  ik(this);
  this.ac
    ? (this.ac.clear(), fk(this.ac, a))
    : ((this.ac = new ek(a)),
      (a = na(this.xk, this)),
      (this.ac.Gp = a),
      Yh(this).ia(this.ac, "select", this.Qw));
  this.va = -1;
};
d.Ml = function() {
  return "";
...
d.Pj = function(a) {
  gk.s.Pj.call(this, a);
  var b = dk(this.Z, this, a.target);
  (b && a.relatedTarget && je(b, a.relatedTarget)) ||
    (b != jk(this) && kk(this, b));
};
d.pf = function(a) {
  gk.s.pf.call(this, a);
...
d.sg = function(a) {
  ...
  return b
    ? (a &&
        (this.Fe() ? "mouseup" != a.type || dk(this.Z, this, a.target) : 1) &&
        this.od(b),
      gk.s.sg.call(this, a))
    : !1;
};
d.Ld = function(a) {
  ...
  switch (a.keyCode) {
    ...
    case 40:
      if ((-1 == e && (e = -c), e < b - c))
        return this.qc(e + c), a.preventDefault(), !0;
  }
  return !1;
};
d.Qw = function() {};
...
d.Ij = function() {
  return this.ac ? this.ac.Ij() : -1;
};
d.Fe = function() {
  return this.ac ? this.ac.Fe() : null;
};
d.Bk = function(a) {
  this.ac && this.ac.Bk(a);
};
d.od = function(a) {
  this.ac && this.ac.od(a);
};
function lk(a, b, c) {
  if (a.G()) {
    var e = a.Rc();
    if (e && 0 <= b && b < e.length) {
      var f = (f = jk(a)) ? f.parentNode : null;
      a.sj.G() != f && (a.sj.P = f);
      f = a.sj;
      f.Sb(c);
      !!(f.La & 2) == c &&
        ...
        c ? vi(b, e) : xi(b, e),
        c
          ? T(a.P, "activedescendant", b.id)
          : b.id == gi(a.P, "activedescendant") &&
            a.P.removeAttribute("aria-activedescendant"));
    }
  }
}
d.Sb = function(a) {
  a && -1 == this.va ? this.qc(-1 < this.Mo ? this.Mo : 0) : a || this.qc(-1);
  gk.s.Sb.call(this, a);
};
d.xk = function(a, b) {
  if (this.G() && a) {
    a = a.parentNode;
    var c = this.Z.sa() + "-cell-selected";
    b ? vi(a, c) : xi(a, c);
    T(a, "selected", b);
  }
};
function ik(a) {
  ...
  if (b)
    if (a.wa && a.wa.width) {
      if (
        ((b = Math.ceil(b.length / a.wa.width)),
        !r(a.wa.height) || a.wa.height < b)
      )
        a.wa.height = b;
    } else (b = Math.ceil(Math.sqrt(b.length))), (a.wa = new Vd(b, b));
...
d.so = function() {
  ...
  if (a) {
    ...
    if ("undefined" !== typeof b) a = b;
      ...
      b = a.style;
      var c = hh["background-color"];
      if (!c) {
        var e = Wa();
        c = e;
        void 0 === a.style[e] &&
          ((e =
            (C ? "Webkit" : B ? "Moz" : A ? "ms" : lb ? "O" : null) + Xa(e)),
          void 0 !== a.style[e] && (c = e));
        hh["background-color"] = c;
      }
      a = b[c] || "";
    }
    return ok(a);
...
function pk(a, b) {
  Uh.call(this, a);
  this.Xa = b || null;
  Yh(this).ia(this, "action", this.Jx);
}
w(pk, Uh);
d = pk.prototype;
d.$g = !0;
d.Nm = function(a) {
  this.Xa ? this.Xa.Nm(a) : qk(this, a);
};
d.Qm = function(a) {
  this.Xa || qk(this, []);
  this.Xa.Qm(a);
...
d.nf = function() {
  return this.Xa ? this.Xa.nf() : null;
};
d.Ij = function() {
  return this.Xa ? this.Xa.Ij() : -1;
};
d.Bk = function(a) {
  this.Xa && this.Xa.Bk(a);
};
d.so = function() {
  return this.Xa ? this.Xa.so() : null;
};
d.Op = function(a) {
  this.Xa && this.Xa.Op(a);
};
d.qf = function() {
  return this.$g;
};
...
function sk(a, b) {
  sk.s.constructor.call(this, a, b);
  this.Ob("\u00a0\u00a0\u00a0");
}
var tk;
w(sk, uh);
sk.la = function(a) {
  return new sk(a.colour);
};
d = sk.prototype;
d.Mv = null;
d.Xq = 0;
...
d.setValue = function(a) {
  this.v &&
    x.j.isEnabled() &&
    this.we != a &&
    x.j.V(new x.j.Mc(this.v, "field", this.name, this.we, a));
  this.we = a;
...
d.Re = function() {
  x.K.show(this, this.v.u, uk);
  var a = x.i.xo(),
    b = Ch(this),
    c = this.qj(),
    e = nh(c.G());
  x.K.op(a, b, e, this.v.u);
  var f = this;
  tk = ec(c, "change", function(a) {
    a = a.target.so() || "#000000";
    x.K.Pa();
    f.v && (a = Ie(f, a));
    null !== a && f.setValue(a);
  });
...
function P(a, b) {
  ...
  if (u(a)) {
    for (var c = !1, e = 0; e < a.length; e++) {
      ...
      "string" == typeof f
        ? (a[e][0] = x.i.pc(f))
        : (null != f.alt && (a[e][0].alt = x.i.pc(f.alt)), (c = !0));
    }
    if (!(c || 2 > a.length)) {
      f = [];
...
d.I = function() {
  this.Za ||
    ((this.Of = x.i.B("tspan", {}, null)),
    this.Of.appendChild(
      document.createTextNode(this.v.u ? wk + " " : " " + wk)
    ),
    P.s.I.call(this));
};
d.Re = function() {
  x.K.show(this, this.v.u, null);
  var a = new sj();
  a.Af(this.v.u);
...
function yk(a) {
  Yh(a).ia(a.G(), "touchstart", function(a) {
    bj(this, a.target).pf(a);
  });
}
function zk(a) {
  Yh(a).ia(a.G(), "touchend", function(a) {
    bj(this, a.target).sg(a);
  });
}
d.qj = function(a) {
  a.aa(x.K.na);
...
d.setValue = function(a) {
  if (null !== a && a !== this.Vb) {
    this.v &&
      x.j.isEnabled() &&
      x.j.V(new x.j.Mc(this.v, "field", this.name, this.Vb, a));
    this.Vb = a;
    for (var b = this.getOptions(), c = 0; c < b.length; c++)
      if (b[c][1] == a) {
        a = b[c][0];
        "object" == typeof a
          ? ((this.Ie = a), (this.ya = a.alt))
          : ((this.Ie = null), (this.ya = a));
        this.Cj();
        return;
      }
    this.ya = a;
...
d.Ne = function() {
  if (this.Ma) {
    ...
    if (this.Ie) {
      this.ie = x.i.B(
        "image",
        { y: 5, height: this.Ie.height + "px", width: this.Ie.width + "px" },
        this.Za
      );
      this.ie.setAttributeNS(
        "http://www.w3.org/1999/xlink",
        "xlink:href",
        this.Ie.src
      );
      ...
      this.v.u
        ? (this.ie.setAttribute("x", a), this.Ba.setAttribute("x", -1))
        : (this.Ba.setAttribute("text-anchor", "end"),
          this.Ba.setAttribute("x", this.wa.width + 1));
    } else
      (a = document.createTextNode(Ah(this))),
        this.Ba.appendChild(a),
        this.v.u
          ? this.Ba.insertBefore(this.Of, this.Ba.firstChild)
          : this.Ba.appendChild(this.Of),
        this.Ba.setAttribute("text-anchor", "start"),
        this.Ba.setAttribute("x", 0),
        (this.wa.height = 25),
        (this.wa.width = Bh(this.Ba));
...
d.Qk = function() {
  if (this.Ie && (A || mb)) {
    ...
    this.wa.width = a;
  } else uh.prototype.Qk.call(this);
};
d.A = function() {
  x.K.Sj(this);
  P.s.A.call(this);
...
d.I = function() {
  this.Za ||
    ...
    (this.ie = x.i.B(
      "image",
      { height: this.Fa + "px", width: this.ma + "px" },
      this.Za
    )),
    this.setValue(this.At),
    this.v.ha().appendChild(this.Za),
    this.ka(this.v),
    x.C.Rg(this.ie),
    this.Jn && (this.sm = x.O(this.Za, "mousedown", this, this.tf)));
};
d.A = function() {
  H(this.Za);
...
function Bk(a, b, c, e, f) {
  ...
  this.setValue(Ie(this, this.getValue()));
}
w(Bk, tj);
Bk.la = function(a) {
  return new Bk(a.value, a.min, a.max, a.precision);
};
Bk.prototype.Hn = function(a) {
  if (null === a) return null;
  a = String(a);
  a = a.replace(/O/gi, "0");
  a = a.replace(/,/g, "");
...
w(Ck, P);
Ck.la = function(a) {
  var b = x.i.pc(a.variable);
  return new Ck(b, null, a.variableTypes, a.defaultType);
};
d = Ck.prototype;
d.I = function() {
  this.Za || (Ck.s.I.call(this), this.hh());
};
d.hh = function() {
  if (!this.re) {
    this.m = this.v.o;
    var a = x.H.Vl(this.m, null, this.cw, this.bw);
    x.j.disable();
    try {
      this.setValue(a.ba());
    } finally {
...
d.getValue = function() {
  return this.re ? this.re.ba() : null;
};
d.Ib = function() {
  return this.re ? this.re.name : "";
};
d.Sc = function() {
  return this.re;
};
d.setValue = function(a) {
  var b = x.H.Sc(this.v.o, a);
  if (!b)
  ...
  this.v &&
    x.j.isEnabled() &&
    ((c = this.re ? this.re.ba() : null),
    x.j.V(new x.j.Mc(this.v, "field", this.name, c, a)));
  this.re = b;
  this.Vb = a;
  this.Ob(b.name);
};
...
function Dk() {
  ...
  c.sort(yg);
  b = [];
  for (f = 0; f < c.length; f++) b[f] = [c[f].name, c[f].ba()];
  b.push([x.g.RENAME_VARIABLE, x.yq]);
  x.g.DELETE_VARIABLE && b.push([x.g.DELETE_VARIABLE.replace("%1", a), x.pq]);
  return b;
}
d.Us = function(a) {
  a = a.getValue();
...
function Hk(a, b) {
  if (!b) return "";
  if (b.disabled) return Hk(a, Oc(b));
  var c = a[b.type].call(b, b);
  if (u(c)) return [a.Lm(b, c[0]), c[1]];
  if (q(c)) {
    var e = b.id.replace(/\$/g, "$$$$");
    a.Wh && (c = a.Wh.replace(/%1/g, "'" + e + "'") + c);
    return a.Lm(b, c);
  }
  if (null === c) return "";
}
...
function Kk(a, b) {
  ...
  c.Wh && (a += Ik(c.Wh.replace(/%1/g, "'" + b + "'"), c.Xe));
  return a;
}
d.nn = "";
function Lk(a) {
...
d.xd = "{leCUI8hutHZI4480Dc}";
function Mk(a, b) {
  var c = x.h;
  if (!c.Ug[a]) {
    var e = Nk(c.Ra, a, x.ra.Sa);
    c.lo[a] = e;
    b = b.join("\n").replace(c.qu, e);
    for (var f; f != b; )
...
function Ok() {
  var a = x.h.nn;
  this.St = "";
  this.qt = Object.create(null);
  if (a) {
    a = a.split(",");
    for (var b = 0; b < a.length; b++) this.qt[a[b]] = !0;
  }
  this.reset();
}
...
function Nk(a, b, c) {
  b
    ...
    : (b = "unnamed");
  for (var e = ""; a.yr[b + e] || b + e in a.qt; ) e = e ? e + 1 : 2;
  b += e;
  a.yr[b] = !0;
  return (c == x.H.Sa || "DEVELOPER_VARIABLE" == c ? a.St : "") + b;
}
function Wc(a, b) {
...
x.ra.ht = function(a, b) {
  return a[0].toLowerCase().localeCompare(b[0].toLowerCase());
};
x.ra.uw = function(a, b) {
  if (b.vb) return a;
  for (; !x.ra.mx(a, b.o, b); ) {
    var c = a.match(/^(.*?)(\d+)$/);
...
x.ra.mx = function(a, b, c) {
  return !x.ra.ox(a, b, c);
};
x.ra.ox = function(a, b, c) {
  b = Tc(b);
  for (var e = 0; e < b.length; e++)
    if (b[e] != c && b[e].mf) {
      var f = b[e].mf();
      if (Wc(f[0], a)) return !0;
    }
  return !1;
};
x.ra.Fm = function(a) {
  a = a.replace(/^[\s\xa0]+|[\s\xa0]+$/g, "");
  var b = x.ra.uw(a, this.v),
    c = this.ya;
  if (c != a && c != b) {
    a = Tc(this.v.o);
    for (var e = 0; e < a.length; e++) a[e].vk && a[e].vk(c, b);
  }
  return b;
};
x.ra.Uf = function(a) {
  ...
  x.D.procedures_defreturn &&
    ...
    e.setAttribute("gap", 16),
    (f = G("field", null, x.g.PROCEDURES_DEFRETURN_PROCEDURE)),
    f.setAttribute("name", "NAME"),
    e.appendChild(f),
    c.push(e));
...
x.ra.Xo = function(a) {
  ...
  for (var f; (f = a[c]); c++) {
    ...
    h != k &&
      ((x.j.oc = !1),
      x.j.V(new x.j.Mc(f, "mutation", null, h, k)),
      (x.j.oc = b));
  }
};
x.ra.Pl = function(a, b) {
  b = fd(b, !1);
  for (var c = 0; c < b.length; c++)
    if (b[c].mf) {
      var e = b[c].mf();
      if (e && Wc(e[0], a)) return b[c];
    }
  return null;
};
function Pk(a, b, c, e) {
  ...
  this.kh && a
    ? console.warn("Labels should not have callbacks. Label text: " + this.ya)
    : this.kh || (a && ah(b, a))
    ? (this.Gn = ah(b, a))
    : console.warn("Buttons should have callbacks. Button text: " + this.ya);
  this.jr = c.getAttribute("web-class") || null;
}
d = Pk.prototype;
d.width = 0;
d.height = 0;
...
d.T = function() {
  ...
  var c = x.i.B(
    "text",
    {
      class: this.kh ? "blocklyFlyoutLabelText" : "blocklyText",
      x: 0,
      y: 0,
      "text-anchor": "middle"
    },
...
function Qk(a) {
  a.w.setAttribute("transform", "translate(" + a.Wc.x + "," + a.Wc.y + ")");
}
d.moveTo = function(a, b) {
  this.Wc.x = a;
  this.Wc.y = b;
...
d.Jr = 70;
d.T = function(a) {
  this.w = x.i.B(a, { class: "blocklyFlyout", style: "display: none" }, null);
  this.pd = x.i.B("path", { class: "blocklyFlyoutBackground" }, this.w);
  this.w.appendChild(this.m.T());
  return this.w;
};
d.I = function(a) {
  this.xa = a;
...
function Sk(a, b, c, e, f) {
  ...
  "svg" == a.w.tagName
    ? x.i.zk(a.w, "translate(" + e + "px," + f + "px)")
    : a.w.setAttribute("transform", "translate(" + e + "," + f + ")");
  a.$b && ((a.$b.ip = new D(e, f)), a.$b.resize());
}
d.Pa = function() {
  if (this.Y()) {
    this.pa(!1);
    for (var a = 0, b; (b = this.Hc[a]); a++) x.Qa(b);
    this.Hc.length = 0;
  ...
  for (var b = [], c = [], e = (this.mp.length = 0), f; (f = a[e]); e++)
    if (f.tagName) {
      ...
      if ("BLOCK" == h)
        ...
        (f = new Pk(this.m, this.xa, f, "LABEL" == h)),
          b.push({ type: "button", button: f }),
          c.push(k);
    }
  this.ws(b, c);
  this.Hc.push(
    x.O(this.pd, "mouseover", this, function() {
      for (var a = fd(this.m, !1), b = 0, c; (c = a[b]); b++) c.uh();
    })
  );
...
function Tk(a) {
  for (var b = fd(a.m, !1), c = 0, e; (e = b[c]); c++)
    e.o == a.m && e.A(!1, !1);
  for (c = 0; c < a.rm.length; c++) (b = a.rm[c]) && H(b);
  for (c = a.rm.length = 0; (b = a.ij[c]); c++) b.A();
  a.ij.length = 0;
  a.m.Gi.clear();
}
function Uk(a, b, c, e) {
  a.Hc.push(x.O(b, "mousedown", null, Vk(a, c)));
...
function Uf(a, b) {
  ...
  try {
    var f = a.xa;
    if (!b.ha()) throw "oldBlock is not rendered.";
    var h = x.F.Rf(b);
    f.Tb(!1);
    var k = x.F.gi(h, f);
    if (!k.ha()) throw "block is not rendered.";
    var l = x.i.Sl(f.Va),
      m = x.i.Sl(a.m.Va),
  ...
  b = x.H.Tr(a.xa, e);
  if (x.j.isEnabled())
    for (x.j.S(!0), x.j.V(new Bc(c)), e = 0; e < b.length; e++)
      x.j.V(new Fc(b[e]));
  a.$h ? a.Pa() : a.ho();
  return c;
}
...
d.ho = function() {
  for (var a = id(this.xa), b = fd(this.m, !1), c = 0, e; (e = b[c]); c++)
    if (-1 == this.mp.indexOf(e)) {
      var f = Ac(e, !1);
      e.Pd(f.length > a);
    }
};
d.vp = function() {
  this.tg && this.m.ug(this.tg);
  this.nt();
...
d.lf = function() {
  ...
  this.Df == x.Pg && (b = 0);
  var e = this.Fa;
  this.Df == x.Nf && (e -= this.Og);
  return {
    fb: e,
    Aa: this.ma - 2 * this.Og,
    uc: (a.height + 2 * this.yd) * this.m.scale,
    Qc: (a.width + 2 * this.yd) * this.m.scale,
    Ve: -this.m.scrollY,
    Cb: -this.m.scrollX,
    vc: a.y,
    Pc: a.x,
...
d.Om = function(a) {
  var b = this.lf();
  b &&
    (r(a.x) && (this.m.scrollX = -b.Qc * a.x),
    this.m.translate(this.m.scrollX + b.ob, this.m.scrollY + b.zb));
};
d.position = function() {
  if (this.Y()) {
    var a = this.xa.ub();
    if (a) {
      this.ma = a.Aa;
      this.Ip(a.Aa - 2 * this.qa, this.Fa - this.qa);
      var b = a.ob,
        c = a.zb;
...
d.Ip = function(a, b) {
  var c = this.Df == x.Nf,
    e = ["M 0," + (c ? 0 : this.qa)];
  c
    ? (e.push("h", a + 2 * this.qa),
      e.push("v", b),
      e.push("a", this.qa, this.qa, 0, 0, 1, -this.qa, this.qa),
      e.push("h", -1 * a),
      e.push("a", this.qa, this.qa, 0, 0, 1, -this.qa, -this.qa))
    : (e.push("a", this.qa, this.qa, 0, 0, 1, this.qa, -this.qa),
      e.push("h", a),
...
d.Ep = function() {
  this.$b.set(this.u ? Infinity : 0);
};
d.Xt = function(a) {
  var b = a.deltaX;
  if (b) {
    B && 1 === a.deltaMode && (b *= 10);
    var c = this.lf();
    b = c.Cb + b;
...
d.ws = function(a, b) {
  ...
  for (var f = 0, h; (h = a[f]); f++)
    if ("block" == h.type) {
      h = h.block;
      for (var k = Ac(h, !1), l = 0, m; (m = k[l]); l++) m.vb = !0;
      h.aa();
      k = h.ha();
      l = h.Hb();
      m = h.M ? M : 0;
      ...
      "button" == h.type &&
        (Wk(this, h.button, e, c), (e += h.button.width + b[f]));
};
d.ss = function(a) {
...
d.ki = function() {
  ...
  var a = this.w.getBoundingClientRect(),
    b = a.top;
  a = a.height;
  if (this.Df == x.Nf) return new wg(-1e9, b - 1e9, 2e9, 1e9 + a);
  if (this.Df == x.Pg) return new wg(-1e9, b, 2e9, 1e9 + a);
};
d.nt = function() {
  this.m.scale = this.xa.scale;
  for (var a = 0, b = fd(this.m, !1), c = 0, e; (e = b[c]); c++)
    a = Math.max(a, e.Hb().height);
  a += 1.5 * this.yd;
  a *= this.m.scale;
  a += I;
  if (this.Fa != a) {
    for (c = 0; (e = b[c]); c++) e.Jl && Yk(this, e.Jl, e);
    this.Fa = a;
    this.xa.resize();
  }
};
...
d.lf = function() {
  ...
  return {
    fb: c,
    Aa: e,
    uc: a.height * this.m.scale + 2 * this.yd,
    Qc: a.width * this.m.scale + 2 * this.yd,
    Ve: -this.m.scrollY + a.y,
    Cb: -this.m.scrollX,
    vc: a.y,
    Pc: a.x,
    zb: b,
...
d.position = function() {
  if (this.Y()) {
    ...
    if (a) {
      this.Fa = a.fb;
      this.Ip(this.ma - this.qa, a.fb - 2 * this.qa);
      var b = a.zb,
        c = a.ob;
...
d.ws = function(a, b) {
  this.m.scale = this.xa.scale;
  for (var c = this.yd, e = this.u ? c : c + M, f = 0, h; (h = a[f]); f++)
    if ("block" == h.type) {
      h = h.block;
      for (var k = Ac(h, !1), l = 0, m; (m = k[l]); l++) m.vb = !0;
      h.aa();
      ...
      "button" == h.type &&
        (Wk(this, h.button, e, c), (c += h.button.height + b[f]));
};
d.ss = function(a) {
  a = (Math.atan2(a.y, a.x) / Math.PI) * 180;
  var b = this.Jr;
...
d.ki = function() {
  ...
  var a = this.w.getBoundingClientRect(),
    b = a.left;
  a = a.width;
  if (this.Df == x.Mf) return new wg(b - 1e9, -1e9, 1e9 + a, 2e9);
  if (B && this.xa && this.xa.ak) {
    var c = this.xa.w.getBoundingClientRect().x;
    10 > Math.abs(c - b) && (b += this.qx * this.xa.options.Lb.scale);
  }
  return new wg(b, -1e9, 1e9 + a, 2e9);
};
d.nt = function() {
  this.m.scale = this.xa.scale;
  for (var a = 0, b = fd(this.m, !1), c = 0, e; (e = b[c]); c++) {
  ...
  for (c = 0; (e = this.ij[c]); c++) a = Math.max(a, e.width);
  a += 1.5 * this.yd + M;
  a *= this.m.scale;
  a += I;
  if (this.ma != a) {
    for (c = 0; (e = b[c]); c++)
      this.u &&
        ((f = e.oa().x), e.moveBy(a / this.m.scale - this.yd - M - f, 0)),
        e.Jl && Yk(this, e.Jl, e);
    if (this.u)
      for (c = 0; (e = this.ij[c]); c++)
        (b = e.Wr().y), e.moveTo(a / this.m.scale - e.width - this.yd - M, b);
    this.ma = a;
    this.xa.resize();
  }
};
function Zk(a) {
  ...
  this.ux = ec(this.P, a, this, !A);
}
w(Zk, tg);
Zk.prototype.handleEvent = function(a) {
  var b = new Qb(a.Ae);
...
d.append = function(a, b, c) {
  this.Db += String(a);
  if (null != b)
    for (var e = 1; e < arguments.length; e++) this.Db += arguments[e];
  return this;
};
d.clear = function() {
  this.Db = "";
...
d.em = function() {
  ...
  if (a) {
    ...
    (b = this.Ql()) && fi(b, "presentation");
    if ((b = el(this)))
      if ((fi(b, "group"), b.hasChildNodes()))
        for (T(a, "expanded", !1), a = ai(this), b = 1; b <= a; b++) {
          var c = S(this, b - 1).G();
          T(c, "setsize", a);
          T(c, "posinset", b);
        }
...
d.T = function() {
  ...
  A ? (Ud(a, Rd(Td, b)), a.removeChild(a.firstChild)) : Ud(a, b);
...
d.Yh = function(a, b) {
  ...
  gl(a, this.li() + 1);
  if ((b = this.G()))
    if ((this.Ti(), T(b, "expanded", this.zc()), this.zc())) {
      b = el(this);
      a.G() || a.T();
      var f = a.G(),
        h = e && e.G();
...
d.removeChild = function(a) {
  var b = this.Cc(),
    c = b ? b.Fe() : null;
  if (c == a || a.contains(c))
    b.hasFocus() ? (this.select(), Af(this.ay, 10, this)) : this.select();
  ...
  if (b && (b.removeNode(a), this.za)) {
    ...
    c && (c = S(this, ai(this) - 1)) && c.Ti();
    ci(this) ||
      ((b.style.display = "none"),
      this.Ti(),
      (this.Rl().className = this.Ll()),
      (c = this.G()) && c.removeAttribute("aria-expanded"));
  }
  return a;
};
...
d.li = function() {
  var a = this.Bl;
  0 > a && ((a = (a = this.getParent()) ? a.li() + 1 : 0), gl(this, a));
  return a;
};
function gl(a, b) {
  if (b != a.Bl) {
    ...
    if (c) {
      var e = il(a) + "px";
      bi(a) ? (c.style.paddingRight = e) : (c.style.paddingLeft = e);
    }
    $h(a, function(a) {
      gl(a, b + 1);
    });
...
function jl(a, b) {
  if (a.Fp != b) {
    ...
    c &&
      (T(c, "selected", b),
      b && ((b = a.Cc().G()), T(b, "activedescendant", a.ba())));
  }
}
d.zc = function() {
  return this.zj;
...
d.oe = function(a) {
  ...
  if (!b || this.dispatchEvent(a ? "beforeexpand" : "beforecollapse")) {
    ...
    var e = this.G();
    if (ci(this)) {
      if ((!a && c && this.contains(c.Fe()) && this.select(), e)) {
        if ((c = el(this)))
          if (
            (ph(c, a), T(e, "expanded", a), a && this.za && !c.hasChildNodes())
          ) {
            var f = [];
            $h(this, function(a) {
              f.push(a.Ym());
...
d.Ym = function() {
  ...
  a = Qd("div", b, c);
  return Qd("div", { class: this.cb.ur, id: this.ba() }, [ml(this), a]);
};
function il(a) {
  return Math.max(0, (a.li() - 1) * a.cb.Go);
}
function ml(a) {
  var b = {};
  b["padding-" + (bi(a) ? "right" : "left")] = il(a) + "px";
  b = { class: a.Hj(), style: b };
  var c = a.qo(),
    e = Qd("span", { style: { display: "inline-block" }, class: a.Ll() }),
    f = Qd("span", { class: a.cb.vr, title: a.Cy || null }, a.Uj);
  a = Rd(f, Qd("span", {}, a.jv));
  return Qd("div", b, [c, e, a]);
}
d.Hj = function() {
  return this.cb.Rn + (this.bk() ? " " + this.cb.xr : "");
};
d.qo = function() {
  return Qd("span", {
    type: "expand",
...
function nl(a) {
  ...
  } else c ? f.append(e.mr) : a.ke ? f.append(e.pr) : f.append(e.nr);
  return f.toString();
}
function ll(a) {
  var b = a.zc() && ci(a);
  return Bd({ "background-position": ol(a), display: b ? null : "none" });
}
function ol(a) {
  return (a.ke ? (a.li() - 1) * a.cb.Go : "-100") + "px 0";
}
d.G = function() {
  var a = al.s.G.call(this);
  a || (this.P = a = this.Yb().G(this.ba()));
  return a;
};
function hl(a) {
...
function dl(a) {
  return (a = hl(a)) && a.lastChild ? a.lastChild.previousSibling : null;
}
function el(a) {
...
d.Ib = function() {
  var a = Kd(this.Uj);
  return -1 != a.indexOf("&") ? ("document" in g ? Sa(a) : Ua(a)) : a;
};
function kl(a) {
  var b = hl(a);
  b && (b.className = a.Hj());
...
d.Ti = function() {
  var a = this.Ql();
  a && (a.className = nl(this));
  if ((a = el(this))) a.style.backgroundPosition = ol(this);
};
d.Vs = function(a) {
  "expand" == a.target.getAttribute("type") && ci(this)
    ? this.ck && this.toggle()
    : (this.select(), kl(this));
};
d.cp = function(a) {
...
function ql(a) {
  return a.zc() && ci(a) ? ql(S(a, ai(a) - 1)) : a;
}
function fl(a, b) {
  a.Gg != b &&
    ((a.Gg = b),
...
w(rl, al);
rl.prototype.Cc = function() {
  if (this.Gg) return this.Gg;
  var a = this.getParent();
  return a && (a = a.Cc()) ? (fl(this, a), a) : null;
};
rl.prototype.Ll = function() {
  var a = this.zc(),
    b = this.qw;
  if (a && b) return b;
  b = this.bx;
  ...
  b = this.cb;
  if (ci(this)) {
    if (a && b.Pn) return b.Tg + " " + b.Pn;
    if (!a && b.kr) return b.Tg + " " + b.kr;
  } else if (b.Qn) return b.Tg + " " + b.Qn;
  return "";
};
function sl(a) {
  if (a.Jj && "function" == typeof a.Jj) return a.Jj();
...
function tl(a) {
  ...
  this.hc = {};
  if (a) {
    if (a.Ul && "function" == typeof a.Ul) var b = a.Ul();
...
d.get = function(a) {
  a: {
    for (var b = this, c = 0; c < a.length; c++)
      if (((b = b.hc[a.charAt(c)]), !b)) {
        a = void 0;
        break a;
      }
    a = b;
  }
  return a ? a.Vb : void 0;
};
d.Jj = function() {
  var a = [];
  vl(this, a);
...
function vl(a, b) {
  void 0 !== a.Vb && b.push(a.Vb);
  for (var c in a.hc) vl(a.hc[c], b);
}
d.Ul = function(a) {
  var b = [];
  if (a) {
...
function wl(a, b, c) {
  void 0 !== a.Vb && c.push(b);
  for (var e in a.hc) wl(a.hc[e], b + e, c);
}
d.clear = function() {
  this.hc = {};
  this.Vb = void 0;
...
function yl(a, b) {
  var c = b.Ib();
  if (c && !Ga(null == c ? "" : String(c))) {
    c = c.toLowerCase();
    var e = a.ph.get(c);
    if (e) {
      for (var f = ai(b), h = 0; h < f; h++) yl(a, S(b, h));
      ya(e, b);
...
function zl(a, b) {
  ...
  (b = a.ph.Ul(b)) &&
    b.length &&
    ((a.Ai = 0), (a.hk = 0), (c = a.ph.get(b[0])), (c = Al(a, c))) &&
    (a.Uo = b);
  return c;
}
function Al(a, b) {
...
function Bl(a, b, c) {
  ...
  this.Bj = !1;
  this.ww = null;
  this.Wp = this.zh = this.Vp = this.Ck = !0;
  if (A)
    try {
...
d.zc = function() {
  return !this.zh || Bl.s.zc.call(this);
};
d.oe = function(a) {
  this.zh ? Bl.s.oe.call(this, a) : (this.zj = a);
};
d.qo = function() {
  return Sd;
};
...
d.Ti = function() {};
d.Hj = function() {
  return Bl.s.Hj.call(this) + (this.zh ? "" : " " + this.cb.rr);
};
d.Ll = function() {
  var a = this.zc(),
    b = this.qw;
  ...
  if (!a && b) return b;
  b = this.cb;
  return a && b.qr ? b.Tg + " " + b.qr : !a && b.lr ? b.Tg + " " + b.lr : "";
};
d.od = function(a) {
  if (this.wb != a) {
    var b = !1;
    this.wb && ((b = this.wb == this.ww), jl(this.wb, !1));
    if ((this.wb = a)) jl(a, !0), b && a.select();
    this.dispatchEvent("change");
  }
};
d.Fe = function() {
...
function Cl(a) {
  0 != a.Ck && ((a.Ck = !1), a.za && Dl(a));
}
function Dl(a) {
  function b(a) {
    var h = el(a);
    if (h) {
      var l = !e || (c == a.getParent() && !f) ? a.cb.ir : a.cb.gr;
      h.className = l;
      if ((h = a.Ql())) h.className = nl(a);
    }
    $h(a, b);
  }
  var c = a,
...
d.rb = function() {
  ...
  a = this.G();
  a.tabIndex = 0;
  var b = (this.mc = new li(a)),
    c = (this.jo = new Zk(a));
  Yh(this)
    .ia(c, "focusout", this.Ew)
    .ia(c, "focusin", this.Jw)
    .ia(b, "key", this.Ld)
    .ia(a, "mousedown", this.zo)
    .ia(a, "click", this.zo)
    .ia(a, "dblclick", this.zo);
  this.em();
};
d.Hd = function() {
  Bl.s.Hd.call(this);
...
d.Ld = function(a) {
  ...
  switch (a.keyCode) {
    ...
    case 38:
      if (a.ctrlKey) {
        ...
        if (e) {
          ...
          if (b.qm) {
            var k = b.Ai + c;
            0 <= k && k < b.qm.length ? ((b.Ai = k), (f = b.qm)) : (h = !0);
          }
          f ||
            ((k = b.hk + c),
            0 <= k && k < e.length && (b.hk = k),
            e.length > b.hk && (f = b.ph.get(e[b.hk])),
            f && f.length && h && (b.Ai = -1 == c ? f.length - 1 : 0));
          Al(b, f) && (b.Uo = e);
        }
        c = !0;
      }
    ...
    case 8:
      ...
      c = !0;
      0 < e
        ? ((b.Db = b.Db.substring(0, e)), zl(b, b.Db))
        : 0 == e
        ? (b.Db = "")
        : (c = !1);
      break;
...
d.createNode = function(a) {
  return new rl(a || Sd, this.cb, this.Yb());
};
function pl(a, b) {
  a = a.Lk;
  var c = b.Ib();
...
function Qg(a) {
  ...
  this.cb = {
    ...
    xr: "blocklyTreeSelected"
  };
  this.Ot = { Rn: "blocklyTreeSeparator" };
  this.ge &&
    ((this.cb.cssTreeRow += a.u
...
d.I = function() {
  ...
  x.O(
    ...
    this,
    function(a) {
      x.i.jg(a) || a.target == this.Nc ? x.Qb(!1) : x.Qb(!0);
      x.Touch.df();
    },
    !1,
    !0
  ...
  this.cb.cssCollapsedFolderIcon =
  ...
  if (a) {
    ...
    this.ge
      ? ((a.style.left = "0"),
        ...
        this.Ea == x.Nf ? (a.style.top = "0") : (a.style.bottom = "0"))
      : (this.Ea == x.se ? (a.style.right = "0") : (a.style.left = "0"),
...
d.Bm = function(a) {
  ...
  this.Sd.ue = [];
  this.fs = !1;
  a = Il(this, a, this.Sd, this.m.options.le);
  if (this.Sd.ue.length)
    ...
    if (l.tagName)
      switch (l.tagName.toUpperCase()) {
        case "CATEGORY":
          ...
          q(m)
            ? ((h.Co = /^#[0-9a-fA-F]{6}$/.test(m) ? m : x.ns(Number(m))),
              (a.fs = !0))
            : (h.Co = "");
          "true" == l.getAttribute("expanded")
            ? (h.ue.length && (f = h), h.oe(!0))
            : h.oe(!1);
          h = l;
          break;
        case "SEP":
...
function Yg(a, b) {
  ...
  for (var c = 0, e; (e = b[c]); c++) {
    var f = hl(e);
    if (f) {
      var h = a.fs ? "8px solid " + (e.Co || "#ddd") : "none";
...
d.ki = function() {
  ...
  var a = this.Nc.getBoundingClientRect(),
    b = a.left,
    c = a.top,
    e = a.width;
  a = a.height;
  return this.Ea == x.Mf
    ? new wg(-1e7, -1e7, 1e7 + b + e, 2e7)
    : this.Ea == x.se
    ? new wg(b, -1e7, 1e7 + e, 2e7)
    : this.Ea == x.Nf
    ? new wg(-1e7, -1e7, 2e7, 1e7 + c + a)
    : new wg(0, c, 2e7, 1e7 + e);
};
function Hl(a, b) {
  this.ga = a;
  Bl.call(this, Sd, b);
...
Hl.prototype.createNode = function(a) {
  a = a ? Ld(a) : Sd;
  return new Kl(this.ga, a, this.cb, this.Yb());
};
Hl.prototype.od = function(a) {
  var b = this.ga;
  if (a != this.wb && a != b.Sd) {
    b.ek && (hl(b.ek).style.backgroundColor = "");
    if (a) {
      var c = a.Co || "#57e";
    ...
    a && a.ue && a.ue.length
      ? (b.J.show(a.ue), b.ek != a && b.J.Ep())
      : b.J.Pa();
    c != a &&
      c != this &&
      ((c = new Ic(null, "category", c && Kd(c.Uj), a && Kd(a.Uj))),
      (c.Kc = b.m.id),
      x.j.V(c));
    a && (b.ek = a);
  }
...
d.fp = function(a) {
  ...
  return Kl.s.fp.call(this, a);
};
function Jl(a) {
  Kl.call(this, null, Sd, a);
}
w(Jl, Kl);
x.wd = {};
x.wd.uC = "";
...
x.K.T = function() {
  x.K.na ||
    ((x.K.na = G("DIV", "blocklyWidgetDiv")),
    document.body.appendChild(x.K.na));
};
x.K.show = function(a, b, c) {
  x.K.Pa();
  x.K.nk = a;
  x.K.di = c;
...
x.K.position = function(a, b, c, e, f) {
  b < e.y && (b = e.y);
  f ? a > c.width + e.x && (a = c.width + e.x) : a < e.x && (a = e.x);
  x.K.et(a, b, c.height);
};
x.K.et = function(a, b, c) {
  x.K.na.style.left = a + "px";
  x.K.na.style.top = b + "px";
  x.K.na.style.height = c + "px";
};
x.K.op = function(a, b, c, e) {
  x.K.et(x.K.Bv(a, b, c, e), x.K.Cv(a, b, c), c.height);
};
x.K.Bv = function(a, b, c, e) {
  if (e)
    return (
...
d.Ff = function(a, b) {
  this.Fk = new D(a * this.xg, b * this.xg);
  a = this.Fk.x;
  b = this.Fk.y;
  a = a.toFixed(0);
  b = b.toFixed(0);
...
d.Yl = function() {
  var a = x.i.Bc(this.ab);
  return new D(a.x / this.xg, a.y / this.xg);
};
d.Ac = function() {
  return this.ye;
};
d.jj = function(a) {
  a
    ? a.appendChild(this.ye.firstChild)
    : this.ye.removeChild(this.ye.firstChild);
  this.ab.style.display = "none";
  this.Fk = null;
};
x.fg = function(a, b) {
  ...
  if (!je(document, a)) throw "Error: container is not in current document.";
  b = new dg(b || {});
  var c = G("DIV", "injectionDiv");
  a.appendChild(c);
  a = x.oj(c, b);
  var e = new Ll(c);
  c = new Dg(c);
...
x.oj = function(a, b) {
  ...
  0 < f.length && 0 < f.spacing
    ? (x.i.B("line", { stroke: f.colour }, c),
      1 < f.length && x.i.B("line", { stroke: f.colour }, c))
    : x.i.B("line", {}, c);
  b.Yr = c;
  return a;
};
...
x.jx = function(a) {
  var b = a.options,
    c = L(a);
  x.O(c.parentNode, "contextmenu", null, function(a) {
    x.i.km(a) || a.preventDefault();
  });
  c = x.O(window, "resize", null, function() {
    x.Qb(!0);
    x.Eh(a);
  });
  a.Jm = c;
  ...
  b.Ke &&
    (a.ga
      ...
      : a.J &&
        (a.J.I(a),
        a.J.show(b.Ke.childNodes),
        a.J.Ep(),
        (a.scrollX = a.J.ma),
        b.Ea == x.se && (a.scrollX *= -1),
...
x.fg.vv = function() {
  x.mw ||
    (x.O(document, "keydown", null, x.Px),
    x.Oc(document, "touchend", null, x.mg),
    x.Oc(document, "touchcancel", null, x.mg),
    rb &&
      x.O(window, "orientationchange", document, function() {
        x.Eh(x.oi());
      }));
  x.mw = !0;
};
...
x.ns = function(a) {
  ...
  return wj([Math.floor(e), Math.floor(f), Math.floor(h)]);
};
x.Kt = function(a) {
...
x.Eh = function(a) {
  for (; a.options.Lb; ) a = a.options.Lb;
  var b = L(a),
    c = b.parentNode;
  if (c) {
    var e = c.offsetWidth;
  ...
  if (!x.ng.options.readOnly && !x.i.km(a)) {
    ...
    if (27 == a.keyCode) x.Qb();
      ...
      x.selected &&
        ...
        x.selected.Je() &&
        (67 == a.keyCode
          ? (x.Qb(), x.On(x.selected))
          : 88 != a.keyCode || x.selected.o.je || (x.On(x.selected), (b = !0)));
      86 == a.keyCode
        ? x.kj && (x.j.S(!0), (a = x.tl), a.je && (a = a.Fh), Vg(a), x.j.S(!1))
        : 90 == a.keyCode && (x.Qb(), x.ng.eq(a.shiftKey));
    }
    b &&
      !x.selected.o.je &&
      (x.j.S(!0), x.Qb(), x.selected.A(!0, !0), x.j.S(!1));
  }
};
x.On = function(a) {
  if (a.rs) var b = a.Jk();
...
x.alert = function(a, b) {
  window.alert(a);
  b && b();
};
x.confirm = function(a, b) {
  b(window.confirm(a));
};
x.prompt = function(a, b, c) {
  c(window.prompt(a, b));
};
x.px = function(a) {
  return function() {
...
x.O = function(a, b, c, e, f, h) {
  function k(a) {
    ...
    for (var h = 0, k; (k = a[h]); h++)
      if (!b || x.Touch.Tp(k)) x.Touch.ky(k), c ? e.call(c, k) : e(k), (l = !0);
  }
  var l = !1,
    m = [];
  if (g.PointerEvent && b in x.Touch.te)
    for (var n = 0, p; (p = x.Touch.te[b][n]); n++)
      a.addEventListener(p, k, !1), m.push([a, p, k]);
  else if ((a.addEventListener(b, k, !1), m.push([a, b, k]), b in x.Touch.te)) {
    var t = function(a) {
      k(a);
      var b = !h;
      l && b && a.preventDefault();
    };
    for (n = 0; (p = x.Touch.te[b][n]); n++)
...
x.Oc = function(a, b, c, e) {
  ...
  var h = [],
    k = g.window;
  if (k && k.PointerEvent && b in x.Touch.te) {
    k = 0;
    for (var l; (l = x.Touch.te[b][k]); k++)
      a.addEventListener(l, f, !1), h.push([a, l, f]);
  } else if (
    (a.addEventListener(b, f, !1), h.push([a, b, f]), b in x.Touch.te)
  ) {
    var m = function(a) {
...
x.Ev = function() {
  ...
  x.gc("LISTS_HUE", ["Constants", "Lists", "HUE"], 260);
...
x.gc = function(a, b, c) {
  for (var e = "Blockly", f = x, h = 0; h < b.length; ++h)
    (e += "." + b[h]), f && (f = f[b[h]]);
  f &&
    f !== c &&
    ((a = (void 0 === c
...
var Nl = {
  ...
  Tl = Number,
  Ul,
  Vl = window.location.search.match(/[?&]level=([^&]+)/);
...
x.g.xC = {};
x.g.ADD_COMMENT = "A\u00f1adir comentario";
x.g.CANNOT_DELETE_VARIABLE_PROCEDURE =
  'No se puede eliminar la variable "%1" porque es parte de la definici\u00f3n de la funci\u00f3n "%2"';
x.g.CHANGE_VALUE_TITLE = "Cambiar el valor:";
x.g.CLEAN_UP = "Limpiar los bloques";
x.g.COLLAPSE_ALL = "Contraer bloques";
x.g.COLLAPSE_BLOCK = "Contraer bloque";
x.g.COLOUR_BLEND_COLOUR1 = "color 1";
x.g.COLOUR_BLEND_COLOUR2 = "color 2";
x.g.COLOUR_BLEND_HELPURL = "http://meyerweb.com/eric/tools/color-blend/";
x.g.COLOUR_BLEND_RATIO = "proporci\u00f3n";
x.g.COLOUR_BLEND_TITLE = "combinar";
x.g.COLOUR_BLEND_TOOLTIP =
  "Combina dos colores con una proporci\u00f3n determinada (0,0\u20131,0).";
x.g.COLOUR_PICKER_HELPURL = "https://es.wikipedia.org/wiki/Color";
x.g.COLOUR_PICKER_TOOLTIP = "Elige un color de la paleta.";
x.g.COLOUR_RANDOM_HELPURL = "http://randomcolour.com";
x.g.COLOUR_RANDOM_TITLE = "color aleatorio";
x.g.COLOUR_RANDOM_TOOLTIP = "Elige un color al azar.";
x.g.COLOUR_RGB_BLUE = "azul";
x.g.COLOUR_RGB_GREEN = "verde";
x.g.COLOUR_RGB_HELPURL = "http://www.december.com/html/spec/colorper.html";
x.g.COLOUR_RGB_RED = "rojo";
x.g.COLOUR_RGB_TITLE = "colorear con";
x.g.COLOUR_RGB_TOOLTIP =
  "Crea un color con cantidades espec\u00edficas de rojo, verde y azul. Todos los valores deben encontrarse entre 0 y 100.";
x.g.CONTROLS_FLOW_STATEMENTS_HELPURL =
  "https://github.com/google/blockly/wiki/Loops#loop-termination-blocks";
x.g.CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK = "romper el bucle";
x.g.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE =
  "continuar con la siguiente iteraci\u00f3n del bucle";
x.g.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK = "Romper el bucle que lo contiene.";
x.g.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE =
  "Saltar el resto de este bucle, y continuar con la siguiente iteraci\u00f3n.";
x.g.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Atenci\u00f3n: este bloque puede usarse solamente dentro de un bucle.";
x.g.CONTROLS_FOREACH_HELPURL = "https://es.wikipedia.org/wiki/Foreach";
x.g.CONTROLS_FOREACH_TITLE = "para cada elemento %1 en la lista %2";
x.g.CONTROLS_FOREACH_TOOLTIP =
  "Para cada elemento en una lista, establecer la variable '%1' al elemento y luego hacer algunas declaraciones.";
x.g.CONTROLS_FOR_HELPURL =
  "https://github.com/google/blockly/wiki/Loops#count-with";
x.g.CONTROLS_FOR_TITLE = "contar con %1 desde %2 hasta %3 de a %4";
x.g.CONTROLS_FOR_TOOLTIP =
...
x.g.CONTROLS_IF_ELSEIF_TOOLTIP = "Agregar una condici\u00f3n a este bloque.";
x.g.CONTROLS_IF_ELSE_TOOLTIP =
  "Agregar una condici\u00f3n general final a este bloque.";
x.g.CONTROLS_IF_HELPURL = "https://github.com/google/blockly/wiki/IfElse";
x.g.CONTROLS_IF_IF_TOOLTIP =
  "Agregar, eliminar o reordenar las secciones para reconfigurar este bloque.";
x.g.CONTROLS_IF_MSG_ELSE = "sino";
x.g.CONTROLS_IF_MSG_ELSEIF = "sino si";
x.g.CONTROLS_IF_MSG_IF = "si";
x.g.CONTROLS_IF_TOOLTIP_1 =
...
x.g.CONTROLS_REPEAT_HELPURL = "https://es.wikipedia.org/wiki/Bucle_for";
x.g.CONTROLS_REPEAT_INPUT_DO = "hacer";
x.g.CONTROLS_REPEAT_TITLE = "repetir %1 veces";
x.g.CONTROLS_REPEAT_TOOLTIP = "Hacer algunas declaraciones varias veces.";
x.g.CONTROLS_WHILEUNTIL_HELPURL =
  "https://github.com/google/blockly/wiki/Loops#repeat";
x.g.CONTROLS_WHILEUNTIL_OPERATOR_UNTIL = "repetir hasta";
x.g.CONTROLS_WHILEUNTIL_OPERATOR_WHILE = "repetir mientras";
x.g.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL =
  "Mientras un valor sea falso, entonces hacer algunas declaraciones.";
x.g.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE =
  "Mientras un valor sea verdadero, entonces hacer algunas declaraciones.";
x.g.DELETE_ALL_BLOCKS = "\u00bfEliminar todos los %1 bloques?";
x.g.DELETE_BLOCK = "Eliminar bloque";
x.g.DELETE_VARIABLE = 'Borrar la variable "%1"';
x.g.DELETE_VARIABLE_CONFIRMATION = '\u00bfBorrar %1 usos de la variable "%2"?';
x.g.DELETE_X_BLOCKS = "Eliminar %1 bloques";
x.g.DISABLE_BLOCK = "Desactivar bloque";
x.g.DUPLICATE_BLOCK = "Duplicar";
x.g.DUPLICATE_COMMENT = "Duplicar comentario";
x.g.ENABLE_BLOCK = "Activar bloque";
x.g.EXPAND_ALL = "Expandir bloques";
x.g.EXPAND_BLOCK = "Expandir bloque";
x.g.EXTERNAL_INPUTS = "Entradas externas";
x.g.HELP = "Ayuda";
x.g.INLINE_INPUTS = "Entradas en l\u00ednea";
x.g.IOS_CANCEL = "Cancelar";
x.g.IOS_ERROR = "Error";
x.g.IOS_OK = "Aceptar";
x.g.IOS_PROCEDURES_ADD_INPUT = "+ A\u00f1adir entrada";
x.g.IOS_PROCEDURES_ALLOW_STATEMENTS = "Permitir declaraciones";
x.g.IOS_PROCEDURES_DUPLICATE_INPUTS_ERROR =
  "Esta funci\u00f3n tiene entradas duplicadas.";
x.g.IOS_PROCEDURES_INPUTS = "ENTRADAS";
x.g.IOS_VARIABLES_ADD_BUTTON = "A\u00f1adir";
x.g.IOS_VARIABLES_ADD_VARIABLE = "+ A\u00f1adir variable";
x.g.IOS_VARIABLES_DELETE_BUTTON = "Borrar";
x.g.IOS_VARIABLES_EMPTY_NAME_ERROR =
  "No puedes usar un nombre de variable vac\u00edo.";
x.g.IOS_VARIABLES_RENAME_BUTTON = "Renombrar";
x.g.IOS_VARIABLES_VARIABLE_NAME = "Nombre de la variable";
x.g.LISTS_CREATE_EMPTY_HELPURL =
  "https://github.com/google/blockly/wiki/Lists#create-empty-list";
x.g.LISTS_CREATE_EMPTY_TITLE = "crear lista vac\u00eda";
x.g.LISTS_CREATE_EMPTY_TOOLTIP =
  "Devuelve una lista, de longitud 0, sin ning\u00fan dato";
x.g.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = "lista";
x.g.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  "Agregar, eliminar o reorganizar las secciones para reconfigurar este bloque de lista.";
x.g.LISTS_CREATE_WITH_HELPURL =
  "https://github.com/google/blockly/wiki/Lists#create-list-with";
x.g.LISTS_CREATE_WITH_INPUT_WITH = "crear lista con";
x.g.LISTS_CREATE_WITH_ITEM_TOOLTIP = "Agregar un elemento a la lista.";
x.g.LISTS_CREATE_WITH_TOOLTIP =
  "Crear una lista con cualquier n\u00famero de elementos.";
x.g.LISTS_GET_INDEX_FIRST = "primero";
x.g.LISTS_GET_INDEX_FROM_END = "# del final";
x.g.LISTS_GET_INDEX_FROM_START = "#";
x.g.LISTS_GET_INDEX_GET = "obtener";
x.g.LISTS_GET_INDEX_GET_REMOVE = "obtener y eliminar";
x.g.LISTS_GET_INDEX_LAST = "\u00faltimo";
x.g.LISTS_GET_INDEX_RANDOM = "aleatorio";
x.g.LISTS_GET_INDEX_REMOVE = "eliminar";
x.g.LISTS_GET_INDEX_TAIL = "";
x.g.LISTS_GET_INDEX_TOOLTIP_GET_FIRST =
  "Devuelve el primer elemento de una lista.";
x.g.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "Devuelve el elemento en la posici\u00f3n especificada en una lista.";
x.g.LISTS_GET_INDEX_TOOLTIP_GET_LAST =
  "Devuelve el \u00faltimo elemento de una lista.";
x.g.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM =
  "Devuelve un elemento aleatorio en una lista.";
x.g.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST =
  "Elimina y devuelve el primer elemento de una lista.";
x.g.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM =
  "Elimina y devuelve el elemento en la posici\u00f3n especificada en una lista.";
x.g.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_LAST =
  "Elimina y devuelve el \u00faltimo elemento de una lista.";
x.g.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_RANDOM =
  "Elimina y devuelve un elemento aleatorio en una lista.";
x.g.LISTS_GET_INDEX_TOOLTIP_REMOVE_FIRST =
  "Elimina el primer elemento de una lista.";
x.g.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM =
  "Elimina el elemento en la posici\u00f3n especificada en una lista.";
x.g.LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST =
  "Elimina el \u00faltimo elemento de una lista.";
x.g.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM =
  "Elimina un elemento aleatorio en una lista.";
x.g.LISTS_GET_SUBLIST_END_FROM_END = "hasta # del final";
x.g.LISTS_GET_SUBLIST_END_FROM_START = "hasta #";
x.g.LISTS_GET_SUBLIST_END_LAST = "hasta el \u00faltimo";
x.g.LISTS_GET_SUBLIST_HELPURL =
  "https://github.com/google/blockly/wiki/Lists#getting-a-sublist";
x.g.LISTS_GET_SUBLIST_START_FIRST = "obtener sublista desde el primero";
x.g.LISTS_GET_SUBLIST_START_FROM_END = "obtener sublista desde # del final";
x.g.LISTS_GET_SUBLIST_START_FROM_START = "obtener sublista desde #";
x.g.LISTS_GET_SUBLIST_TAIL = "";
x.g.LISTS_GET_SUBLIST_TOOLTIP =
  "Crea una copia de la parte especificada de una lista.";
x.g.LISTS_INDEX_FROM_END_TOOLTIP = "%1 es el \u00faltimo elemento.";
x.g.LISTS_INDEX_FROM_START_TOOLTIP = "%1 es el primer elemento.";
x.g.LISTS_INDEX_OF_FIRST = "encontrar la primera aparici\u00f3n del elemento";
x.g.LISTS_INDEX_OF_HELPURL =
  "https://github.com/google/blockly/wiki/Lists#getting-items-from-a-list";
x.g.LISTS_INDEX_OF_LAST =
  "encontrar la \u00faltima aparici\u00f3n del elemento";
x.g.LISTS_INDEX_OF_TOOLTIP =
  "Devuelve el \u00edndice de la primera/\u00faltima aparici\u00f3n del elemento en la lista. Devuelve %1 si el elemento no se encuentra.";
x.g.LISTS_INLIST = "en la lista";
x.g.LISTS_ISEMPTY_HELPURL =
  "https://github.com/google/blockly/wiki/Lists#is-empty";
x.g.LISTS_ISEMPTY_TITLE = "%1 est\u00e1 vac\u00eda";
x.g.LISTS_ISEMPTY_TOOLTIP =
  "Devuelve verdadero si la lista est\u00e1 vac\u00eda.";
x.g.LISTS_LENGTH_HELPURL =
  "https://github.com/google/blockly/wiki/Lists#length-of";
x.g.LISTS_LENGTH_TITLE = "longitud de %1";
x.g.LISTS_LENGTH_TOOLTIP = "Devuelve la longitud de una lista.";
x.g.LISTS_REPEAT_HELPURL =
  "https://github.com/google/blockly/wiki/Lists#create-list-with";
x.g.LISTS_REPEAT_TITLE = "crear lista con el elemento %1 repetido %2 veces";
x.g.LISTS_REPEAT_TOOLTIP =
  "Crea una lista que consta de un valor dado repetido el n\u00famero de veces especificado.";
x.g.LISTS_REVERSE_HELPURL =
  "https://github.com/google/blockly/wiki/Lists#reversing-a-list";
x.g.LISTS_REVERSE_MESSAGE0 = "invertir %1";
x.g.LISTS_REVERSE_TOOLTIP = "Invertir una copia de una lista.";
x.g.LISTS_SET_INDEX_HELPURL =
  "https://github.com/google/blockly/wiki/Lists#in-list--set";
x.g.LISTS_SET_INDEX_INPUT_TO = "como";
x.g.LISTS_SET_INDEX_INSERT = "insertar en";
x.g.LISTS_SET_INDEX_SET = "establecer";
x.g.LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST =
...
x.g.LISTS_SET_INDEX_TOOLTIP_INSERT_LAST =
  "A\u00f1ade el elemento al final de una lista.";
x.g.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM =
  "Inserta el elemento aleatoriamente en una lista.";
x.g.LISTS_SET_INDEX_TOOLTIP_SET_FIRST =
  "Establece el primer elemento de una lista.";
x.g.LISTS_SET_INDEX_TOOLTIP_SET_FROM =
  "Establece el elemento en la posici\u00f3n especificada en una lista.";
x.g.LISTS_SET_INDEX_TOOLTIP_SET_LAST =
  "Establece el \u00faltimo elemento de una lista.";
x.g.LISTS_SET_INDEX_TOOLTIP_SET_RANDOM =
  "Establece un elemento aleatorio en una lista.";
x.g.LISTS_SORT_HELPURL =
  "https://github.com/google/blockly/wiki/Lists#sorting-a-list";
x.g.LISTS_SORT_ORDER_ASCENDING = "ascendente";
x.g.LISTS_SORT_ORDER_DESCENDING = "descendente";
x.g.LISTS_SORT_TITLE = "orden %1 %2 %3";
x.g.LISTS_SORT_TOOLTIP = "Ordenar una copia de una lista.";
x.g.LISTS_SORT_TYPE_IGNORECASE =
  "alfab\u00e9tico, ignorar may\u00fascula/min\u00fascula";
x.g.LISTS_SORT_TYPE_NUMERIC = "num\u00e9rico";
x.g.LISTS_SORT_TYPE_TEXT = "alfab\u00e9tico";
x.g.LISTS_SPLIT_HELPURL =
  "https://github.com/google/blockly/wiki/Lists#splitting-strings-and-joining-lists";
x.g.LISTS_SPLIT_LIST_FROM_TEXT = "hacer lista a partir de texto";
x.g.LISTS_SPLIT_TEXT_FROM_LIST = "hacer texto a partir de lista";
x.g.LISTS_SPLIT_TOOLTIP_JOIN =
  "Unir una lista de textos en un solo texto, separado por un delimitador.";
x.g.LISTS_SPLIT_TOOLTIP_SPLIT =
  "Dividir el texto en una lista de textos, separando en cada delimitador.";
x.g.LISTS_SPLIT_WITH_DELIMITER = "con delimitador";
x.g.LOGIC_BOOLEAN_FALSE = "falso";
x.g.LOGIC_BOOLEAN_HELPURL =
  "https://github.com/google/blockly/wiki/Logic#values";
x.g.LOGIC_BOOLEAN_TOOLTIP = "Devuelve verdadero o falso.";
x.g.LOGIC_BOOLEAN_TRUE = "verdadero";
x.g.LOGIC_COMPARE_HELPURL =
  "https://es.wikipedia.org/wiki/Desigualdad_matem\u00e1tica";
x.g.LOGIC_COMPARE_TOOLTIP_EQ =
  "Devuelve verdadero si ambas entradas son iguales.";
x.g.LOGIC_COMPARE_TOOLTIP_GT =
  "Devuelve verdadero si la primera entrada es mayor que la segunda entrada.";
x.g.LOGIC_COMPARE_TOOLTIP_GTE =
  "Devuelve verdadero si la primera entrada es mayor o igual a la segunda entrada.";
x.g.LOGIC_COMPARE_TOOLTIP_LT =
  "Devuelve verdadero si la primera entrada es menor que la segunda entrada.";
x.g.LOGIC_COMPARE_TOOLTIP_LTE =
  "Devuelve verdadero si la primera entrada es menor que o igual a la segunda entrada.";
x.g.LOGIC_COMPARE_TOOLTIP_NEQ =
...
x.g.LOGIC_NEGATE_TITLE = "no %1";
x.g.LOGIC_NEGATE_TOOLTIP =
...
x.g.LOGIC_NULL_TOOLTIP = "Devuelve nulo.";
x.g.LOGIC_OPERATION_AND = "y";
x.g.LOGIC_OPERATION_HELPURL =
  "https://github.com/google/blockly/wiki/Logic#logical-operations";
x.g.LOGIC_OPERATION_OR = "o";
x.g.LOGIC_OPERATION_TOOLTIP_AND =
  "Devuelve verdadero si ambas entradas son verdaderas.";
x.g.LOGIC_OPERATION_TOOLTIP_OR =
  "Devuelve verdadero si al menos una de las entradas es verdadera.";
x.g.LOGIC_TERNARY_CONDITION = "prueba";
x.g.LOGIC_TERNARY_HELPURL = "https://en.wikipedia.org/wiki/%3F:";
x.g.LOGIC_TERNARY_IF_FALSE = "si es falso";
x.g.LOGIC_TERNARY_IF_TRUE = "si es verdadero";
x.g.LOGIC_TERNARY_TOOLTIP =
...
x.g.MATH_ARITHMETIC_HELPURL = "https://es.wikipedia.org/wiki/Aritm\u00e9tica";
x.g.MATH_ARITHMETIC_TOOLTIP_ADD = "Devuelve la suma de ambos n\u00fameros.";
x.g.MATH_ARITHMETIC_TOOLTIP_DIVIDE =
  "Devuelve el cociente de ambos n\u00fameros.";
x.g.MATH_ARITHMETIC_TOOLTIP_MINUS =
  "Devuelve la diferencia de ambos n\u00fameros.";
x.g.MATH_ARITHMETIC_TOOLTIP_MULTIPLY =
  "Devuelve el producto de ambos n\u00fameros.";
x.g.MATH_ARITHMETIC_TOOLTIP_POWER =
  "Devuelve el primer n\u00famero elevado a la potencia del segundo.";
x.g.MATH_CHANGE_HELPURL =
  "https://en.wikipedia.org/wiki/Programming_idiom#Incrementing_a_counter";
x.g.MATH_CHANGE_TITLE = "a\u00f1adir %2 a %1";
x.g.MATH_CHANGE_TOOLTIP =
  "A\u00f1adir un n\u00famero a la variable \u00ab%1\u00bb.";
x.g.MATH_CONSTANT_HELPURL =
  "https://es.wikipedia.org/wiki/Anexo:Constantes_matem\u00e1ticas";
x.g.MATH_CONSTANT_TOOLTIP =
  "Devuelve una de las constantes comunes: \u03c0 (3.141\u2026), e (2.718\u2026), \u03c6 (1.618\u2026), sqrt(2) (1.414\u2026), sqrt(\u00bd) (0.707\u2026) o \u221e (infinito).";
x.g.MATH_CONSTRAIN_HELPURL =
  "https://en.wikipedia.org/wiki/Clamping_(graphics)";
x.g.MATH_CONSTRAIN_TITLE = "limitar %1 entre %2 y %3";
x.g.MATH_CONSTRAIN_TOOLTIP =
  "Limitar un n\u00famero entre los l\u00edmites especificados (inclusive).";
x.g.MATH_DIVISION_SYMBOL = "\u00f7";
x.g.MATH_IS_DIVISIBLE_BY = "es divisible por";
x.g.MATH_IS_EVEN = "es par";
x.g.MATH_IS_NEGATIVE = "es negativo";
x.g.MATH_IS_ODD = "es impar";
x.g.MATH_IS_POSITIVE = "es positivo";
x.g.MATH_IS_PRIME = "es primo";
x.g.MATH_IS_TOOLTIP =
...
x.g.MATH_IS_WHOLE = "es entero";
x.g.MATH_MODULO_HELPURL = "https://en.wikipedia.org/wiki/Modulo_operation";
x.g.MATH_MODULO_TITLE = "resto de %1 \u00f7 %2";
x.g.MATH_MODULO_TOOLTIP = "Devuelve el resto al dividir los dos n\u00fameros.";
x.g.MATH_MULTIPLICATION_SYMBOL = "\u00d7";
x.g.MATH_NUMBER_HELPURL = "https://es.wikipedia.org/wiki/N\u00famero";
x.g.MATH_NUMBER_TOOLTIP = "Un n\u00famero.";
x.g.MATH_ONLIST_HELPURL = "";
x.g.MATH_ONLIST_OPERATOR_AVERAGE = "promedio de la lista";
x.g.MATH_ONLIST_OPERATOR_MAX = "m\u00e1ximo de la lista";
x.g.MATH_ONLIST_OPERATOR_MEDIAN = "mediana de la lista";
x.g.MATH_ONLIST_OPERATOR_MIN = "m\u00ednimo de la lista";
x.g.MATH_ONLIST_OPERATOR_MODE = "modas de la lista";
x.g.MATH_ONLIST_OPERATOR_RANDOM = "elemento aleatorio de la lista";
x.g.MATH_ONLIST_OPERATOR_STD_DEV = "desviaci\u00f3n est\u00e1ndar de la lista";
x.g.MATH_ONLIST_OPERATOR_SUM = "suma de la lista";
x.g.MATH_ONLIST_TOOLTIP_AVERAGE =
  "Devuelve el promedio (media aritm\u00e9tica) de los valores num\u00e9ricos en la lista.";
x.g.MATH_ONLIST_TOOLTIP_MAX =
  "Devuelve el n\u00famero m\u00e1s grande en la lista.";
x.g.MATH_ONLIST_TOOLTIP_MEDIAN = "Devuelve la mediana en la lista.";
x.g.MATH_ONLIST_TOOLTIP_MIN =
  "Devuelve el n\u00famero m\u00e1s peque\u00f1o en la lista.";
x.g.MATH_ONLIST_TOOLTIP_MODE =
  "Devuelve una lista de los elementos m\u00e1s comunes en la lista.";
x.g.MATH_ONLIST_TOOLTIP_RANDOM = "Devuelve un elemento aleatorio de la lista.";
x.g.MATH_ONLIST_TOOLTIP_STD_DEV =
  "Devuelve la desviaci\u00f3n est\u00e1ndar de la lista.";
x.g.MATH_ONLIST_TOOLTIP_SUM =
  "Devuelve la suma de todos los n\u00fameros en la lista.";
x.g.MATH_POWER_SYMBOL = "^";
x.g.MATH_RANDOM_FLOAT_HELPURL =
  "https://es.wikipedia.org/wiki/Generador_de_n\u00fameros_aleatorios";
x.g.MATH_RANDOM_FLOAT_TITLE_RANDOM = "fracci\u00f3n aleatoria";
x.g.MATH_RANDOM_FLOAT_TOOLTIP =
  "Devuelve una fracci\u00f3n aleatoria entre 0,0 (ambos inclusive) y 1.0 (exclusivo).";
x.g.MATH_RANDOM_INT_HELPURL =
  "https://es.wikipedia.org/wiki/Generador_de_n\u00fameros_aleatorios";
x.g.MATH_RANDOM_INT_TITLE = "entero aleatorio de %1 a %2";
x.g.MATH_RANDOM_INT_TOOLTIP =
  "Devuelve un entero aleatorio entre los dos l\u00edmites especificados, inclusive.";
x.g.MATH_ROUND_HELPURL = "https://es.wikipedia.org/wiki/Redondeo";
x.g.MATH_ROUND_OPERATOR_ROUND = "redondear";
x.g.MATH_ROUND_OPERATOR_ROUNDDOWN = "redondear a la baja";
x.g.MATH_ROUND_OPERATOR_ROUNDUP = "redondear al alza";
x.g.MATH_ROUND_TOOLTIP = "Redondear un n\u00famero al alza o a la baja.";
x.g.MATH_SINGLE_HELPURL = "https://es.wikipedia.org/wiki/Ra%C3%ADz_cuadrada";
x.g.MATH_SINGLE_OP_ABSOLUTE = "absoluto";
x.g.MATH_SINGLE_OP_ROOT = "ra\u00edz cuadrada";
x.g.MATH_SINGLE_TOOLTIP_ABS = "Devuelve el valor absoluto de un n\u00famero.";
x.g.MATH_SINGLE_TOOLTIP_EXP = "Devuelve e a la potencia de un n\u00famero.";
x.g.MATH_SINGLE_TOOLTIP_LN = "Devuelve el logaritmo natural de un n\u00famero.";
x.g.MATH_SINGLE_TOOLTIP_LOG10 =
  "Devuelve el logaritmo base 10 de un n\u00famero.";
x.g.MATH_SINGLE_TOOLTIP_NEG = "Devuelve la negaci\u00f3n de un n\u00famero.";
x.g.MATH_SINGLE_TOOLTIP_POW10 = "Devuelve 10 a la potencia de un n\u00famero.";
x.g.MATH_SINGLE_TOOLTIP_ROOT =
...
x.g.MATH_TRIG_HELPURL =
  "https://es.wikipedia.org/wiki/Funci\u00f3n_trigonom\u00e9trica";
x.g.MATH_TRIG_SIN = "sin";
x.g.MATH_TRIG_TAN = "tan";
x.g.MATH_TRIG_TOOLTIP_ACOS = "Devuelve el arcocoseno de un n\u00famero.";
x.g.MATH_TRIG_TOOLTIP_ASIN = "Devuelve el arcoseno de un n\u00famero.";
x.g.MATH_TRIG_TOOLTIP_ATAN = "Devuelve el arcotangente de un n\u00famero.";
x.g.MATH_TRIG_TOOLTIP_COS = "Devuelve el coseno de un grado (no radi\u00e1n).";
x.g.MATH_TRIG_TOOLTIP_SIN = "Devuelve el seno de un grado (no radi\u00e1n).";
x.g.MATH_TRIG_TOOLTIP_TAN =
...
x.g.NEW_VARIABLE = "Crear variable\u2026";
x.g.NEW_VARIABLE_TITLE = "Nombre de variable nueva:";
x.g.NEW_VARIABLE_TYPE_TITLE = "New variable type:";
x.g.ORDINAL_NUMBER_SUFFIX = "";
x.g.PROCEDURES_ALLOW_STATEMENTS = "permitir declaraciones";
x.g.PROCEDURES_BEFORE_PARAMS = "con:";
x.g.PROCEDURES_CALLNORETURN_HELPURL = "https://es.wikipedia.org/wiki/Subrutina";
x.g.PROCEDURES_CALLNORETURN_TOOLTIP =
  "Ejecuta la funci\u00f3n definida por el usuario '%1'.";
x.g.PROCEDURES_CALLRETURN_HELPURL = "https://es.wikipedia.org/wiki/Subrutina";
x.g.PROCEDURES_CALLRETURN_TOOLTIP =
  "Ejecuta la funci\u00f3n definida por el usuario '%1' y usa su salida.";
x.g.PROCEDURES_CALL_BEFORE_PARAMS = "con:";
x.g.PROCEDURES_CREATE_DO = "Crear '%1'";
x.g.PROCEDURES_DEFNORETURN_COMMENT = "Describe esta funci\u00f3n...";
x.g.PROCEDURES_DEFNORETURN_DO = "";
x.g.PROCEDURES_DEFNORETURN_HELPURL = "https://en.wikipedia.org/wiki/Subroutine";
x.g.PROCEDURES_DEFNORETURN_PROCEDURE = "hacer algo";
x.g.PROCEDURES_DEFNORETURN_TITLE = "para";
x.g.PROCEDURES_DEFNORETURN_TOOLTIP = "Crea una funci\u00f3n sin salida.";
x.g.PROCEDURES_DEFRETURN_HELPURL = "https://en.wikipedia.org/wiki/Subroutine";
x.g.PROCEDURES_DEFRETURN_RETURN = "devuelve";
x.g.PROCEDURES_DEFRETURN_TOOLTIP = "Crea una funci\u00f3n con una salida.";
x.g.PROCEDURES_DEF_DUPLICATE_WARNING =
  "Advertencia: Esta funci\u00f3n tiene par\u00e1metros duplicados.";
x.g.PROCEDURES_HIGHLIGHT_DEF = "Destacar definici\u00f3n de la funci\u00f3n";
x.g.PROCEDURES_IFRETURN_HELPURL = "http://c2.com/cgi/wiki?GuardClause";
x.g.PROCEDURES_IFRETURN_TOOLTIP =
  "Si un valor es verdadero, entonces devuelve un segundo valor.";
x.g.PROCEDURES_IFRETURN_WARNING =
  "Advertencia: Este bloque solo puede ser utilizado dentro de la definici\u00f3n de una funci\u00f3n.";
x.g.PROCEDURES_MUTATORARG_TITLE = "nombre de entrada:";
x.g.PROCEDURES_MUTATORARG_TOOLTIP =
  "A\u00f1adir una entrada a la funci\u00f3n.";
x.g.PROCEDURES_MUTATORCONTAINER_TITLE = "entradas";
x.g.PROCEDURES_MUTATORCONTAINER_TOOLTIP =
  "A\u00f1adir, eliminar o reordenar entradas para esta funci\u00f3n.";
x.g.REDO = "Rehacer";
x.g.REMOVE_COMMENT = "Eliminar comentario";
x.g.RENAME_VARIABLE = "Renombrar la variable\u2026";
x.g.RENAME_VARIABLE_TITLE = "Renombrar todas las variables \u00ab%1\u00bb a:";
x.g.TEXT_APPEND_HELPURL =
  "https://github.com/google/blockly/wiki/Text#text-modification";
x.g.TEXT_APPEND_TITLE = "a %1 a\u00f1ade el texto %2";
x.g.TEXT_APPEND_TOOLTIP = "A\u00f1adir texto a la variable '%1'.";
x.g.TEXT_CHANGECASE_HELPURL =
  "https://github.com/google/blockly/wiki/Text#adjusting-text-case";
x.g.TEXT_CHANGECASE_OPERATOR_LOWERCASE = "a min\u00fasculas";
x.g.TEXT_CHANGECASE_OPERATOR_TITLECASE = "a May\u00fasculas Cada Palabra";
x.g.TEXT_CHANGECASE_OPERATOR_UPPERCASE = "a MAY\u00daSCULAS";
x.g.TEXT_CHANGECASE_TOOLTIP =
  "Devuelve una copia del texto en un tama\u00f1o diferente.";
x.g.TEXT_CHARAT_FIRST = "obtener la primera letra";
x.g.TEXT_CHARAT_FROM_END = "obtener la letra # del final";
x.g.TEXT_CHARAT_FROM_START = "obtener la letra #";
x.g.TEXT_CHARAT_HELPURL =
  "https://github.com/google/blockly/wiki/Text#extracting-text";
x.g.TEXT_CHARAT_LAST = "obtener la \u00faltima letra";
x.g.TEXT_CHARAT_RANDOM = "obtener letra aleatoria";
x.g.TEXT_CHARAT_TAIL = "";
x.g.TEXT_CHARAT_TITLE = "en el texto %1 %2";
x.g.TEXT_CHARAT_TOOLTIP = "Devuelve la letra en la posici\u00f3n especificada.";
x.g.TEXT_COUNT_HELPURL =
  "https://github.com/google/blockly/wiki/Text#counting-substrings";
x.g.TEXT_COUNT_MESSAGE0 = "contar %1 en %2";
x.g.TEXT_COUNT_TOOLTIP = "Cuantas veces aparece un texto dentro de otro texto.";
x.g.TEXT_CREATE_JOIN_ITEM_TOOLTIP = "Agregar un elemento al texto.";
x.g.TEXT_CREATE_JOIN_TITLE_JOIN = "unir";
x.g.TEXT_CREATE_JOIN_TOOLTIP =
  "Agregar, eliminar o reordenar las secciones para reconfigurar este bloque de texto.";
x.g.TEXT_GET_SUBSTRING_END_FROM_END = "hasta la letra # del final";
x.g.TEXT_GET_SUBSTRING_END_FROM_START = "hasta la letra #";
x.g.TEXT_GET_SUBSTRING_END_LAST = "hasta la \u00faltima letra";
x.g.TEXT_GET_SUBSTRING_HELPURL =
  "https://github.com/google/blockly/wiki/Text#extracting-a-region-of-text";
x.g.TEXT_GET_SUBSTRING_INPUT_IN_TEXT = "en el texto";
x.g.TEXT_GET_SUBSTRING_START_FIRST = "obtener subcadena desde la primera letra";
x.g.TEXT_GET_SUBSTRING_START_FROM_END =
  "obtener subcadena desde la letra # del final";
x.g.TEXT_GET_SUBSTRING_START_FROM_START = "obtener subcadena desde la letra #";
x.g.TEXT_GET_SUBSTRING_TAIL = "";
x.g.TEXT_GET_SUBSTRING_TOOLTIP =
  "Devuelve una porci\u00f3n determinada del texto.";
x.g.TEXT_INDEXOF_HELPURL =
  "https://github.com/google/blockly/wiki/Text#finding-text";
x.g.TEXT_INDEXOF_OPERATOR_FIRST =
  "encontrar la primera aparici\u00f3n del texto";
x.g.TEXT_INDEXOF_OPERATOR_LAST =
  "encontrar la \u00faltima aparici\u00f3n del texto";
x.g.TEXT_INDEXOF_TITLE = "en el texto %1 %2 %3";
x.g.TEXT_INDEXOF_TOOLTIP =
...
x.g.TEXT_ISEMPTY_HELPURL =
  "https://github.com/google/blockly/wiki/Text#checking-for-empty-text";
x.g.TEXT_ISEMPTY_TITLE = "%1 est\u00e1 vac\u00edo";
x.g.TEXT_ISEMPTY_TOOLTIP =
  "Devuelve verdadero si el texto proporcionado est\u00e1 vac\u00edo.";
x.g.TEXT_JOIN_HELPURL =
  "https://github.com/google/blockly/wiki/Text#text-creation";
x.g.TEXT_JOIN_TITLE_CREATEWITH = "crear texto con";
x.g.TEXT_JOIN_TOOLTIP =
  "Crear un fragmento de texto al unir cualquier n\u00famero de elementos.";
x.g.TEXT_LENGTH_HELPURL =
  "https://github.com/google/blockly/wiki/Text#text-modification";
x.g.TEXT_LENGTH_TITLE = "longitud de %1";
x.g.TEXT_LENGTH_TOOLTIP =
  "Devuelve el n\u00famero de letras (espacios incluidos) del texto proporcionado.";
x.g.TEXT_PRINT_HELPURL =
  "https://github.com/google/blockly/wiki/Text#printing-text";
x.g.TEXT_PRINT_TITLE = "imprimir %1";
x.g.TEXT_PRINT_TOOLTIP =
  "Imprimir el texto, n\u00famero u otro valor especificado.";
x.g.TEXT_PROMPT_HELPURL =
  "https://github.com/google/blockly/wiki/Text#getting-input-from-the-user";
x.g.TEXT_PROMPT_TOOLTIP_NUMBER = "Solicitar al usuario un n\u00famero.";
x.g.TEXT_PROMPT_TOOLTIP_TEXT = "Solicitar al usuario un texto.";
x.g.TEXT_PROMPT_TYPE_NUMBER = "solicitar n\u00famero con el mensaje";
x.g.TEXT_PROMPT_TYPE_TEXT = "solicitar texto con el mensaje";
x.g.TEXT_REPLACE_HELPURL =
  "https://github.com/google/blockly/wiki/Text#replacing-substrings";
x.g.TEXT_REPLACE_MESSAGE0 = "reemplazar %1 con %2 en %3";
x.g.TEXT_REPLACE_TOOLTIP =
  "Reemplazar todas las veces que un texto dentro de otro texto.";
x.g.TEXT_REVERSE_HELPURL =
  "https://github.com/google/blockly/wiki/Text#reversing-text";
x.g.TEXT_REVERSE_MESSAGE0 = "invertir %1";
x.g.TEXT_REVERSE_TOOLTIP = "Invierte el orden de los caracteres en el texto.";
x.g.TEXT_TEXT_HELPURL = "https://es.wikipedia.org/wiki/Cadena_de_caracteres";
x.g.TEXT_TEXT_TOOLTIP = "Una letra, palabra o l\u00ednea de texto.";
x.g.TEXT_TRIM_HELPURL =
  "https://github.com/google/blockly/wiki/Text#trimming-removing-spaces";
x.g.TEXT_TRIM_OPERATOR_BOTH = "quitar espacios de ambos lados de";
x.g.TEXT_TRIM_OPERATOR_LEFT = "quitar espacios iniciales de";
x.g.TEXT_TRIM_OPERATOR_RIGHT = "quitar espacios finales de";
x.g.TEXT_TRIM_TOOLTIP =
  "Devuelve una copia del texto sin los espacios de uno o ambos extremos.";
x.g.TODAY = "Hoy";
x.g.UNDO = "Deshacer";
x.g.VARIABLES_DEFAULT_NAME = "elemento";
x.g.VARIABLES_GET_CREATE_SET = "Crear 'establecer %1'";
x.g.VARIABLES_GET_HELPURL =
  "https://github.com/google/blockly/wiki/Variables#get";
x.g.VARIABLES_GET_TOOLTIP = "Devuelve el valor de esta variable.";
x.g.VARIABLES_SET = "establecer %1 a %2";
x.g.VARIABLES_SET_CREATE_GET = "Crear 'obtener %1'";
x.g.VARIABLES_SET_HELPURL =
  "https://github.com/google/blockly/wiki/Variables#set";
x.g.VARIABLES_SET_TOOLTIP =
  "Establece esta variable para que sea igual a la entrada.";
x.g.VARIABLE_ALREADY_EXISTS = 'Ya existe una variable llamada "%1".';
x.g.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE =
  "Ya existe una variable nombrada '%1' para otra variable del tipo: '%2'.";
x.g.WORKSPACE_COMMENT_DEFAULT_TEXT = "Di algo\u2026";
...
var Y = {
  ...
  I: function() {
    ...
    "BlocklyStorage" in window
      ? ((BlocklyStorage.HTTPREQUEST_ERROR = W("Games_httpRequestError")),
        (BlocklyStorage.LINK_ALERT = W("Games_linkAlert")),
        (BlocklyStorage.HASH_ERROR = W("Games_hashError")),
        (BlocklyStorage.XML_ERROR = W("Games_xmlError")),
        (BlocklyStorage.alert = X.It.bind(X, a)),
        a && am(a, BlocklyStorage.link))
      : a && (a.style.display = "none");
    (a = document.getElementById("languageMenu")) &&
      a.addEventListener("change", Y.Dv, !0);
    x.D && (x.D.Pu = !1);
    x.h && (x.h.Pu = !1);
  },
  BC: function(a, b) {
    if ("BlocklyStorage" in window && 1 < window.location.hash.length)
      ...
      var c = null;
      try {
        c = window.sessionStorage.As;
      } catch (h) {}
      c && delete window.sessionStorage.As;
      var e = Yl(Sl),
        f = b && Yl(Sl - 1);
  ...
  vt: function(a) {
    Y.xc
      ? Y.xc.setValue(a, -1)
      : ((a = x.F.Xc(a)), Gk.clear(), x.F.ae(a, Gk), Gk.In());
  },
  oo: function() {
    if (Y.xc) var a = Y.xc.getValue();
    else {
      a = x.F.gq(Gk, !0);
      if (1 == fd(Gk, !1).length && a.querySelector) {
  ...
  GC: function() {
    window.localStorage && (window.localStorage[$l + Sl] = Y.oo());
  },
  dm: function() {
    window.location = (Rl ? "index.html" : "./") + "?lang=" + Pl;
  },
  Dv: function() {
    if (window.sessionStorage) {
      if (Y.xc) var a = Y.xc.getValue();
      else (a = x.F.gq(Gk)), (a = x.F.Gd(a));
      window.sessionStorage.As = a;
    }
    a = document.getElementById("languageMenu");
  ...
  ks: function(a, b) {
    ...
    a = Gk;
    if (void 0 === b) {
      for (var f = 0; (c = a.Tj[f]); f++) c.Sb(!1);
      a.Tj.length = 0;
    }
    if ((c = e ? Nc(a, e) : null))
      (b = void 0 === b || b)
        ? -1 == a.Tj.indexOf(c) && a.Tj.push(c)
        : ya(a.Tj, c),
        c.Sb(b);
  },
  AC: function(a, b) {
    ...
    a.firstChild ||
      ((a = x.fg(a, { rtl: -1 != Ol.indexOf(Pl), readOnly: !0 })),
  ...
  ze: function(a) {
    if (
      ("click" == a.type &&
        "touchend" == Y.ze.sp &&
        Y.ze.rp + 2e3 > Date.now()) ||
      (Y.ze.sp == a.type && Y.ze.rp + 400 > Date.now())
    )
...
var X = {
  ...
  Rm: function(a, b, c, e, f, h) {
    ...
    e &&
      ...
      (e.id = "dialogHeader"),
      l.appendChild(e),
      (X.Tn = x.Oc(e, "mousedown", null, X.iw)));
    l.appendChild(a);
    a.className = a.className.replace("dialogHiddenContent", "");
    c && b ? (X.og(b, !1, 0.2), X.og(l, !0, 0.8), setTimeout(k, 175)) : k();
  },
  Er: 0,
  Fr: 0,
  iw: function(a) {
  ...
  jd: function(a) {
    ...
    if (X.ih) {
      ...
      e.style.opacity = 0;
      c && a ? (X.og(a, !1, 0.8), X.og(c, !0, 0.2), setTimeout(b, 175)) : b();
  ...
  gv: function() {
    if (!Yl(Sl))
      if (X.ih || Gk.sb()) setTimeout(X.gv, 15e3);
        ...
        b.addEventListener("touchend", Y.dm, !0);
        X.Rm(
          a,
          null,
          !1,
          ...
          function() {
            document.body.removeEventListener("keydown", X.Eq, !0);
          }
        );
  ...
  yt: function() {
    ...
    X.Rm(a, b, !0, !0, { width: "40%", left: "30%", top: "3em" }, function() {
      document.body.removeEventListener("keydown", X.Rr, !0);
    });
  ...
  sC: function() {
    ...
    if (Gk) {
      ...
      c =
        1 == e
          ? W("Games_linesOfCode1")
          : W("Games_linesOfCode2").replace("%1", String(e));
      b.appendChild(document.createTextNode(c));
    }
    c =
      10 > Sl
        ? W("Games_nextLevel").replace("%1", String(Sl + 1))
        : W("Games_finalLevel");
    ...
    X.Rm(
      ...
      { width: "40%", left: "30%", top: "3em" },
      function() {
        document.body.removeEventListener("keydown", X.Zq, !0);
      }
    );
  ...
  Cr: function(a) {
    !X.ih ||
      ...
      (X.jd(!0), a.stopPropagation(), a.preventDefault());
  },
  qy: function() {
    document.body.addEventListener("keydown", X.Cr, !0);
  },
  yy: function() {
    document.body.removeEventListener("keydown", X.Cr, !0);
  },
  Zq: function(a) {
  ...
  Rr: function(a) {
    27 == a.keyCode ? X.jd(!0) : 13 == a.keyCode && X.mo();
  },
  mo: function() {
...
d.reset = function() {
  ...
  this.ta.x = this.Et.x;
  this.ta.y = this.Et.y;
  this.facing = this.hf = tc(
    (180 * Math.atan2(50 - this.ta.y, 50 - this.ta.x)) / Math.PI
  );
  var a = this.Lv;
  if (v(a)) a = a();
...
Z.reset = function() {
  ...
  Z.Ph.length = 0;
  Z.dl.length = 0;
  for (var a = (Z.Mt = 0), b; (b = Z.Lc[a]); a++) b.reset();
};
Z.iv = function(a, b, c, e) {
  c || (c = Z.Xu[Z.Lc.length]);
  a = new bm(a, b, c, e);
  Z.Lc.push(a);
};
Z.start = function(a) {
...
Z.stop = function() {
  for (var a = [], b = 0, c; (c = Z.Lc[b]); b++) c.$d || a.push(c);
  b = a.length;
  for (
    a.sort(function(a, b) {
      return a.kc - b.kc;
...
Z.Jy = function() {
  for (var a = Z.Ph.length - 1; 0 <= a; a--) {
    var b = Z.Ph[a];
    b.qk += Z.tq;
    var c = 0;
    if (b.Dm - b.qk < Z.tq / 2) {
      Z.Ph.splice(a, 1);
      for (var e = 0, f; (f = Z.Lc[e]); e++)
        if (!f.$d) {
          var h = 10 * (1 - wc(f.ta, b.yj) / 4);
          0 < h && (cm(f, h), (c = Math.max(c, h)));
        }
      Z.Td.push({ type: "BOOM", damage: c, x: b.yj.x, y: b.yj.y });
    }
  }
};
Z.Hy = function() {
  for (var a = 0, b; (b = Z.Lc[a]); a++)
    if (
      !b.$d &&
      (b.speed < b.xe
        ? (b.speed = Math.min(b.speed + Z.iq, b.xe))
        : b.speed > b.xe && (b.speed = Math.max(b.speed - Z.iq, b.xe)),
      0 < b.speed)
    ) {
      var c = Z.Vq(b),
        e = c[1],
      ...
      b.ta.x += k;
      b.ta.y += h;
      0 > b.ta.x || 100 < b.ta.x || 0 > b.ta.y || 100 < b.ta.y
        ? ((b.ta.x = sc(b.ta.x, 0, 100)),
          (b.ta.y = sc(b.ta.y, 0, 100)),
          (e = (b.speed / 100) * Z.dn),
          cm(b, e),
          (b.speed = 0),
          (b.xe = 0),
          Z.Td.push({ type: "CRASH", avatar: b, damage: e }))
        : ((c = Z.Vq(b)),
          (f = c[0]),
          (c = c[1]),
          c < Z.fu &&
            ...
            ((b.ta.x -= k),
            (b.ta.y -= h),
            (e = (Math.max(b.speed, f.speed) / 100) * Z.dn),
            cm(b, e),
            (b.speed = 0),
            (b.xe = 0),
            cm(f, e),
            ...
            (f.xe = 0),
            Z.Td.push({ type: "CRASH", avatar: b, damage: e }),
            Z.Td.push({ type: "CRASH", avatar: f, damage: e })));
    }
};
Z.Iy = function() {
  for (var a = 0; a < Z.Yu; a++) {
    Z.Mt++;
    for (var b = 0, c; (c = Z.Lc[b]); b++)
      if (!c.$d) {
        Z.Zd = c;
        try {
          c.lx.step();
        } catch (e) {
          console.log(c + " throws an error: " + e), dm(c);
        }
        Z.Zd = null;
      }
  }
...
Z.ix = function(a, b) {
  var c = function(a, b) {
    var c = a;
    a = Z.Zd;
    var e = void 0 === b || null === b ? 5 : b;
    if (!r(c) || isNaN(c) || !r(e) || isNaN(e)) throw TypeError;
    c = tc(c);
    e = sc(e, 0, 20);
    ...
    b > c && (c += 360);
    e = a.ta.x;
    for (var f = a.ta.y, m = Infinity, n = 0, p; (p = a.Qf.Lc[n]); n++)
      if (p != a && !p.$d) {
        var t = p.ta.x,
          y = p.ta.y;
        p = Math.sqrt((y - f) * (y - f) + (t - e) * (t - e));
        p >= m ||
          ((t = Math.atan2(y - f, t - e)),
          (t = tc((180 * t) / Math.PI)),
          t < b && (t += 360),
          b <= t && t <= c && (m = p));
      }
  ...
  c = function(a, b) {
    var c = b;
    b = Z.Zd;
    if (!r(a) || isNaN(a) || !r(c) || isNaN(c)) throw TypeError;
    var e = Date.now();
    b.No + 1e3 * b.Qf.Su > e
      ? (a = !1)
      : ((b.No = e),
        ...
        (a = {
          ...
          hf: a,
          Dm: c,
          yj: new D(e.x + c * Math.cos(uc(a)), e.y + c * Math.sin(uc(a))),
          qk: 0
        }),
        b.Qf.Ph.push(a),
        b.Qf.Td.push({ type: "BANG", avatar: b, degree: a.hf }),
        (a = !0));
    return a;
  };
  ...
  c = function(a, b) {
    ...
    if (!r(a) || isNaN(a) || !r(b) || isNaN(b)) throw TypeError;
    c.hf != tc(a) &&
      (50 >= c.speed ? ((c.hf = tc(a)), (c.facing = c.hf)) : (b = 0));
    0 == c.speed && 0 < b && (c.speed = 0.1);
    c.xe = sc(b, 0, 100);
  };
  ...
  if ((b = a.getProperty(b, "Math")))
    (c = function(a) {
      return Math.sin((a / 180) * Math.PI);
    }),
      a.setProperty(b, "sin_deg", a.createNativeFunction(c)),
      (c = function(a) {
        return Math.cos((a / 180) * Math.PI);
      }),
      a.setProperty(b, "cos_deg", a.createNativeFunction(c)),
      (c = function(a) {
        return Math.tan((a / 180) * Math.PI);
      }),
      a.setProperty(b, "tan_deg", a.createNativeFunction(c)),
      (c = function(a) {
        return (Math.asin(a) / Math.PI) * 180;
      }),
      a.setProperty(b, "asin_deg", a.createNativeFunction(c)),
      (c = function(a) {
        return (Math.acos(a) / Math.PI) * 180;
      }),
      a.setProperty(b, "acos_deg", a.createNativeFunction(c)),
      (c = function(a) {
        return (Math.atan(a) / Math.PI) * 180;
      }),
      a.setProperty(b, "atan_deg", a.createNativeFunction(c));
};
Z.Vq = function(a) {
  for (var b = null, c = Infinity, e = 0, f; (f = Z.Lc[e]); e++)
    if (!f.$d && a != f) {
      var h = Math.min(c, wc(a.ta, f.ta));
      h < c && ((c = h), (b = f));
    }
  return [b, c];
};
...
function nm() {
  em = document.getElementById("scratch").getContext("2d");
  ...
  om(["pond/splash.mp3", "pond/splash.ogg"], "splash");
  if (!rb && !qb)
    for (var b in mm) (a = mm[b]), (a.volume = 0.01), a.play(), a.pause();
}
function pm() {
  clearTimeout(lm);
  im.length = 0;
  ...
  for (e = 0; (l = c[e]); e++)
    l.style.height = l.parentNode.offsetHeight - 2 + "px";
  qm();
}
var rm = 0,
  sm = 0;
...
function qm() {
  ...
  for (c = 0; (e = b[c]); c++) {
    ...
    e.$d && (a.globalAlpha = 0.25);
    0 < e.speed &&
      (a.save(),
      (f = 50 < e.speed ? 0 : 25 < e.speed ? 35 : 70),
      a.rotate((-e.hf / 180) * Math.PI),
      a.drawImage(jm, 455, f, 35, 35, -45.5, -17.5, 35, 35),
      a.restore());
    a.drawImage(jm, 0, k, 35, 35, -17.5, -17.5, 35, 35);
  ...
  for (c = 0; c < Z.Td.length; c++)
    if (((f = Z.Td[c]), (e = f.avatar), "CRASH" == f.type)) {
      if (((k = hm[e.id]), !k || k + 1e3 < pa()))
        vm("whack", f.damage / Z.dn), (hm[e.id] = pa());
    } else
      "SCAN" == f.type
        ...
        : "BANG" != f.type &&
          ("BOOM" == f.type
            ? (f.damage && vm("boom", f.damage / 10),
              im.push({ x: f.x, y: f.y, t: 0 }))
            : "DIE" == f.type && vm("splash"));
  Z.Td.length = 0;
  for (c = im.length - 1; 0 <= c; c--)
    (e = im[c]),
      (f = um(e.x)),
      (h = um(100 - e.y)),
      a.beginPath(),
      ...
      a.stroke(),
      (e.t += 2),
      10 < e.t && im.splice(c, 1);
  fm.drawImage(a.canvas, 0, 0);
  for (c = 0; (e = b[c]); c++)
    (a = e.Ny),
      (a.parentNode.title = e.name + ": " + Math.round(100 - e.kc) + "%"),
      (a.style.width =
        Math.max(0, a.parentNode.offsetWidth * (1 - e.kc / 100) - 2) + "px");
}
function om(a, b) {
  if (window.Audio && a.length) {
    for (var c, e = new window.Audio(), f = 0; f < a.length; f++) {
      var h = a[f],
        k = h.match(/\.(\w+)$/);
      if (k && e.canPlayType("audio/" + k[1])) {
        c = new window.Audio(h);
        break;
      }
    }
    c && c.play && (mm[b] = c);
...
x.ca.Math.Au = {
  ...
  Ub: function(a) {
    var b = K(this, "DIVISOR");
    a ? b || Q(this, "DIVISOR").Ua("Number") : b && this.Ga("DIVISOR");
  }
};
x.ca.Math.Bu = function() {
  zh(He(this, "PROPERTY"), function(a) {
    this.v.Ub("DIVISIBLE_BY" == a);
  });
};
...
x.ca.Math.Eu = {
  Pk: function(a) {
    "MODE" == a ? this.M.Ua("Array") : this.M.Ua("Number");
  },
  Ka: function() {
    var a = document.createElement("mutation");
    a.setAttribute("op", F(this, "OP"));
    return a;
  },
  hb: function(a) {
    this.Pk(a.getAttribute("op"));
  }
};
x.ca.Math.Du = function() {
  zh(
    He(this, "OP"),
    function(a) {
      this.Pk(a);
...
x.h.I = function(a) {
  x.h.Ug = Object.create(null);
  x.h.lo = Object.create(null);
  x.h.Ra ? x.h.Ra.reset() : (x.h.Ra = new Ok());
  x.h.Ra.ua = a.ua;
  for (var b = [], c = x.H.kv(a), e = 0; e < c.length; e++)
    b.push(x.h.Ra.getName(c[e], "DEVELOPER_VARIABLE"));
  a = x.H.Gq(a);
  for (e = 0; e < a.length; e++) b.push(x.h.Ra.getName(a[e].ba(), x.H.Sa));
  b.length && (x.h.Ug.variables = "var " + b.join(", ") + ";");
};
x.h.finish = function(a) {
  var b = [],
    c;
  for (c in x.h.Ug) b.push(x.h.Ug[c]);
  delete x.h.Ug;
  delete x.h.lo;
  x.h.Ra.reset();
  return b.join("\n\n") + "\n\n\n" + a;
...
x.h.Ce = function(a, b, c, e, f) {
  c = c || 0;
  f = f || x.h.Wb;
  a.o.options.Le && c--;
  var h = a.o.options.Le ? "1" : "0";
  a =
    0 < c
      ? V(a, b, x.h.Kf) || h
      : 0 > c
      ...
      ? V(a, b, x.h.dj) || h
      : V(a, b, f) || h;
  if (x.ig(a)) (a = parseFloat(a) + c), e && (a = -a);
  else {
    if (0 < c) {
      a = a + " + " + c;
      var k = x.h.Kf;
    } else 0 > c && ((a = a + " - " + -c), (k = x.h.Uh));
    e && ((a = c ? "-(" + a + ")" : "-" + a), (k = x.h.dj));
    k = Math.floor(k);
    f = Math.floor(f);
    k && f >= k && (a = "(" + a + ")");
...
x.h.zx = {};
x.h.math_number = function(a) {
  a = parseFloat(F(a, "NUM"));
  return [a, 0 <= a ? x.h.Ng : x.h.dj];
};
x.h.math_arithmetic = function(a) {
  var b = {
      ADD: [" + ", x.h.Kf],
      MINUS: [" - ", x.h.Uh],
      MULTIPLY: [" * ", x.h.mn],
  ...
  var e = V(a, "A", b) || "0";
  a = V(a, "B", b) || "0";
  return c ? [e + c + a, b] : ["Math.pow(" + e + ", " + a + ")", x.h.Da];
};
...
x.h.math_constant = function(a) {
  return {
    PI: ["Math.PI", x.h.mb],
    E: ["Math.E", x.h.mb],
    GOLDEN_RATIO: ["(1 + Math.sqrt(5)) / 2", x.h.bl],
    SQRT2: ["Math.SQRT2", x.h.mb],
    SQRT1_2: ["Math.SQRT1_2", x.h.mb],
    INFINITY: ["Infinity", x.h.Ng]
  }[F(a, "CONSTANT")];
};
...
x.h.math_change = function(a) {
  var b = V(a, "DELTA", x.h.Kf) || "0";
  a = x.h.Ra.getName(F(a, "VAR"), x.H.Sa);
...
x.h.math_on_list = function(a) {
  ...
  switch (b) {
    ...
    case "MODE":
      ...
      break;
    case "STD_DEV":
      b = Mk("mathStandardDeviation", [
        "function " + x.h.xd + "(numbers) {",
...
x.h.math_modulo = function(a) {
  var b = V(a, "DIVIDEND", x.h.cj) || "0";
  a = V(a, "DIVISOR", x.h.cj) || "0";
  return [b + " % " + a, x.h.cj];
};
x.h.math_constrain = function(a) {
  var b = V(a, "VALUE", x.h.ec) || "0",
    c = V(a, "LOW", x.h.ec) || "0";
  a = V(a, "HIGH", x.h.ec) || "Infinity";
  return ["Math.min(Math.max(" + b + ", " + c + "), " + a + ")", x.h.Da];
};
x.h.math_random_int = function(a) {
  var b = V(a, "FROM", x.h.ec) || "0";
  a = V(a, "TO", x.h.ec) || "0";
  return [
    Mk("mathRandomInt", [
      "function " + x.h.xd + "(a, b) {",
...
x.h.math_random_float = function() {
  return ["Math.random()", x.h.Da];
};
x.D.To = {};
x.ca.Ku = {};
x.ca.Ku.Yk = 260;
...
x.D.lists_create_with = {
  I: function() {
    this.Ta = x.g.LISTS_CREATE_WITH_HELPURL;
  ...
  gf: function(a) {
    ...
    for (var c = K(b, "STACK").connection, e = 0; e < this.Fc; e++) {
      var f = a.rf("lists_create_with_item");
      f.Ec();
      c.connect(f.$);
      c = f.L;
    }
  ...
  ef: function(a) {
    var b = Ph(a, "STACK");
    for (a = []; b; ) a.push(b.fq), (b = b.L && J(b.L));
    for (b = 0; b < this.Fc; b++) {
      var c = K(this, "ADD" + b).connection.Ia;
      c && -1 == a.indexOf(c) && c.disconnect();
    }
    this.Fc = a.length;
    this.Ub();
    for (b = 0; b < this.Fc; b++) dh(a[b], this, "ADD" + b);
  },
  Km: function(a) {
    a = Ph(a, "STACK");
    for (var b = 0; a; ) {
  ...
  Ub: function() {
    ...
    for (var a = 0; a < this.Fc; a++)
      if (!K(this, "ADD" + a)) {
        var b = Q(this, "ADD" + a);
        0 == a && O(b, x.g.LISTS_CREATE_WITH_INPUT_WITH);
      }
    for (; K(this, "ADD" + a); ) this.Ga("ADD" + a), a++;
  }
};
x.D.lists_create_with_container = {
  I: function() {
    this.Ha(x.g.LISTS_HUE);
...
x.D.lists_indexOf = {
  I: function() {
    ...
    var b = this;
    this.ka(function() {
      return x.g.LISTS_INDEX_OF_TOOLTIP.replace(
        "%1",
        b.o.options.Le ? "0" : "-1"
      );
    });
...
x.D.lists_getIndex = {
    ...
    this.ka(function() {
      ...
      if ("FROM_START" == e || "FROM_END" == e)
        f +=
          "  " +
          ("FROM_START" == e
            ? x.g.LISTS_INDEX_FROM_START_TOOLTIP
            : x.g.LISTS_INDEX_FROM_END_TOOLTIP
          ).replace("%1", b.o.options.Le ? "#1" : "#0");
      return f;
    });
  },
  Ka: function() {
    ...
    a.setAttribute("at", K(this, "AT").type == x.$a);
    return a;
  },
  hb: function(a) {
  ...
  Qt: function(a) {
    a != !this.M &&
      (Ke(this, !0),
      a
        ? (this.Ic(!1), this.nd(!0), this.md(!0))
        : (this.nd(!1), this.md(!1), this.Ic(!0)));
  },
  td: function(a) {
    this.Ga("AT");
    this.Ga("ORDINAL", !0);
    a
      ? (Q(this, "AT").Ua("Number"),
        x.g.ORDINAL_NUMBER_SUFFIX &&
          O(R(this, "ORDINAL"), x.g.ORDINAL_NUMBER_SUFFIX))
      : R(this, "AT");
    var b = new P(this.vn, function(b) {
    ...
    O(K(this, "AT"), b, "WHERE");
    x.g.LISTS_GET_INDEX_TAIL && Oh(this, "TAIL", null);
  }
};
x.D.lists_setIndex = {
  I: function() {
    ...
    R(this, "AT");
    O(Q(this, "TO"), x.g.LISTS_SET_INDEX_INPUT_TO);
    this.bc(!0);
    this.nd(!0);
    this.md(!0);
    ...
    this.ka(function() {
      ...
      switch (a + " " + e) {
        ...
        case "INSERT FROM_END":
          f = x.g.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM;
          break;
        case "INSERT FIRST":
      ...
      if ("FROM_START" == e || "FROM_END" == e)
        f +=
          "  " +
          x.g.LISTS_INDEX_FROM_START_TOOLTIP.replace(
            "%1",
            b.o.options.Le ? "#1" : "#0"
          );
      return f;
...
x.D.lists_getSublist = {
  I: function() {
    ...
    R(this, "AT2");
    x.g.LISTS_GET_SUBLIST_TAIL &&
      O(R(this, "TAIL"), x.g.LISTS_GET_SUBLIST_TAIL);
    this.bc(!0);
    this.Ic(!0, "Array");
    this.td(1, !0);
    this.td(2, !0);
  ...
  Ka: function() {
    ...
    a.setAttribute("at2", K(this, "AT2").type == x.$a);
    return a;
  },
  hb: function(a) {
  ...
  td: function(a, b) {
    ...
    this.Ga("ORDINAL" + a, !0);
    b
      ? (Q(this, "AT" + a).Ua("Number"),
        x.g.ORDINAL_NUMBER_SUFFIX &&
          O(R(this, "ORDINAL" + a), x.g.ORDINAL_NUMBER_SUFFIX))
      : R(this, "AT" + a);
    var c = new P(this["WHERE_OPTIONS_" + a], function(c) {
    ...
    1 == a &&
      (Oh(this, "AT1", "AT2"),
      K(this, "ORDINAL1") && Oh(this, "ORDINAL1", "AT2"));
...
x.D.lists_sort = {
  I: function() {
    Nh(this, {
      ...
      output: "Array",
      colour: x.g.LISTS_HUE,
      tooltip: x.g.LISTS_SORT_TOOLTIP,
      helpUrl: x.g.LISTS_SORT_HELPURL
    });
  }
};
x.D.lists_split = {
  ...
  Pk: function(a) {
    "SPLIT" == a
      ? (this.M.Ua("Array"), K(this, "INPUT").Ua("String"))
      : (this.M.Ua("String"), K(this, "INPUT").Ua("Array"));
  },
  Ka: function() {
    var a = document.createElement("mutation");
    a.setAttribute("mode", F(this, "MODE"));
    return a;
  },
  hb: function(a) {
    this.Pk(a.getAttribute("mode"));
  }
};
x.D.wx = {};
x.ca.ad = {};
...
x.ca.ad.ju = {
  ...
  Xb: 0,
  Ka: function() {
    if (!this.Gb && !this.Xb) return null;
    var a = document.createElement("mutation");
    this.Gb && a.setAttribute("elseif", this.Gb);
    this.Xb && a.setAttribute("else", 1);
    return a;
  },
  hb: function(a) {
  ...
  gf: function(a) {
    ...
    b.Ec();
    for (var c = b.L, e = 1; e <= this.Gb; e++) {
      var f = a.rf("controls_if_elseif");
      f.Ec();
      c.connect(f.$);
      c = f.L;
    }
    this.Xb && ((a = a.rf("controls_if_else")), a.Ec(), c.connect(a.$));
    return b;
  },
  ef: function(a) {
    var b = J(a.L);
    ...
    this.Ub();
    for (b = 1; b <= this.Gb; b++)
      dh(a[b], this, "IF" + b), dh(c[b], this, "DO" + b);
    dh(e, this, "ELSE");
  },
  Km: function(a) {
    a = J(a.L);
  ...
  Ub: function() {
    K(this, "ELSE") && this.Ga("ELSE");
    for (var a = 1; K(this, "IF" + a); )
      this.Ga("IF" + a), this.Ga("DO" + a), a++;
    for (a = 1; a <= this.Gb; a++)
      O(Q(this, "IF" + a).Ua("Boolean"), x.g.CONTROLS_IF_MSG_ELSEIF),
        O(Mh(this, "DO" + a), x.g.CONTROLS_IF_MSG_THEN);
    this.Xb && O(Mh(this, "ELSE"), x.g.CONTROLS_IF_MSG_ELSE);
  }
};
x.N.wp("controls_if_mutator", x.ca.ad.ju, null, [
  "controls_if_elseif",
  "controls_if_else"
]);
x.ca.ad.ku = function() {
  this.ka(
    function() {
      if (this.Gb || this.Xb) {
        if (!this.Gb && this.Xb) return x.g.CONTROLS_IF_TOOLTIP_2;
        if (this.Gb && !this.Xb) return x.g.CONTROLS_IF_TOOLTIP_3;
        if (this.Gb && this.Xb) return x.g.CONTROLS_IF_TOOLTIP_4;
      } else return x.g.CONTROLS_IF_TOOLTIP_1;
      return "";
    }.bind(this)
  );
};
...
x.ca.ad.Gu = {
  onchange: function(a) {
    ...
    b &&
      ...
      (x.j.S(a.group),
      (a = this.Hi[0]),
      a !== b && (Ke(b), a && !a.jb && K(this, "A").connection.connect(a.M)),
      (b = this.Hi[1]),
      b !== c && (Ke(c), b && !b.jb && K(this, "B").connection.connect(b.M)),
      this.qb(),
      x.j.S(!1));
    this.Hi[0] = Ph(this, "A");
    this.Hi[1] = Ph(this, "B");
    ...
    if ((b || c) && e)
      for (var f = 0; 2 > f; f++) {
        ...
        h &&
          !Te(h.M, e) &&
          (x.j.S(a.group),
          e === this.ft ? (Ke(this), e.v.qb()) : (Ke(h), h.qb()),
          x.j.S(!1));
      }
    this.ft = e;
  }
...
x.N.register(
  ...
  x.N.En("%{BKY_CONTROLS_FOREACH_TOOLTIP}")
);
x.ca.Ye.lu = {
  Ju: [
    "controls_repeat",
  ...
  onchange: function() {
    if (this.o.sb && !this.o.sb()) {
      ...
      a
        ? (this.Pe(null), this.vb || this.Pd(!1))
        : (this.Pe(x.g.CONTROLS_FLOW_STATEMENTS_WARNING),
          this.vb || Lh(this) || this.Pd(!0));
    }
  }
};
...
x.D.procedures_defnoreturn = {
  I: function() {
    ...
    (this.o.options.lj ||
      (this.o.options.Lb && this.o.options.Lb.options.lj)) &&
      x.g.PROCEDURES_DEFNORETURN_COMMENT &&
      this.xf(x.g.PROCEDURES_DEFNORETURN_COMMENT);
  ...
  Oe: function(a) {
    this.cm !== a &&
      (a
        ? (O(Mh(this, "STACK"), x.g.PROCEDURES_DEFNORETURN_DO),
          K(this, "RETURN") && Oh(this, "STACK", "RETURN"))
        : this.Ga("STACK", !0),
      (this.cm = a));
  },
  Ok: function() {
    for (var a = !1, b = {}, c = 0; c < this.W.length; c++) {
      if (b["arg_" + this.W[c].toLowerCase()]) {
        a = !0;
        break;
      }
      b["arg_" + this.W[c].toLowerCase()] = !0;
    }
    a ? this.Pe(x.g.PROCEDURES_DEF_DUPLICATE_WARNING) : this.Pe(null);
    a = "";
    this.W.length &&
      (a = x.g.PROCEDURES_BEFORE_PARAMS + " " + this.W.join(", "));
    x.j.disable();
    try {
      Kh(this, a, "PARAMS");
    } finally {
  ...
  Ka: function(a) {
    ...
    for (var c = 0; c < this.tb.length; c++) {
    ...
    this.cm || b.setAttribute("statements", "false");
    return b;
  },
  hb: function(a) {
    this.W = [];
  ...
  gf: function(a) {
    var b = a.rf("procedures_mutatorcontainer");
    b.Ec();
    K(this, "RETURN")
      ? Kh(b, this.cm ? "TRUE" : "FALSE", "STATEMENTS")
      : K(b, "STATEMENT_INPUT").pa(!1);
    for (var c = K(b, "STACK").connection, e = 0; e < this.W.length; e++) {
      var f = a.rf("procedures_mutatorarg");
      f.Ec();
      Kh(f, this.W[e], "NAME");
      f.CC = e;
      c.connect(f.$);
  ...
  ef: function(a) {
    ...
    if (null !== a && ((a = "TRUE" == a), this.cm != a))
      if (a) this.Oe(!0), dh(this.pe, this, "STACK"), (this.pe = null);
        ...
        a = K(this, "STACK").connection;
        if ((this.pe = a.Ia)) (a = J(a)), Ke(a), a.qb();
        this.Oe(!1);
      }
  },
  mf: function() {
    return [F(this, "NAME"), this.W, !1];
  },
  wo: function() {
    return this.W;
  },
  ...
  wk: function(a, b) {
    ...
    if ("" == c.type) {
      c = c.name;
      b = this.o.fe(b);
      for (var e = !1, f = 0; f < this.tb.length; f++)
        this.tb[f].ba() == a &&
          ((this.W[f] = b.name), (this.tb[f] = b), (e = !0));
      e && this.El(c, b.name);
    }
  },
  Zm: function(a) {
    for (var b = a.name, c = !1, e = 0; e < this.tb.length; e++)
      if (this.tb[e].ba() == a.ba()) {
        var f = this.W[e];
        this.W[e] = b;
        c = !0;
      }
  ...
  El: function(a, b) {
    this.Ok();
    if (this.kd.Y())
      for (var c = Tc(this.kd.m), e = 0, f; (f = c[e]); e++)
  ...
  ff: function(a) {
    if (!this.vb) {
      var b = { enabled: !0 },
        c = F(this, "NAME");
      b.text = x.g.PROCEDURES_CREATE_DO.replace("%1", c);
      var e = G("mutation");
      e.setAttribute("name", c);
      for (var f = 0; f < this.W.length; f++)
        (c = G("arg")), c.setAttribute("name", this.W[f]), e.appendChild(c);
      c = G("block", null, e);
      c.setAttribute("type", this.Mq);
      b.gb = x.ea.ll(this, c);
      a.push(b);
      if (!this.isCollapsed())
        for (f = 0; f < this.tb.length; f++)
          (b = { enabled: !0 }),
            (e = this.tb[f]),
            (c = e.name),
            (b.text = x.g.VARIABLES_SET_CREATE_GET.replace("%1", c)),
            (c = x.H.Sr(e)),
            (c = G("block", null, c)),
...
x.D.procedures_defreturn = {
  I: function() {
    ...
    (this.o.options.lj ||
      (this.o.options.Lb && this.o.options.Lb.options.lj)) &&
      x.g.PROCEDURES_DEFRETURN_COMMENT &&
      this.xf(x.g.PROCEDURES_DEFRETURN_COMMENT);
    this.Ha(x.g.PROCEDURES_HUE);
...
x.D.procedures_mutatorcontainer = {
  I: function() {
    O(R(this), x.g.PROCEDURES_MUTATORCONTAINER_TITLE);
    Mh(this, "STACK");
    O(
      O(R(this, "STATEMENT_INPUT"), x.g.PROCEDURES_ALLOW_STATEMENTS),
      new Kj("TRUE"),
      "STATEMENTS"
    );
    this.Ha(x.g.PROCEDURES_HUE);
...
x.D.procedures_mutatorarg = {
  ...
  dw: function(a) {
    var b = eh(this.v.o);
    if (b)
      for (var c = 0; c < this.rj.length; c++) {
        var e = this.rj[c];
        e.name != a && b.Tf(e.ba());
      }
  }
...
x.D.procedures_callnoreturn = {
  ...
  Np: function(a, b) {
    ...
    c = c && c.kd && c.kd.Y();
    c || ((this.uf = {}), (this.ne = null));
    if (b) {
      a: {
        var e = this.W;
        if (fa(e) && fa(a) && e.length == a.length) {
        ...
        for (f = 0; f < this.W.length; f++)
          if ((h = K(this, "ARG" + f)))
            (h = h.connection.Ia),
              ...
              c &&
                h &&
                -1 == b.indexOf(this.ne[f]) &&
                (h.disconnect(), h.v.qb());
        this.W = [].concat(a);
        this.tb = [];
        for (f = 0; f < this.W.length; f++)
          (a = x.H.Vl(this.o, null, this.W[f], "")), this.tb.push(a);
        this.Ub();
        if ((this.ne = b))
          for (f = 0; f < this.W.length; f++)
            (b = this.ne[f]),
              b in this.uf &&
                ((h = this.uf[b]), dh(h, this, "ARG" + f) || delete this.uf[b]);
        (this.R = e) && this.aa();
      }
    }
  },
  Ub: function() {
    for (var a = 0; a < this.W.length; a++) {
      ...
      if (b) {
        ...
        (b = new Dh(this.W[a])),
          O(Hh(Q(this, "ARG" + a), x.Lg), b, "ARGNAME" + a).I();
    }
    for (; K(this, "ARG" + a); ) this.Ga("ARG" + a), a++;
    if ((a = K(this, "TOPROW")))
      this.W.length
        ? He(this, "WITH") ||
          (O(a, x.g.PROCEDURES_CALL_BEFORE_PARAMS, "WITH"), a.I())
        : He(this, "WITH") && Gh(a, "WITH");
  },
  Ka: function() {
    var a = document.createElement("mutation");
    a.setAttribute("name", this.Jd());
  ...
  onchange: function(a) {
    if (this.o && !this.o.je)
      if (a.type == x.j.au && -1 != a.cg.indexOf(this.id)) {
        ...
        !b ||
          (b.type == this.Sn &&
            JSON.stringify(b.W) == JSON.stringify(this.W)) ||
          (b = null);
        if (!b) {
          x.j.S(a.group);
          a = G("xml");
        ...
        a.type == x.j.bu &&
          ((b = this.Jd()),
          (b = x.ra.Pl(b, this.o)),
          b || (x.j.S(a.group), this.A(!0, !1), x.j.S(!1)));
  },
  ff: function(a) {
    var b = { enabled: !0 };
...
x.D.procedures_ifreturn = {
  I: function() {
    O(Q(this, "CONDITION").Ua("Boolean"), x.g.CONTROLS_IF_MSG_IF);
  ...
  Ka: function() {
    var a = document.createElement("mutation");
    a.setAttribute("value", Number(this.$f));
    return a;
  },
  hb: function(a) {
    this.$f = 1 == a.getAttribute("value");
    this.$f ||
      (this.Ga("VALUE"), O(R(this, "VALUE"), x.g.PROCEDURES_DEFRETURN_RETURN));
  },
  onchange: function() {
    if (this.o.sb && !this.o.sb()) {
      var a = !1,
      ...
      a
        ? ("procedures_defnoreturn" == b.type && this.$f
            ? (this.Ga("VALUE"),
              O(R(this, "VALUE"), x.g.PROCEDURES_DEFRETURN_RETURN),
              (this.$f = !1))
          ...
          this.Pe(null),
          this.vb || this.Pd(!1))
        : (this.Pe(x.g.PROCEDURES_IFRETURN_WARNING),
          this.vb || Lh(this) || this.Pd(!0));
    }
  },
...
x.ca.H.nu = {
  ff: function(a) {
    if (!this.vb) {
      ...
      else (b = "variables_get"), (c = x.g.VARIABLES_SET_CREATE_GET);
      var e = { enabled: 0 < id(this.o) },
        f = He(this, "VAR").Ib();
...
x.h.To = {};
x.h.lists_create_empty = function() {
  return ["[]", x.h.Ng];
};
x.h.lists_create_with = function(a) {
  for (var b = Array(a.Fc), c = 0; c < a.Fc; c++)
    b[c] = V(a, "ADD" + c, x.h.ec) || "null";
  return ["[" + b.join(", ") + "]", x.h.Ng];
};
x.h.lists_repeat = function(a) {
  var b = Mk("listsRepeat", [
      "function " + x.h.xd + "(value, n) {",
      "  var array = [];",
      "  for (var i = 0; i < n; i++) {",
      "    array[i] = value;",
      "  }",
...
x.h.lists_length = function(a) {
  return [(V(a, "VALUE", x.h.mb) || "[]") + ".length", x.h.mb];
};
x.h.lists_isEmpty = function(a) {
  return ["!" + (V(a, "VALUE", x.h.mb) || "[]") + ".length", x.h.bj];
};
x.h.lists_indexOf = function(a) {
  var b = "FIRST" == F(a, "END") ? "indexOf" : "lastIndexOf",
    c = V(a, "FIND", x.h.Wb) || "''";
  b = (V(a, "VALUE", x.h.mb) || "[]") + "." + b + "(" + c + ")";
  return a.o.options.Le ? [b + " + 1", x.h.Kf] : [b, x.h.Da];
};
x.h.lists_getIndex = function(a) {
  ...
  switch (c) {
    ...
    case "RANDOM":
      e =
        Mk("listsGetRandomItem", [
          "function " + x.h.xd + "(list, remove) {",
          "  var x = Math.floor(Math.random() * list.length);",
          "  if (remove) {",
...
x.h.lists_setIndex = function(a) {
  function b() {
    if (c.match(/^\w+$/)) return "";
    var a = Nk(x.h.Ra, "tmpList", x.H.Sa),
      b = "var " + a + " = " + c + ";\n";
    c = a;
    return b;
  }
  ...
  switch (f) {
    ...
    case "FROM_END":
      ...
      a = b();
      if ("SET" == e)
        return a + (c + "[" + c + ".length - " + f + "] = " + h + ";\n");
      if ("INSERT" == e)
        return (
          a + (c + ".splice(" + c + ".length - " + f + ", 0, " + h + ");\n")
        );
      break;
    case "RANDOM":
      a = b();
      ...
      if ("INSERT" == e) return a + (c + ".splice(" + f + ", 0, " + h + ");\n");
  }
  throw "Unhandled combination (lists_setIndex).";
};
x.h.To.Cw = function(a, b, c) {
  return "FIRST" == b
    ? "0"
    : "FROM_END" == b
    ? a + ".length - 1 - " + c
...
x.h.lists_sort = function(a) {
  ...
  a = F(a, "TYPE");
  var e = Mk("listsGetSortCompare", [
    "function " + x.h.xd + "(type, direction) {",
    "  var compareFuncs = {",
...
x.h.lists_split = function(a) {
  var b = V(a, "INPUT", x.h.mb),
    c = V(a, "DELIM", x.h.Wb) || "''";
  a = F(a, "MODE");
...
x.h.lists_reverse = function(a) {
  return [(V(a, "LIST", x.h.Da) || "[]") + ".slice().reverse()", x.h.Da];
};
x.h.wx = {};
x.h.controls_if = function(a) {
  var b = 0,
    c = "";
  do {
    var e = V(a, "IF" + b, x.h.Wb) || "false";
    var f = Jk(a, "DO" + b);
    c += (0 < b ? " else " : "") + "if (" + e + ") {\n" + f + "}";
    ++b;
  } while (K(a, "IF" + b));
...
x.h.logic_operation = function(a) {
  var b = "AND" == F(a, "OP") ? "&&" : "||",
    c = "&&" == b ? x.h.kn : x.h.ln,
    e = V(a, "A", c);
  a = V(a, "B", c);
...
x.h.logic_negate = function(a) {
  var b = x.h.bj;
  return ["!" + (V(a, "BOOL", b) || "true"), b];
};
x.h.logic_boolean = function(a) {
  return ["TRUE" == F(a, "BOOL") ? "true" : "false", x.h.Ng];
};
x.h.logic_null = function() {
  return ["null", x.h.Ng];
};
x.h.logic_ternary = function(a) {
  var b = V(a, "IF", x.h.al) || "false",
    c = V(a, "THEN", x.h.al) || "null";
  a = V(a, "ELSE", x.h.al) || "null";
  return [b + " ? " + c + " : " + a, x.h.al];
};
x.h.yx = {};
x.h.controls_repeat_ext = function(a) {
  var b = He(a, "TIMES")
      ? String(Number(F(a, "TIMES")))
      : V(a, "TIMES", x.h.Ze) || "0",
    c = Jk(a, "DO");
  c = Kk(c, a.id);
  a = "";
  var e = Nk(x.h.Ra, "count", x.H.Sa),
    f = b;
  b.match(/^\w+$/) ||
    x.ig(b) ||
    ((f = Nk(x.h.Ra, "repeat_end", x.H.Sa)),
    (a += "var " + f + " = " + b + ";\n"));
  return (
    a +
    ("for (var " +
...
x.h.controls_whileUntil = function(a) {
  var b = "UNTIL" == F(a, "MODE"),
...
x.h.controls_for = function(a) {
  ...
  if (x.ig(c) && x.ig(e) && x.ig(f)) {
    ...
    (a = ""),
      ...
      c.match(/^\w+$/) ||
        x.ig(c) ||
        ((k = Nk(x.h.Ra, b + "_start", x.H.Sa)),
        (a += "var " + k + " = " + c + ";\n")),
      (c = e),
      e.match(/^\w+$/) ||
        x.ig(e) ||
        ((c = Nk(x.h.Ra, b + "_end", x.H.Sa)),
        (a += "var " + c + " = " + e + ";\n")),
      (e = Nk(x.h.Ra, b + "_inc", x.H.Sa)),
      (a += "var " + e + " = "),
      (a = x.ig(f)
        ? a + (Math.abs(f) + ";\n")
        : a + ("Math.abs(" + f + ");\n")),
...
x.h.controls_forEach = function(a) {
  var b = x.h.Ra.getName(F(a, "VAR"), x.H.Sa),
    c = V(a, "LIST", x.h.Ze) || "[]",
    e = Jk(a, "DO");
  e = Kk(e, a.id);
  ...
  var f = c;
  c.match(/^\w+$/) ||
    ((f = Nk(x.h.Ra, b + "_list", x.H.Sa)),
    (a += "var " + f + " = " + c + ";\n"));
  c = Nk(x.h.Ra, b + "_index", x.H.Sa);
  e = x.h.Xe + b + " = " + f + "[" + c + "];\n" + e;
  return a + ("for (var " + c + " in " + f + ") {\n" + e + "}\n");
};
x.h.controls_flow_statements = function(a) {
  switch (F(a, "FLOW")) {
    case "BREAK":
      return "break;\n";
    case "CONTINUE":
...
x.h.gy = {};
x.h.procedures_defreturn = function(a) {
  var b = x.h.Ra.getName(F(a, "NAME"), x.ra.Sa),
    c = Jk(a, "STACK");
  if (x.h.Wh) {
    var e = a.id.replace(/\$/g, "$$$$");
    c = Ik(x.h.Wh.replace(/%1/g, "'" + e + "'"), x.h.Xe) + c;
  }
  x.h.Zk && (c = x.h.Zk.replace(/%1/g, "'" + a.id + "'") + c);
  (e = V(a, "RETURN", x.h.Wb) || "") && (e = x.h.Xe + "return " + e + ";\n");
  for (var f = [], h = 0; h < a.W.length; h++)
    f[h] = x.h.Ra.getName(a.W[h], x.H.Sa);
  c = "function " + b + "(" + f.join(", ") + ") {\n" + c + e + "}";
  c = x.h.Lm(a, c);
  x.h.Ug["%" + b] = c;
  return null;
...
x.h.procedures_callreturn = function(a) {
  for (
    var b = x.h.Ra.getName(F(a, "NAME"), x.ra.Sa), c = [], e = 0;
    e < a.W.length;
    e++
  )
    c[e] = V(a, "ARG" + e, x.h.ec) || "null";
  return [b + "(" + c.join(", ") + ")", x.h.Da];
};
x.h.procedures_callnoreturn = function(a) {
  for (
    var b = x.h.Ra.getName(F(a, "NAME"), x.ra.Sa), c = [], e = 0;
    e < a.W.length;
    e++
...
x.h.procedures_ifreturn = function(a) {
  var b = "if (" + (V(a, "CONDITION", x.h.Wb) || "false") + ") {\n";
  a.$f
    ? ((a = V(a, "VALUE", x.h.Wb) || "null"),
      (b += x.h.Xe + "return " + a + ";\n"))
    : (b += x.h.Xe + "return;\n");
  return b + "}\n";
};
x.h.Ly = {};
x.h.variables_get = function(a) {
  return [x.h.Ra.getName(F(a, "VAR"), x.H.Sa), x.h.Ng];
};
x.h.variables_set = function(a) {
  var b = V(a, "VALUE", x.h.Ze) || "0";
  return x.h.Ra.getName(F(a, "VAR"), x.H.Sa) + " = " + b + ";\n";
};
x.D.controls_if.I = function() {
  ...
  this.ka(function() {
    if (a.Gb || a.Xb) {
      if (!a.Gb && a.Xb) return x.g.CONTROLS_IF_TOOLTIP_2;
      if (a.Gb && !a.Xb) return x.g.CONTROLS_IF_TOOLTIP_3;
      if (a.Gb && a.Xb) return x.g.CONTROLS_IF_TOOLTIP_4;
    } else return x.g.CONTROLS_IF_TOOLTIP_1;
    return "";
  });
  this.Xb = this.Gb = 0;
};
x.D.controls_if.Ub = function() {
  K(this, "ELSE") && (this.Ga("ELSEMSG"), this.Ga("ELSE"));
  for (var a = 1; K(this, "IF" + a); )
    this.Ga("IF" + a), this.Ga("TAIL" + a), this.Ga("DO" + a), a++;
  for (a = 1; a <= this.Gb; a++)
    O(Q(this, "IF" + a).Ua("Boolean"), "} else if ("),
      O(R(this, "TAIL" + a), ") {"),
      Mh(this, "DO" + a);
...
x.D.logic_compare.I = function() {
  ...
  this.ka(function() {
    var b = F(a, "OP");
    return {
      EQ: x.g.LOGIC_COMPARE_TOOLTIP_EQ,
      NEQ: x.g.LOGIC_COMPARE_TOOLTIP_NEQ,
      LT: x.g.LOGIC_COMPARE_TOOLTIP_LT,
      LTE: x.g.LOGIC_COMPARE_TOOLTIP_LTE,
      GT: x.g.LOGIC_COMPARE_TOOLTIP_GT,
      GTE: x.g.LOGIC_COMPARE_TOOLTIP_GTE
    }[b];
  });
  this.Hi = [null, null];
};
...
x.D.controls_whileUntil.I = function() {
  Nh(this, {
    ...
    previousStatement: null,
    nextStatement: null,
    colour: x.g.LOOPS_HUE,
    tooltip: x.g.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE,
    helpUrl: x.g.CONTROLS_WHILEUNTIL_HELPURL
  });
};
x.D.controls_for.I = function() {
  Nh(this, {
    ...
    nextStatement: null,
    colour: x.g.LOOPS_HUE,
    helpUrl: x.g.CONTROLS_FOR_HELPURL
  });
  var a = this;
  this.ka(function() {
    return x.g.CONTROLS_FOR_TOOLTIP.replace("%1", F(a, "VAR"));
  });
};
x.D.controls_for.onchange = function() {
  var a = F(this, "VAR");
  Kh(this, a, "VAR1");
  Kh(this, a, "VAR2");
};
...
x.D.math_arithmetic.I = function() {
  Nh(this, {
    ...
    output: "Number",
    colour: x.g.MATH_HUE,
    helpUrl: x.g.MATH_ARITHMETIC_HELPURL
  });
  var a = this;
  this.ka(function() {
    var b = F(a, "OP");
...
x.D.math_change.I = function() {
  Nh(this, {
    ...
    previousStatement: null,
    nextStatement: null,
    colour: x.g.VARIABLES_HUE,
    helpUrl: x.g.MATH_CHANGE_HELPURL
  });
  var a = this;
  this.ka(function() {
    return x.g.MATH_CHANGE_TOOLTIP.replace("%1", F(a, "VAR"));
  });
};
x.h.math_change = function(a) {
  var b = V(a, "DELTA", x.h.Kf) || "0";
...
x.D.math_random_int.I = function() {
  Nh(this, {
    message0: "%1(%2,%3)",
    args0: [
      "Math.randomInt",
    ...
    output: "Number",
    colour: x.g.MATH_HUE,
    tooltip: x.g.MATH_RANDOM_INT_TOOLTIP,
    helpUrl: x.g.MATH_RANDOM_INT_HELPURL
  });
};
x.g.MATH_RANDOM_FLOAT_TITLE_RANDOM = "Math.random  (  )";
x.g.LISTS_CREATE_EMPTY_TITLE = "[ ]";
x.g.LISTS_CREATE_WITH_INPUT_WITH = "[";
x.D.lists_create_with.Ub = function() {
  K(this, "TAIL") && this.Ga("TAIL");
  this.Fc && K(this, "EMPTY")
    ? this.Ga("EMPTY")
    : this.Fc ||
      K(this, "EMPTY") ||
  ...
  for (var a = 0; a < this.Fc; a++)
    if (!K(this, "ADD" + a)) {
      var b = Q(this, "ADD" + a);
      0 == a ? O(b, x.g.LISTS_CREATE_WITH_INPUT_WITH) : O(b, ",");
    }
  for (; K(this, "ADD" + a); ) this.Ga("ADD" + a), a++;
...
x.D.lists_getIndex = {
  I: function() {
    Nh(this, {
      ...
      tooltip:
        x.g.LISTS_GET_INDEX_TOOLTIP_GET_FROM +
        x.g.LISTS_INDEX_FROM_START_TOOLTIP.replace("%1", "#0"),
      helpUrl: x.g.LISTS_GET_INDEX_HELPURL
    });
  }
};
x.D.lists_setIndex = {
  I: function() {
    Nh(this, {
      ...
      tooltip:
        x.g.LISTS_SET_INDEX_TOOLTIP_SET_FROM +
        x.g.LISTS_INDEX_FROM_START_TOOLTIP.replace("%1", "#0"),
      helpUrl: x.g.LISTS_SET_INDEX_HELPURL
    });
  }
};
x.g.LISTS_LENGTH_TITLE = "%1 . length";
x.D.variables_get.I = function() {
  this.Ta = x.g.VARIABLES_GET_HELPURL;
  this.Ha(x.g.VARIABLES_HUE);
  O(R(this), new Ck("name"), "VAR");
  this.Ic(!0);
  this.ka(x.g.VARIABLES_GET_TOOLTIP);
};
x.D.variables_set.I = function() {
  this.Ta = x.g.VARIABLES_SET_HELPURL;
  this.Ha(x.g.VARIABLES_HUE);
...
x.D.procedures_defnoreturn.I = function() {
  var a = new tj("", x.ra.Fm);
...
x.D.procedures_defreturn.I = function() {
  var a = new tj("", x.ra.Fm);
  O(O(O(O(O(R(this), "function"), a, "NAME"), "("), "", "PARAMS"), ") {");
...
x.D.procedures_callnoreturn.I = function() {
  this.Ta = x.g.PROCEDURES_CALLNORETURN_HELPURL;
  this.Ha(x.g.PROCEDURES_HUE);
  O(O(R(this), "", "NAME"), "(");
  O(R(this, "TAIL"), ");");
...
x.D.procedures_callnoreturn.Ub = function() {
  for (var a = 0; a < this.W.length; a++)
    if (!K(this, "ARG" + a)) {
      new Dh(this.W[a]);
      var b = Q(this, "ARG" + a);
...
x.D.procedures_callreturn.I = function() {
  this.Ta = x.g.PROCEDURES_CALLRETURN_HELPURL;
  this.Ha(x.g.PROCEDURES_HUE);
  O(O(R(this), "", "NAME"), "(");
  O(R(this, "TAIL"), ")");
...
x.D.pond_scan = {
  I: function() {
    Nh(this, {
      ...
      output: "Number",
      colour: 290,
      tooltip: W("Pond_scanTooltip")
    });
  }
};
x.h.pond_scan = function(a) {
  return ["scan(" + (V(a, "DEGREE", x.h.Wb) || 0) + ")", x.h.Da];
};
x.D.pond_cannon = {
  I: function() {
    Nh(this, {
      ...
      nextStatement: null,
      colour: 290,
      tooltip: W("Pond_cannonTooltip")
    });
  }
};
x.h.pond_cannon = function(a) {
  var b = V(a, "DEGREE", x.h.ec) || 0;
  a = V(a, "RANGE", x.h.ec) || 0;
  return "cannon(" + b + ", " + a + ");\n";
};
x.D.pond_swim = {
  I: function() {
    Nh(this, {
      ...
      nextStatement: null,
      colour: 290,
      tooltip: W("Pond_swimTooltip")
    });
  }
};
x.h.pond_swim = function(a) {
  return "swim(" + (V(a, "DEGREE", x.h.Wb) || 0) + ");\n";
};
x.D.pond_stop = {
  I: function() {
    Nh(this, {
      ...
      nextStatement: null,
      colour: 290,
      tooltip: W("Pond_stopTooltip")
    });
  }
};
x.h.pond_stop = function() {
  return "stop();\n";
};
x.D.pond_health = {
  I: function() {
    Nh(this, {
      ...
      output: "Number",
      colour: 290,
      tooltip: W("Pond_healthTooltip")
    });
  }
};
x.h.pond_health = function() {
  return ["health()", x.h.Da];
};
x.D.pond_speed = {
  I: function() {
    Nh(this, {
      ...
      output: "Number",
      colour: 290,
      tooltip: W("Pond_speedTooltip")
    });
  }
};
x.h.pond_speed = function() {
  return ["speed()", x.h.Da];
};
x.D.pond_getX = {
  I: function() {
    Nh(this, {
      ...
      output: "Number",
      colour: 290,
      tooltip: W("Pond_locXTooltip")
    });
  }
};
x.h.pond_getX = function() {
  return ["getX()", x.h.Da];
};
x.D.pond_getY = {
  I: function() {
    Nh(this, {
      ...
      output: "Number",
      colour: 290,
      tooltip: W("Pond_locYTooltip")
    });
  }
};
x.h.pond_getY = function() {
  return ["getY()", x.h.Da];
};
x.D.pond_math_number = {
  I: function() {
    this.Ta = x.g.MATH_NUMBER_HELPURL;
    this.Ha(x.g.MATH_HUE);
    O(R(this, "DUMMY"), new Bk(0), "NUM");
    this.Ic(!0, "Number");
    this.ka(x.g.MATH_NUMBER_TOOLTIP);
  },
  onchange: function() {
    if (this.o && this.M.Ia && this.M.Ia.Wd) {
      var a = K(this, "DUMMY"),
        b = He(this, "NUM"),
        c = b.getValue();
      -1 != this.M.Ia.Wd.indexOf("Angle")
        ? b.constructor != Ij &&
          (x.j.disable(),
          Gh(a, "NUM"),
          (b = new Ij("")),
          ...
          x.j.enable())
        : b.constructor != Bk &&
          (x.j.disable(), Gh(a, "NUM"), O(a, new Bk(c), "NUM"), x.j.enable());
    }
  }
};
x.D.pond_math_single = {
  I: function() {
    Nh(this, {
      ...
      output: "Number",
      colour: x.g.MATH_HUE,
      helpUrl: x.g.MATH_SINGLE_HELPURL
    });
    var a = this;
    this.ka(function() {
      var b = F(a, "OP");
...
x.h.pond_math_single = function(a) {
  var b = F(a, "OP");
  a = V(a, "NUM", x.h.Wb) || "0";
  switch (b) {
    case "ABS":
...
Em.prototype.Ym = function() {
  if (this.Nn === Dm) return Ld(this.toString());
  if (this.Nn !== Cm)
    throw Error("Sanitized content was not of kind TEXT or HTML.");
  return Md(this.toString(), this.Mn || null);
};
function Fm(a) {
  if (null != a)
    switch (a.Mn) {
...
Gm.prototype.Nn = Cm;
function Hm(a) {
  return null != a && a.Nn === Cm
    ? a
    : Im(String(String(a)).replace(Jm, Km), Fm(a));
}
var Im = (function(a) {
    function b() {}
...
d.T = function(a) {
  var b = Om.s.T.call(this, a);
  (a = a.to()) && this.ka(b, a);
  return b;
};
d.Fd = function(a, b) {
  b = Om.s.Fd.call(this, a, b);
  var c = this.to(b);
  c && (a.Nt = c);
  a.bk() && (c = a.getParent()) && v(c.Ni) && (a.Qd(8, !1), c.Ni(a));
  return b;
};
d.to = function(a) {
  return a.title || "";
...
function Pm(a, b, c) {
  U.call(this, a, b || Om.Id(), c);
  this.rc(8, !0);
  this.Bf |= 9;
}
w(Pm, U);
Pm.prototype.to = function() {
  return this.Nt;
};
...
Qm.prototype.Rp = function(a, b, c) {
  this.Bs || (this.ol || Rm(this), (this.Bs = db(this.ol)));
  var e = this.Bs[b];
  e
    ? (a.setOrientation(e == Sm || e == Tm ? Gi : Fi), (a.Cs = e))
    : Qm.s.Rp.call(this, a, b, c);
};
Qm.prototype.bh = function(a) {
  var b = Qm.s.bh.call(this, a);
  this.ol || Rm(this);
  b.push(this.ol[a.Cs]);
  return b;
};
...
d.removeChild = function(a, b) {
  Ym(this, a);
  return Wm.s.removeChild.call(this, a, b);
};
d.Mp = function(a) {
  Wm.s.Mp.call(this, a);
...
d.Ni = function(a) {
  a ? a.Mi(!0) : this.Nd && this.Nd.Mi(!1);
};
function Ym(a, b) {
  if (b && b == a.Nd) {
    for (var c = di(a, b), e = c - 1; (b = S(a, e)); e--)
      if (b.Y() && b.isEnabled()) {
        a.Ni(b);
        return;
      }
...
d.Uw = function(a) {
  this.Nd && this.Nd != a.target && this.Nd.Mi(!1);
  this.Nd = a.target;
};
d.Vw = function(a) {
  a.target == this.Nd && (this.Nd = null);
};
d.Sw = function(a) {
  Ym(this, a.target);
};
...
d.Nj = function() {
  S(this, this.va) || this.Sb(this.Nd || S(this, 0));
};
function Xm(a) {
  Yh(a)
    .ia(a, "select", a.Uw)
...
var $l = "pond-duck",
  ...
  $m = !0;
function an(a) {
  for (var b = ["blockly", "editor"], c = 0, e; (e = b[c]); c++)
    (e = document.getElementById(e)),
      (e.style.visibility = c == a ? "visible" : "hidden");
  b = [".blocklyTooltipDiv", ".blocklyToolboxDiv"];
  for (c = 0; (e = b[c]); c++)
  ...
  wm &&
    (document.getElementById("frameDocs").src =
      "pond/docs.html?lang=" + Pl + "&mode=" + Sl);
  1 == a && Zm && ((a = Fk()), ($m = !0), Y.xc.setValue(a, -1), ($m = !1));
}
function bn() {
  if (!$m)
    if (Zm)
      if (!fd(Gk, !1).length || confirm(W("Games_breakLink")))
        S(Mm, 0).yf(!1), (Zm = !1);
      else {
        var a = Fk();
        $m = !0;
      ...
      (a = Y.xc.getValue()),
        a.trim() || (Gk.clear(), S(Mm, 0).yf(!0), (Zm = !0));
}
window.addEventListener("load", function() {
  function a() {
    ...
    a = Math.max(0, a + e.offsetHeight - window.pageYOffset) + "px";
    for (
      var f = b ? "10px" : "420px",
        h = window.innerWidth - 440 + "px",
        l = 0,
        m;
      (m = k[l]);
      l++
    )
      (m.style.top = a), (m.style.left = f), (m.style.width = h);
  }
  document.body.innerHTML = Nm();
  Y.I();
  nm();
  am("runButton", zm);
  am("resetButton", Bm);
  ...
  a(null);
  ec(Mm, "select", function(a) {
    a = a.target.getParent();
    an(di(a, a.Nd));
  });
  ...
  Gk.In();
  f = [
    { start: new D(20, 80), kc: 0, name: "Pond_myName", code: null },
    { start: new D(80, 20), kc: 0, name: "Pond_rookName", code: "playerRook" },
    {
      start: new D(20, 20),
      kc: 0,
  ...
  for (var l = 0; (h = f[l]); l++) {
    var m = h.code
        ? document.getElementById(h.code).textContent
        : function() {
            return Zm ? Fk() : Y.xc.getValue();
          },
      n = W(h.name);
    Z.iv(n, m, h.start, h.kc);
  }
  Z.reset();
  pm();
  an(0);
